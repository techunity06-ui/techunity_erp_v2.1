...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								<header class="panel-heading">
									<span class="tools pull-right">
										<!--<a href="javascript:;" onClick="tableToExcel('stock-table', 'Instalment Collection')" ><button class="btn btn-success btn-flat" >Export Excel</button></a>-->	
										<a href="<?=ROOT.'generate_export_product_stock_csv'?>" ><button class="btn btn-info btn-flat" ><i class="fa fa-download" aria-hidden="true"></i> Export Items</button></a>
									</span>
									<span class="tools pull-right">
									 ...
									 if(empty($start_date)){
									  ...
									  ?>
										 ...
										 <input type="hidden" id="product_name"  value="<?= @$product_name?>">
         					 		        <input type="text" id="rep_date"  onChange="generate_report_stock();" class="form-control datepikerdemo" value="">
											...
											<div class="col-md-4" >
												  <label class="control-label col-md-4  text-right">Choose Product</label>
												
												<div class="col-md-8">
												<input id="product_id" name="product_id"  style="width:100% !important"  placeholder="Select product" onchange="generate_report_stock();load_batch_no(this.value)" />
											</div>
											</div>
											<div class="col-md-4" >
												<label class="control-label col-md-4  text-right">Batch No</label>
												<div class="col-md-8">
													<select  class="select2" name="batch_no" id="batch_no" onChange="generate_report_stock();" style="width:100% !important" readonly>
														
													</select> 
												</div>
											</div>
											<div class='col-lg-4 col-md-6 col-xs-12' style="margin-top: 10px;">
									<?php if($branch_id=='0'){ ?>
												<div class="col-md-12">
													
													<?php echo getBranchBox($dbcon, $branch_id,$select_branchId, $branch_read, false, 'generate_report_stock();'); ?>	
												</div>
		...
		<script src="<?=ROOT.REPORT_ROOT?>js/app/batch_stock_report.js?<?=time()?>"></script>
