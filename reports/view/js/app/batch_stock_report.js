...
function generate_report_stock() 
{
	...
	$.ajax({
		type: "POST",
		url: root_domain+report_domain+'app/batch_stock_report/',
		data: { mode : "generate_report_stock", date :  date,product_id:product_id,date:date,batch_no:batch_no,branch_id:branch_id},
...
/*function generate_report_stock() 
{
	...
	var datatable = $("#stock-table").dataTable({
			...
			"iDisplayLength": 10,
			"sAjaxSource": root_domain+report_domain+'app/batch_stock_report/',
...
function product_load(){
	...
	//$("#product_id").html("");
	var mainurl = root_domain+ report_domain +'app/batch_stock_report/index.php?mode=product_load&inquiry_type='+inquiry_type+'&type=production_pro_type&search=bom_pro_search';
