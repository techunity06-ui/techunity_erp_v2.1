<div class="modal colored-header info " id="add_income_head_modal" role="dialog" data-keyboard="false" data-backdrop="static">
...
<div class="modal-content">
	...
	<div class="modal-body form">
		<div class="row"> 
			<div class="col-md-12"> 
			<form class="form-horizontal" role="form" id="group_add" action="javascript:;" method="post" name="income_head_add"> 
