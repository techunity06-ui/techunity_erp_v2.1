<div class="modal colored-header info " id="bs-dispatch-modal" role="dialog" data-keyboard="false" data-backdrop="static">
			...
			<form class="form-horizontal" role="form" id="dispatch" action="javascript:;" method="post" name="dispatch">
				...
				<div class="col-md-12">
			      <div class="form-group">
					<label class="col-md-12 control-label" style="text-align:left;line-height:25px">Mode Of Dispatch</label>
						<div class="col-md-12 col-xs-11">
							<!--<input type="text" class="form-control" placeholder="Payment Terms" name="payment_terms" id="payment_terms"  title="Payment Terms"/>-->
							  <input type="text" class="form-control" id="mode_dispatch" name="mode_dispatch" placeholder="Mode Of Dispatch">
						</div>
