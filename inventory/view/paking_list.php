		...
		<div class="col-sm-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<div class="col-md-4">
						<label class="col-md-4 control-label" style="white-space:nowrap;">Status</label>
						<div class="col-md-8" style="padding-left: 9px;">
							<select class="select2" name="pstatus" id="pstatus" title="Select Status" onChange="load_grn_datatable();" >
								<option value=""> All </option>
								<option value="2">Invoice Pending </option>
								<option value="1">Invoice Done </option>
							</select>
						</div>  
					</div>
					...
					<span class="tools pull-right">
						<a href="<?=ROOT.INVENTORY_ROOT.'paking_add'?>"><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>
					</span>	
					<?php //} ?>
				</header>	
