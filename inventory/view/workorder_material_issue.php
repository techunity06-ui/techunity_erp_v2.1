...
$back_link = ROOT.PRODUCTION_ROOT.'work_order';
$mode = "Add";
...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	...
	// if(!in_array(INVENTORY_WORKORDER_MATERIAL_ISSUE_LIST_SLUG_VIEW,$bulkAccessArray)){
...
<html lang="en">
<head>
	<title>WORKORDER MATERIAL ISSUE LIST</title>
...
<body>
  <section id="container" >
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				...
				<span class="tools pull-right">
					<a href="<?=ROOT.INVENTORY_ROOT.'workorder_material_issue_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>	
	...
	<?php include_once($include1.'workorder_direct_material_aprv_hist.php');?>
