			...
			?>
					...
					<tr >
						...
						<tr style="font-size: 10px;">
							<td style="width:30%;white-space:nowrap;"><strong>Cat. No.: <span style="margin-left:5px"><?=$batch_rel['product_icode']?></span></strong></td>
							...
							<td style="width:40%;"><!-- <strong><span style="margin-left:5px"><?=$batch_rel['product_icode']?></span></strong>--></td>
						</tr>
						<tr style="font-size: 10px;">
							<td style=""><strong>Material: <span style="margin-left:5px;font-size: 8px;"><?=$batch_rel['smpl_material']?></span></strong></td>
							...
							<td style=""><strong><span style="margin-left:5px"><?=$batch_rel['batch_no']?></span></strong></td>
						</tr>
						<tr style="font-size: 8px;">
							...
							<td style="font-size: 5px;text-align: end;vertical-align: top;width:20%;"><img style="width: 35px;" src="../stickerprinting/EC_representativenew.jpg" /><!--<span style="border: 1px solid black;padding:2px">EC <span style="border-left: 1px solid black;padding:2px">REP</span></span>--></td>
						...
						<tr style="font-size: 8px;">
							<td colspan="3" style="width:70%;">
								...
								<img style="height: 22px;margin-left:5px;" src="../stickerprinting/non_sterilenew.jpg" />
