<?php 
	...
	$bulkAccessArray = canCheckPermissionAccess($dbcon, [
			OVERDUE_PO_PRO_VIEW,OVERDUE_PO_PRO_ADD
	]);
	if(!in_array(OVERDUE_PO_PRO_VIEW,$bulkAccessArray)){
			...
			<div class="col-sm-12">
				<section class="panel">
						...
						<div class="form-group">
							...
							<div class=" col-lg-9 col-md-9 col-xs-9">
								<div class="input-group date form_datetime-component">
									...
									<input type="text" id="rep_date" onChange="load_po_req_datatable();" class="form-control datepikerdemo" value="" autocomplete="off">
					...
					<div class="col-md-3">
							...
							<input id="product_id" name="product_id"  style="width:100% !important"  placeholder="Select product" onchange="load_po_req_datatable();" />
							</div>					
						</div>
					</div>
					...
					<div class="col-md-3">
						...
						<div class="col-md-8" style="padding-left: 9px;">
							<select class="select2" name="vender_id" id="vender_id" required title="Select Vender" onChange="load_po_req_datatable();" >
						...
						<span class="tools pull-right mtop20">
							<a href="<?=ROOT.INVENTORY_ROOT.'grn_add_new'?>" ><button class="btn btn-success btn-flat" >Create GRN</button></a>
						</span>	
						<?php } ?>			 
					</header>
...
<script src="<?=ROOT.INVENTORY_ROOT?>js/app/overdue_po_pro_list.js?<?=time()?>"></script>
