...
if(!in_array(PRODUCTION_STORE_LIST_APPROVE,$bulkAccessArray)){
	...
	$opening_stock_id=$dbcon->real_escape_string($_REQUEST['id']);
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
									  ...
									  <li class="active"><a href="<?=ROOT.'inventory/stock_list'?>"> Opening Stock List</a></li>
									</ul>
								</div>
							</section>
						</div>
   ...
   ?>	
					...
					border-collapse:separate;font-weight:bold;" id="batch<?=$i?>" >
						...
						<tr style="font-size: 12px;">
							...
							<td  >: <?=$batch_rel['opening_stock_qty']?> <?=$batch_rel['bunit']?></td>
						</tr>
						<!-- <tr style="font-size: 12px;">
...
disp_setting+="scrollbars=yes,width=800, height=600, left=100, top=25";
 ...
 function generateBarcode(barcodeno){
 	//alert(barcodeno);
        var value = barcodeno;
        var btype = "code39";
        var renderer = "css";
