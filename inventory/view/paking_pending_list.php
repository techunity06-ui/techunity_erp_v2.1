...
<html lang="en">
<head>
	<title>Paking Pending List</title>
			...
			<section class="panel">
				...
				<div class="">
					<ul class="breadcrumb">
						...
						<li><a href="<?=ROOT.INVENTORY_ROOT.'paking_pending_list'?>"><?=$form?> List</a></li>
					</ul>
				</div>
			</section>
			<!--breadcrumbs end -->
		...
		<div class="col-sm-12">
			<section class="panel">
				...
				<div class="panel-body"> 
					<div class="adv-table">
						<table class="display table table-bordered table-striped" id="dynamic-table_new">
							<thead>
								<tr> 
									<th>Sr No</th> 
									<th>Sales Order</th> 
