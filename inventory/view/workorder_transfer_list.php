<?php 
	...
	$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	    INVENTORY_WORKORDER_TRANSFER_SLUG_VIEW,INVENTORY_WORKORDER_TRANSFER_SLUG_CREATE
	]);

	if(!in_array(INVENTORY_WORKORDER_TRANSFER_SLUG_VIEW,$bulkAccessArray)){
...
<body>
  <section id="container" >
					  ...
					  <header class="panel-heading">
						...
						<?php //include_once("../include/head_menu.php") ?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.INVENTORY_ROOT.'stock_transfer_list'?>">Workorder Transfer List</a></li>
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				<section class="panel">
									...
									?>
                                        <input type="hidden" id="from_date"  value="<?=$start?>">
										 <input type="hidden" id="to_date"  value="<?=$end?>">
         					 		        <input type="text" id="rep_date"  onChange="load_workorder_transfer_datatable();;" class="form-control datepikerdemo" value="">
				 ...
				 <?php if(in_array(INVENTORY_WORKORDER_TRANSFER_SLUG_CREATE,$bulkAccessArray)){ ?>		
				 <span class="tools pull-right">
					<a href="<?=ROOT.INVENTORY_ROOT.'workorder_transfer'?>" ><button class="btn btn-success btn-flat" >Workorder Transfer</button></a>					
				 </span>
				 <?php } ?>
	...
	<?php include_once($include1.'workorder_transfer_approve_model.php');?>
	
   <script src="<?=ROOT.INVENTORY_ROOT?>js/app/workorder_transfer.js"></script>
