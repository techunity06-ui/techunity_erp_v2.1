<?php 
	...
	$query="select * from tbl_batch_data where grn_id = '$grn_id'";
			...
			<th colspan="8" style="padding:0px !important;">
				<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
					...
					?>					
							...
							<td width="50%" style="vertical-align:top;border:1px solid;"><?php echo $product_res['product_name']; ?></td>
							</tr>
							<tr>
							...
							<td width="50%" style="vertical-align:top;border:1px solid;"><?php echo  $rel['batch_qty'].'/'.$rel['batch_no'];?></td>
							</tr>
							...
							<td width="50%" style="vertical-align:top;border:1px solid;"><?php echo $bundle;?></td>
							</tr>
							<tr>
							...
							<td width="50%" style="vertical-align:top;border:1px solid;">  <?php echo $grn_res['product_qty']; ?></td>
							</tr>
							<tr>
