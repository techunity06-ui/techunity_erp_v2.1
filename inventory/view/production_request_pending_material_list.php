<?php 
	...
	$form="Store Release Pending List";
...
<html lang="en">
	<head>
		<title>Store Release Pending List</title>
	...
	<body>
		...
		<?php include_once($include.'include_js_file.php');?>   
		 <?php include_once($include1.'store_release_modal.php'); ?>
		 <?php include_once($include1.'batch_wise_release_modal.php'); ?>
		<script src="<?=ROOT.INVENTORY_ROOT?>js/app/store_release_list.js?<?=time()?>"></script>
