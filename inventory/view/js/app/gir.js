...
$("#gir_add").on('submit',function(e) {
	...
	$.ajax({
		cache:false,
		url: root_domain+inventory_domain+'app/gir/',
		type: "POST",
		data: form_data,
		contentType: false,
		processData:false,
		success: function(response)
		{
			...
			if(arr.msg == '1') {
				...
				window.location=root_domain+inventory_domain+'gir_list'; 
			}
			else if(arr.msg == '0') {
...
function load_gir_datatable()
{
	...
	datatable = $("#gir-table").dataTable({
		...
		"oLanguage": {
			"sLengthMenu": "_MENU_",
			"sProcessing": "<img src='"+root_domain+inventory_domain+"img/loading.gif'/> Loading ...",
			"sEmptyTable": "NO DATA ADDED YET !",
		},
		"aLengthMenu": [[10, 20, 30, 50], [10, 20, 30, 50]],
		"iDisplayLength": 10,
		"sAjaxSource": root_domain+inventory_domain+'app/gir/',
