<div class="modal colored-header info" id="store_aprv_hist_modal" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="btn_close  close md-close" data-dismiss="modal" aria-hidden="true">Close &times;</button>
				<h3>Approval : #<span id="apprv_issue_no"></span></h3>
			</div>
			<div class="modal-body form">
				<div class="row">
						...
						<div class="form-group">
							<table class="display table table-bordered table-striped">
								...
								<tr>
									...
									<td>
									<input type="hidden"  id="stock_receive_id"  value="">
									<input type="hidden"  id="ref_name"  value="">
					...
					<div class="col-md-12">
						<div class="form-group">
						<div class="adv-table">
							<table class="display table table-bordered table-striped" id="grn-history-datatable">
								<thead>
									<tr>
										<th>Sr. No.</th>
										<th>GRN ID</th>
