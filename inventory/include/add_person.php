				...
				<form class="form-horizontal" role="form" id="add_person_form" action="javascript:;" method="post" name="add_person_form">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-12">
                                                            <input type="email" class="form-control" name="com_email" id="com_email" placeholder="Email" required/>
							</div>
						</div>	
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-12">
                                                            <input type="text" class="form-control" name="con_mobile" id="con_mobile" placeholder="Mobile" pattern="\d*" maxlength="10"/>
							</div>
						</div>	
					</div>
					<div class="clearfix"></div>
