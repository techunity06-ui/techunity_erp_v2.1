<div class="modal colored-header info" id="preview_direct_material_aprv_hist_modal" role="dialog" data-keyboard="false" data-backdrop="static">
			...
			<div class="modal-body form">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
						<div class="adv-table">
							<table class="display table table-bordered table-striped" id="direct_material-history-datatable">
								<thead>
									<tr>
										<th>Sr. No.</th>
										<th>User</th>
