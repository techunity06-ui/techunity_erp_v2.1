<div class="modal fade full-width-modal-right in" id="bs-batch_wise_stock-modal" role="dialog" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-content">
			...
			<div class="modal-body form">
				...
				<div class="col-md-12" style="margin-top: 20px;">
					<center>						
						<input type="button"  name="m_addrow" id="m_addrow" onClick="return add_returnable_channal();"  class="btn btn-primary addbutton" value="Add"/>
