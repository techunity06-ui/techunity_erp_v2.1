<div class="modal colored-header info" id="preview_work_order_material_approval" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="btn_close  close md-close" data-dismiss="modal" aria-hidden="true">Close &times;</button>
				<h3>Approval : #<span id="material_issue_no"></span></h3>
			</div>
			<div class="modal-body form">
				<div class="row">
					<div class="col-md-12" id="detail_show"></div>
					<div class="col-md-12" id="mod_wo_per_div_sec">
		...
		<input type="hidden" id="material_issue_id" name="material_issue_id" value="">
	</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->