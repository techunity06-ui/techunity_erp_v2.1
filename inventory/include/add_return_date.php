<div class="modal fade full-width-modal-right in" id="bs-return_date-modal" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button"  class="btn_close close md-close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3>Add Return Date </h3>
			</div>
						...
						<form class="form-horizontal" role="form" id="dispatch" action="javascript:;" method="post" name="dispatch">
							...
							<div class="col-md-12" style="margin-top: 20px;">
								<center>
									...
									<input type="button"  name="m_addrow" id="m_addrow" onClick="return add_returnable_channal();"  class="btn btn-primary" value="Add"/>
