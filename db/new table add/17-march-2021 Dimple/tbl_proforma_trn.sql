...
--
-- Table structure for table `tbl_proforma_trn`
--

CREATE TABLE IF NOT EXISTS `tbl_proforma_trn` (
  `trancation_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `trancation_status` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`trancation_id`)
