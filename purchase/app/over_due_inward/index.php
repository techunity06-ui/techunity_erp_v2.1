...
if($_POST != NULL) {
	...
	if(strtolower($POST['mode']) == "fetch") {
		...
		//$branch=$_SESSION['branch_id'];
			...
			$appData = array();
			$i=1;
			$aColumns = array('foll.po_folloup_id','foll.folloup_date', 'foll.remark', 'foll.cdate');
