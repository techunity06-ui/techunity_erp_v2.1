...
<body>
  <section id="container" >
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				...
				<span class="tools pull-right">
					<a href="<?=ROOT.PURCHASE_ROOT.'purchase_card_item'?>" ><button class="btn btn-success btn-flat" >Create Item Wise <?=$form?></button></a>			
					<a href="<?=ROOT.PURCHASE_ROOT.'purchase_card_vendor'?>" ><button class="btn btn-success btn-flat" >Create Vendor Wise <?=$form?></button></a>					
				</span>
   ...
   <script src="<?=ROOT.PURCHASE_ROOT?>js/app/purchase_card.js"></script>
