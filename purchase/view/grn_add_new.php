...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li><a href="<?=ROOT.PURCHASE_ROOT.'grn_list'?>"><?=$form?> List</a></li>
									</ul>
								</div>
							</section>
						</div>	
											...
											<div class="col-md-12" style="margin-top:10px;">
												<div class="col-md-4">
													...
													<div class="col-md-8" style="padding-left: 9px;">
														<select class="select2" name="grn_against" id="grn_against" title="Select GRN Against" onChange="get_order_no();" required>
												...
												<div class="col-md-4">
													...
													<div class="col-md-8" style="padding-left: 9px;">
														<select class="select2" name="vender_id" id="vender_id" required title="Select Vender" onChange="get_order_no();load_purhcase_order_data();" >
															<option value="">--Seelct Vender--</option>
												...
												<div class="col-md-4">
													...
													<div class="col-md-8">
														<?php if($mode=='Add'){?>
															...
															<select class="select2" name="purchaseorder_id" id="purchaseorder_id" onChange="load_purhcase_order_data()">
													...
													<div class="col-md-12 col-xs-11">
														<table cellspacing="10" style=" border-spacing:10px;" class="display table table-bordered table-striped">
															<tr id="field">
																...
																<th width="10%" class="text-center">Godown</th>
		...
		<script src="<?=ROOT.PURCHASE_ROOT?>js/app/grn.js?<?=time()?>"></script>
		<script>
