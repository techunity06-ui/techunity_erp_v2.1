...
<html lang="en">
	...
	<body>
				...
				<section class="wrapper">
					...
					<div class="row">			
						<div class="col-sm-12">
							<section class="panel">
								<header class="panel-heading">
									<div class='col-lg-5 col-md-7 col-xs-9' style="display: none;">
		...
		<script src="<?=ROOT.PURCHASE_ROOT?>js/app/po_inward_follow_up.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
