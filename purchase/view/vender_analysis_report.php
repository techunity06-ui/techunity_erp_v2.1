...
$form="Vendor Analysis Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        VENDOR_ANALYSIS_VIEW
]);
if(!in_array(VENDOR_ANALYSIS_VIEW,$bulkAccessArray)){
...
<body>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-6">
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<label>
														<div class='external-event label label-primary ui-draggable' style='position: relative;width:110px;'>All</div>					
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="allanalysisreport" checked="" onchange="report_require(this.value)">
													</label>
												</div>
												<div class="col-md-6">
													<label>
														<div class='external-event label label-primary ui-draggable' style='position: relative;width:110px;'>Vendor Wise</div>					
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="vendorwiseanalysisreport" checked="" onchange="report_require(this.value)">
													</label>
												</div>
												<div class="col-md-6">
													<label>
														<div class='external-event label label-warning  ui-draggable' style='position: relative;width:110px;'>Delivery Analysis</div>					
														<input id="task_status_all" name="analysis_type" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="delivery" checked="">
													</label>
												</div>
												<div class="col-md-6" style="display:none">
													<label>
														<div class='external-event label label-warning  ui-draggable' style='position: relative;width:110px;'>Rejection Analysis</div>					
														<input id="task_status_all" name="analysis_type" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="rejection">
													</label>
												</div>
											</div>
											...
											<!-- <div class="col-md-12">
												<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="vendorwiseanalysisreport" checked="">
													</label>
												</div>
												<div class="col-md-6">
													<label>
											...
											<!-- <div class="col-md-12">
												<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="itemwisesummaryreport">
													</label>
												</div>
											</div> -->
										</div>
										...
										<!-- <div class="col-md-3">
											...
											<div class="col-md-12">
												<label>
													<div class='external-event label label-primary ui-draggable' style='position: relative;width:90px;'>PO. Date Filter</div>					
										...
										<div class="col-md-3">
											<div class="col-md-12">
												...
												<div class="input-group date form_datetime-component">
													...
													<input type="text" id="rep_po_date"  onChange="generate_chart_report()" class="form-control datepikerdemo" value="">
										...
										<div class="col-md-6">
											...
											<div class="col-md-7" style="">
												<!-- <select  class="select2" name="vendor_id" id="vendor_id" onChange="getitemsbyvendorid(this.value);" > -->
													<select  class="select2" name="vendor_id" id="vendor_id" onChange="generate_chart_report();" >
									...
									<?php if(in_array(VENDOR_ANALYSIS_VIEW,$bulkAccessArray)){ ?> 
									<div class="col-md-12" style="text-align: right;">
										<button id="preview" class="btn btn-success" onclick="generate_chart_report()">Preview</button>
									</div>
									<?php } ?>
									<div class="row">
										<div class="col-md-12 margin_row">
											...
											<div class="col-md-8">
												<div id="report_task_act_byowner" style="width: 900px; height: 400px;display:none"></div>
											</div>
											<div class="col-md-2">
											</div>
										</div>
	...
	<script src="<?=ROOT.PURCHASE_ROOT?>js/app/vendoranalysis.js?<?=time()?>"></script>
