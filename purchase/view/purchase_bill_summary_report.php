									...
									<div class="col-md-12">
										...
										<div class="col-md-6">
											...
											<div class="col-md-12" style="margin-top: 15px;">
												...
												<div class="col-md-8" style="display: none;">
													<select class="select2" name="purchase_type" id="purchase_type" >
...
<script>
	...
	$('#purchase_type').attr('disabled','disabled');

	$("input[name='report_wise']").change(function(){
		var report_wise = $("input[name='report_wise']:checked").val();
		if(report_wise == 'itemwisepurchasebillreport'){
			$('#item_id').removeAttr('disabled');
			$('#purchase_type').select2("val","");
			$('#purchase_type').attr('disabled','disabled');
			$('#vendor_id').attr('disabled','disabled');
			$('#vendor_id').select2("val","");
		}else if(report_wise == 'purchasetypewisepurchasebillreport'){
			$('#purchase_type').removeAttr('disabled');
			$('#item_id').select2("val","");
			$('#item_id').attr('disabled','disabled');
			$('#vendor_id').select2("val","");
			$('#vendor_id').attr('disabled','disabled');
