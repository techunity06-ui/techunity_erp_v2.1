...
$form="Pending Purchase Order Summary Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        PENDING_PURCHASE_ORDER_BRIEF_REPORT_VIEW
]);
if(!in_array(PENDING_PURCHASE_ORDER_BRIEF_REPORT_VIEW,$bulkAccessArray)){
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-3">
											<div class="col-md-12">
												<label>
													...
													<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="vendorwisebriefreport" onchange="filter_field()" checked="">
												</label>
											</div>
											<div class="col-md-12">
												<label>
													<div class='external-event label label-warning  ui-draggable' style='position: relative;width:90px;'>Item Wise</div>					
													<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="itemwisebriefreport" onchange="filter_field()">
												</label>
											</div>
											<div class="col-md-12">
												<label>
													<div class='external-event label label-success ui-draggable' style='position: relative;width:90px;'>All</div>					
													<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="allbriefreport" onchange="filter_field()">
												</label>
											</div>

											<!-- <div class="col-md-12">
												<label>
													<div class='external-event label label-primary ui-draggable' style='position: relative;width:90px;'>With Conv Qty.</div>					
										...
										<div class="col-md-3">
											...
											<div class="col-md-12">
												<label>
													...
													<input id="task_status_all po_date_wise" name="reporttype" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" onchange="reporttype(this.value);filter_field()" title="All" value="detail" checked="">
												</label>
											</div>

											<div class="col-md-12">
												<label>
													<div class='external-event label label-success ui-draggable' style='position: relative;width:90px;'>Summary</div>				<input id="task_status_all po_date_wise" name="reporttype" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="Summary" onchange="reporttype(this.value);filter_field()" value="summary">
												</label>
											</div>
										...
										<div class="col-md-6">
											...
											<div class="col-md-12" style="margin-top: 15px;">
												<div class="col-md-4">
													<label>
														...
														<input id="task_status_all" name="specific_vendor" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="VENDOR" value="1" onchange="filter_field()">
													</label>
												</div>
											...
											<div class="col-md-12" style="margin-top: 15px;">
												<div class="col-md-4">
													...
													<label>
														...
														<input id="task_status_all" name="specific_item" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="wo" value="1" onchange="filter_field()">
													</label>
												</div>
												<div class="col-md-8" style="">
											...
											<div class="col-md-12" style="margin-top: 15px;">
												...
												<div class="col-md-4">
													<label>
														...
														<input id="task_status_all" name="item_status" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="wo" value="1" onchange="filter_field()">
													</label>
												</div>
												<div class="col-md-8" style="">
											...
											<div class="col-md-12" style="margin-top: 15px;">
												...
												<div class="col-md-4">
													<label>
														<div class='external-event label label-warning  ui-draggable' style='position: relative;width:90px;'>PO Status</div>					
														<input id="task_status_all" name="po_status" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="po" value="1" onchange="filter_field()">
													</label>
												</div>
												<div class="col-md-8" style="">
													<select class="select2" name="po_status_id" id="po_status_id" >
														<option value="3">-Select Status</option>
														<option value="1">Pending</option>
														<option value="2">Completed</option>
														<option value="3">All</option>
									...
									<?php if(in_array(PENDING_PURCHASE_ORDER_BRIEF_REPORT_VIEW,$bulkAccessArray)){ ?>
									<button id="preview" class="btn btn-success" onclick="generate_report_product_brief_data()" style="margin-left:40%">Preview</button>
									<?php } ?>
...
<?php 
	echo "<script>filter_field()</script>";
?>
</body>
</html>
