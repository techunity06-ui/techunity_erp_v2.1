<?php 
	...
	if(!in_array(GRN_REGISTER_REPORT,$bulkAccessArray)){
...
<body>
  <section id="container" >
                                ...
                                <section class="panel">
                                    ...
                                    <div class="">
                                        <ul class="breadcrumb">
                                                ...
                                                <li ><a href="<?=ROOT.PURCHASE_ROOT.'partypaymentreport'?>"><?=$form?></a></li>
                                        </ul>
                                     </div>
                                </section>
                                <!--bread crumbs end -->
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4" >Choose PO No.</label>
											<div class="col-md-8">
											  <select  name="po_no[]" class="select2" id="po_no" onChange="reload_data();" multiple placeholder="Choose Po No">
													<?=get_po_no_grn($dbcon,$id); ?>	
											  </select>
											</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group" style="margin-top:10px;">
										<label class="control-label col-md-4" >Choose Vender</label>
											<div class="col-md-8">
											  <select  name="companyid[]" class="select2" id="companyid" onChange="reload_data();" multiple placeholder="Choose Customer">
													<?=get_vender_grn($dbcon,$id); ?>	
											  </select>
											</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group" style="margin-top:10px;">
										<label class="control-label col-md-4" >Choose Item</label>
											<div class="col-md-8">
											  <select  name="product_id[]" class="select2" id="product_id" onChange="reload_data();" multiple placeholder="Choose Product">
													<?=get_item_grn($dbcon,$id); ?>	
											  </select>
											</div>
									</div>
								</div>
							...
							<div class="col-md-12" style="margin-top:60px">
								<div class="adv-table" id="adv-table" style="overflow: auto;">
								</div>
							</div>
						</div>
					</div>	
	...
	<script src="<?=ROOT.PURCHASE_ROOT?>js/app/grn_register_report.js?<?=time()?>"></script>
...
disp_setting+="scrollbars=yes,width=800, height=600, left=100, top=25";
  ...
  docprint.document.write('font-family:Tahoma,Verdana; font-size:10px;} .tableFloatingHeaderOriginal { margin-top:25px !important;} .dataTables_length, .dataTables_filter , .dataTables_paginate { display:none; }');
  docprint.document.write('#mainpart table,#mainpart tr,#mainpart td,#mainpart th {border:1px #eee solid;padding:2px 5px 2px 5px;text-align:center;}');
   docprint.document.write('.table{border-spacing:0px !important;} .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th { padding:5px !important;} .noborder { border:none !important;} table.display thead th,.table>tfoot>tr>td {padding: 3px 18px 3px 10px;font-weight: bold;cursor: pointer;color: black;} ');
  docprint.document.write('a{color:#000;text-decoration:none;} h1 {font-size:25px; line-height:5px;} b { font-weight:normal; } div.page { page-break-before: always; page-break-inside: always; } </style>');
...
disp_setting+="scrollbars=yes,width=800, height=600, left=100, top=25";
  ...
  docprint.document.write('"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">');
  docprint.document.write('<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">');
  docprint.document.write('<head><title><?=TITLE?>2</title>');
  docprint.document.write('<link rel="stylesheet" href="<?php echo ROOT;?>css/style.css" media="all"/>');
  docprint.document.write('<link rel="stylesheet" href="<?php echo ROOT;?>css/bootstrap.min.css" media="all"/>');
