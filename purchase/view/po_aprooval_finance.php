<?php 
   ...
   $form="Purchase Order Finance Approval";
...
<html lang="en">
   <head>
      <title>PO FINANCE APPROVAL</title>
   ...
   <body>
                        ...
                        <header class="panel-heading">
                           ...
                           <div class="col-md-4">
                              <div class="col-md-4">
                              	...
                              	<input id="po_type_status1" name="po_approval_status"  type="radio" checked="checked" onClick="reload_data();" class="" title="Created" value="3">
                              </div>
                              <div class="col-md-4">
                              	<label for="po_type_status3" class="external-event label label-success ui-draggable" style="position: relative;cursor:pointer;">Approved</label>
      ...
      <?php include_once($include1.'preview_purchase_order_finance_aprv_hist.php'); ?>
      <?php include_once($include1.'view_delivery_detail.php');?>
      <?php include_once($include.'/include_js_file.php');?>    
      <script src="<?=ROOT.PURCHASE_ROOT?>js/app/po_approoval_finance.js"></script>
