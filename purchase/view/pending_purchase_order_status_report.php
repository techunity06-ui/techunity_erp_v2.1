...
$start=date('1-m-Y');
$end=date("d-m-Y");
$form="Pending Purchase Order Status Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        PENDING_PURCHASE_ORDER_STATUS_REPORT_VIEW
]);
if(!in_array(PENDING_PURCHASE_ORDER_STATUS_REPORT_VIEW,$bulkAccessArray)){
...
<body>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12" style="margin-bottom:20px">
										...
										<div class='col-lg-6 col-md-7 col-xs-9'>
			                              <div class="form-group">
			                                 <label class="control-label col-lg-4 col-md-4 col-xs-3" style="text-align:right">Choose Date</label>
										...
										<div class="col-md-12" style="margin-top: 15px;">
											...
											<div class="col-md-4" >
												<select  class="select2" name="vendor_id" id="vendor_id" onChange="getpos(this.value);" >
													<option value="">--Select Vendor--</option>
													<?=getAllVendor($dbcon,$emp_id)?>	
												</select> 
											</div>
										</div>
										...
										<div class="col-md-12" style="margin-top: 15px;">
											...
											<div class="col-md-4" >
												<select  class="select2" name="pos_id" id="pos_id" onChange="getitems(this.value);" >
										...
										<div class="col-md-2">
											<label>
														...
														<input id="task_status_all" name="item_status" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="wo" value="1" onchange="pending_po_status_filter()">
													</label>
										...
										<div class="col-md-2">
											<label>
														...
														<input id="task_status_all" name="po_status" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="wo" value="1" onchange="pending_po_status_filter()">
													</label>
									...
									<center>
										<?php if(in_array(PENDING_PURCHASE_ORDER_STATUS_REPORT_VIEW,$bulkAccessArray)){ ?>
										<button id="preview" class="btn btn-success" onclick="generate_purchase_order_status_report()">Preview</button>
										<?php } ?>
									</center>
									</div>
	...
	<!--<script src="js/coiviunt.js"></script>-->
	<script>
		$(".select2").select2({
			width: '100%'
		});
	...
	<?
		echo "<script>pending_po_status_filter()</script>";
	?>
</body>
</html>
