...
$form="Purchase Order Detail Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	PURCHASE_ORDER_DETAIL_REPORT
]);
if(!in_array(PURCHASE_ORDER_DETAIL_REPORT,$bulkAccessArray)){
...
<body>
							...
							<div class="panel-body">
								<div class="row">
			                        ...
			                        <div class="col-md-12">
		                           		<div class="col-md-6">
											<div class="form-group">
		                           				<label class="control-label col-lg-4 col-md-4 col-xs-3">Choose Sales Order No</label>
		                           				<div class=" col-lg-8 col-md-8 col-xs-9">
		                           					<select class="select2" name="sales_order_no" id="sales_order_no" title="Select Sales Order No" onchange="generate_report_price_list()">
		                           						<?=po_detail_so($dbcon)?>
		                           					</select>
		                           				</div>
		                           			</div>
		                           		...
		                           		<div class="col-md-6">
											<div class="form-group">
		                           				<label class="control-label col-lg-4 col-md-4 col-xs-3">Choose Work Order No</label>
		                           				<div class=" col-lg-8 col-md-8 col-xs-9">
		                           					<select class="select2" name="work_no" id="work_no" title="Select Work Order No" onchange="generate_report_price_list()">
		                           						<?=workorder_no($dbcon)?>
		                           					</select>
		                           				</div>
		                           			</div>
		                           		...
		                           		<div class="col-md-6">
											<div class="form-group">
		                           				...
		                           				<div class=" col-lg-8 col-md-8 col-xs-9">
		                           					<select class="select2" name="vender_id" id="vender_id" title="Select Vender" onchange="generate_report_price_list()">
		                           		...
		                           		<!-- <div class="col-md-6">
											<div class="form-group">
		                           				<label class="control-label col-lg-4 col-md-4 col-xs-3">Choose User</label>
		                           				<div class=" col-lg-8 col-md-8 col-xs-9">
		                           					<select class="select2" name="user_id" id="user_id" title="User Name" onchange="generate_report_price_list()">
		                           						<?=get_assign_users_inq($dbcon,$sid='')?>
		                           					</select>
		                           				</div>
		                           			</div>
		                           		</div> -->
	...
	<script src="<?=ROOT.PURCHASE_ROOT?>js/app/purchase_order_detail.js?<?=time()?>"></script>
