...
$form="Pending Purchase Order Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        PENDING_PURCHASE_ORDER_REPORT_VIEW
]);
if(!in_array(PENDING_PURCHASE_ORDER_REPORT_VIEW,$bulkAccessArray)){
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-3">
											<div class="col-md-12">
												<label>
													...
													<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="vendorwisereport" onchange="pending_po_fliter()" checked="">
												</label>
											</div>
											<div class="col-md-12">
												<label>
													<div class='external-event label label-warning  ui-draggable' style='position: relative;width:90px;'>Item Wise</div>					
													<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="itemwisereport" onchange="pending_po_fliter()">
												</label>
											</div>
											<div class="col-md-12"style="display: none;">
												<label>
													<div class='external-event label label-success ui-draggable' style='position: relative;width:90px;'>All</div>					
													<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="all">
												</label>
											</div>
										...
										<div class="col-md-3">
											<div class="col-md-12">
												<div class="form-group">
													<select class="select2" name="vender_id" id="vender_id" title="Select Vender">
														 <?=getcust($dbcon,'',$purchase_party_show);?>
													</select>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<input id="product_id" name="product_id" style="width:100%;" placeholder="Select product" />
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-3">
											...
											<div class="col-md-12" style="display:none">
												<label>
													...
													<input id="task_status_all po_date_wise" name="po_date_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="delivery">
												</label>
											</div>
									...
									<div class="col-md-12" style="margin-top:20px">
										<center>
											<?php if(in_array(PENDING_PURCHASE_ORDER_REPORT_VIEW,$bulkAccessArray)){ ?>
												<button id="preview" class="btn btn-success" onclick="generate_report_product_service_data()">Priview</button>
											<?php } ?>		
										</center>
									</div>
