...
<body>
							...
							<div class="panel-body">
								<div class="row">
			                        ...
			                        <div class="col-md-12">
		                           		<div class="col-md-6">
		                           			<div class="form-group">
		                           				<label class="control-label col-lg-4 col-md-4 col-xs-3">Choose Status</label>
		                           				<div class=" col-lg-8 col-md-8 col-xs-9">
		                           					<select class="select2" name="status" id="status" title="Select Status" onchange="generate_report_price_list()">
	...
	<script src="<?=ROOT.PURCHASE_ROOT?>js/app/indent_status_report.js?<?=time()?>"></script>
