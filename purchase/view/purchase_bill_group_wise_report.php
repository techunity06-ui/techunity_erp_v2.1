...
$form = "Purchase Bill Group Wise Report";
...
<head>
	<title>PURCHASE BILL GROUP WISE</title>
...
<body>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-3">
											<label>
												...
												<input id="task_status_all po_date_wise" name="reporttype" type="radio" style="width:20px;height:20px;vertical-align:middle" class="" title="All" value="detailgrouppruchasebill" checked="">
											</label>
										</div>

										<div class="col-md-3">
											<label>
												<div class='external-event label label-success ui-draggable' style='position: relative;width:90px;'>Summary</div> <input id="task_status_all po_date_wise" name="reporttype" type="radio" style="width:20px;height:20px;vertical-align:middle" class="" title="Summary" onchange="reporttype(this.value)" value="summarygrouppruchasebill">
											</label>
										</div>
									...
									<div class="col-md-12" style="margin-top: 8px;">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="opening stock" class="col-md-4 control-label">Item Group :</label>
									...
									<div class="col-md-12" style="margin-top: 8px;">
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-md-3">Choose Vendor</label>
												<div class="col-md-9">
													<!-- <input id="vender_id" name="vender_id" style="width:100%;" placeholder="Select product" /> -->
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="opening stock" class="col-md-4 control-label">Item :</label>
												<div class="col-md-8 col-xs-11">
													<input id="item_id" name="item_id" style="width:100%;" placeholder="Select product" />
												</div>
											</div>
										</div>
									</div>

									<?php if (in_array(VENDOR_ANALYSIS_REPORT_VIEW, $bulkAccessArray)) { ?>
										<button id="preview" class="btn btn-success" onclick="generate_item_wise_pur_bil_report()" style="float: right; margin-right: 33px; margin-top: 10px;">Preview</button>
									<?php } ?>
	...
	<script src="<?= ROOT . PURCHASE_ROOT ?>js/app/purchasebillsummaryreport.js?<?= time() ?>"></script>
	...
	<script>
		...
		// 	$('.datepikerdemo span').html(start.format('MMMM D, YYYY'));
		// }
		...
		// 	$('.deliverydatepikerdemo span').html(end.format('MMMM D, YYYY'));
		// }
