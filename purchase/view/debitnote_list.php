...
<body>
  <section id="container" >
      ...
      <!--main content start-->
					...
					<section class="panel">
						...
						<div class="">
							<ul class="breadcrumb">
							  ...
							  <li><a href="<?=ROOT.PURCHASE_ROOT.'debitnote_list'?>"><?=$form?> list</a></li>
							</ul>
						</div>
					</section>
				  <!--breadcrumbs end -->
		  ...
		  <div class="row">			
			<div class="col-sm-12">
					...
					<div class="form-group">
                                  ...
                                  <div class=" col-lg-8 col-md-8 col-xs-9">
									...
									?>
										...
										<input type="text" id="rep_date"  onChange="load_debitnote_datatable();" class="form-control datepikerdemo" value="">
				...
				<?php if(in_array(DEBIT_PENDING_NOTE_ADD,$bulkAccessArray)){ ?>			
				<span class="tools pull-right">
					<a href="<?=ROOT.PURCHASE_ROOT.'debitnote_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
				</span>
				<?php } ?> 
			</header>	
			<div class="panel-body">	 
			  <div class="adv-table">
				  <table class="display table table-bordered table-striped" id="debit-note-table">
				  <thead>
					<tr>
						<th>Series No.</th>
						<th>Bill No.</th>
   ...
   <script src="<?=ROOT.PURCHASE_ROOT?>js/app/debitnote.js"></script>
