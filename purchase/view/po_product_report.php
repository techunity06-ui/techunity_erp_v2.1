...
$form="PO Product Report";
// error_reporting(E_ALL);
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	PO_PRODUCT_REPORT
]);
if(!in_array(PO_PRODUCT_REPORT,$bulkAccessArray)){
...
<body>
	...
	<script src="<?=ROOT.PURCHASE_ROOT?>js/app/po_product_report.js?<?=time()?>"></script>
