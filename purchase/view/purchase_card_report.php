...
$form="Purchase Card Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	PURCHASE_CARD_REPORT
]);
if(!in_array(PURCHASE_CARD_REPORT,$bulkAccessArray)){
...
<html lang="en">
<head>
	<title>PURCHASE CARD REPORT</title>
...
<body>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
			                        ...
			                        <div class="col-md-12">
		                           		<div class="col-md-6 col-md-7 col-xs-9">
		                           			<div class="form-group">
		                           				<label class="control-label col-lg-4 col-md-4 col-xs-3">Choose Product</label>
												<div class="col-lg-8 col-md-8 col-xs-9">
													<input id="product_id" name="product_id" onchange="generate_report_price_list()" style="width:100%;" placeholder="Select product" />
												</div>
		                           			</div>
		                           		</div>
	...
	<script src="<?=ROOT.PURCHASE_ROOT?>js/app/purchase_card_report.js?<?=time()?>"></script>
