...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	    PRODUCTION_GRN_LIST_SLUG_VIEW,PRODUCTION_GRN_LIST_SLUG_CREATE
]);
		...
		<div class="col-sm-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<?php if(in_array(PRODUCTION_GRN_LIST_SLUG_CREATE,$bulkAccessArray)){ ?>
					<span class="tools pull-right">
						<a href="<?=ROOT.PURCHASE_ROOT.'grn_add_new'?>"><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>
					</span>	
					<?php } ?>
				</header>	
