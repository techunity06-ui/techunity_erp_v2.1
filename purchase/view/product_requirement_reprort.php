...
$form="Product Requirement Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	PRODUCT_REQUIREMENT_REPORT
]);
if(!in_array(PRODUCT_REQUIREMENT_REPORT,$bulkAccessArray)){
...
<html lang="en">
<head>
	<title>PRODUCT REQUIREMENT REPORT</title>
...
<body>
	...
	<script src="<?=ROOT.PURCHASE_ROOT?>js/app/product_requirement_reprort.js?<?=time()?>"></script>
