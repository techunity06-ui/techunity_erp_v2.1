  ...
  <?php include_once($include.'/include_top_menu.php');?>
					...
					<tr id="field1">
						<td style="vertical-align:top;" class="grn">
							<select class="select2" name="grn_id" id="grn_id" onChange="load_grn_data(this.value);">
								<?=get_grn_for_debitnote($dbcon,$rel['vender_id'],"",$mode);?>
							</select>
						</td>
	...
	<div id="sale_productdata"></div>	
				...
				<div class="col-md-12 text-center">
					...
					<a href="<?=ROOT.PURCHASE_ROOT.'debitnote_list'?>" type="button" class="btn btn-danger">Cancel</a>
				</div>			
				</div>
				<!--Vendor row end-->	
...
<script src="<?=ROOT.PURCHASE_ROOT?>js/app/debitnote.js?<?=time()?>"></script>
