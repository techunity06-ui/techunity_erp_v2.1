...
$form="Pending Purchase Order With Rate Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        PENDING_PURCHASE_ORDER_SUMMARY_WITHRATE_REPORT_VIEW
]);
if(!in_array(PENDING_PURCHASE_ORDER_SUMMARY_WITHRATE_REPORT_VIEW,$bulkAccessArray)){
...
<html lang="en">
<head>
	<title>PENDING PO WITH RATE</title>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="col-md-12">
												<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="vendorwiseratesummaryreport" checked="" onchange="pending_po_summary_withrate_filter()">
													</label>
												</div>
											</div>
											<div class="col-md-12">
												<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="itemwiseratesummaryreport" onchange="pending_po_summary_withrate_filter()">
													</label>
												</div>
											</div>
											...
											<div class="col-md-12" style="display:none">
												<div class="col-md-5">
													<label>
														<div class='external-event label label-warning  ui-draggable' style='position: relative;width:90px;'>All</div>					
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="allwiseratesummaryreport" onchange="pending_po_summary_withrate_filter()">
													</label>
												</div>
											</div>
										...
										<div class="col-md-6">
											<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="specific_vendor" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="VENDOR" value="1" onchange="pending_po_summary_withrate_filter()">
													</label>
												</div>
												<div class="col-md-7" style="">
										...
										<div class="col-md-6">
											<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="specific_item" type="checkbox" style="width:20px;height:20px;vertical-align:middle"  class="" title="wo" value="1" onchange="pending_po_summary_withrate_filter()">
													</label>
												</div>
												<div class="col-md-7" style="">
									...
									<?php if(in_array(PENDING_PURCHASE_ORDER_SUMMARY_WITHRATE_REPORT_VIEW,$bulkAccessArray)){ ?> 
									<div class="col-md-12" style="text-align: center;">
										<button id="preview" class="btn btn-success" onclick="generate_report_product_order_withratesummary()">Preview</button>
									</div>
									<?php } ?>
