...
$("#purchasecard_add").on('submit',function(e) {
	...
	$.ajax({
		cache:false,
		url: root_domain+purchase_domain+'app/purchase_card_vendor_wise/',
		type: "POST",
		data: form_data,
		contentType: false,
		processData:false,
...
function load_po_datatable()
{
	...
	datatable = $("#dynamic-table").dataTable({
			...
			"iDisplayLength": 10,
			"sAjaxSource": root_domain+purchase_domain+'app/purchase_card_vendor_wise/',
...
function get_vendor_details(tab){
 ...
 function get_vendor_name(vid) {
 	...
 	$.ajax({
		...
		success: function(data){
				window.location.href=root_domain+purchase_domain+'purchase_card_vendor_wise';
				Unloading();
			}		
	});
 }
...
function get_item_information(product_id, vender_id, type) {

	Loading();
 	$.ajax({
		type: "POST",
		url: root_domain+purchase_domain+'app/purchase_card_vendor_wise/',
		data: { mode : 'get_item_selected_information', product_id : product_id, vender_id : vender_id, type : type},
		success: function(data){
				Unloading();
