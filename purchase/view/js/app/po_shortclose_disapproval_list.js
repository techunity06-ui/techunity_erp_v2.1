...
function load_po_req_datatable()
{
	...
	$("#overdue-po-req-datatable").dataTable({
		...
		"iDisplayLength": 10,
		"sAjaxSource": root_domain+purchase_domain+'app/po_shortclose_disapproval_list/',
		"fnServerParams": function ( aoData ) {
			aoData.push( { "name": "mode", "value": "fetch" },{ "name": "branch_id", "value": branch_id },{ "name": "date", "value": date }, );
		},
...
function load_party_po_dtl(){
	...
	$.ajax({
		type: "POST",
		url: root_domain+purchase_domain+'app/po_shortclose_disapproval_list/',
