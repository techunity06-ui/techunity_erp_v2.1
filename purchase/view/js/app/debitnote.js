...
$("#debitnote_add").on('submit',function(e) {
	...
	$.ajax({
		cache:false,
		url: root_domain+purchase_domain+'app/debitnote/',
		type: "POST",
		data: form_data,
		contentType: false,
		processData:false,
		success: function(response)
		{
			...
			if(arr.msg == '1') {
				...
				window.location=root_domain+purchase_domain+'debitnote_list';
			}
			else if(arr.msg == '0') {
...
function load_debitnote_datatable()
{
	...
	datatable = $("#debit-note-table").dataTable({
		...
		"iDisplayLength": 10,
		"sAjaxSource": root_domain+purchase_domain+'app/debitnote/',
