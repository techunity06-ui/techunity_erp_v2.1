...
function generate_report_price_list(){
	...
	$.ajax({
		type: "POST",
		url: root_domain+purchase_domain+'app/purchase_order_detail/',
		data: { mode : 'po_product_report',date:date,work_no:work_no,sales_order_no:sales_order_no,product_id:product_id,vender_id:vender_id},		
