...
$amnts = get_purchase_bill_taxable_total($dbcon);
$cnyts = explode(",",$amnts);
$id=$_SESSION['type_id'];
?>
...
<html lang="en">
<head>
	<title>PURCHASE BILL LIST</title>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li ><a href="<?=ROOT.PURCHASE_ROOT.'purchase_list'?>">Purchase List</a></li>
									...
									<div class="col-lg-12 centeral-align">
										<div class="icons">
											<div class="icon1 success" >
												<p style="color:white;padding-top:10px;">Total Purchase Bill Amount</p>
										...
										<div class="icons">	 	
											<div class="icon1 info" >
												...
												<p style="color:white;padding-top:10px;">Total Purchase Bill<br> Taxable Value</p>
					...
					<!--	<div class="col-md-5">
							...
							<?php if(in_array(PURCHASE_BILL_ADD,$bulkAccessArray)){	?>
								<span class="tools pull-right">
									<a href="<?=ROOT.PURCHASE_ROOT.'purchase_add'?>" ><button class="btn btn-success btn-flat" >Create Purchase</button></a>					
								</span>
							<?php } ?>
							...
							<div class="col-md-5">
								...
								<div class="col-md-7" >
									<select class="form-control" name="type_id" id="type_id" onChange="reload_data();">
										...
										<?=get_invoice_type_list($dbcon,1,$rel['type_id'])?>
									</select>
								</div>
							</div>
							<div class="col-md-5">
								<div class="col-md-4" style="text-align:left;">Serach By Date Type </div>
								<div class="col-md-8" >
									<select class="form-control" name="date_id" id="date_id" onChange="reload_data();">
...
<script src="<?=ROOT.PURCHASE_ROOT?>js/app/purchase.js?<?php echo time(); ?>"></script>
