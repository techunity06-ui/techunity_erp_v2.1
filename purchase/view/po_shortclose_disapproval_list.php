<?php 
	...
	$form="PO Shortclose Approval Pending";
...
<html lang="en">
<head>
	<title>PO SHORTCLOSE APPROVAL</title>
...
<script src="<?=ROOT.PURCHASE_ROOT?>js/app/po_shortclose_disapproval_list.js?<?=time()?>"></script>
