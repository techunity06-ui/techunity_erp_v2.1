			...
			<div class="col-md-12 margin_row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="transport_gr_no" id="transport_gr_no" value="<?php echo $ewayDetail[0]['transport_gr_no']; ?>" />
					</div>	
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control default_financial_date" name="transport_gr_date" id="transport_gr_date" value="<?php echo $ewayDetail[0]['transport_gr_date']; ?>" />
					</div>	
				</div>
			...
			<div class="col-md-12 margin_row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="distance_km" id="distance_km" value="<?php echo $ewayDetail[0]['distance_km']; ?>" />
					</div>	
				</div>
			...
			<div class="col-md-12 margin_row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="transport_vehicle_no" id="transport_vehicle_no" value="<?php echo $ewayDetail[0]['transport_vehicle_no']; ?>" />
					</div>	
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="transport_station" id="transport_station" value="<?php echo $ewayDetail[0]['transport_station']; ?>"  />
					</div>	
				</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" class="form-control numbersOnly valid" name="transport_pincode" id="transport_pincode" maxlength="6" value="<?php echo $ewayDetail[0]['transport_pincode']; ?>" />
					</div>	
				</div>
			...
			<div class="col-md-12 margin_row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="transport_doc_no" id="transport_doc_no" value="<?php echo $ewayDetail[0]['transport_doc_no']; ?>" />						
					</div>	
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control default-date-picker" name="transport_doc_date" id="transport_doc_date" value="<?php echo $ewayDetail[0]['transport_doc_date']; ?>" />
					</div>	
				</div>
			...
			<div class="col-md-12 margin_row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control" id="iseinvoice_bill" name="iseinvoice_bill"> 
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control" id="iseway_bill" name="iseway_bill" > 
							<option value="0">No</option>
							<option value="1">Yes</option>
						</select>
					</div>	
			...
			<div class="col-md-12 margin_row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control" id="eway_sub_type" name="eway_sub_type"> 
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control" id="eway_transaction_type" name="eway_transaction_type" > 
