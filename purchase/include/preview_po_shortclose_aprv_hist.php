<div class="modal colored-header info" id="preview_shortclose_po_approval_hist_modal" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="btn_close  close md-close" data-dismiss="modal" aria-hidden="true">Close &times;</button>
				<h3>Approval : #<span id="sortclose_apprv_po_ref_no"></span></h3>
			</div>
		...
		<input type="hidden" id="ref_ord_trn_id" name="ref_ord_trn_id" value="">
	</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
