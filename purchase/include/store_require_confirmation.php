...
<div class="modal colored-header info" id="store_required_confirmation_modal" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="btn_close  close md-close" data-dismiss="modal" aria-hidden="true">Close &times;</button>
				<h3>IN Store Save Action</h3>
			</div>
			<div class="modal-body form">
				<div class="row">
					...
					<div class="col-md-12 m-bot15 middle div_store_confirm">
					  ...
					  <label>
					  <input type="radio" name="store_confirm" value="0" id="store_in" checked/>
					  ...
					  <label>
					  <input type="radio"  name="store_confirm" value="1" id="next_process"/>
