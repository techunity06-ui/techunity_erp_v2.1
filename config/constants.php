...
define('INHOUSE_GRN', 41);
define('OUTSIDE_GRN', 42);
define('SALES_CARD', 43);
//PATHIK END

define('COSTING_NO', 47);
define('WORKORDER_MATERIAL_ISSUE_NO', 48);

define('BATCH', 30); // ADDED SANAT
define('ISSUE', 32); // ADDED SANAT


define('RELEASE_MATERIAL', 51); // ADDED SANAT
//Dhaval Start
define('INVOICE_TYPE_SALE_RETURN', 52);
define('JOBCARD', 54); // ADDED SANAT
define('DOCUMENT_NO', 55); // ADDED SANAT
define('BMR_NO', 56); // ADDED SANAT
define('SO_DEALLOCATE_NO', 57); // ADDED SANAT
define('WO_STOCK_TRANSFER', 60); // ADDED SANAT

///Define Constant For Maulik /////
define('COMPLAINT_SERIES', 1);
define('INQUIRY_SERIES', 2);
define('QUOTATION_SERIES', 3);
define('PAYMENT_SERIES', 4);
define('BOM_SERIES', 5);
define('PURCHASE_ORDER_SERIES', 6);
define('PLANNING_SERIES', 7);
define('GRN_SERIES', 8);
define('MIN_MAX_SERIES', 9);
define('PO_REQUEST_SERIES', 10);
define('BILL_SUPPLY_SERIES', 11);
define('PURCHASE_BILL_SERIES', 12);
define('DEBIT_NOTE_SERIES', 13);
define('QC_SERIES', 14);
define('STOCK_ADJUSTMENT_SERIES', 15);
define('HRMS_SERIES', 16);
define('INDENT_SERIES', 17);
define('JOURNAL_SERIES', 18);
define('PROFORMA_SERIES', 19);
define('DRAWING_SERIES', 20);
define('MANUAL_INDENT_SERIES', 21);
define('PO_CARD_SERIES', 22);
define('INHOUSE_PRODUCTION_SERIES', 23);
define('DEBIT_NOTE_WITHOUT_ITEM_SERIES', 24);
define('CREDIT_NOTE_WITHOUT_ITEM_SERIES', 25);
define('LEAVE_APPLICATION_SERIES', 26);
define('SALARY_SLIP_SERIES', 27);
define('LEAVE_ALLOCATION_SERIES', 28);
define('ATTENDENSE_SERIES', 29);
define('BATCH_SERIES', 30);
define('CREDITNOTE_SERIES', 31);
define('ISSUE_SERIES', 32);
define('SERVICE_SERIES', 33);
define('CONTRA_SERIES', 34);
define('RECEIPT_PAYMENT_SERIES', 35);
define('STORE_ACCEPT_SERIES', 36);
define('TAX_INVOICE_SERIES', 37);
define('OUTSIDE_JOBWORK_SERIES', 38);
define('OUTSIDE_JOBWORK_CHALLAN_SERIES', 39);
define('JOBWORK_RATECARD_SERIES', 40);
define('INHOUSE_GRN_SERIES', 41);
define('OUTSIDE_GRN_SERIES', 42);
define('SALES_CARD_SERIES', 43);
define('PRODUCTION_DIRECT_SERIES', 44);
define('SALES_ORDER_SERIES', 45);
define('GODOWN_STOCK_TRNSFER_SERIES', 46);
define('BOM_COSTING_SERIES', 47);
define('WORK_ORDER_MATERIAL_ISSUE_SERIES', 48);
define('FORECAST_NO_SERIES', 49);
define('STOCK_GENERAL_SERIES', 50);
define('REALEASE_MATERIAL_SERIES', 51);
define('MAINTAINANCE_SERIES', 52);
define('CALIBRATION_SERIES', 53);
define('JOBCARD_SERIES', 54);
define('DOCUMENT_NO_SERIES', 55);
...
//WD PURCHASE DISAPPROVED
define('DASHBOARD_PURCHASE_DISAPPROVED_VIEW','purchase-disapproved-view');
define('DASHBOARD_PO_SHORTCLOSE_APPROVAL','dashboard-po-shorclose-aprooval-pending');
define('DASHBOARD_PO_SHORTCLOSE_DISAPPROVAL','dashboard-po-shorclose-disaprooval');
define('PO_SHORTCLOSE_LIST','po-shortclose-list');
// INDENT   
...
define('PO_LIST_OTHER', 'po-list-other');
...
// SALES CARD LIST
define('SALES_CARD_VIEW', 'sales-card-list-view');
define('SALES_CARD_ADD', 'sales-card-add');
define('SALES_CARD_READ', 'sales-card-read');
define('SALES_CARD_UPDATE', 'sales-card-update');
define('SALES_CARD_DELETE', 'sales-card-delete');
define('SALES_CARD_APPROVE', 'sales-card-approve');
define('SALES_CARD_ACTIVE', 'sales-card-active');

// ELCON SALES CARD LIST
define('ELCON_SALES_CARD_VIEW', 'elcon-sales-card-list-view');
define('ELCON_SALES_CARD_ADD', 'elcon-sales-card-add');
define('ELCON_SALES_CARD_READ', 'elcon-sales-card-read');
define('ELCON_SALES_CARD_UPDATE', 'elcon-sales-card-update');
define('ELCON_SALES_CARD_DELETE', 'elcon-sales-card-delete');
define('ELCON_SALES_CARD_APPROVE', 'elcon-sales-card-approve');
define('ELCON_SALES_CARD_ACTIVE', 'elcon-sales-card-active');
/**
...
define('SALES_ORDER_SLUG_PRINT', 'sales-order-print');
define('SALES_ORDER_SLUG_FINAL_APPROVE', 'sales-order-final-approve');
define('SALES_ORDER_SLUG_UPDATE_USER', 'sales-order-update-user');
...
define('JOBWORK_RATE_CARD_PRINT', 'jobwork-rate-card-print');
...
//purcahse card report 
define('PURCHASE_CARD_REPORT', 'purchase-card-report');
//purchase order product report 
define('PO_PRODUCT_REPORT', 'purchase-order-product-report');
//Item history purchase
define('ITEM_HISTORY','item-history-report');
//Product Requirement Report 
define('PRODUCT_REQUIREMENT_REPORT','product-requirement-report');

//grn register report
define('GRN_REGISTER_REPORT','grn-register-report');

//Indent Status Report
define('INDENT_STATUS_REPORT','indent_status-report-view');

//Indent Status Report
define('PURCHASE_ORDER_DETAIL_REPORT','purchase-order-detail-report');
/**
...
define('FINANCE_USER_UPDATE', 'finance-user-update');
...
define('PRODUCTION_WORK_ORDER_SLUG_CREATE', 'production-work-order-create');
define('PRODUCTION_WORK_ORDER_SLUG_UPDATE', 'production-work-order-update');
define('PRODUCTION_WORK_ORDER_SLUG_DELETE', 'production-work-order-delete');
define('PRODUCTION_WORK_ORDER_SLUG_PRINT', 'production-work-order-print');
...
define('PRODUCTION_GRN_DIRECT', 'direct-grn-add');
...
*/
//
define('INVENTORY_STOCK_GENERAL_SLUG_VIEW', 'inventory-stock-general-list');
define('INVENTORY_STOCK_GENERAL_SLUG_CREATE', 'inventory-stock-general-add');
define('INVENTORY_STOCK_GENERAL_SLUG_READ', 'inventory-stock-general-list');
define('INVENTORY_STOCK_GENERAL_SLUG_UPDATE', 'inventory-stock-general-update');
define('INVENTORY_STOCK_GENERAL_SLUG_DELETE', 'inventory-stock-general-delete');
define('INVENTORY_STOCK_GENERAL_SLUG_APPROVE', 'inventory-stock-general-approve');
define('INVENTORY_STOCK_GENERAL_SLUG_PRINT', 'inventory-stock-general-print');
...
define('INVENTORY_STOCK_TRANSFER_LIST_SLUG_APPROVE', 'inventory-stock-transfer-list-approve');
...
// WORKORDER TRANSFER
define('INVENTORY_WORKORDER_TRANSFER_SLUG_VIEW', 'inventory-workorder-transfer-list-view');
define('INVENTORY_WORKORDER_TRANSFER_SLUG_CREATE', 'inventory-workorder-transfer-list-create');
define('INVENTORY_WORKORDER_TRANSFER_SLUG_READ', 'inventory-workorder-transfer-list-read');
define('INVENTORY_WORKORDER_TRANSFER_SLUG_UPDATE', 'inventory-workorder-transfer-list-update');
define('INVENTORY_WORKORDER_TRANSFER_SLUG_DELETE', 'inventory-workorder-transfer-list-delete');
define('INVENTORY_WORKORDER_TRANSFER_LIST_SLUG_APPROVE', 'inventory-workorder-transfer-list-approve');
...
define('QUOTATION_DETAIL_REPORT','quotation-detail-report');
...
// Dispatch List Slug
define('WD_DISPATCH_VIEW', 'wd-dispatch-view');
define('DISPATCH_MODULE_VIEW', 'dispatch-module-view');
define('DISPATCH_LIST_VIEW', 'dispatch-view');
define('DISPATCH_APPROVAL', 'dispatch-approval');
define('DASHBOARD_DISPATCH', 'dashboard-dispatch');
define('DASHBOARD_DISPATCH_PENDING', 'dashboard-dispatch-pending');
define('DASHBOARD_FINAL_DISPATCH', 'dashboard-final-dispatch');


// Working Dashboard Finance Purchase Module
define('DASHBOARD_VENDOR_UNADJUSTED_AMOUNT', 'dashboard-vendor-unadjusted-amount');

define('DASHBOARD_WORKORDER_SHORTAGE_LIST_SLUG_VIEW','dashboard-workorder-shortage-list-view');
define('DASHBOARD_WORKORDER_SHORTAGE_LIST_SLUG_CREATE','dashboard-workorder-shortage-list-create');
define('DASHBOARD_WORKORDER_SHORTAGE_LIST_SLUG_UPDATE','dashboard-workorder-shortage-list-update');
define('DASHBOARD_WORKORDER_SHORTAGE_LIST_SLUG_DELETE','dashboard-workorder-shortage-list-delete');
...
define('ADMINISTRATOR_SPECIFICATION_LIST', 'administrator-specification-list');
define('ADMINISTRATOR_SPECIFICATION_CREATE', 'administrator-specification-create');
define('ADMINISTRATOR_SPECIFICATION_UPDATE', 'administrator-specification-update');
define('ADMINISTRATOR_SPECIFICATION_DELETE', 'administrator-specification-delete');
...
define('ADMINISTRATOR_PRODUCT_APPROVE', 'administrator-product-approve');
/* START JAYESH */
...
define('ADMINISTRATOR_DRAWING_CHECKED', 'administrator-drawing-checked');
define('ADMINISTRATOR_DRAWING_APPROVED', 'administrator-drawing-approved');
define('ADMINISTRATOR_DRAWING_PREPARED', 'administrator-drawing-prepared');
...
define('ADMINISTRATOR_DESIGN_LIST', 'administrator-design-list');
define('ADMINISTRATOR_DESIGN_CREATE', 'administrator-design-create');
define('ADMINISTRATOR_DESIGN_UPDATE', 'administrator-design-update');
define('ADMINISTRATOR_DESIGN_DELETE', 'administrator-design-delete');
define('ADMINISTRATOR_DESIGN_EXCEL', 'administrator-design-excel');


define('ADMINISTRATOR_BODY_MOC_LIST', 'administrator-bodymoc-list');
define('ADMINISTRATOR_BODY_MOC_CREATE', 'administrator-bodymoc-create');
define('ADMINISTRATOR_BODY_MOC_UPDATE', 'administrator-bodymoc-update');
define('ADMINISTRATOR_BODY_MOC_DELETE', 'administrator-bodymoc-delete');
define('ADMINISTRATOR_BODY_MOC_EXCEL', 'administrator-bodymoc-excel');


define('ADMINISTRATOR_BONNET_MOC_LIST', 'administrator-bonnetmoc-list');
define('ADMINISTRATOR_BONNET_MOC_CREATE', 'administrator-bonnetmoc-create');
define('ADMINISTRATOR_BONNET_MOC_UPDATE', 'administrator-bonnetmoc-update');
define('ADMINISTRATOR_BONNET_MOC_DELETE', 'administrator-bonnetmoc-delete');
define('ADMINISTRATOR_BONNET_MOC_EXCEL', 'administrator-bonnetmoc-excel');


define('ADMINISTRATOR_WEDGE_LIST', 'administrator-wedge-list');
define('ADMINISTRATOR_WEDGE_CREATE', 'administrator-wedge-create');
define('ADMINISTRATOR_WEDGE_UPDATE', 'administrator-wedge-update');
define('ADMINISTRATOR_WEDGE_DELETE', 'administrator-wedge-delete');
define('ADMINISTRATOR_WEDGE_EXCEL', 'administrator-wedge-excel');

define('ADMINISTRATOR_SEATRING_LIST', 'administrator-seatring-list');
define('ADMINISTRATOR_SEATRING_CREATE', 'administrator-seatring-create');
define('ADMINISTRATOR_SEATRING_UPDATE', 'administrator-seatring-update');
define('ADMINISTRATOR_SEATRING_DELETE', 'administrator-seatring-delete');
define('ADMINISTRATOR_SEATRING_EXCEL', 'administrator-seatring-excel');

define('ADMINISTRATOR_SPINDLE_LIST', 'administrator-spindle-list');
define('ADMINISTRATOR_SPINDLE_CREATE', 'administrator-spindle-create');
define('ADMINISTRATOR_SPINDLE_UPDATE', 'administrator-spindle-update');
define('ADMINISTRATOR_SPINDLE_DELETE', 'administrator-spindle-delete');
define('ADMINISTRATOR_SPINDLE_EXCEL', 'administrator-spindle-excel');

define('ADMINISTRATOR_BONNETBOLT_LIST', 'administrator-bonnetbolt-list');
define('ADMINISTRATOR_BONNETBOLT_CREATE', 'administrator-bonnetbolt-create');
define('ADMINISTRATOR_BONNETBOLT_UPDATE', 'administrator-bonnetbolt-update');
define('ADMINISTRATOR_BONNETBOLT_DELETE', 'administrator-bonnetbolt-delete');
define('ADMINISTRATOR_BONNETBOLT_EXCEL', 'administrator-bonnetbolt-excel');

define('ADMINISTRATOR_BONNETGASKET_LIST', 'administrator-bonnetgasket-list');
define('ADMINISTRATOR_BONNETGASKET_CREATE', 'administrator-bonnetgasket-create');
define('ADMINISTRATOR_BONNETGASKET_UPDATE', 'administrator-bonnetgasket-update');
define('ADMINISTRATOR_BONNETGASKET_DELETE', 'administrator-bonnetgasket-delete');
define('ADMINISTRATOR_BONNETGASKET_EXCEL', 'administrator-bonnetgasket-excel');

define('ADMINISTRATOR_END_LIST', 'administrator-end-list');
define('ADMINISTRATOR_END_CREATE', 'administrator-end-create');
define('ADMINISTRATOR_END_UPDATE', 'administrator-end-update');
define('ADMINISTRATOR_END_DELETE', 'administrator-end-delete');
define('ADMINISTRATOR_END_EXCEL', 'administrator-end-excel');

define('ADMINISTRATOR_OPERATION_LIST', 'administrator-operation-list');
define('ADMINISTRATOR_OPERATION_CREATE', 'administrator-operation-create');
define('ADMINISTRATOR_OPERATION_UPDATE', 'administrator-operation-update');
define('ADMINISTRATOR_OPERATION_DELETE', 'administrator-operation-delete');
define('ADMINISTRATOR_OPERATION_EXCEL', 'administrator-operation-excel');

define('ADMINISTRATOR_TESTINGSTD_LIST', 'administrator-testingstd-list');
define('ADMINISTRATOR_TESTINGSTD_CREATE', 'administrator-testingstd-create');
define('ADMINISTRATOR_TESTINGSTD_UPDATE', 'administrator-testingstd-update');
define('ADMINISTRATOR_TESTINGSTD_DELETE', 'administrator-testingstd-delete');
define('ADMINISTRATOR_TESTINGSTD_EXCEL', 'administrator-testingstd-excel');

define('ADMINISTRATOR_STEM_NUT_LIST', 'administrator-stemnut-list');
define('ADMINISTRATOR_STEM_NUT_CREATE', 'administrator-stemnut-create');
define('ADMINISTRATOR_STEM_NUT_UPDATE', 'administrator-stemnut-update');
define('ADMINISTRATOR_STEM_NUT_DELETE', 'administrator-stemnut-delete');
define('ADMINISTRATOR_STEM_NUT_EXCEL', 'administrator-stemnut-excel');

define('ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_LIST', 'administrator-gbush-list');
define('ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_CREATE', 'administrator-gbush-create');
define('ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_UPDATE', 'administrator-gbush-update');
define('ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_DELETE', 'administrator-gbush-delete');
define('ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_EXCEL', 'administrator-gbush-excel');

define('ADMINISTRATOR_DISC_NUT_LIST', 'administrator-discnut-list');
define('ADMINISTRATOR_DISC_NUT_CREATE', 'administrator-discnut-create');
define('ADMINISTRATOR_DISC_NUT_UPDATE', 'administrator-discnut-update');
define('ADMINISTRATOR_DISC_NUT_DELETE', 'administrator-discnut-delete');
define('ADMINISTRATOR_DISC_NUT_EXCEL', 'administrator-discnut-excel');

define('ADMINISTRATOR_COVER_NUT_LIST', 'administrator-covernut-list');
define('ADMINISTRATOR_COVER_NUT_CREATE', 'administrator-covernut-create');
define('ADMINISTRATOR_COVER_NUT_UPDATE', 'administrator-covernut-update');
define('ADMINISTRATOR_COVER_NUT_DELETE', 'administrator-covernut-delete');
define('ADMINISTRATOR_COVER_NUT_EXCEL', 'administrator-covernut-excel');

define('ADMINISTRATOR_GLAND_FLANGE_LIST', 'administrator-glandflange-list');
define('ADMINISTRATOR_GLAND_FLANGE_CREATE', 'administrator-glandflange-create');
define('ADMINISTRATOR_GLAND_FLANGE_UPDATE', 'administrator-glandflange-update');
define('ADMINISTRATOR_GLAND_FLANGE_DELETE', 'administrator-glandflange-delete');
define('ADMINISTRATOR_GLAND_FLANGE_EXCEL', 'administrator-glandflange-excel');

define('ADMINISTRATOR_HAND_WHEEL_LIST', 'administrator-handwheel-list');
define('ADMINISTRATOR_HAND_WHEEL_CREATE', 'administrator-handwheel-create');
define('ADMINISTRATOR_HAND_WHEEL_UPDATE', 'administrator-handwheel-update');
define('ADMINISTRATOR_HAND_WHEEL_DELETE', 'administrator-handwheel-delete');
define('ADMINISTRATOR_HAND_WHEEL_EXCEL', 'administrator-handwheel-excel');

define('ADMINISTRATOR_BONNET_NUTS_LIST', 'administrator-bonnetnuts-list');
define('ADMINISTRATOR_BONNET_NUTS_CREATE', 'administrator-bonnetnuts-create');
define('ADMINISTRATOR_BONNET_NUTS_UPDATE', 'administrator-bonnetnuts-update');
define('ADMINISTRATOR_BONNET_NUTS_DELETE', 'administrator-bonnetnuts-delete');
define('ADMINISTRATOR_BONNET_NUTS_EXCEL', 'administrator-bonnetnuts-excel');

define('ADMINISTRATOR_EYE_BOLT_CROSS_PIN_LIST', 'administrator-eyebolt-list');
define('ADMINISTRATOR_EYE_BOLT_CROSS_PIN_CREATE', 'administrator-eyebolt-create');
define('ADMINISTRATOR_EYE_BOLT_CROSS_PIN_UPDATE', 'administrator-eyebolt-update');
define('ADMINISTRATOR_EYE_BOLT_CROSS_PIN_DELETE', 'administrator-eyebolt-delete');
define('ADMINISTRATOR_EYE_BOLT_CROSS_PIN_EXCEL', 'administrator-eyebolt-excel');

define('ADMINISTRATOR_F_TO_F_LIST', 'administrator-ftof-list');
define('ADMINISTRATOR_F_TO_F_CREATE', 'administrator-ftof-create');
define('ADMINISTRATOR_F_TO_F_UPDATE', 'administrator-ftof-update');
define('ADMINISTRATOR_F_TO_F_DELETE', 'administrator-ftof-delete');
define('ADMINISTRATOR_F_TO_F_EXCEL', 'administrator-ftof-excel');

define('ADMINISTRATOR_EXTRA_PARA_LIST', 'administrator-extrapara-list');
define('ADMINISTRATOR_EXTRA_PARA_CREATE', 'administrator-extrapara-create');
define('ADMINISTRATOR_EXTRA_PARA_UPDATE', 'administrator-extrapara-update');
define('ADMINISTRATOR_EXTRA_PARA_DELETE', 'administrator-extrapara-delete');
define('ADMINISTRATOR_EXTRA_PARA_EXCEL', 'administrator-extrapara-excel');

define('ADMINISTRATOR_DISC_MOC_LIST', 'administrator-discmoc-list');
define('ADMINISTRATOR_DISC_MOC_CREATE', 'administrator-discmoc-create');
define('ADMINISTRATOR_DISC_MOC_UPDATE', 'administrator-discmoc-update');
define('ADMINISTRATOR_DISC_MOC_DELETE', 'administrator-discmoc-delete');
define('ADMINISTRATOR_DISC_MOC_EXCEL', 'administrator-discmoc-excel');

define('ADMINISTRATOR_COVER_MOC_LIST', 'administrator-covermoc-list');
define('ADMINISTRATOR_COVER_MOC_CREATE', 'administrator-covermoc-create');
define('ADMINISTRATOR_COVER_MOC_UPDATE', 'administrator-covermoc-update');
define('ADMINISTRATOR_COVER_MOC_DELETE', 'administrator-covermoc-delete');
define('ADMINISTRATOR_COVER_MOC_EXCEL', 'administrator-covermoc-excel');

define('ADMINISTRATOR_HINGE_PIN_LIST', 'administrator-hingepin-list');
define('ADMINISTRATOR_HINGE_PIN_CREATE', 'administrator-hingepin-create');
define('ADMINISTRATOR_HINGE_PIN_UPDATE', 'administrator-hingepin-update');
define('ADMINISTRATOR_HINGE_PIN_DELETE', 'administrator-hingepin-delete');
define('ADMINISTRATOR_HINGE_PIN_EXCEL', 'administrator-hingepin-excel');

define('ADMINISTRATOR_COVER_STUD_NUTS_LIST', 'administrator-coverstudnuts-list');
define('ADMINISTRATOR_COVER_STUD_NUTS_CREATE', 'administrator-coverstudnuts-create');
define('ADMINISTRATOR_COVER_STUD_NUTS_UPDATE', 'administrator-coverstudnuts-update');
define('ADMINISTRATOR_COVER_STUD_NUTS_DELETE', 'administrator-coverstudnuts-delete');
define('ADMINISTRATOR_COVER_STUD_NUTS_EXCEL', 'administrator-coverstudnuts-excel');

define('ADMINISTRATOR_COVER_GASKET_LIST', 'administrator-covergasket-list');
define('ADMINISTRATOR_COVER_GASKET_CREATE', 'administrator-covergasket-create');
define('ADMINISTRATOR_COVER_GASKET_UPDATE', 'administrator-covergasket-update');
define('ADMINISTRATOR_COVER_GASKET_DELETE', 'administrator-covergasket-delete');
define('ADMINISTRATOR_COVER_GASKET_EXCEL', 'administrator-covergasket-excel');

define('ADMINISTRATOR_GLAND_PACKING_LIST', 'administrator-glandpacking-list');
define('ADMINISTRATOR_GLAND_PACKING_CREATE', 'administrator-glandpacking-create');
define('ADMINISTRATOR_GLAND_PACKING_UPDATE', 'administrator-glandpacking-update');
define('ADMINISTRATOR_GLAND_PACKING_DELETE', 'administrator-glandpacking-delete');
define('ADMINISTRATOR_GLAND_PACKING_EXCEL', 'administrator-glandpacking-excel');

define('ADMINISTRATOR_COVER_STUD_LIST', 'administrator-coverstud-list');
define('ADMINISTRATOR_COVER_STUD_CREATE', 'administrator-coverstud-create');
define('ADMINISTRATOR_COVER_STUD_UPDATE', 'administrator-coverstud-update');
define('ADMINISTRATOR_COVER_STUD_DELETE', 'administrator-coverstud-delete');
define('ADMINISTRATOR_COVER_STUD_EXCEL', 'administrator-coverstud-excel');

define('ADMINISTRATOR_SCREEN_LIST', 'administrator-screen-list');
define('ADMINISTRATOR_SCREEN_CREATE', 'administrator-screen-create');
define('ADMINISTRATOR_SCREEN_UPDATE', 'administrator-screen-update');
define('ADMINISTRATOR_SCREEN_DELETE', 'administrator-screen-delete');
define('ADMINISTRATOR_SCREEN_EXCEL', 'administrator-screen-excel');

define('ADMINISTRATOR_DRAIN_PLUG_LIST', 'administrator-drainplug-list');
define('ADMINISTRATOR_DRAIN_PLUG_CREATE', 'administrator-drainplug-create');
define('ADMINISTRATOR_DRAIN_PLUG_UPDATE', 'administrator-drainplug-update');
define('ADMINISTRATOR_DRAIN_PLUG_DELETE', 'administrator-drainplug-delete');
define('ADMINISTRATOR_DRAIN_PLUG_EXCEL', 'administrator-drainplug-excel');

define('ADMINISTRATOR_SPRING_LIST', 'administrator-spring-list');
define('ADMINISTRATOR_SPRING_CREATE', 'administrator-spring-create');
define('ADMINISTRATOR_SPRING_UPDATE', 'administrator-spring-update');
define('ADMINISTRATOR_SPRING_DELETE', 'administrator-spring-delete');
define('ADMINISTRATOR_SPRING_EXCEL', 'administrator-spring-excel');

define('ADMINISTRATOR_HINGE_LIST', 'administrator-hing_e-list');
define('ADMINISTRATOR_HINGE_CREATE', 'administrator-hing_e-create');
define('ADMINISTRATOR_HINGE_UPDATE', 'administrator-hing_e-update');
define('ADMINISTRATOR_HINGE_DELETE', 'administrator-hing_e-delete');
define('ADMINISTRATOR_HINGE_EXCEL', 'administrator-hing_e-excel');

define('ADMINISTRATOR_BRACKET_LIST', 'administrator-bracket-list');
define('ADMINISTRATOR_BRACKET_CREATE', 'administrator-bracket-create');
define('ADMINISTRATOR_BRACKET_UPDATE', 'administrator-bracket-update');
define('ADMINISTRATOR_BRACKET_DELETE', 'administrator-bracket-delete');
define('ADMINISTRATOR_BRACKET_EXCEL', 'administrator-bracket-excel');

define('ADMINISTRATOR_YOKE_LIST', 'administrator-yoke-list');
define('ADMINISTRATOR_YOKE_CREATE', 'administrator-yoke-create');
define('ADMINISTRATOR_YOKE_UPDATE', 'administrator-yoke-update');
define('ADMINISTRATOR_YOKE_DELETE', 'administrator-yoke-delete');
define('ADMINISTRATOR_YOKE_EXCEL', 'administrator-yoke-excel');

define('ADMINISTRATOR_BALL_MOC_LIST', 'administrator-ballmoc-list');
define('ADMINISTRATOR_BALL_MOC_CREATE', 'administrator-ballmoc-create');
define('ADMINISTRATOR_BALL_MOC_UPDATE', 'administrator-ballmoc-update');
define('ADMINISTRATOR_BALL_MOC_DELETE', 'administrator-ballmoc-delete');
define('ADMINISTRATOR_BALL_MOC_EXCEL', 'administrator-ballmoc-excel');

define('ADMINISTRATOR_FASTENERS_LIST', 'administrator-fastners-list');
define('ADMINISTRATOR_FASTENERS_CREATE', 'administrator-fastners-create');
define('ADMINISTRATOR_FASTENERS_UPDATE', 'administrator-fastners-update');
define('ADMINISTRATOR_FASTENERS_DELETE', 'administrator-fastners-delete');
define('ADMINISTRATOR_FASTENERS_EXCEL', 'administrator-fastners-excel');

define('ADMINISTRATOR_SIDE_PIECE_CONNECTORS_LIST', 'administrator-sidepiececonn-list');
define('ADMINISTRATOR_SIDE_PIECE_CONNECTORS_CREATE', 'administrator-sidepiececonn-create');
define('ADMINISTRATOR_SIDE_PIECE_CONNECTORS_UPDATE', 'administrator-sidepiececonn-update');
define('ADMINISTRATOR_SIDE_PIECE_CONNECTORS_DELETE', 'administrator-sidepiececonn-delete');
define('ADMINISTRATOR_SIDE_PIECE_CONNECTORS_EXCEL', 'administrator-sidepiececonn-excel');

define('ADMINISTRATOR_SEAT_INSERT_LIST', 'administrator-seatinsert-list');
define('ADMINISTRATOR_SEAT_INSERT_CREATE', 'administrator-seatinsert-create');
define('ADMINISTRATOR_SEAT_INSERT_UPDATE', 'administrator-seatinsert-update');
define('ADMINISTRATOR_SEAT_INSERT_DELETE', 'administrator-seatinsert-delete');
define('ADMINISTRATOR_SEAT_INSERT_EXCEL', 'administrator-seatinsert-excel');
...
define('ADMINISTRATOR_COMPLAINT_MST_LIST', 'administrator-complaintmst-list');
define('ADMINISTRATOR_COMPLAINT_MST_CREATE', 'administrator-complaintmst-create');
define('ADMINISTRATOR_COMPLAINT_MST_UPDATE', 'administrator-complaintmst-update');
define('ADMINISTRATOR_COMPLAINT_MST_DELETE', 'administrator-complaintmst-delete');
define('ADMINISTRATOR_COMPLAINT_MST_EXCEL', 'administrator-complaintmstgit -excel');

define('ADMINISTRATOR_ITEM_MASTER_FIELD_LIST', 'administrator-item-master-field-list');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_CREATE', 'administrator-item-master-field-create');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_UPDATE', 'administrator-item-master-field-update');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_DELETE', 'administrator-item-master-field-delete');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_EXCEL', 'administrator-item-master-field-excel');

define('ADMINISTRATOR_ITEM_MASTER_FIELD_DATA_LIST', 'administrator-item-master-field-data-list');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_DATA_CREATE', 'administrator-item-master-field-data-create');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_DATA_UPDATE', 'administrator-item-master-field-data-update');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_DATA_DELETE', 'administrator-item-master-field-data-delete');
define('ADMINISTRATOR_ITEM_MASTER_FIELD_DATA_EXCEL', 'administrator-item-master-field-data-excel');

define('ADMINISTRATOR_MASTER_FIELD_LIST', 'administrator-master-field-list');
define('ADMINISTRATOR_MASTER_FIELD_CREATE', 'administrator-master-field-create');
define('ADMINISTRATOR_MASTER_FIELD_UPDATE', 'administrator-master-field-update');
define('ADMINISTRATOR_MASTER_FIELD_DELETE', 'administrator-master-field-delete');
define('ADMINISTRATOR_MASTER_FIELD_EXCEL', 'administrator-master-field-excel');

define('ADMINISTRATOR_MASTER_FIELD_DATA_LIST', 'administrator-master-field-data-list');
define('ADMINISTRATOR_MASTER_FIELD_DATA_CREATE', 'administrator-master-field-data-create');
define('ADMINISTRATOR_MASTER_FIELD_DATA_UPDATE', 'administrator-master-field-data-update');
define('ADMINISTRATOR_MASTER_FIELD_DATA_DELETE', 'administrator-master-field-data-delete');
define('ADMINISTRATOR_MASTER_FIELD_DATA_EXCEL', 'administrator-master-field-data-excel');
...
// DAILY EMAIL SUMMARY PERMISSION SLUG
define('TODAY_PURCHASE_SLUG_VIEW', 'today-purchase-view');
define('TILL_DATE_PURCHASE_SLUG_VIEW', 'till-date-purchase-view');
define('TODAY_SALE_SLUG_VIEW', 'today-sale-view');
define('TILL_DATE_SALE_SLUG_VIEW', 'till-date-sale-view');
define('TODAY_INQUIRY_ADD_SLUG_VIEW', 'today-inquiry-add-view');
define('TODAY_QUOTATION_CREATE_SLUG_VIEW', 'today-quotation-create-view');
define('TODAY_PENDING_INQUIRY_FOLLOWUP_SLUG_VIEW', 'today-pending-inquiry-followup-view');
define('TODAY_PENDING_QUOTATION_FOLLOWUP_SLUG_VIEW', 'today-pending-quotation-followup-view');
define('TODAY_SO_PLANNING_PENDING_SLUG_VIEW', 'today-so-planning-pending-view');
define('TODAY_INDENT_APPROVED_PENDING_SLUG_VIEW', 'today-indent-approved-pending-view');
define('TODAY_PO_CREATED_SLUG_VIEW', 'today-po-created-view');
define('TODAY_PO_PENDING_SLUG_VIEW', 'today-po-pending-view');
define('TODAY_PENDING_GRN_SLUG_VIEW', 'today-pending-grn-view');
define('TODAY_INQUIRY_WON_SLUG_VIEW', 'today-inquiry-won-view');
define('TODAY_TOTAL_AMOUNT_WON_INQUIRY_SLUG_VIEW', 'today-total-amount-won-inquiry-view');
/*END SANAT*/

/*start hardi*/
define('ADMINISTRATOR_CARTRIDGE_LIST', 'administrator-cartridge-list');
define('ADMINISTRATOR_CARTRIDGE_CREATE', 'administrator-cartridge-create');
define('ADMINISTRATOR_CARTRIDGE_UPDATE', 'administrator-cartridge-update');
define('ADMINISTRATOR_CARTRIDGE_DELETE', 'administrator-cartridge-delete');

define('ADMINISTRATOR_CLASS_LIST', 'administrator-class-list');
define('ADMINISTRATOR_CLASS_CREATE', 'administrator-class-create');
define('ADMINISTRATOR_CLASS_UPDATE', 'administrator-class-update');
define('ADMINISTRATOR_CLASS_DELETE', 'administrator-class-delete');

define('ADMINISTRATOR_FIRST_NAME_MST_LIST', 'administrator-first-name-mst-list');
define('ADMINISTRATOR_FIRST_NAME_MST_CREATE', 'administrator-first-name-mst-create');
define('ADMINISTRATOR_FIRST_NAME_MST_UPDATE', 'administrator-first-name-mst-update');
define('ADMINISTRATOR_FIRST_NAME_MST_DELETE', 'administrator-first-name-mst-delete');

define('ADMINISTRATOR_IMPREGNATION_LIST', 'administrator-impregnation-list');
define('ADMINISTRATOR_IMPREGNATION_CREATE', 'administrator-impregnation-create');
define('ADMINISTRATOR_IMPREGNATION_UPDATE', 'administrator-impregnation-update');
define('ADMINISTRATOR_IMPREGNATION_DELETE', 'administrator-impregnation-delete');

define('ADMINISTRATOR_INSTALLATION_LIST', 'administrator-installation-list');
define('ADMINISTRATOR_INSTALLATION_CREATE', 'administrator-installation-create');
define('ADMINISTRATOR_INSTALLATION_UPDATE', 'administrator-installation-update');
define('ADMINISTRATOR_INSTALLATION_DELETE', 'administrator-installation-delete');

define('ADMINISTRATOR_PRODUCT_MODEL_LIST', 'administrator-product-model-list');
define('ADMINISTRATOR_PRODUCT_MODEL_CREATE', 'administrator-product-model-create');
define('ADMINISTRATOR_PRODUCT_MODEL_UPDATE', 'administrator-product-model-update');
define('ADMINISTRATOR_PRODUCT_MODEL_DELETE', 'administrator-product-model-delete');

define('ADMINISTRATOR_SURFACE_AREA_MST_LIST', 'administrator-surface-area-mst-list');
define('ADMINISTRATOR_SURFACE_AREA_MST_CREATE', 'administrator-surface-area-mst-create');
define('ADMINISTRATOR_SURFACE_AREA_MST_UPDATE', 'administrator-surface-area-mst-update');
define('ADMINISTRATOR_SURFACE_AREA_MST_DELETE', 'administrator-surface-area-mst-delete');

define('ADMINISTRATOR_TYPE_MST_LIST', 'administrator-type-mst-list');
define('ADMINISTRATOR_TYPE_MST_CREATE', 'administrator-type-mst-create');
define('ADMINISTRATOR_TYPE_MST_UPDATE', 'administrator-type-mst-update');
define('ADMINISTRATOR_TYPE_MST_DELETE', 'administrator-type-mst-delete');

define('ADMINISTRATOR_TYPE_MSTE_LIST', 'administrator-type-mste-list');
define('ADMINISTRATOR_TYPE_MSTE_CREATE', 'administrator-type-mste-create');
define('ADMINISTRATOR_TYPE_MSTE_UPDATE', 'administrator-type-mste-update');
define('ADMINISTRATOR_TYPE_MSTE_DELETE', 'administrator-type-mste-delete');

define('REPORT_TO_USER_READ', 'crm-master-report-to-user-view');
define('REPORT_TO_USER_APPROVE', 'crm-master-report-to-user-unlock');

define('CRM_INQUIRY_TYPE_MST_LIST', 'crm-inquiry-type-mst-list');
define('CRM_INQUIRY_TYPE_MST_CREATE', 'crm-inquiry-type-mst-create');
define('CRM_INQUIRY_TYPE_MST_UPDATE', 'crm-inquiry-type-mst-update');
define('CRM_INQUIRY_TYPE_MST_DELETE', 'crm-inquiry-type-mst-delete');

define('CUSTOMER_DAILY_UPDATE_SLUG_READ', 'customer-daiy-update-list');
define('CUSTOMER_DAILY_UPDATE_SLUG_CREATE', 'customer-daiy-update-create');
define('CUSTOMER_DAILY_UPDATE_SLUG_UPDATE', 'customer-daiy-update-update');
define('CUSTOMER_DAILY_UPDATE_SLUG_DELETE', 'customer-daiy-update-delete');

// FORECAST BY USER
define('FORECAST_USER_SLUG_READ', 'forecast-user-list');
define('FORECAST_USER_SLUG_ADD', 'forecast-user-add');
define('FORECAST_USER_SLUG_EDIT', 'forecast-user-edit');
define('FORECAST_USER_SLUG_DELETE', 'forecast-user-delete');
define('FORECAST_USER_SLUG_PRINT', 'forecast-user-print');

//Indent Status Report
define('FORECAST_USER_REPORT','forecast-user-report-view');

/*end hardi*/
define('MAINTENANCE_ADD_SLUG_READ', 'maintenance-add-list');
define('MAINTENANCE_ADD_SLUG_CREATE', 'maintenance-add-create');
define('MAINTENANCE_ADD_SLUG_UPDATE', 'maintenance-add-update');
define('MAINTENANCE_ADD_SLUG_DELETE', 'maintenance-add-delete');

/*
*  Sanat Start :: 09-05-22  
*/

// CREATE BOM
define('PRODUCTION_BOM_COSTING_LIST_SLUG_VIEW', 'production-bom-costing-list-view');
define('PRODUCTION_BOM_COSTING_LIST_SLUG_CREATE', 'production-bom-costing-list-create');
define('PRODUCTION_BOM_COSTING_LIST_SLUG_UPDATE', 'production-bom-costing-list-update');
define('PRODUCTION_BOM_COSTING_LIST_SLUG_DELETE', 'production-bom-costing-list-delete');

define('INVENTORY_WORKORDER_MATERIAL_ISSUE_LIST_SLUG_VIEW', 'inventory-workorder-material-issue-list-view');
define('INVENTORY_WORKORDER_MATERIAL_ISSUE_LIST_SLUG_CREATE', 'inventory-workorder-material-issue-list-create');
define('INVENTORY_WORKORDER_MATERIAL_ISSUE_LIST_SLUG_UPDATE', 'inventory-workorder-material-issue-list-update');
define('INVENTORY_WORKORDER_MATERIAL_ISSUE_LIST_SLUG_DELETE', 'inventory-workorder-material-issue-list-delete');
define('INVENTORY_WORKORDER_MATERIAL_ISSUE_LIST_SLUG_APPROVE', 'inventory-workorder-material-issue-list-approve');
...
define('SERVICE',8);
define('MATERIAL_ISSUE_PRINT',26);  // Added By Sanat  09-03-2023   
define('SALESORDER_DEALLOCATION_PRINT',27);  // Added By Sanat  09-03-2023

define('ISO_INQUIRY_REPORT','iso-inquiry-report');
define('DELAY_FOLLOWUP_REPORT','delay-followup-report');
define('MODULE_INVOICE','Invoice');
define('MODULE_PURCHASE','Purchase');

// extra stock start
define('EXTRA_STOCK_LIST','extra-stock-list');
define('EXTRA_STOCK_ADD','extra-stock-add');
define('EXTRA_STOCK_DELETE','extra-stock-delete');

//extra stock end


define('ADMINISTRATOR_PACKING_LIST', 'administrator-packing-list');
define('ADMINISTRATOR_PACKING_CREATE', 'administrator-packing-create');
define('ADMINISTRATOR_PACKING_UPDATE', 'administrator-packing-update');
define('ADMINISTRATOR_PACKING_DELETE', 'administrator-packing-delete');

/*START SANAT*/
// OPENING STOCK SLUG
define('WORKORDER_SO_DETAIL_REPORT_SLUG_VIEW', 'workorder_so_detail_report');
define('WORKORDER_SO_DISPATCH_REPORT_SLUG_VIEW', 'workorder_so_dispatch_report');
define('SALESORDER_INVOICE_REPORT_SLUG_VIEW', 'salesorder_invoice_report');
/*END SANAT*/


define('INVENTORY_SO_DEALLOCATE_LIST_SLUG_VIEW','inventory-so-deallocate-list-view');
define('INVENTORY_SO_DEALLOCATE_LIST_SLUG_CREATE','inventory-so-deallocate-list-create');
define('INVENTORY_SO_DEALLOCATE_LIST_SLUG_UPDATE','inventory-so-deallocate-list-update');
define('INVENTORY_SO_DEALLOCATE_LIST_SLUG_DELETE','inventory-so-deallocate-list-delete');
define('INVENTORY_SO_DEALLOCATE_LIST_SLUG_APPROVE','inventory-so-deallocate-list-approve');


define('INVENTORY_STORE_ACCEPTED_LIST_SLUG_VIEW','inventory-store-accepted-list-view');
define('INVENTORY_STORE_ACCEPTED_LIST_SLUG_DELETE','inventory-store-accepted-list-delete');

define('ON_FLOOR_GODOWN','-111'); // added by sanat  12/07/23
?>