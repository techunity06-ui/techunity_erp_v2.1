<?php
// function get_magic_quotes_gpc(){}		//add just for define
...
function brp_sc_mysql_escape($value, $db){
	...
	if (function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() && (strstr($value,'\"') || strstr($value,"\\'"))) $value = stripslashes($value);	
