<?php
	...
	$sOrder = "ORDER BY `acc_name`,`bank_name`,`bank_branch`";
	...
	$sQuery = "SELECT COUNT(".$sIndexColumn.") FROM   $sTable WHERE `acc_of` = '$_SESSION[user_id]' AND `acc_status` = 1";
