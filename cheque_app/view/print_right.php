	...
	@media
		{
			...
			#cheque {	
				...
				/*transform-origin: top center;	filter:progid:DXImageTransform.Microsoft.BasicImage(rotation=3);transform: rotate(-90deg) translateY(-100%);
				top:30%;
				left:18%;
top:30%;				
				position: absolute;
			...
			<?php
				switch($r['cheque_mode']) {
					...
					case 2:
						...
						echo '<img src="'.DOMAIN_CHEQUE.'cheque_marks/ac_payee_e.png" id="img_ac_e" style="left:10px;" />';
						break;
					case 3:
						echo '<div id="bearer" class="ui-widget-content cheque-item">*************</div>';
			...
			$.ajax({
				...
				success: function(response)
				{
					...
					if(response == 0) {
						...
						$("#date").attr("style","position: absolute;width:"+reply.design_dateWidth+"px;top:"+(parseInt(reply.design_date.top))+"px;left:"+(parseInt(reply.design_date.left))+"px;letter-spacing:"+(reply.design_dateLspace)+"px;");
						...
						$("#amount-number").attr("style","position: absolute;width:"+reply.design_amount_numberWidth+"px;top:"+(reply.design_amount_number.top)+"px;left:"+(parseInt(reply.design_amount_number.left))+"px;");
						$("#bearer").attr("style","position: absolute;width:"+reply.design_bearerWidth+"px;top:"+reply.design_bearer.top+"px;left:"+(parseInt(reply.design_bearer.left))+"px;");
						$("#not_more_than").removeClass("hidden").attr("style","width:"+reply.design_notmoreWidth+"px;top:"+reply.design_notmore.top+"px;left:"+(parseInt(reply.design_notmore.left))+"px;");
