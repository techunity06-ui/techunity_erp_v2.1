					...
					<div class="form-group">
						<table cellspacing="10" style="border-spacing:10px;" id="product_list" class="display table table-bordered table-striped">
							<tr id="field">
								...
								<th width="25%" class="text-center">Opening Balance(currency symbol)</th>
								<th width="20%" class="text-center">D/C</th>
								<th width="25%" class="text-center">Opening Balance(in Rs.)</th>
							...
							<tr id="field1">
								...
								<td style="vertical-align:top;">
									<input type="text"  title="Currency Opening Balance" placeholder="Currency Opening Balance" maxlength="20" id="currency_opening_balance" name="currency_opening_balance" class="form-control" onkeypress="return isNumberKey(event)" onchange="validateFloatKeyPress(this);" />
								</td>
								<td style="vertical-align:top;">
								...
								<td style="vertical-align:top;">
									<input type="text"  title="Opening Balance" placeholder="Opening Balace In Rs." id="curreency_opening_balance_rs" name="curreency_opening_balance_rs" maxlength="20" class="form-control" onkeypress="return isNumberKey(event)" onchange="validateFloatKeyPress(this);" />
								</td>
					...
					<div class="form-group">
						<div class="adv-table">
							<table  class="display table table-bordered table-striped" id="multi_currency_table">							
								...
								<tfoot>
									<tr><th colspan="4" style="text-align: right;">Total</th><th><span id="multicurrency_total"></span><span id="multicurrency_total_type"></span></th></tr>
								</tfoot>
							</table>
						</div>
					</div>
