						...
						<div class="col-md-12">								
							<form class="form-horizontal" role="form" id="common_category_add" action="javascript:;" method="post" name="common_category_add">
									...
									<div class="form-group">
										...
										<div class="col-md-12 col-xs-11">
											<select class="form-control" name="sundry_type" id="sundry_type" onchange="" required >
												...
												<option value="2" <?php if($sundryDetails['sundry_type']=='2'){ echo "selected"; } ?> >Substractive</option>		
											</select>
										</div>
									</div>
									<!-- <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-12 col-xs-11">
											<select class="form-control" name="sundry_calculate_on" id="sundry_calculate_on" onchange="isbasiccalculate(this.value);" >
												<option value="">--Select--</option>
									...
									<div class="applygst">
										<div class="form-group">
											<label class="col-md-12 control-label" style="text-align:left;line-height:25px">Do you want to apply GST ?</label>
											<div class="col-md-12 col-xs-11">
												<select class="form-control" name="apply_gst" id="apply_gst" onchange="showtax(this.value);" >
													<option value="1" <?php if($sundryDetails['apply_gst']=='1'){ echo "selected"; } ?>>No</option>
													<option value="2" <?php if($sundryDetails['apply_gst']=='2'){ echo "selected"; } ?>>Yes</option>
												</select>
											</div>
										</div>

										<div class="form-group taxcat">
											<label class="col-md-12 control-label" style="text-align:left;line-height:25px">Select Hsn Code</label>
											<div class="col-md-12 col-xs-11">
												<select class="select2" name='sundry_hsn' id='sundry_hsn' value='' title="Select HSN Code" onchange="get_tax_category_hsn_wise(this.value)">
													<?=get_hsn($dbcon,$sundryDetails['sundry_hsn'],'');?>
												</select>
											</div>
										</div>

										<div class="form-group taxcat">
											<label class="col-md-12 control-label" style="text-align:left;line-height:25px">Select Tax Category</label>
											<div class="col-md-12 col-xs-11">
												<select class="select2" name='sundry_gst' id='sundry_gst' value=''title="Select Gst">
													<?=get_tax_category_new($dbcon,$sundryDetails['sundry_gst']);?>
												</select>
											</div>
										</div>
									</div>
