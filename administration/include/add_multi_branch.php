					...
					<div class="form-group">
						<table cellspacing="10" style="border-spacing:10px;" id="product_list" class="display table table-bordered table-striped">
							...
							<tr id="field1">
								...
								<td style="vertical-align:top;">
									<input type="text"  title="Opening Balance" placeholder="Opening Balace In Rs." maxlength="20" id="branch_opening_balance" name="branch_opening_balance" class="form-control" onkeypress="return isNumberKey(event)" onchange="validateFloatKeyPress(this);" />
								</td>
