<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_SPRING_LIST,
        ADMINISTRATOR_SPRING_CREATE,
		ADMINISTRATOR_SPRING_UPDATE,
		ADMINISTRATOR_SPRING_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_SPRING_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_SPRING_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='spring' id='spring' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">SPRING




</label>
								   <input type="text" class="form-control" name="edit_spring" id="edit_spring" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/spring.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
