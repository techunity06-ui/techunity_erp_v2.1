<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_COUNTRY_LIST,
        ADMINISTRATOR_COUNTRY_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_COUNTRY_LIST,$bulkAccessArray)){
  ...
  <section id="container" >
      ...
      <section id="main-content">
		...
		<?php //include_once('../include/country_state_city.php');?>	
		  <div class="row">
		  	<?php if(in_array(ADMINISTRATOR_COUNTRY_CREATE,$bulkAccessArray)){ ?>
				<div class="col-sm-3">
					<section class="panel">
						<header class="panel-heading">
						  New <?=$form?>
						...
						<div class="panel-body">
							<form role="form" id="country_add" action="javascript:;" method="post" name="country_add">
							  ...
							  <div class="form-group">
								  ...
								  <input type="text" class="form-control txtOnly" id="country_name" name="country_name" placeholder=" Country Name">
							  </div>
							  <div class="form-group">
								  <label for="country_code">Country Code</label>
								  <input type="text" class="form-control " maxlength="4" id="country_code" name="country_code" placeholder=" Country Code">
							  </div>
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-content">
			...
			<form id="FormEditCountry" role="form" method="post" novalidate>
				...
				<div class="form-group">
					...
					<input type="text" name="edit_country_name"  id="edit_country_name" class="form-control txtOnly">
				</div>	
				<div class="form-group">
				  <label for="edit_country_code">Country Code</label>
				  <input type="text" class="form-control digitOnly" maxlength="4"  id="edit_country_code" name="edit_country_code" placeholder=" Country Code">
				</div>			
			</div>
	...
	<script src="<?=ROOT.ADMINISTRATION_ROOT ?>js/app/country_mst.js?<?=time()?>"></script>
<script>
