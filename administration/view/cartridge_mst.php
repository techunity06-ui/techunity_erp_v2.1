<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_CARTRIDGE_LIST,
        ADMINISTRATOR_CARTRIDGE_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_CARTRIDGE_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_CARTRIDGE_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="cartridge_add" action="javascript:;" method="post" name="cartridge_add">
												<?php //if($branch_id=='0'){ ?>
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='cartridge_name' id='cartridge_name' value='' />
												</div>
												
												<div class="form-group">
													<label>Cartridge Code</label>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Cartridge Name</label>
								   <input type="text" class="form-control" name="edit_cartridge_name" id="edit_cartridge_name" />
								</div>
								
								<div class="form-group">
								   <label for="unitid">Cartridge Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/cartridge_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
