<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_BODY_MOC_LIST,
        ADMINISTRATOR_BODY_MOC_CREATE,
		ADMINISTRATOR_BODY_MOC_UPDATE,
		ADMINISTRATOR_BODY_MOC_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_BODY_MOC_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_BODY_MOC_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>BODY MOC</label>
													<input class="form-control" type='text' name='body_moc' id='body_moc' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">BODY MOC</label>
								   <input type="text" class="form-control" name="edit_body_moc" id="edit_body_moc" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/body_moc_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
