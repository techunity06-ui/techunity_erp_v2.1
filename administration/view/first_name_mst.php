<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_FIRST_NAME_MST_LIST,
        ADMINISTRATOR_FIRST_NAME_MST_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_FIRST_NAME_MST_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_FIRST_NAME_MST_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="first_name_add" action="javascript:;" method="post" name="first_name_add">
												<?php //if($branch_id=='0'){ ?>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Material Description</label>
								   <input type="text" class="form-control" name="edit_first_name" id="edit_first_name" />
								</div>
								<div class="form-group">
								   <label for="unitid">Material Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/first_name_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
