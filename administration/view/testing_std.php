<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_TESTINGSTD_LIST,
        ADMINISTRATOR_TESTINGSTD_CREATE,
		ADMINISTRATOR_TESTINGSTD_UPDATE,
		ADMINISTRATOR_TESTINGSTD_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_TESTINGSTD_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_TESTINGSTD_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Testing std</label>
													<input class="form-control" type='text' name='testing_std' id='testing_std' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Testing std</label>
								   <input type="text" class="form-control" name="edit_testing_std" id="edit_testing_std" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/testing_std_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
