<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_BALL_MOC_LIST,
        ADMINISTRATOR_BALL_MOC_CREATE,
		ADMINISTRATOR_BALL_MOC_UPDATE,
		ADMINISTRATOR_BALL_MOC_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_BALL_MOC_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_BALL_MOC_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label><?=$form?></label>
													<input class="form-control" type='text' name='ball_moc' id='ball_moc' value='' />
												</div>
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   ...
								   <input type="text" class="form-control" name="edit_ball_moc" id="edit_ball_moc" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/ball_moc.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
