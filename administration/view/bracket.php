<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_BRACKET_LIST,
        ADMINISTRATOR_BRACKET_CREATE,
		ADMINISTRATOR_BRACKET_UPDATE,
		ADMINISTRATOR_BRACKET_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_BRACKET_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_BRACKET_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label>bracket</label>
													<input class="form-control" type='text' name='bracket' id='bracket' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">bracket



</label>
								   <input type="text" class="form-control" name="edit_bracket" id="edit_bracket" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/bracket.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
