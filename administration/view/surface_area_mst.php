<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_SURFACE_AREA_MST_LIST,
        ADMINISTRATOR_SURFACE_AREA_MST_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_SURFACE_AREA_MST_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_SURFACE_AREA_MST_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="surface_area_add" action="javascript:;" method="post" name="surface_area_add">
												<?php //if($branch_id=='0'){ ?>
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='surface_area_name' id='surface_area_name' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Product Name</label>
								   <input type="text" class="form-control" name="edit_surface_area_name" id="edit_surface_area_name" />
								</div>
								
								<div class="form-group">
								   <label for="unitid">Product Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/surface_area_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
