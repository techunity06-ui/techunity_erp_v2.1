<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_BONNETBOLT_LIST,
        ADMINISTRATOR_BONNETBOLT_CREATE,
		ADMINISTRATOR_BONNETBOLT_UPDATE,
		ADMINISTRATOR_BONNETBOLT_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_BONNETBOLT_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_BONNETBOLT_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>BONNET BOLT</label>
													<input class="form-control" type='text' name='bonnet_bolt' id='bonnet_bolt' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">BONNET BOLT</label>
								   <input type="text" class="form-control" name="edit_bonnet_bolt" id="edit_bonnet_bolt" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/bonnet_bolt.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
