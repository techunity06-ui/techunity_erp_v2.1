...
<body>
											...
											<div class="col-md-12">
												<div class="col-md-6">
													...
													<div class="form-group">
														...
														<div class="col-md-6">
															<select class="select2" name="branch_id" id="branch_id" onchange="load_category_datatable()" required <?php if($companyConfiguration['branch_wise_manage']=='0'){ ?>disabled<?php } ?>>
																<?php $branch = isset($rel['branch_id']) ? $rel['branch_id'] : '1000'; ?>
																<?= getBranchBox_new($dbcon, $branch, 'all'); ?>
															</select>
														</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body form">
					<form id="FormEditunit" role="form" method="post" novalidate>
						...
						<div class="form-group">
							<label for="unitid">Parent Category *</label>
							<select class="form-control" name="e_cat_parent" id="e_cat_parent">
	...
	<script src="<?= ROOT . ADMINISTRATION_ROOT ?>js/app/category_mst.js?<?= time() ?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
