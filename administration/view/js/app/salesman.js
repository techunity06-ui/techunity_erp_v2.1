...
$("#salesman_add").on('submit',function(e) {
	...
	//alert(root_domain+administration_domain+'app/salesman_mst/');
	//alert(root_domain+administration_domain+'app/salesman_mst/');
	...
	$.ajax({
		cache:false,
		url: root_domain+administration_domain+'app/salesman_mst/',
		type: "POST",
		data: form_data,
		contentType: false,
		processData:false,
		success: function(response)
		{
			...
			if(response.trim() == '1') {
				...
				window.location=root_domain+administration_domain+'salesman_list';
			}
...
datatable = $("#salesman-table").dataTable({
		...
		"iDisplayLength": 10,
		"sAjaxSource": root_domain+administration_domain+'app/salesman_mst/',
	...
	var r= confirm(" Are you want to delete ?");
		...
		if(r) {
			...
			$.ajax({
				type: "POST",
				url: root_domain+administration_domain+'app/salesman_mst/',
				data: { mode : "delete_sales_data",  eid : id},
				success: function(response)
				{
