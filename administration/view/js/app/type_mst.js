$(document).ready(function() {
	...
	$("#type_add").validate({
		...
		messages: {
			...
			type_name: {
				required: "Please Enter End Connection Name "
			},
			code: {
				required: "Please Enter End Connection Code "
			},
		}
	}); 
...
$("#type_add").on('submit',function(e) {
	...
	$.ajax({
		cache:false,
		url: root_domain+administration_domain+'app/type_mst/',
		type: "POST",
		data: form_data,
...
function load_type_msteter_datatable(){
	...
	datatable = $("#dynamic-table").dataTable({
			...
			"iDisplayLength": 10,
			"sAjaxSource": root_domain+administration_domain+'app/type_mst/',
