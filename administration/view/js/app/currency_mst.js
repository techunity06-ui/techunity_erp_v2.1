...
$("#currency_add").on('submit',function(e) {
	...
	var form_data = {
		...
		currency_symbl: $("#currency_symbl").val(),
	...
	$.ajax({
		cache:false,
		url: root_domain+administration_domain+'app/currencymst/',
		type: "POST",
		data: form_data,
...
$("#FormEditCurrency").on('submit',function(e) {
	...
	var form_data = {
		...
		currency_symbl: $("#edit_currency_symbl").val(),
...
function edit_test(id)
{
	...
	editReq = $.ajax({
		...
		success: function(response)
		{
			...
			$("#edit_currency_symbl").val(obj.currency_symbl);
...
function load_currency_datatable(){
	...
	datatable = $("#currency-table").dataTable({
		...
		"iDisplayLength": 10,
		"sAjaxSource": root_domain+administration_domain+'app/currencymst/',
