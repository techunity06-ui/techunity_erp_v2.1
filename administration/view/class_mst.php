<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_CLASS_LIST,
        ADMINISTRATOR_CLASS_CREATE,
		ADMINISTRATOR_CLASS_UPDATE,
		ADMINISTRATOR_CLASS_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_CLASS_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_CLASS_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='class_name' id='class_name' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Class Name</label>
								   <input type="text" class="form-control" name="edit_class_name" id="edit_class_name" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/class_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
