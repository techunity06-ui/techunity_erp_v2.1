		...
		<?php //include_once('../include/Currency_state_city.php');?>	
		  <div class="row">
				...
				<div class="col-sm-3">
					<section class="panel">
						...
						<div class="panel-body">
							<form role="form" id="batch_size_add" action="javascript:;" method="post" name="batch_size_add">
								  
								  <div class="form-group">
									  <label for="batch_size_name">Batch Size Name*</label>
									  <input type="text" class="form-control" id="batch_size_name" name="batch_size_name" placeholder="Batch Size Name">
								  </div>
			...
			<section class="panel">
				  ...
				  <div class="panel-body">
				  <div class="adv-table">
				  <table  class="display table table-bordered table-striped" id="batch-size-table">
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog custom-width">
		<div class="modal-content">
			...
			<form id="FormEditCurrency" role="form" method="post" novalidate>
				...
				<div class="form-group">
					<label class="control-label">Batch Size Name*</label>
					<input type="text" name="edit_batch_size_name"  id="edit_batch_size_name" class="form-control">
				</div>
	...
	<script src="<?=ROOT.ADMINISTRATION_ROOT ?>js/app/batch_size_mst.js?<?=time()?>"></script>
<script>
