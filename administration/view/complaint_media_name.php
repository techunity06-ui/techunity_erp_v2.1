...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	ADMINISTRATOR_COMPLAINT_MST_LIST,
	ADMINISTRATOR_COMPLAINT_MST_CREATE,
	ADMINISTRATOR_COMPLAINT_MST_DELETE,
	ADMINISTRATOR_COMPLAINT_MST_EXCEL
]);

if (!in_array(ADMINISTRATOR_COMPLAINT_MST_LIST, $bulkAccessArray)) {
...
<body>
	<section id="container">
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<?php if (in_array(ADMINISTRATOR_COMPLAINT_MST_CREATE, $bulkAccessArray)) { ?>
						<div class="col-sm-3">
							<section class="panel">
								<header class="panel-heading">
									New <?= $form ?>
								...
								<div class="panel-body">
									<form role="form" id="media_add" action="javascript:;" method="post" name="media_add">
										<?php if ($branch_id == '0') { ?>
					...
					<?php } ?>
					<?php if (in_array(ADMINISTRATOR_COMPLAINT_MST_LIST, $bulkAccessArray)) { ?>
						<div class="col-sm-9">
						<?php } else { ?>
							<div class="col-sm-12">
							<?php } ?>
							<section class="panel">
								...
								<div class="panel-body">
									<div class="adv-table">
										<table class="display table table-bordered table-striped" id="media-table">
											<div class="col-md-12">
												<div class="col-md-6">
													<select class="select2" name="branch_id" id="branch_id" onchange="load_media_datatable()" required>
														<?php $branch = isset($rel['branch_id']) ? $rel['branch_id'] : '1000'; ?>
														<?= getBranchBox_new($dbcon, $branch, 'all'); ?>
													</select>
												</div>
		...
		<div class="modal-dialog custom-width">
			<div class="modal-content">
				...
				<div class="modal-body form">
					<form id="FormEditmedia" role="form" method="post" novalidate>
						<?php if ($branch_id == '0') { ?>
							<div class="form-group">
								<label>Branch *</label>
						...
						<div class="form-group">
							...
							<input type="text" name="edit_media_name" id="edit_media_name" class="form-control">
						</div>
				</div>
				<div class="modal-footer">
					<input type="hidden" name="edit_id" id="edit_id" value="" />
					<button type="button" class="btn btn-default btn-flat md-close" data-dismiss="modal">Cancel</button>
					<button class="btn btn-info btn-flat" type="submit">Update Media</button>
				</div>
				</form>
			</div><!-- /.modal-content -->
		</div><!-- /.modal-dialog -->
	...
	<script src="<?= ROOT . ADMINISTRATION_ROOT ?>js/app/complaint_media_name.js?<?= time() ?>"></script>
	<script>
