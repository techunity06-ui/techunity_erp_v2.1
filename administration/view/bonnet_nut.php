<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_BONNET_NUTS_LIST,
        ADMINISTRATOR_BONNET_NUTS_CREATE,
		ADMINISTRATOR_BONNET_NUTS_UPDATE,
		ADMINISTRATOR_BONNET_NUTS_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_BONNET_NUTS_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_BONNET_NUTS_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>BONNET NUTS</label>
													<input class="form-control" type='text' name='bonnet_nut' id='bonnet_nut' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">BONNET NUTS</label>
								   <input type="text" class="form-control" name="edit_bonnet_nut" id="edit_bonnet_nut" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/bonnet_nut_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
