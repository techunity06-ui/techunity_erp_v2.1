...
";
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_GLAND_PACKING_LIST,
        ADMINISTRATOR_GLAND_PACKING_CREATE,
		ADMINISTRATOR_GLAND_PACKING_UPDATE,
		ADMINISTRATOR_GLAND_PACKING_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_GLAND_PACKING_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_GLAND_PACKING_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='gland_packing' id='gland_packing' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">GLAND PACKING

</label>
								   <input type="text" class="form-control" name="edit_gland_packing" id="edit_gland_packing" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/gland_packing.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
