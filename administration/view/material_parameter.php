<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_MATERIAL_PARAMETER_LIST,
        ADMINISTRATOR_MATERIAL_PARAMETER_CREATE,
        ADMINISTRATOR_MATERIAL_PARAMETER_EXCEL
    ]);

    if(!in_array(ADMINISTRATOR_MATERIAL_PARAMETER_LIST,$bulkAccessArray)){
...
<html lang="en">
<head>
	<title>MATERIAL PARAMETER</title>
...
<body>
  <section id="container" >
      ...
      <section id="main-content">
		  ...
		  <div class="row">
		  	<?php if(in_array(ADMINISTRATOR_MATERIAL_PARAMETER_CREATE,$bulkAccessArray)){ ?>
				<div class="col-sm-3">
					<section class="panel">
						<header class="panel-heading">
						  New <?=$form?>
						...
						<div class="panel-body">
							<form role="form" id="make_add" action="javascript:;" method="post" name="make_add">
						        ...
						        <?php } ?>
							    <div class="form-group">
								  <label>Material Parameter Name *</label>
								  <input type="text" class="form-control" id="material_parameter_name" name="material_parameter_name" placeholder="Material Parameter Name">
							    </div>
			...
			<section class="panel">
				  <header class="panel-heading">
					  <?=$form?> List
					<?php if($_SESSION['user_type'] == 2 && in_array(ADMINISTRATOR_MATERIAL_PARAMETER_EXCEL,$bulkAccessArray)){ ?>					  
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog custom-width">
		<div class="modal-content">
			...
			<form id="FormEditMake" role="form" method="post" novalidate>
				...
				<div class="form-group">
					<label class="control-label">Material Parameter Name *</label>
					<input type="text" name="edit_material_parameter_name"  id="edit_material_parameter_name" class="form-control">
				</div>	
			</div>
			<div class="modal-footer">
				<input type="hidden" name="edit_id" id="edit_id" value="" />
				<button type="button" class="btn btn-default btn-flat md-close" data-dismiss="modal">Cancel</button>
				<button class="btn btn-info btn-flat" type="submit">Update Material Parameter</button>
			</div>
			</form>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
	...
	<script src="<?=ROOT.ADMINISTRATION_ROOT ?>js/app/material_parameter_mst.js?<?=time()?>"></script>
<script>
