<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_MAKE_NUMBER_LIST,
        ADMINISTRATOR_MAKE_NUMBER_CREATE,
        ADMINISTRATOR_MAKE_NUMBER_EXCEL
    ]);

    if(!in_array(ADMINISTRATOR_MAKE_NUMBER_LIST,$bulkAccessArray)){
...
<body>
  <section id="container" >
      ...
      <section id="main-content">
		  ...
		  <div class="row">
		  	<?php if(in_array(ADMINISTRATOR_MAKE_NUMBER_CREATE,$bulkAccessArray)){ ?>
				<div class="col-sm-3">
					<section class="panel">
						<header class="panel-heading">
						  New <?=$form?>
						...
						<div class="panel-body">
							<form role="form" id="make_add" action="javascript:;" method="post" name="make_add">
						        ...
						        <?php } ?>
							   <div class="form-group">
								  <label>Make Number *</label>
								  <input type="text" class="form-control" id="make_number" name="make_number" placeholder="Make Number">
							  </div>
			...
			<section class="panel">
				  <header class="panel-heading">
					  <?=$form?> List
					<?php if($_SESSION['user_type'] == 2 && in_array(ADMINISTRATOR_MAKE_NUMBER_EXCEL,$bulkAccessArray)){?>					  
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog custom-width">
		<div class="modal-content">
			...
			<form id="FormEditMake" role="form" method="post" novalidate>
		        ...
		        <?php } ?> 				
				<div class="form-group">
					<label class="control-label">Make Number *</label>
					<input type="text" name="edit_make_number"  id="edit_make_number" class="form-control">
				</div>	
			</div>
	...
	<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/make_number_mst.js?<?=time()?>"></script>
<script>
