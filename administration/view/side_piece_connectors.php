<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_SIDE_PIECE_CONNECTORS_LIST,
        ADMINISTRATOR_SIDE_PIECE_CONNECTORS_CREATE,
		ADMINISTRATOR_SIDE_PIECE_CONNECTORS_UPDATE,
		ADMINISTRATOR_SIDE_PIECE_CONNECTORS_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_SIDE_PIECE_CONNECTORS_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_SIDE_PIECE_CONNECTORS_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label><?=$form?></label>
													<input class="form-control" type='text' name='side_piece_connectors' id='side_piece_connectors' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid"><?=$form?>



</label>
								   <input type="text" class="form-control" name="edit_side_piece_connectors" id="edit_side_piece_connectors" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/side_piece_connectors.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
