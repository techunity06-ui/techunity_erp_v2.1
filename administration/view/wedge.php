<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_WEDGE_LIST,
        ADMINISTRATOR_WEDGE_CREATE,
		ADMINISTRATOR_WEDGE_UPDATE,
		ADMINISTRATOR_WEDGE_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_WEDGE_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_WEDGE_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label>WEDGE</label>
													<input class="form-control" type='text' name='wedge' id='wedge' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">WEDGE</label>
								   <input type="text" class="form-control" name="edit_wedge" id="edit_wedge" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/wedge_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
