<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_YOKE_LIST,
        ADMINISTRATOR_YOKE_CREATE,
		ADMINISTRATOR_YOKE_UPDATE,
		ADMINISTRATOR_YOKE_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_YOKE_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_YOKE_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label>yoke</label>
													<input class="form-control" type='text' name='yoke' id='yoke' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">yoke



</label>
								   <input type="text" class="form-control" name="edit_yoke" id="edit_yoke" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/yoke.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
