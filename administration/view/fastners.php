<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_FASTENERS_LIST,
        ADMINISTRATOR_FASTENERS_CREATE,
		ADMINISTRATOR_FASTENERS_UPDATE,
		ADMINISTRATOR_FASTENERS_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_FASTENERS_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_FASTENERS_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label><?=$form?></label>
													<input class="form-control" type='text' name='fastners' id='fastners' value='' />
												</div>
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   ...
								   <input type="text" class="form-control" name="edit_fastners" id="edit_fastners" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/fastners.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
