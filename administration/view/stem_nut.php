<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_STEM_NUT_LIST,
        ADMINISTRATOR_STEM_NUT_CREATE,
		ADMINISTRATOR_STEM_NUT_UPDATE,
		ADMINISTRATOR_STEM_NUT_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_STEM_NUT_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_STEM_NUT_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Stem nut</label>
													<input class="form-control" type='text' name='stem_nut' id='stem_nut' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Stem nut</label>
								   <input type="text" class="form-control" name="edit_stem_nut" id="edit_stem_nut" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/stem_nut_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
