<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_DRAIN_PLUG_LIST,
        ADMINISTRATOR_DRAIN_PLUG_CREATE,
		ADMINISTRATOR_DRAIN_PLUG_UPDATE,
		ADMINISTRATOR_DRAIN_PLUG_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_DRAIN_PLUG_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_DRAIN_PLUG_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='drain_plug' id='drain_plug' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">DRAIN PLUG



</label>
								   <input type="text" class="form-control" name="edit_drain_plug" id="edit_drain_plug" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/drain_plug.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
