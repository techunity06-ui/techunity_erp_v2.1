<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_HAND_WHEEL_LIST,
        ADMINISTRATOR_HAND_WHEEL_CREATE,
		ADMINISTRATOR_HAND_WHEEL_UPDATE,
		ADMINISTRATOR_HAND_WHEEL_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_HAND_WHEEL_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_HAND_WHEEL_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Hand Wheel</label>
													<input class="form-control" type='text' name='hand_wheel' id='hand_wheel' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Hand Wheel</label>
								   <input type="text" class="form-control" name="edit_hand_wheel" id="edit_hand_wheel" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/hand_wheel_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
