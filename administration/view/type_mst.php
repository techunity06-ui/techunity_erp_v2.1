<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_TYPE_MST_LIST,
        ADMINISTRATOR_TYPE_MST_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_TYPE_MST_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_TYPE_MST_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="type_add" action="javascript:;" method="post" name="type_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>End Connection Name</label>
													<input class="form-control" type='text' name='type_name' id='type_name' value='' />
												</div>
												
												<div class="form-group">
													<label>End Connection Code</label>
								...
								<div class="adv-table">
									<table  class="display table table-bordered table-striped" id="dynamic-table">
										<div class="col-md-12">
											<div class="col-md-6">
											<?php if($companyConfiguration['branch_wise_manage']=='1'){ ?>
												<?php echo getBranchBox($dbcon, $branch_id, $rel['branch_id'], false, true,'load_type_msteter_datatable()','4','6'); ?>
											<?php } ?>
											</div>
										</div>
										<thead>
											<tr>
												<th>Sr. NO.</th>
												<th>End Connection Name</th>
												<th>End Connection Code</th>
												<th>Branch Name</th>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">End Connection Name</label>
								   <input type="text" class="form-control" name="edit_type_name" id="edit_type_name" />
								</div>
								
								<div class="form-group">
								   <label for="unitid">End Connection Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/type_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
