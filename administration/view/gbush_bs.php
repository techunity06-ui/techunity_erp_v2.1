<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_LIST,
        ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_CREATE,
		ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_UPDATE,
		ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_GBUSH_BACK_SEAT_BUSH_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>G.BUSH / BACK SEAT BUSH</label>
													<input class="form-control" type='text' name='gbush' id='gbush' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">G.BUSH / BACK SEAT BUSH</label>
								   <input type="text" class="form-control" name="edit_gbush" id="edit_gbush" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/gbush_bs_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
