<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_COVER_NUT_LIST,
        ADMINISTRATOR_COVER_NUT_CREATE,
		ADMINISTRATOR_COVER_NUT_UPDATE,
		ADMINISTRATOR_COVER_NUT_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_COVER_NUT_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_COVER_NUT_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>COVER NUT</label>
													<input class="form-control" type='text' name='cover_nut' id='cover_nut' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">COVER NUT</label>
								   <input type="text" class="form-control" name="edit_cover_nut" id="edit_cover_nut" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/cover_nut_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
