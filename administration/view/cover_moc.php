<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_COVER_MOC_LIST,
        ADMINISTRATOR_COVER_MOC_CREATE,
		ADMINISTRATOR_COVER_MOC_UPDATE,
		ADMINISTRATOR_COVER_MOC_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_COVER_MOC_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_COVER_MOC_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Cover moc</label>
													<input class="form-control" type='text' name='cover_moc' id='cover_moc' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Cover moc</label>
								   <input type="text" class="form-control" name="edit_cover_moc" id="edit_cover_moc" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/cover_moc.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
