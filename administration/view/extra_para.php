<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_EXTRA_PARA_LIST,
        ADMINISTRATOR_EXTRA_PARA_CREATE,
		ADMINISTRATOR_EXTRA_PARA_UPDATE,
		ADMINISTRATOR_EXTRA_PARA_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_EXTRA_PARA_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_EXTRA_PARA_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Extra para</label>
													<input class="form-control" type='text' name='extra_para' id='extra_para' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Extra para</label>
								   <input type="text" class="form-control" name="edit_extra_para" id="edit_extra_para" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/extra_para.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
