<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_GLAND_FLANGE_LIST,
        ADMINISTRATOR_GLAND_FLANGE_CREATE,
		ADMINISTRATOR_GLAND_FLANGE_UPDATE,
		ADMINISTRATOR_GLAND_FLANGE_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_GLAND_FLANGE_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_GLAND_FLANGE_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>GLAND FLANGE</label>
													<input class="form-control" type='text' name='gland_flange' id='gland_flange' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">GLAND FLANGE</label>
								   <input type="text" class="form-control" name="edit_gland_flange" id="edit_gland_flange" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/gland_flange.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
