<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_HINGE_LIST,
        ADMINISTRATOR_HINGE_CREATE,
		ADMINISTRATOR_HINGE_UPDATE,
		ADMINISTRATOR_HINGE_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_HINGE_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_HINGE_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label>Hinge</label>
													<input class="form-control" type='text' name='hinge' id='hinge' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Hinge



</label>
								   <input type="text" class="form-control" name="edit_hinge" id="edit_hinge" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/hinge.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
