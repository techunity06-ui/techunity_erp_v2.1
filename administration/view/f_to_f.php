<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_F_TO_F_LIST,
        ADMINISTRATOR_F_TO_F_CREATE,
		ADMINISTRATOR_F_TO_F_UPDATE,
		ADMINISTRATOR_F_TO_F_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_F_TO_F_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_F_TO_F_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label>F TO F</label>
													<input class="form-control" type='text' name='f_to_f' id='f_to_f' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">F TO F</label>
								   <input type="text" class="form-control" name="edit_f_to_f" id="edit_f_to_f" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/f_to_f.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
