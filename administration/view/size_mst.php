		...
		<?php //include_once('../include/Currency_state_city.php');?>	
		  <div class="row">
				...
				<div class="col-sm-3">
					<section class="panel">
						...
						<div class="panel-body">
							<form role="form" id="Size_add" action="javascript:;" method="post" name="Size_add">
			...
			<section class="panel">
				  ...
				  <div class="panel-body">
				  <div class="adv-table">
				  <table  class="display table table-bordered table-striped" id="Size-table">
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-content">
			...
			<form id="FormEditCurrency" role="form" method="post" novalidate>
				...
				<div class="form-group">
					...
					<input type="text" name="edit_size_name"  id="edit_size_name" class="form-control">
				</div>
	...
	<script src="<?=ROOT.ADMINISTRATION_ROOT ?>js/app/size_mst.js?<?=time()?>"></script>
<script>
