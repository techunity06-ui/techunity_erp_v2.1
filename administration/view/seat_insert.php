<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_SEAT_INSERT_LIST,
        ADMINISTRATOR_SEAT_INSERT_CREATE,
		ADMINISTRATOR_SEAT_INSERT_UPDATE,
		ADMINISTRATOR_SEAT_INSERT_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_SEAT_INSERT_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_SEAT_INSERT_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label><?=$form?></label>
													<input class="form-control" type='text' name='seat_insert' id='seat_insert' value='' />
												</div>
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   ...
								   <input type="text" class="form-control" name="edit_seat_insert" id="edit_seat_insert" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/seat_insert.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
