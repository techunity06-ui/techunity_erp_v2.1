<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_SPINDLE_LIST,
        ADMINISTRATOR_SPINDLE_CREATE,
		ADMINISTRATOR_SPINDLE_UPDATE,
		ADMINISTRATOR_SPINDLE_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_SPINDLE_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_SPINDLE_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													<label>SPINDLE</label>
													<input class="form-control" type='text' name='spindle' id='spindle' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">SPINDLE</label>
								   <input type="text" class="form-control" name="edit_spindle" id="edit_spindle" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/spindle_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
