<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_INSTALLATION_LIST,
        ADMINISTRATOR_INSTALLATION_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_INSTALLATION_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_INSTALLATION_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="installation_add" action="javascript:;" method="post" name="installation_add">
												<?php //if($branch_id=='0'){ ?>
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='installation_name' id='installation_name' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Configuration Name</label>
								   <input type="text" class="form-control" name="edit_installation_name" id="edit_installation_name" />
								</div>
								
								<div class="form-group">
								   <label for="unitid">Configuration Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/installation_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
