<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_DESIGN_LIST,
        ADMINISTRATOR_DESIGN_CREATE,
		ADMINISTRATOR_DESIGN_UPDATE,
		ADMINISTRATOR_DESIGN_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_DESIGN_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_DESIGN_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Design STD</label>
													<input class="form-control" type='text' name='design_name' id='design_name' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Design std</label>
								   <input type="text" class="form-control" name="edit_design_name" id="edit_design_name" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/design_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
