...
<body>
  <section id="container" >
      ...
      <section id="main-content">
		  ...
		  <div class="row">
		  	<?php if(1==1){//if(in_array(ADMINISTRATOR_MAKE_CREATE,$bulkAccessArray)){ ?>
				<div class="col-sm-3">
					<section class="panel">
						<header class="panel-heading">
						  New <?=$form?>
						...
						<div class="panel-body">
							<form role="form" id="make_add" action="javascript:;" method="post" name="make_add">
							    ...
							    <div class="form-group">
								  ...
								  <input type="text" class="form-control" id="dilivary_type_name" name="dilivary_type_name" placeholder="DELIVERY TYPE">
							    </div>
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-content">
			...
			<form id="FormEditMake" role="form" method="post" novalidate>
				...
				<div class="form-group">
					...
					<input type="text" name="edit_dilivary_type_name"  id="edit_dilivary_type_name" class="form-control">
				</div>	
			</div>
	...
	<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/apson_dilivary_type.js?<?=time()?>"></script>
<script>
