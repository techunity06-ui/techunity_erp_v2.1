<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_TYPE_MSTE_LIST,
        ADMINISTRATOR_TYPE_MSTE_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_TYPE_MSTE_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_TYPE_MSTE_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="type_add" action="javascript:;" method="post" name="type_add">
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='type_desc' id='type_desc' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Type Description</label>
								   <input type="text" class="form-control" name="edit_type_desc" id="edit_type_desc" />
								</div>
								
								<div class="form-group">
								   <label for="unitid">Type Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/type_mste.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
