<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_IMPREGNATION_LIST,
        ADMINISTRATOR_IMPREGNATION_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_IMPREGNATION_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_IMPREGNATION_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="impregnation_add" action="javascript:;" method="post" name="impregnation_add">
												<?php //if($branch_id=='0'){ ?>
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='impregnation_name' id='impregnation_name' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Style Name</label>
								   <input type="text" class="form-control" name="edit_impregnation_name" id="edit_impregnation_name" />
								</div>
								
								<div class="form-group">
								   <label for="unitid">Style Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/impregnation_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
