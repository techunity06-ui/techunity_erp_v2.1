<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_BONNETGASKET_LIST,
        ADMINISTRATOR_BONNETGASKET_CREATE,
		ADMINISTRATOR_BONNETGASKET_UPDATE,
		ADMINISTRATOR_BONNETGASKET_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_BONNETGASKET_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_BONNETGASKET_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Bonnet Gasket</label>
													<input class="form-control" type='text' name='bonnet_gasket' id='bonnet_gasket' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">BONNET GASKET</label>
								   <input type="text" class="form-control" name="edit_bonnet_gasket" id="edit_bonnet_gasket" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/bonnet_gasket_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
