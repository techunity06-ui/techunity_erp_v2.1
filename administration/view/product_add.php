...
<body>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-md-12 margin_row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="Product Type" class="col-md-4 control-label" style="white-space: nowrap;">Product Alias Name</label>
                                    <div class="col-md-8 col-xs-11">
                                        <input type="text" class="form-control" id="product_alias_name" name="product_alias_name" placeholder="Product Alias Name" value="<?= htmlspecialchars(stripcslashes($rel['product_alias_name'])) ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-10">
                                        ...
                                        <?php if ($mode == 'Edit' && $getspecialConfiguration['power_drive'] == 0) { ?>
                        ...
                        <div class="col-md-12 margin_row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="Cat No." class="col-md-4 control-label">CAT No.</label>
                                    <div class="col-md-8 col-xs-11">
                                        <input type="text" class="form-control" id="cat_no" name="cat_no" placeholder="CAT No." value="<?= $rel['cat_no'] ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <?phpif($getspecialConfiguration['rb_auto_permission']==1 || $getspecialConfiguration['rapidrop_permission']==1 || $getspecialConfiguration['make_permission']==1 ){?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-11">
                                            <select class="select2" name="product_rb_make" id="product_rb_make" title="Select Make">
                                                <?= getmake($dbcon, $rel['r_make_id']); ?>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 margin_row" style="margin-top:25px !important;">
                            ...
                            <input type="hidden" name="eid_main" id="eid_main" value="<?php if ($mode == 'Edit') {
                                                                                            echo $rel['product_id'];
                                                                                        } ?>" />
                        </div>
    ...
    <?php include_once($include1 . 'add_category.php'); ?>
    ...
    <script src="<?= ROOT . ADMINISTRATION_ROOT ?>js/app/category_mst.js?<?php echo time(); ?>"></script>
