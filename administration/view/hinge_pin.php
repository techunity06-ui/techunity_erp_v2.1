<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_HINGE_PIN_LIST,
        ADMINISTRATOR_HINGE_PIN_CREATE,
		ADMINISTRATOR_HINGE_PIN_UPDATE,
		ADMINISTRATOR_HINGE_PIN_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_HINGE_PIN_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_HINGE_PIN_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>Hinge pin</label>
													<input class="form-control" type='text' name='hinge_pin' id='hinge_pin' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Hinge pin</label>
								   <input type="text" class="form-control" name="edit_hinge_pin" id="edit_hinge_pin" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/hinge_pin.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
