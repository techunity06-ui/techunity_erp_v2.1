<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_PRODUCT_MODEL_LIST,
        ADMINISTRATOR_PRODUCT_MODEL_CREATE
    ]);

    if(!in_array(ADMINISTRATOR_PRODUCT_MODEL_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_PRODUCT_MODEL_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="product_model_add" action="javascript:;" method="post" name="product_model_add">
												<?php //if($branch_id=='0'){ ?>
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='product_model_name' id='product_model_name' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">Size Description</label>
								   <input type="text" class="form-control" name="edit_product_model_name" id="edit_product_model_name" />
								</div>
								
								<div class="form-group">
								   <label for="unitid">Size Code</label>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/product_model_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
