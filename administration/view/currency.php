						...
						<div class="panel-body">
							<form role="form" id="currency_add" action="javascript:;" method="post" name="currency_add">
								  ...
								  <div class="form-group">
								   ...
								   <div class="form-group">
									  <label for="vendor_name">Currency Rate*</label>
									  <input type="text" class="form-control numbersOnly copyPastNotAllowed" id="currency_rate" name="currency_rate" placeholder=" Currency Rate">
								  </div>
								  <div class="form-group">
									  <label for="vendor_name">Currency Symbol </label>
									  <input type="text" class="form-control" id="currency_symbl" value="" name="currency_symbl" placeholder=" Currency Symbol">
								  </div>
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-content">
			...
			<form id="FormEditCurrency" role="form" method="post" novalidate>
				...
				<div class="form-group">
					...
					<input type="text" name="edit_currency_rate"  id="edit_currency_rate" class="form-control">
				</div>	
				<div class="form-group">
					  <label for="vendor_name">Currency Symbol </label>
					  <input type="text" class="form-control" id="edit_currency_symbl" name="edit_currency_symbl" placeholder=" Currency Symbol">
				  </div>
			</div>
	...
	<script src="<?=ROOT.ADMINISTRATION_ROOT ?>js/app/currency_mst.js?<?=time()?>"></script>
<script>
