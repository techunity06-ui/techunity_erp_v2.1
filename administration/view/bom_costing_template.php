				...
				<section class="panel">
					<header class="panel-heading">
						...
						<span class="tools pull-right"> 
							<a href="<?=ROOT.ADMINISTRATION_ROOT.'bom_costing_template_create'?>" ><button class="btn btn-success btn-flat" >Add <?=$form?></button></a>
						</span>
                        <?php } ?>
					</header>
					<div class="panel-body">
						<div class="adv-table">
							<table  class="display table table-bordered table-striped" id="tax-category-table">
								<thead>
									<tr>
										<th>Sr. NO.</th>
										<th>Template Name</th>
