...
";
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_COVER_GASKET_LIST,
        ADMINISTRATOR_COVER_GASKET_CREATE,
		ADMINISTRATOR_COVER_GASKET_UPDATE,
		ADMINISTRATOR_COVER_GASKET_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_COVER_GASKET_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_COVER_GASKET_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='cover_gasket' id='cover_gasket' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">COVER GASKET
</label>
								   <input type="text" class="form-control" name="edit_cover_gasket" id="edit_cover_gasket" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/cover_gasket.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
