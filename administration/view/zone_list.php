		...
		<div class="row">
			...
			<?php } ?>		
				<section class="panel">
					...
					<div class="panel-body">
						<div class="adv-table">
							<table class="display table table-bordered table-striped" id="zone-table">
								<thead>
									<tr>
										<th>Sr. NO.</th>
										<th>Zone Name</th> 
...
<!-- Modal -->
<div class="modal colored-header info" id="ModalEditZone" role="dialog" data-keyboard="false" data-backdrop="static">
<div class="modal-dialog custom-width">
	<div class="modal-content">
		...
		<form id="FormEditZone" role="form" method="post" novalidate>
			<div class="form-group">
				<label for="edit_zone_name">Zone Name</label>
				<input class="form-control" type='text' name='edit_zone_name' id='edit_zone_name' value='' />
			</div>		
