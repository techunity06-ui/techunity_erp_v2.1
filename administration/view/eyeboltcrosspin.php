<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_EYE_BOLT_CROSS_PIN_LIST,
        ADMINISTRATOR_EYE_BOLT_CROSS_PIN_CREATE,
		ADMINISTRATOR_EYE_BOLT_CROSS_PIN_UPDATE,
		ADMINISTRATOR_EYE_BOLT_CROSS_PIN_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_EYE_BOLT_CROSS_PIN_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_EYE_BOLT_CROSS_PIN_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>EYE BOLTS & CROSS PIN</label>
													<input class="form-control" type='text' name='eyebolt' id='eyebolt' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">EYE BOLTS & CROSS PIN</label>
								   <input type="text" class="form-control" name="edit_eyebolt" id="edit_eyebolt" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/eyeboltcrosspin_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
