<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_OPERATION_LIST,
        ADMINISTRATOR_OPERATION_CREATE,
		ADMINISTRATOR_OPERATION_UPDATE,
		ADMINISTRATOR_OPERATION_DELETE
    ]); 

    if(!in_array(ADMINISTRATOR_OPERATION_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_OPERATION_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<div class="form-group">
													...
													<input class="form-control" type='text' name='operation' id='operation' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">operation</label>
								   <input type="text" class="form-control" name="edit_operation" id="edit_operation" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/operation.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
