<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
    	ADMINISTRATOR_SEATRING_LIST,
        ADMINISTRATOR_SEATRING_CREATE,
		ADMINISTRATOR_SEATRING_UPDATE,
		ADMINISTRATOR_SEATRING_DELETE
    ]);

    if(!in_array(ADMINISTRATOR_SEATRING_LIST,$bulkAccessArray)){
...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<section id="main-content">
				<section class="wrapper">
					...
					<div class="row">
						<?php if(in_array(ADMINISTRATOR_SEATRING_CREATE,$bulkAccessArray))
						{ ?>
							<div class="col-sm-3">
								<section class="panel">
									<header class="panel-heading">
									...
									<div class="panel-body">
										<form role="form" id="class_add" action="javascript:;" method="post" name="class_add">
												...
												<?php } ?>
												<div class="form-group">
													<label>SEATRING</label>
													<input class="form-control" type='text' name='seatring' id='seatring' value='' />
												</div>
			...
			<div class="modal-dialog custom-width">
				<div class="modal-content">
					...
					<div class="modal-body form">
						...
						<?php	} ?> 
								<div class="form-group">
								   <label for="unitid">SEATRING</label>
								   <input type="text" class="form-control" name="edit_seatring" id="edit_seatring" />
								</div>
		...
		<script src="<?=ROOT.ADMINISTRATION_ROOT?>js/app/seatring_mst.js?<?=time()?>"></script>
		<script>
		$(".select2").select2({
				width: '100%'
			});
