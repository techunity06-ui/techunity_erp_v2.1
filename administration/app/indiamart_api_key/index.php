...
if($_POST != NULL) {
	...
	if(strtolower($POST['mode']) == "fetch") {
		...
		foreach($sqlReturn as $row) {
			...
			$edit_btn=''; $delete_btn='';  
			//if($edit_btn_per){ 
				$edit_btn=' <button type="button" class="btn btn-xs btn-warning" data-original-title="Edit" data-toggle="tooltip" data-placement="top" onClick="edit_indiamart('.$row['i_id'].');"><i class="fa fa-pencil"></i></button>'; 
			//}
			//if($delete_btn_per){
				$delete_btn=' <button type="button" class="btn btn-xs btn-danger" data-original-title="Delete" data-toggle="tooltip" data-placement="top" onClick="delete_indiamart('.$row['i_id'].')"><i class="fa fa-trash-o"></i></button>'; 
			//}
