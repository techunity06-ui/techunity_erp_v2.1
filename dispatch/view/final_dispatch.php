<?php 
	...
	if(!in_array(DISPATCH_LIST_VIEW,$bulkAccessArray)){
...
<body>
  <section id="container" >
				...
				<div class="panel-body">
				  ...
				  <table class="display table table-bordered table-striped" id="dynamic-table">
					  ...
					  <tr>
                            ...
                            <th>Courier Name</th>
                            <th>Docket No</th>
                            <?php if(in_array(DISPATCH_APPROVAL,$bulkAccessArray)) { ?>
      ...
      <!--main content end-->
      <!--footer start-->
        <?php include_once($include1.'add_transport_detail.php');?>
        <?php include_once($include1.'final_dispatch_modal.php');?>
	    <?php include_once($include.'footer.php');?>
      <!--footer end-->
  </section>
    <!-- js placed at the end of the document so the pages load faster -->
	<?php include_once($include.'include_js_file.php');?>   
   <script src="<?=ROOT.DISPATCH_ROOT?>js/app/final_dispatch.js"></script>
