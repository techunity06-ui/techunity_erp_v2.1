						...
						<div class="col-md-12 m-bot15">
							...
							<div class="col-md-12 m-bot15 resource_label_manage">
								<div class="form-group">
									...
									<div class="col-md-8 col-xs-11">
					                  ...
					                  <?php  echo get_all_resource($dbcon,$resource_id) ?>
					                  </select>
							...
							<div class="col-md-12 m-bot15">
								<div class="form-group">
									...
									<div class="col-md-8 col-xs-11">
										 <input type="number" class="form-control numbersOnly" name="process_scrap_tolerance_plus" id="process_scrap_tolerance_plus" onkeyup="check_scrap_tolerance(this.value)" />
							...
							<div class="col-md-12 mbot30">
								<div class="form-group">
									<label class="col-md-4 control-label">Scrap Tol. (-) *</label>
									<div class="col-md-8 col-xs-11">
										  <input type="number" class="form-control numbersOnly" name="process_scrap_tolerance_minus" id="process_scrap_tolerance_minus" onkeyup="check_scrap_tolerance(this.value)" />

									</div>
								</div>
							</div>
							<input type="hidden" name="direct_product_id" id="direct_product_id" value="">
							<input type="hidden" name="direct_version_id" id="direct_version_id" value="">
