						...
						<div class="col-md-12 m-bot15">
							...
							<div class="col-md-12 m-bot15">
								<div class="form-group">
									...
									<div class="col-md-8 col-xs-11">
										   <input type="text" class="form-control numbersOnly" name="tolerance_plus" id="tolerance_plus" onkeyup="check_param_tolerance(this)" />
							...
							<div class="col-md-12 m-bot15">
								<div class="form-group">
									<label class="col-md-4 control-label">Tolerance (-)</label>
									<div class="col-md-8 col-xs-11">
										<input type="text" class="form-control numbersOnly" name="tolerance_minus" id="tolerance_minus" onkeyup="check_param_tolerance(this)" />
