<div class="modal colored-header info" id="preview_shortage_indent" role="dialog" data-keyboard="false" data-backdrop="static">
				...
				<form class="form-horizontal" role="form" id="create_wo_indent" action="javascript:;" method="post" name="create_wo_indent">
					...
					<div class="row">
						<div class="col-md-6 m-bot15">
							...
							<input type="hidden" name="so_rp_id" id="so_rp_id">
							<input type="hidden" name="mode" id="mode" value="create_indent">
