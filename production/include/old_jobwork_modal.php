...
<div class="modal colored-header info" id="old_jobwork_modal" role="dialog" data-keyboard="false" data-backdrop="static">
		...
		<div class="modal-content">
			...
			<div class="modal-body form">
				<div class="row">
					...
					<div class="col-md-12 m-bot15 middle div_store_confirm">
					  <h3 class="m-bot15">Please Select Option</h3>
					  <label>
					  <input type="radio" name="sel_jobwork_no" value="0" id="opt_new_jobwork_no" checked/>
					  <div class="inhouse box">
					    <span>NEW JOBWORK NO</span>
					  </div>
					</label>

					  <label>
					  <input type="radio"  name="sel_jobwork_no" value="1" id="opt_old_jobwork_no"/>
					  <div class="outside box">
					    <span>SAME JOBWORK NO</span>
					  </div>
					</label>
					</div>
					<div class="clearfix" ></div>
						<div class="col-md-12 text-center" style="margin-top:10px;">
							<button type="button" onclick="save_store_confirmation()" class="btn btn-success">Save</button> &nbsp;
