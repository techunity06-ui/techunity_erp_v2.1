<div class="modal fade full-width-modal-right in" id="workorder_wise_qty_modal" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-lg" style="width:490px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3>Workorder Wise Jobwork Qty</h3>
			</div>
