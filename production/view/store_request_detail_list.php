<?php 
	...
	$form="Store Approval Request List";
	...
	//echo store_production_start_count_using_p_id($dbcon,5);

	//echo check_row_material_availability($dbcon,5,0);
?>

<!DOCTYPE html>
<html lang="en">
	<head>
		<title>STORE REQUEST LIST</title>
	...
	<body>
		<section id="container" >
									...
									<div class="col-md-6">
										...
										<div class="col-md-6">
											<select class="select2" title="Select product" name="product_id" id="product_id" onChange="load_datatable();">
												<?=get_production_filter_product($dbcon,0,$id)?>
											</select>
										</div>
									</div>
									<div class="col-md-6">
		 ...
		 <?php include_once($include1.'store_request_process_modal.php'); ?>
		 <?php include_once($include1.'batch_generate_modal.php'); ?>
		<?php include_once($include.'include_js_file.php');?>   
		<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/store_request_details_list.js?<?=time()?>"></script>
