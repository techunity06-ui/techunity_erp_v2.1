...
<html lang="en">
<head>
<title>RE-PROCESS DETAIL LIST</title>
...
<body>
  <section id="container" >
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				<section class="panel">
				 ...
				 <input type="hidden" name="process_type" id="process_type" value="<?=$type;?>" />
   ...
   <script src="<?=ROOT.PRODUCTION_ROOT?>js/app/allocate_reprocess.js"></script>
