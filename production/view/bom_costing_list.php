...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	...
	if(!in_array(PRODUCTION_BOM_COSTING_LIST_SLUG_VIEW,$bulkAccessArray)){
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				...
				<span class="tools pull-right">
					<a href="<?=ROOT.PRODUCTION_ROOT.'bom_costing'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>	
