<?php 
   ...
   $bulkAccessArray = canCheckPermissionAccess($dbcon, [
      JOBWORK_RATE_CARD_VIEW,JOBWORK_RATE_CARD_ADD
   ]);

   if(!in_array(JOBWORK_RATE_CARD_VIEW,$bulkAccessArray)){
       header("Location: ".DOMAIN."permission_access");
   }

   $form="Jobwork Rate Card";
...
<html lang="en">
   <head>
      <title>JOBWORK RATE CARD LIST</title>
   ...
   <body>
      <section id="container" >
                     ...
                     <section class="panel">
                        <header class="panel-heading">
						  ...
						  <div class="col-md-12">
                           ...
                           <a href="<?=ROOT.PRODUCTION_ROOT.'jobwork_rate_card'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
                           </span>
                        </header>
         ...
         <!--main content end-->
         <!--footer start-->
         <?php include_once($include1.'preview_jobwork_rate_card_aprooval.php');?>
         <?php include_once($include.'footer.php');?>
         <!--footer end-->
      </section>
      <!-- js placed at the end of the document so the pages load faster -->
      <?php include_once($include.'include_js_file.php');?>    
      <script src="<?=ROOT.PRODUCTION_ROOT?>js/app/jobwork_rate_card.js"></script>
