<?php 
	...
	$form="Process Store Approval List";
	...
	$_SESSION['redirect_page'] = 'working_process_store_approval_detail_list';
	//echo $type;
...
<html lang="en">
	...
	<body>
		<section id="container" >
		 ...
		 <?php include_once($include1.'store_approve_process_modal.php'); ?>
		<?php include_once($include.'include_js_file.php');?>   
		<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/working_process_store_approval_detail_list.js?<?=time()?>"></script>
