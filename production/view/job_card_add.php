...
<html lang="en">
	...
	<body>
										...
										<div class="col-md-12" style="    margin-top: 10px;">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-xs-11">
													...
													<input id="product_id" name="product_id"  style="width:100% !important"  placeholder="Select product" onchange="check_bom_version();" />
												</div>
											</div>	
											</div>
										</div>
		...
		<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/job_card_add.js?<?=time()?>"></script>
		<script>
			$(".selproduct1").select2({
				width: '100%',
