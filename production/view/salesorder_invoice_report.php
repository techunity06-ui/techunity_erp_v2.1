	...
	$form="Salesorder Invoice Report";
	...
	if(!in_array(SALESORDER_INVOICE_REPORT_SLUG_VIEW,$bulkAccessArray)){
...
<?php include_once($include.'include_js_file.php');?>  
	<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/salesorder_invoice_report.js?<?=time()?>"></script>
