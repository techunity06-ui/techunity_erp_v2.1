...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<?php include_once($include1.'solid_extrusion_entry.php');?>
			
			
		</section>
		<?php include_once($include.'include_js_file.php');?>   
		<script src="<?php echo ROOT.PRODUCTION_ROOT; ?>js/app/solid_extrusion_entry.js"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
