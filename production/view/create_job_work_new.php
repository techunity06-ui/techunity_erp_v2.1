...
$job_work_id = "";
if (strpos($_SERVER['REQUEST_URI'], "create_job_work_new") == true) {
   $mode = "Add";
...
} else if (strpos($_SERVER['REQUEST_URI'], "job_work_edit_new") == true) {
   $mode = "edit";
                    ...
                    <table cellspacing="10" style="border-collapse:inherit;table-layout: fixed;" id="product_list" class="display table table-bordered table-striped">
                       ...
                       <tr id="field1">
                          <td style="vertical-align:top;" width="25%">
                             ...
                             <select class="select2" title="Select Product" name="product_id" onchange="get_process_list(this.value);get_jobwork_rate();" id="product_id">
                          ...
                          <td class="hide_product_version">
                             <select class="select2" title="Select Process" name="process_id" id="process_id" onchange="show_jobwork_detail_data(this.value); get_jobwork_rate()">
                                ...
                                <?= get_all_process($dbcon,$process_id)?>
                             </select>
                          </td>
                          <!-- <td class="hide_product_version">
