...
<style type="text/css">
   ...
   <body >
                     ...
                     <section class="panel">
                        ...
                        <div class="">
                           <ul class="breadcrumb">
                              ...
                              <li><a href="<?=ROOT.PRODUCTION_ROOT.'pending_jobowork_chalan_list'?>">Pending Jobwork Chalan List </a></li>
                           </ul>
                        </div>
                     </section>
                  </div>
                             ...
                             <div id="tbl_jobwork_data" style="margin: 35px;"></div>
                                 ...
                                 <div class="col-md-12">
                                    <center>
                                       ...
                                       <a href="<?=ROOT.PRODUCTION_ROOT.'pending_jobowork_chalan_list'?>" type="button" class="btn btn-danger">Cancel</a>
                                    </center>
                                 </div>
      ...
      <script src="<?=ROOT.PRODUCTION_ROOT?>js/app/create_jobowork_chalan.js?<?=time()?>"></script>
      <script>
         $(".select2").select2({
            width: '100%'
         });
