<?php 
	...
	$query="select p.product_name,pr.process_name,ap.branch_id,ap.process_unit,umst.unit_name,ap.p_product_id,ap.process_id,ap.product_version,p.batch_wise_stock_manage,ap.batch_no from tbl_allocate_process as ap 
	...
	$working_qty=store_production_start_count_using_p_id($dbcon,$p_id,0);
...
// echo "W :" . $working_qty;
// echo "re :" . $req_qty;die;
	// $pending_qty = $pending_qty - $req_qty;
...
<html lang="en">
	...
	<body onload="show_material_list();">
							...
							<section class="panel" >
								...
								<div class="" style="padding:20px !important;">
								  <ul class="breadcrumb">
									  ...
									  <li><a href="<?=ROOT.PRODUCTION_ROOT.'process_detail_list/'.$rel['process_id'].'/'.$rel['pr_process_type'];?>">Store Request </a></li>
								  </ul>
								</div>
							</section>
						</div>	
						...
						<div class="col-sm-12">
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal" role="form" id="store_request_add" action="javascript:;" method="post" name="store_request_add">
										...
										<div class="row">
											...
											<?php if($company_config['batch_wise_stock'] == '1' &&  $company_config['batch_process'] == '0' && $rel['batch_wise_stock_manage'] == '1'){ ?>
												<div class="col-md-4">
												<div class="form-group">
													<label class="col-md-4 control-label" style="color: #404040;font-weight: 600;">Batch No.</label>
													<div class="col-md-6 col-xs-11">
														<input type="text" name="batch_no" readonly id="batch_no" class="form-control"  value="<?=$rel['batch_no']?>" /> 
													</div>
												</div>
												</div>
											<?php } ?>											
											...
											<div class="col-md-12">
												<div class="col-md-6 col-md-offset-4">  	
													...
													<input type="submit" id="sp_btn" name="submit" class="btn btn-success" value="Request" />
												</div>
											</div>		
										</div>
		...
		?>   
		<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/production_store_request.js"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
