<?php 
	...
	$process_id = $dbcon->real_escape_string($_REQUEST['id']);
?>
...
<html lang="en">
	...
	<body>
		...
		<?php include_once($include.'include_js_file.php');?>   
		 <?php include_once($include1.'store_release_pending_modal.php'); ?>
		<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/store_release_pending_list.js?<?=time()?>"></script>
