...
<body>
  <section id="container" >
                                ...
                                <section class="panel">
                                    ...
                                    <div class="">
                                        <ul class="breadcrumb">
                                                ...
                                                <li ><a href="<?=ROOT.PURCHASE_ROOT.'production_report_list'?>">Report List </a></li>
                                                <li >Jobwork GRN Report</li>
                                        </ul>
                                     </div>
                                </section>
                                <!--bread crumbs end -->
	...
	<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/jobwork_grn_register_report.js?<?=time()?>"></script>
