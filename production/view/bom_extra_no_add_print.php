	...
	<thead>
		...
		<tbody style="border: 1px solid;">
			...
			<tr>
				...
				<?php} ?>
				<td style="border:1px #444 solid;" ><?=$rel['product_name'].''.$item_code;?><?=$drawing_number?><?=$alias_name?><?if($companyConfiguration['enable_item_description']==1){ ?><br><?=$rel['product_desc']?><?php} ?></td>
