	...
	Loading();
		$.ajax({
				...
				success: function(response)
				{
					if(response != 0)
					{
						$('#add_bom_version_id,#add_bom_sub_version_id').empty();
						$('#add_bom_version_id,#add_bom_sub_version_id').html(response);
						$("#add_bom_version_id,#add_bom_sub_version_id").val("10000");
						$('#add_bom_version_id,#add_bom_sub_version_id').trigger('change');
					}
					Unloading();
				}
		});
...
function check_bom_version(product_id = '')
{
	...
	Loading();
		$.ajax({
				...
				success: function(response)
				{ 
					$('#add_bom_version_id,#add_bom_sub_version_id').html('');
					if(response != 0)
					{
						$('#add_bom_version_id,#add_bom_sub_version_id').html(response);
					}
					...
					{
						$('#add_bom_version_id,#add_bom_sub_version_id').html('<option selected="selected" value="10000">R&D</option>');
...
function load_wo_hist_datatable(){
	...
	$("#order-wo-history-datatable1").dataTable({
		...
		"iDisplayLength": 5,
		"sAjaxSource": root_domain+production_domain+'app/direct_jobcard/',
