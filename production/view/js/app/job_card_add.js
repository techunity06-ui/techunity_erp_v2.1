...
function next_page(){
	...
	Loading();
		...
		$.ajax({
			type: "POST",
			url: root_domain+production_domain+'app/job_card_add/',
			data: { mode : "save_work_order_product",product_id:product_id,qty:qty,bom_version_id:bom_version_id,branch_id:branch_id,priority_status:priority_status},
			success: function(response)
			{
				...
				if(arr.res==="1"){
						...
						location.href= root_domain+production_domain+'direct_jobcard/'+product_id+'/'+branch_id+'/'+bom_version_id+'/'+qty+'/'+jobcard_rp_id;
						return false;
					}else{
