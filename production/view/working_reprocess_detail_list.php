<?php 
	...
	if($type=="1"){
		$form="Reprocess start Pending List";
	}else{
		$form="Reprocess End Pending List";
	}
	...
	$_SESSION['redirect_page'] = 'working_reprocess_detail_list';
	//echo $type;
...
<html lang="en">
	<head>
	<title><?php if($type=="1"){
		echo "REPROCESS START PENDING LIST";
	}else{
		echo "REPROCESS END PENDING LIST";
	}?></title>
	...
	<body>
									...
									<div class="col-md-6">
										...
										<div class="col-md-6">
											<select class="select2" title="Select product" name="product_id" id="product_id" onChange="load_datatable();">
												<?=get_production_repocess_filter_product($dbcon,0,$id)?>
											</select>
		...
		<script src="<?=ROOT.PRODUCTION_ROOT?>js/app/working_reprocess_details_list.js?<?=time()?>"></script>
