...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	PRODUCTION_BOM_LIST_SLUG_VIEW,
	PRODUCTION_BOM_LIST_SLUG_CREATE,
	PRODUCTION_BOM_LIST_SLUG_UPDATE,
	PRODUCTION_BOM_LIST_SLUG_DELETE
...
//added bom version series no  
	...
	if (brp_strtolower($POST['mode']) == "load_bom_version_datatable") {
		$whr = "";
		if ($POST['bom_type'] != "") {
...
<ul id="process_right">';
  ...
  <div class="col-md-12">
	...
	/*  END :: Code By : Sanat ::   29-07-2021 */ else if (brp_strtolower($POST['mode']) == "check_duplicate") {
