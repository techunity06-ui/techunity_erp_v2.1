...
if(brp_strtolower($POST['mode']) == "fetch") {
		...
		foreach($sqlReturn as $row) {
			...
			$re12=brp_mysqli_fetch_assoc($resi_grn12);
			
			if(in_array(PRODUCTION_GRN_LIST_SLUG_UPDATE,$bulkAccessArray)){
				if(!empty($re12['grn_id'])){
					$row_data[] = '<a class="" data-original-title="Edit '.$row["grn_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_edit/'.$row['grn_id'].'">'.$row["grn_no"].'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["grn_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_edit/'.$row['grn_id'].'">'.date('d M, Y',strtotime($row["grn_date"])).'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["grn_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_edit/'.$row['grn_id'].'">'.$row["pono"].'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["grn_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_edit/'.$row['grn_id'].'">'.$ref_type.'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["grn_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_edit/'.$row['grn_id'].'">'.$row["l_name"].'</a>';
				}else{
					$row_data[] = '<a class="" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'">'.$row["grn_no"].'</a> ';
					$row_data[] = '<a class="" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'">'.date('d M, Y',strtotime($row["grn_date"])).'</a> ';
					$row_data[] = '<a class="" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'">'.$row["pono"].'</a> ';
					$row_data[] = '<a class="" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'">'.$ref_type.'</a> ';
					$row_data[] = '<a class="" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'">'.$row["l_name"].'</a> ';
				}
			}else{
				$row_data[] = '<a class="" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'">'.$row["grn_no"].'</a> ';
				$row_data[] = '<a class="" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'">'.date('d M, Y',strtotime($row["grn_date"])).'</a> ';
			...
			if(in_array(PRODUCTION_GRN_LIST_SLUG_UPDATE,$bulkAccessArray)){
				if(!empty($re12['grn_id'])){
					$edit_btn='<a class="btn btn-xs btn-warning" data-original-title="Edit" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_edit/'.$row['grn_id'].'"><i class="fa fa-pencil"></i></a>'; 
				}
			}
			...
			if(in_array(PRODUCTION_GRN_LIST_SLUG_VIEW,$bulkAccessArray)){
				$view='<a class="btn btn-xs btn-info" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_view/'.$row['grn_id'].'"><i class="fa fa-eye"></i></a> ';
			}  
			
			
				$stricker_print='<a class="btn btn-xs btn-info" data-original-title="Sticker Print" data-toggle="tooltip" data-placement="top" href="'.ROOT.PRODUCTION_ROOT.'grn_sticker_print/'.$row['grn_id'].'"><i class="fa fa-eye"></i></a> ';
			
			$row_data[] = $edit_btn.' '.$delete_btn.' '.$view.' ' .$stricker_print;
