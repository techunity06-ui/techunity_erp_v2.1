...
if(!in_array(MAINTENANCE_ADD_SLUG_READ,$bulkAccessArray)){
						...
						<section class="panel">
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<div class="input-group date form_datetime-component">
												...
												<input type="text" id="rep_date" onChange="load_maintenance_datatable();" class="form-control datepikerdemo" value="">
							...
							<div class="panel-body">
								<div class="adv-table" id="adv-table">
									<table class="display table table-bordered table-striped" id="maintenance-datatable">
										<thead>
											<tr>
												<th>Sr. No.</th>
