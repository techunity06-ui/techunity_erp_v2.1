...
if(strtolower($POST['mode']) == "fetch") {
	...
	$aColumns = array('id', 'category_name', 'max_exemption_amount', 'status', 'comp.company_name');
	$sIndexColumn = "id";
	$isWhere = array("status IN (0,1) and payrollemp.company_id = $companyID".check_user('payrollemp'));
