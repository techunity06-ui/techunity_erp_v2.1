    ...
    if (funnel_multiple_overlay_element) {
        ...
        funnel_multiple_overlay.setOption({
            ...
            legend: {
                ...
                top: 'center',
                left: 0,
                data: ['Quality Management','Accounts','Production','Operations','Marketing'],
                itemHeight: 8,
                itemWidth: 8
            },
            ...
            series: [
                {
                    ...
                    data: [
                        {value: 45, name: 'Marketing'},
                        {value: 60, name: 'Operations'},
                        {value: 70, name: 'Production'},
                        {value: 80, name: 'Accounts'},
                        {value: 100, name: 'Quality Management'}
                    ]
                },
                {
                    name: 'Result',
