						...
						<section class="panel">
							<header class="panel-heading respadlr0">	
								<span class="tools pull-right respadr_15">
									<a href="<?=ROOT . HRMS_ROOT . 'hrms_appraisal_template_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
								</span>
								...
								<div class="adv-table">
									<table  class="display table table-bordered table-striped" id="dynamic-table">
										<thead>
											<tr>
											  <th>Company Name</th>
											  <th>Appraisal Template Title</th>
											  <th>Appraisal Description</th>
											  <th>Status</th>
