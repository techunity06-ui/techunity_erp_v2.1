				...
				<section class="panel">
				  <header class="panel-heading">
					...
					<span class="tools pull-right">
						<a href="<?= ROOT . HRMS_ROOT . 'hrms_leave_type_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>	
					</span>
					</header>	
							...
							<table  class="display table table-bordered table-striped" id="dynamic-table">
								<thead>
									<tr>
										...
										<th>Max Leave Allowed</th>
										<th>Application After (Working Days)</th>
