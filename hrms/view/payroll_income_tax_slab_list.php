						...
						<section class="panel">
							<header class="panel-heading respadlr0">	
								<span class="tools pull-right respadr_15">
									<a href="<?=ROOT . HRMS_ROOT . 'payroll_income_tax_slab_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
								</span>
									...
									<table  class="display table table-bordered table-striped" id="dynamic-table">
										<thead>
											<tr>
											  <th>Block No</th>
											  <th>Company Name</th>
											  <th>Income Tax Slab Name</th>
											  <th>Income Tax Effective From</th>
											  <th>Status</th>
