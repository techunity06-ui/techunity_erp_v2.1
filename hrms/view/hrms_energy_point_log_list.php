					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once('../../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT . HRMS_ROOT . 'hrms_energy_point_log_list'?>"><?=$form?></a></li>
				...
				<section class="panel">
				  <header class="panel-heading">
				  	<span class="tools pull-right">
						<a href="javascript:;" onClick="tableToExcel('adv-table', 'Energy Point Log')" ><button class="btn btn-success btn-flat" >Export Excel</button></a>	
			 		</span>
				  	<span class="tools pull-right">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group" style="margin-top:20px;">
	                                <div class="col-md-4"><strong>Energy Point</strong></div>
									<div class="col-md-8">
										<select  class="select2" name="energy_point_log_status" id="energy_point_log_status" onChange="generate_hrms_energy_point_log()" >
											<option value="">SELECT ENERGY POINT</option>
...
function generate_hrms_energy_point_log() 
{
	var energy_point = $("#energy_point_log_status").val();
	Loading();
	$.ajax({
		type: "POST",
		url: root_domain + hrms_domain + 'app/hrms_energy_point_log/',
		data: { mode : "generate_report",energy_point:energy_point },
...
$(document).ready(function() {
  generate_hrms_energy_point_log();
});
</script>
<script>
