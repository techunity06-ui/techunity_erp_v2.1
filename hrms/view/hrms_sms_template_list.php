					  ...
					  <header class="panel-heading">
						...
						<div class="">
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT . HRMS_ROOT . 'hrms_sms_template_list'?>"><?=$form?> List</a></li>
				...
				<section class="panel">
				  <header class="panel-heading">
					...
					<span class="tools pull-right">
						<a href="<?=ROOT . HRMS_ROOT . 'hrms_sms_template_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>	
					</span>
					</header>	
