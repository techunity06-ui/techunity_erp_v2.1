						...
						<div class="col-md-6">
							<ul class="nav">
								<?php while($menu_rel = $menu_rs->fetch_assoc()){ ?>
									<?php if($menu_rel['page_name'] == 'hrms/payroll_salary_component_list'){ ?> 
										<li> 
											<a href="<?php echo ROOT.$menu_rel['page_name'] ?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$menu_rel['menu_name']?></a> 
										</li>
									<?php } ?>
									<?php if($menu_rel['page_name'] == 'hrms/payroll_salary_structure_list'){ ?> 
										<li> 
											<a href="<?php echo ROOT.$menu_rel['page_name'] ?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$menu_rel['menu_name']?></a> 
										</li>
									<?php } ?>
									<?php if($menu_rel['page_name'] == 'hrms/payroll_period_list'){ ?> 
										<li> 
											<a href="<?php echo ROOT.$menu_rel['page_name'] ?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$menu_rel['menu_name']?></a> 
										</li>
									<?php } ?>
									<?php if($menu_rel['page_name'] == 'hrms/payroll_income_tax_slab_list'){ ?> 
										<li> 
											<a href="<?php echo ROOT.$menu_rel['page_name'] ?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$menu_rel['menu_name']?></a> 
										</li>
									<?php } ?>
						...
						<div class="col-md-6">
							<ul class="nav">
								<?php while($menu_rel1 = $menu_rs1->fetch_assoc()){ ?>
									<?php if($menu_rel1['page_name'] == 'hrms/payroll_emp_exemption_category_list'){ ?> 
										<li> 
											<a href="<?php echo ROOT.$menu_rel1['page_name'] ?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$menu_rel1['menu_name']?></a> 
										</li>
									<?php } ?>
									<?php if($menu_rel1['page_name'] == 'hrms/payroll_emp_exemption_subcategory_list'){ ?> 
										<li> 
											<a href="<?php echo ROOT.$menu_rel1['page_name'] ?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$menu_rel1['menu_name']?></a> 
										</li>
									<?php } ?>
									<?php if($menu_rel1['page_name'] == 'hrms/payroll_settings_list'){ ?> 
										<li> 
											<a href="<?php echo ROOT.$menu_rel1['page_name'] ?>"><i class="fa fa-angle-right" aria-hidden="true"></i><?=$menu_rel1['menu_name']?></a> 
										</li>
									<?php } ?>
