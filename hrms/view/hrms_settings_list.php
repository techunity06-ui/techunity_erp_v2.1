					  ...
					  <header class="panel-heading">
						...
						<div class="">
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT . HRMS_ROOT . 'hrms_settings_list'?>"><?=$form?> List</a></li>
				...
				<section class="panel">
				  <header class="panel-heading">
					...
					<span class="tools pull-right">
						<a href="<?=ROOT.'hrms/hrms_settings_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>	
					</span>
					</header>	
							...
							<table  class="display table table-bordered table-striped" id="dynamic-table">
								<thead>
									<tr>
										...
										<th>Birthday Reminders</th>
										<th>Expense Approver Mandatory In Expense Claim</th>
										<th>Status</th>
