...
<html lang="en">
	...
	<body>
						...
						<section class="panel">
							<header class="panel-heading respadlr0">	
								<span class="tools pull-right respadr_15">
									<a href="<?=ROOT . HRMS_ROOT . 'hrms_leave_block_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
								</span>
									...
									<table  class="display table table-bordered table-striped" id="dynamic-table">
										<thead>
											<tr>
											  <th>Block No</th>
											  <th>Company Name</th>
											  <th>Block Leave Name</th>
											  <th>Applies to Company</th>
											  <th>Status</th>
		...
		<script src="<?= ROOT . HRMS_ROOT ?>js/app/hrms_leave_block.js?<?=time()?>"></script>
	</body>
</html>
