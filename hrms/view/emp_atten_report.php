...
function generate_report_emp_ledger() 
{
	...
	$.ajax({
		type: "POST",
		url: root_domain+'hrms/app/emp_atten_report/',
...
<section class="panel">
	...
	<div class="">
		<ul class="breadcrumb">
			<li><a href="<?=ROOT.'hrms/hr_dashboard'?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?=ROOT.'hrms/emp_atten_report'?>"><?=$form?></a></li>
		</ul>
	</div>
</section>
<!--breadcrumbs end -->
