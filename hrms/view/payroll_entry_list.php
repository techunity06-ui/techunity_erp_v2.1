					  ...
					  <header class="panel-heading">
						...
						<div class="">
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?= ROOT . HRMS_ROOT . 'payroll_entry_list'?>"><?=$form?> List</a></li>
						  </ul>
						 </div>
					</section>
				  <!--breadcrumbs end -->
				...
				<section class="panel">
				  <header class="panel-heading">
					<span class="tools pull-right">
						<a href="<?= ROOT . HRMS_ROOT . 'payroll_entry_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
					</span>
					</header>	
