...
$title = 'Payroll Employee Incentive';
$mode = 'Add';
...
<body>
						...
						<div class="col-sm-3">
							<section class="panel">
								...
								<div class="panel-body">
									<form role="form" id="payroll_emp_incentive_add" action="javascript:;" method="post" name="payroll_emp_incentive_add">
										<div class="form-group">
											<label class="control-label">Series</label>
											<?php
												$series_id = '';
												$query = $dbcon->query("SELECT `invoicetype_id`,`taxinvoice_start`,`format_value`,`end_format_value` FROM `tbl_invoicetype` WHERE `status` = 0 and `invoice_type`='PAYROLL EMPLOYEE INCENTIVE' and company_id = $companyID and `type_id` = '16' order by invoicetype_id ");
										...
										<div class="form-group">
											...
											<input type="text" class="form-control datepicker" id="payroll_date" name="payroll_date" placeholder="Payroll Date" required/>
										</div>
										<div class="form-group">
											<label for="incentive_amount">Incentive Amount*</label>
											<input type="text" class="form-control" id="incentive_amount" name="incentive_amount" placeholder="Incentive Amount" required />
										</div>
										<div class="form-group">
	...
	<!-- Modal -->
	<div class="modal colored-header info" id="ModalEditPayrollEmpIncentive" role="dialog" data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog custom-width">
			<div class="modal-content">
				...
				<form id="FormEditPayrollEmpIncentive" role="form" method="post" novalidate>
					<div class="modal-body form">
							...
							<div class="form-group">
								<label for="payroll_date">Payroll Date*</label>
								<input type="text" class="form-control datepicker" id="edit_payroll_date" name="payroll_date" placeholder="Payroll Date" required/>
							</div>
							<div class="form-group">
								<label for="incentive_amount">Incentive Amount*</label>
								<input type="text" class="form-control" id="edit_incentive_amount" name="incentive_amount" placeholder="Incentive Amount" required />
							</div>
							<div class="form-group">
	...
	<script src="<?= ROOT . HRMS_ROOT ?>js/app/payroll_emp_incentive.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
