<?php 
	...
	$form="Employee Working on a Holiday";
					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once('../../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT . HRMS_ROOT . 'hrms_employee_working_on_holiday'?>"><?=$form?></a></li>
	                                  ...
	                                  <div class="col-md-3">
	                                    <div class="input-group date form_datetime-component">
											...
											<input type="hidden" id="to_date"  value="<?=date('t-m-Y')?>">
	         					 		    <input type="text" id="rep_date"  onchange="generate_report_emp_working_on_holiday();" class="form-control datepikerdemo" value="">
...
function generate_report_emp_working_on_holiday() 
{
	var date=$("#rep_date").val();
	Loading();
	$.ajax({
		type: "POST",
		url: root_domain + hrms_domain + 'app/hrms_employee_working_on_holiday/',
...
$(document).ready(function() {
  generate_report_emp_working_on_holiday();
});
</script>
<script>
