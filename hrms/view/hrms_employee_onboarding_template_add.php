<?php 
	...
	$form="Hrms Employee Onboarding Template";
	$companyID = $_SESSION['company_id'];
	$usertype=$_SESSION['user_type'];
	if(strpos($_SERVER['REQUEST_URI'], "hrms_employee_onboarding_template_edit")==false)
	{
		$mode="Add";
	...
	else
	{
		...
		$query="select hrmsempsepalist.*,hrmsdesig.designation_name from hrms_employee_onboarding_template as hrmsempsepalist 
...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li ><a href="<?=ROOT . HRMS_ROOT . 'hrms_employee_onboarding_template_list'?>"><?=$form?> List</a></li>
									</ul>
								</div>
							</section>
						</div>	
						...
						<div class="col-sm-12">
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal" role="form" id="hrms_employee_onboarding_template_add" action="javascript:;" method="post" name="hrms_employee_onboarding_template_add">
										<div class="">
								 				...
								 				<?php } else { ?>
								 					<div class="col-md-6">
														  <div class="form-group">
														  		...
														  		<?php
														  		$series_id = '';
														  		$query = $dbcon->query("SELECT `invoicetype_id`,`taxinvoice_start`,`format_value`,`end_format_value` FROM `tbl_invoicetype` WHERE `status` = 0 and `invoice_type`='EMPLOYEE ONBOARDING TEMPLATE' and company_id = $companyID and `type_id` = '16' order by invoicetype_id ");
													...
													<table cellspacing="10" style="border-collapse:inherit; " id="leave_block_days" class="display table table12 table-striped table-bordered">
														...
														<tr id="field1">
															...
															<td style="vertical-align:top;">
																<input type="button"  name="addemployeeonboardingtemplaterow" id="addemployeeonboardingtemplaterow" onClick="return add_employee_onboarding_template_field();"  class="btn btn-primary" value="Add"/>
															</td>
											...
											<div id="hrms_employee_onboarding_template_data"></div>
											<div class="col-md-12 margin_row">
												<div class="col-md-6">
										  			<div class="form-group">
											...
											<div class="col-md-12">
												<center>
													...
													<a href="<?=ROOT.'hrms/hrms_employee_onboarding_template_list'?>" type="button" class="btn btn-danger">Cancel</a>
												</center>
											</div>		
										</div>
		...
		<?php include_once('../../include/include_js_file.php');?>   
			<script src="<?=ROOT . HRMS_ROOT ?>js/app/hrms_employee_onboarding_template.js?<?= time() ?>"></script>
		<script>
		...
		<?php 
			echo "<script>show_employee_onboarding_template_data() </script>";
		?>
	</body>
</html>
