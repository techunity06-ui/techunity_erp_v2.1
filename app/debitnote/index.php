		...
		$where='';
			...
			foreach($sqlReturn as $row) {
				...
				if(in_array(DEBIT_PENDING_NOTE_UPDATE,$bulkAccessArray)){
					$row_data[] = '<a class="" data-original-title="Edit '.$row["debitnote_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_edit/'.$row['debitnote_id'].'">'.$row["debitnote_no"].'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["debitnote_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_edit/'.$row['debitnote_id'].'">'.$row["debitnote_ref_no"].'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["debitnote_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_edit/'.$row['debitnote_id'].'">'.date('d M, Y',strtotime($row["debitnote_date"])).'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["debitnote_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_edit/'.$row['debitnote_id'].'">'.$row["l_name"].'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["debitnote_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_edit/'.$row['debitnote_id'].'">'.$row["city_name"].'</a>';
					$row_data[] = '<a class="" data-original-title="Edit '.$row["debitnote_no"].'" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_edit/'.$row['debitnote_id'].'">'.$row["g_total"].'</a>';
				...
				if(in_array(DEBIT_PENDING_NOTE_UPDATE,$bulkAccessArray)){
					$edit='<a class="btn btn-xs btn-warning" data-original-title="Edit" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_edit/'.$row['debitnote_id'].'"><i class="fa fa-pencil"></i></a>';
				}
			...
			$query_invoicetype = $dbcon->query("UPDATE tbl_invoicetype SET taxinvoice_start = taxinvoice_start +1 WHERE type_id=13 and company_id=".$_SESSION['company_id']);
...
function load_debit_srs_no($dbcon){
	...
	//Load no by Type ID
	$row=array();
	$query1="select * from tbl_invoicetype where status=0 and type_id=13 and company_id=".$_SESSION['company_id'];
