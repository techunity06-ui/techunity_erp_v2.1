...
if($_POST != NULL) {
	...
	if(strtolower($POST['mode']) == "fetch") {
		...
		//$branch=$_SESSION['branch_id'];
			...
			$isWhere = array("pod.po_delivery_date_status=0 and trn.purchaseordertrn_status=0 and po.po_approval_status = 1 and pod.grn_status!=1 and delivery_date<'$today_date'".$where);
