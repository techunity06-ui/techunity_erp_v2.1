<?php
	...
	if(strtolower($POST['mode']) == "fetch") {
		...
		foreach($sqlReturn as $row) {
			...
			$print_btn='';$del_btn='';
			//$print_btn='<a class="btn btn-xs btn-info" data-original-title="Receipt Print" data-toggle="tooltip" data-placement="top" href="'.ROOT.'receipt_purchase/'.$row['receipt_id'].'"><i class="fa fa-print"></i></a>';
			if($delete_btn_per){
		...
		$inserid11=add_record("tbl_general_book", $info2, $dbcon);
