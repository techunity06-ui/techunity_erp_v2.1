		...
		//echo $_SESSION['page'];
			...
			foreach($sqlReturn as $row) {
				...
				if($row['purchasecard_status']==0){
					...
					$edit='<a class="btn btn-xs btn-warning" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.'pcedit/'.$row['purchasecard_id'].'"><i class="fa fa-eye"></i></a>';
				}
				$add_po_btn='';
				if($row['po_type_status']==2){
					if($row['po_req_status']=='1'){
						...
						$add_po_btn='<a class="btn btn-xs btn-primary" data-original-title="Create PC" data-toggle="tooltip" data-placement="top" href="'.ROOT.'direct_po_add/'.$row['purchasecard_id'].'"><i class="fa fa-plus"></i></a>';			
