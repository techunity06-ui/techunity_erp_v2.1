...
if(strtolower($POST['mode']) == "generate_report") {
    ...
    $str .='<table  width="100%" class="display table table-bordered table-striped">
            ...
            $qry='Select invoice_no, invoice_date, cust.l_name as company_name, invoice.g_total,(select SUM(rtrn.paid_amount) as amuount from tbl_receipt_trn as rtrn where  rtrn.status=0 and rtrn.invoice_id=invoice.invoice_id) as paidamo , invoice.invoicetype_id,invoice_type 
