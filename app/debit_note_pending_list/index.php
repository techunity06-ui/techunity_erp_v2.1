	...
	if(strtolower($POST['mode']) == "fetch") {
		...
		foreach($sqlReturn as $row) {
			...
			if(in_array(DEBIT_NOTE_PENDING_ADD,$bulkAccessArray)){
				$add_po_btn='<a class="btn btn-xs btn-primary" data-original-title="Add GRN" data-toggle="tooltip" data-placement="top" href="'.ROOT.'debitnote_add_qc/'.$row['grn_no'].'"><i class="fa fa-plus"></i></a>';
			}
			$row_data[] = $add_po_btn;
