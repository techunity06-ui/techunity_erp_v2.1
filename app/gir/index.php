...
include_once("../../include/common_production_functions.php");
		...
		foreach($sqlReturn as $row) {
			...
			if(in_array(PRODUCTION_GIR_LIST_SLUG_UPDATE,$bulkAccessArray)){
				if(!empty($row['pro_gir_id'])){
					$edit_btn='<a class="btn btn-xs btn-warning" data-original-title="Edit" data-toggle="tooltip" data-placement="top" href="'.ROOT.'gir_edit/'.$row['pro_gir_id'].'"><i class="fa fa-pencil"></i></a>'; 
				}
			}
			...
			if(in_array(PRODUCTION_GIR_LIST_SLUG_VIEW,$bulkAccessArray)){
				...
				$view='<a class="btn btn-xs btn-info" data-original-title="View" data-toggle="tooltip" data-placement="top" href="'.ROOT.'gir_view/'.$row['pro_gir_id'].'"><i class="fa fa-eye"></i></a>';
			}  
