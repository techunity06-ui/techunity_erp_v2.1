...
{ 
    /*if(@isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],DOMAIN) !== false) */
	{
		...
		$aColumns = array('pro.product_id','pro.product_base_unit','pro.product_name','tc.cat_name','pro.product_status','pro.product_min_stock', 'reqqty', 'base_stock_add','base_stock_minus','con_stock_add','con_stock_minus','(((IFNULL(base_stock_add,0)+IFNULL(con_stock_add,0))-(IFNULL(base_stock_minus,0)+IFNULL(con_stock_minus,0)))+IFNULL(reqqty,0)) as stock');
