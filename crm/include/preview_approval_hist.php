				...
				<div class="row">
					<div class="card">
						<ul class="nav nav-tabs" id="my_tab_id" role="tablist">
							...
							<li role="presentation" id="tab2"><a href="#doc_detail" aria-controls="doc_detail" role="tab" data-toggle="tab">Document</a></li>
						</ul>
						<div class="tab-content"> 
							...
							<div role="tabpanel" class="tab-pane" id="doc_detail">
								<div class="col-md-12" id="mod_quot_doc_div_sec"></div>
								<div class="col-md-12" id="attach_doc_detail"></div>
							</div>
						</div>
					</div>
