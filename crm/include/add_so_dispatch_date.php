<div class="modal fade full-width-modal-right in" id="bs-so_dispatch_date-modal" role="dialog" data-keyboard="false" data-backdrop="static">
						...
						<form class="form-horizontal" role="form" id="dispatch" action="javascript:;" method="post" name="dispatch">
							...
							<div class="col-md-12" style="margin-top: 20px;">
								<center>
									...
									<input type="button"  name="m_addrow" id="m_addrow" onClick="<?=$add_field?>"  class="btn btn-primary" value="Add"/>
