...
<body>
					...
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="col-md-12">
								...
								<div class="col-md-5">
									<label class="control-label col-lg-4 col-md-4 col-xs-4 respad-l0">Choose Customer</label>
									<div class=" col-lg-8 col-md-8 col-xs-8 respad-r0">
										<select class="select2" name="cust_id" id="cust_id" autocomplete="new-password" onchange="load_inquiry_reg_datatable();" >
								...
								<div class="col-md-5" style="margin-top:10px">
									<label class="control-label col-lg-4 col-md-4 col-xs-4 respad-l0">Choose Product</label>
									<div class=" col-lg-8 col-md-8 col-xs-8 respad-r0">
								...
								<div class="col-md-5" style="margin-top:10px">
									<div class="form-group">
										...
										<div class="col-md-8">
											<select class="select2" name="sales_order_id" id="sales_order_id" onchange="load_inquiry_reg_datatable()">
												<?=get_sales_order_due_report($dbcon)?>
											</select>
										</div>
									</div>
								</div>
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/pending_so_report.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
