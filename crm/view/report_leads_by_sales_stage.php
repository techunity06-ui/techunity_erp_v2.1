...
<html lang="en">
<head>
	<title>LEAD BY SALES STAGE</title>
...
<body>
	<section id="container" class="sidebar-closed">
					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								...
								<!-- <phpinclude_once('../include/reporthead_menu.php');?> -->
							</header>	
							<div class="">
								<ul class="breadcrumb">
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12 margin_row">
											...
											<div class="col-md-8">
												<div id="report_leads_by_sales_stage" style="width: 900px; height: 400px;"></div>
											</div>
											<div class="col-md-2">
											</div>
										</div>
		...
		<script src="<?=ROOT.CRM_ROOT?>js/app/report_leads_by_sales_stage.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
