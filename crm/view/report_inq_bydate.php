					...
					<header class="panel-heading"> 
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-md-7">
									<select class="select2" name="opp_id" id="opp_id" onchange="generate_chart_report()">
						...
						<div class="col-md-5">
							<div class="form-group">
								<label class="control-label col-md-4">Choose Product</label>
								<div class="col-md-7">
...
<script src="<?=ROOT.CRM_ROOT?>js/app/report_inq_bydate.js?<?=time()?>"></script>  
<script>
	$(".select2").select2({
		width: '100%'
	});
