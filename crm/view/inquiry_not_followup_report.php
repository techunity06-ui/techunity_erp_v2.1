...
$form="Inquiry Not Follow Up Report";
$start=date('1-m-Y');
$end=date("d-m-Y");
...
<html lang="en">
<head>
	<title>Inquiry Not Follow Up Report</title>
...
<body>
						...
						<section class="panel">
							<header class="panel-heading">
								<span class="tools pull-right">
									<a href="javascript:;" onClick="tableToExcel('inquiry_notfollowup_detail', 'Instalment Collection')" ><button class="btn btn-success btn-flat" >Export Excel</button></a>	
								</span>
								<span class="tools pull-right">
									<button class="btn btn-warning btn-flat" onClick="PrintMe('inquiry_notfollowup_detail');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>
								</span>	
								<?=$form?>
							</header>				
							<div class="panel-body">
								...
								<div class="inquiry_notfollowup_detail" id="inquiry_notfollowup_detail" style="overflow-x: scroll;">
	...
	<!-- <script src=""></script> -->
	<!-- <script src=""></script> -->
	<script src="<?=ROOT.CRM_ROOT?>js/app/inquiry_not_followup_report.js?<?=time()?>"></script>
	<!-- <script src="<?=ROOT?>js/jquery-1.12.0.min.js?<?=time()?>"></script> -->
	<script>
		$(".select2").select2({
			width: '100%'
		});
