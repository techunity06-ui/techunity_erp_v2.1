...
$form="Sales Order Due Date wise Report";
$start=date('1-m-Y');
$end=date("d-m-Y");
...
<html lang="en">
<head>
	<title>SALES ORDER DUE DATE</title>
...
<body>
									...
									<div class="col-md-12">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<div class="input-group date form_datetime-component">
														...
														<input type="text" id="rep_date" onChange="generate_sales_order_due_date_report_data();" class="form-control datepikerdemo" value="">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="product_id" name="product_id" style="width:100%;" placeholder="Select Product" onchange="generate_sales_order_due_date_report_data();"/>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="select2" name="cust_id" id="cust_id" onchange="generate_sales_order_due_date_report_data();" >
									...
									<div class="col-md-12">
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="select2" name="user_id" id="user_id" onchange="generate_sales_order_due_date_report_data()">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="select2" name="sales_order_id" id="sales_order_id" onchange="generate_sales_order_due_date_report_data()">
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/salesorderduedatewisereport.js?<?=time()?>"></script>
