					...
					<header class="panel-heading"> 
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-md-7">
									<select class="select2" id="inquiry_status" name="inquiry_status" onChange="generate_chart_report()">
						...
						<div class="col-md-5">
							<div class="form-group">
								<label class="control-label col-md-4">Inquiry No</label>
								<div class="col-md-7">
									<select class="select2" id="inquiry_id" name="inquiry_id" onChange="generate_chart_report()">
						...
						<div class="col-md-5">
							<div class="form-group">
								<label class="control-label col-md-4">Sales Stage</label>
								<div class="col-md-7">
									<select class="select2" id="sales_stage_id" name="sales_stage_id" onChange="generate_chart_report();">
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-md-7">
									<select class="select2" name="stage_id" id="stage_id" onChange="generate_chart_report();">
						...
						<div class="col-md-5">
							<div class="form-group">
								<label class="control-label col-md-4">Source of Inquiry</label>
								<div class="col-md-7">
									<select class="select2" id="source_id" name="source_id" onChange="generate_chart_report();">
...
<script src="<?=ROOT.CRM_ROOT?>js/app/report_inq_bydate_adk.js?<?=time()?>"></script>  
<script>
	$(".select2").select2({
		width: '100%'
	});
