...
if(!$rel){
  header("Location: ".ROOT.CRM."proforma_list");
}
...
<tr>
    <td colspan="4" rowspan="3" width="50%" style="border:1px solid">
       ...
       '.ucwords(convert_number_to_words($totaltaxable+$totaltax1+$totaltax2)).'
       </span>
       <br>
       <br>
       ...
       <br>
       <span style="font-weight:bold;font-size: 14px"> Bank Address: </span> <span style="font-size:14px;">VATVA GIDC</span>
       <br>
       <span style="font-weight:bold;font-size: 14px"> A/c No.: </span> <span style="font-size:14px;"> 59200029121982</span>
       <br>
       <span style="font-weight:bold;font-size: 14px"> IFSC Code: </span> <span style="font-size:14px;"> HDFC0000971</span>
       <br>
       <span style="font-weight:bold;font-size: 14px"> SWIFT Code: </span> <span style="font-size:14px;"> HDFCINBBAHM </span>
       <br>
       <span style="font-weight:bold;font-size: 14px"> MICR Code: </span> <span style="font-size:14px;">380240022 </span>   
    </td>
    <td style="border:1px solid;font-weight:normal;font-size: 14px;" width="25%">
       <b>Gross Total</b>
    </td>
 ...
 $html.='<table><tr id="rawnone" style="float:left;border:none;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;font-size: 16px" >
    <td colspan="3" style="border-bottom:1px solid !important;border-right:1px solid;font-weight:normal;font-size: 14px;" >
       ...
       <span style="font-weight:bold;font-size: 14px"> GSTIN:  </span> <span>24AAHCK4254C1ZV</span>
       <br>
       <span style="font-weight:bold;font-size: 14px"> PAN No.: </span> <span>AAHCK4254C </span>
       <br>
    </td>
    <td colspan="3" width="50%" style="vertical-align:top;float: right !important;text-align:right;border-bottom:none !important;">
       <span style="font-weight:bold;font-size: 14px;">For KESAR EXTRUSIONS PVT LTD  </span><br>
       <br><br>
