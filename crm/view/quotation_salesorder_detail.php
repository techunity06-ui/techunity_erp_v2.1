...
<body>
						...
						<section class="panel">
							<header class="panel-heading">
								<span class="tools pull-right">
									<a href="javascript:;" onClick="tableToExcel('sales_order_detail', 'Instalment Collection')" ><button class="btn btn-success btn-flat" >Export Excel</button></a>	
								</span>
								<span class="tools pull-right">
									<button class="btn btn-warning btn-flat" onClick="PrintMe('sales_order_detail');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>
								</span>	
								<?=$form?>
							</header>				
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-3">Report Mode</label>
												<div class="col-md-9">
													<select class="select2" name="report_mode" id="report_mode" onchange="cust_ledger()" >
														<option value="quotation_mode">Quotation</option>
														<option value="salesorder_mode">Sales Order</option>
													</select>
												</div>
											</div>
										</div>
										<div class="col-md-4 quo_cust">
											<div class="form-group">
									...
									<div class="col-md-12" style="margin-top: 10px;">
										...
										<div class="col-md-4">
											<button class="btn btn-success" onclick="cust_so_detail_report()"> Generate Report
											</button>
										</div>
									</div>
								...
								<div class="sales_order_detail" id="sales_order_detail" style="">
	...
	<!-- <script src=""></script> -->
	<!-- <script src=""></script> -->
	<script src="<?=ROOT.CRM_ROOT?>js/app/quotation_salesorder_detail.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
