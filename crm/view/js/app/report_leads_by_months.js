...
function generate_chart()
{
	...
	//alert(date);
	var mainurl = root_domain + crm_domain +'app/report_leads_by_months/index.php?mode=generate_report_leads_months&start_date='+start_date
	//alert(mainurl);
...
function exportCsv() {
	...
	var url = root_domain +"generate_export?mode=months&source_id=" + encodeURIComponent(source_id);
