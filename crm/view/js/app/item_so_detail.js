...
function item_so_detail_report() {
	...
	$.ajax({
		type: "POST",
		url: root_domain + crm_domain +'app/item_wise_so_report/',
		data: { mode : "item_so_detail_report",product_id:product_id,country_id:country_id,state_id:state_id,city_id:city_id,date:date},		
