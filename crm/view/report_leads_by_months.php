...
<body>
	<section id="container" class="sidebar-closed">
					...
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading">
								...
								<span class="tools pull-right">
									<a href="javascript:;"><button onClick="exportCsv()" class="btn btn-success btn-flat" >Export Excel All</button></a>	
								</span>
								<span class="tools pull-right">
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12 margin_row">
											...
											<div class="col-md-8">
												<div id="report_leads_by_months" style="width: 900px; height: 400px;"></div>
											</div>
											<div class="col-md-2">
											</div>
										</div>
		...
		<script src="<?=ROOT.CRM_ROOT?>js/app/report_leads_by_months.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
