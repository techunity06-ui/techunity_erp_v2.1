...
<body>
					...
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								...
								<div class="sales_order_detail" id="sales_order_detail" style="overflow-x: scroll;width: 100%;">
	...
	<!-- <script src=""></script> -->
	<!-- <script src=""></script> -->
	<script src="<?=ROOT.CRM_ROOT?>js/app/quotation_detail_report.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
