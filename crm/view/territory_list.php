...
$branch_id = $_SESSION['branch_id'];
	//check paermission for territory add
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	CUSTOMER_TERRITORY_SLUG_READ,
	CUSTOMER_TERRITORY_SLUG_CREATE
]);

if(!in_array(CUSTOMER_TERRITORY_SLUG_READ,$bulkAccessArray)){
	...
	<section id="container" >
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<?php if(in_array(CUSTOMER_TERRITORY_SLUG_CREATE,$bulkAccessArray)){ ?>
						<div class="col-sm-3">
							<section class="panel">
								<header class="panel-heading">
									New <?=$form?>
								...
								<div class="panel-body">
									<div class="adv-table">
										<table  class="display table table-bordered table-striped" id="dynamic-table">
											<div class="col-md-12">
												<div class="col-md-6">
													<?php echo getBranchBox($dbcon, $branch_id, $rel['branch_id'], false, true,'load_territory_datatable()','4','6'); ?>
												</div>
											</div>
											<thead>
												<tr>
				...
				<div class="modal-content">
					...
					<div class="modal-body form">
						<form id="FormEditterritory" role="form" method="post" novalidate>
							...
							<div class="form-group" id="edit_territory">
		...
		<script src="<?=ROOT.CRM_ROOT?>js/app/territory_mst.js?<?=time()?>"></script>
	</body>
	</html>
	<script>
		$(".select2").select2({
