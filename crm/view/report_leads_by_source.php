...
$form="Leads By Source Reports";
?>

<!DOCTYPE html>
<html lang="en">
<head>
	<title>LEAD BY SOURCE</title>
...
<body>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12 margin_row">
										...
										<div class="col-md-8">
											<div id="report_leads_by_source_container" style="width: 900px; height: 400px;"></div>
										</div>
										<div class="col-md-2">
										</div>
									</div>
									...
									<div class="col-md-12 margin_row">
										<div class="form-group" style="margin-top:20px;">
											<div class="col-md-3">
												<div class="input-group date form_datetime-component">
													...
													<input type="text" id="rep_date"  onChange="load_data_chart();" class="form-control datepikerdemo" value="">
										...
										<div class="col-md-9">
											<div class="form-group">
												<label class="col-md-3 control-label">Choose Source / Referred By</label>
												<div class="col-md-4 col-xs-11">
													<select class="col-md-3 select2" name="source_id" id="source_id" onChange="quote_stage_report_filters()" multiple >
														<?=get_refer_by($dbcon,"");?>	
													</select>
												</div>
											</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="adv-table" id="adv-table" style="margin-top:30px;">
											<table  class="display table table-bordered table-striped" id="source-table">
												<thead>
													<tr>
														<th>Sr. NO.</th>
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/report_leads_by_source.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
