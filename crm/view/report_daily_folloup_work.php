...
<body>
							...
							<div class="panel-body">
								<div class="col-md-12">
									...
									<div class="col-md-3" >
										...
										<div class="col-md-8">
											<input id="end_date" name="end_date" type="text" class="form-control default-date-picker reuired valid" title="Date" value="<?=$start_date?>" placeholder="End Date">
										</div>
									</div>
									<div class="col-md-3" >
								...
								<div class="adv-table" id="adv-table"></div>
							</div>
						</section>
					</div>
				</div>
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/report_daily_folloup_work.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
