...
$form="Quotes Stage Funnel Report";
...
<html lang="en">
<head>
	<title>QUOTATION STAGE FUNNEL</title>
...
<body>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12 margin_row">
										...
										<div class="col-md-7">
											<div id="quote_stage_container" style="height: 300px; width: 800px;"></div>
										</div>
									...
									<div class="col-md-12 margin_row">
										<div class="col-md-6" style="margin-bottom: 15px;">
											...
											<div class="col-md-9" style="padding-right: 0px;">
												<input id="quote_stage_start_date" name="quote_stage_start_date" type="text" class="form-control default-date-picker required valid" title="Date" value="<?=$start_date?>" placeholder="Start Date" onchange="quote_stage_report_filters();">
											</div>
										</div>
										<div class="col-md-6" style="margin-bottom: 15px;">
											<div class="col-md-3" style="white-space:nowrap;padding-left: 0px;"><strong>End Date</strong></div>
											<div class="col-md-9" style="padding-right: 0px;">
												<input id="quote_stage_end_date" name="quote_stage_end_date" type="text" class="form-control default-date-picker reuired valid" title="Date" value="<?=$end_date?>" placeholder="End Date" onchange="quote_stage_report_filters();">
											</div>
										</div>
										<div class="col-md-6">
											<div class="col-md-3" style="white-space:nowrap;padding-left: 0px;"><strong>Employee</strong></div>
											<div class="col-md-9" style="padding-right: 0px;">
												<select class="form-control" name="quote_stage_user_id" id="quote_stage_user_id" onchange="quote_stage_report_filters();" >
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/report_quotes_stage_funnel.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
