...
.page{
	...
	<td style=" text-align:center;"><b>Unite Rate (INR)</b> </td>
	<td style=" text-align:center;"><b>Disc %</b> </td>
	<td style=" text-align:center;"><b>Amount (INR)</b> </td>
	</tr>
	</thead>
	<tbody>';
	$trn_qry="select *,cat.cat_name,product.product_type FROM `tbl_sales_ordertrn` as trn 
	...
	//$tax_amount = $tax_amount ? $tax_amount : '';
		...
		<td colspan="2" style=" text-align:center;font-size:12px;"> '.$trn_rel['product_hsn'].'</td>
		...
		<td style=" text-align:right;font-size:12px;">'.without_comma_two_digit_amount($trn_rel['discount_per']).'</td>
	...
	foreach($tax as $key => $value){
		if($key){
			...
			$html.= $key.'<br>';
			$html .= '<tr>
			<td colspan="8" style=" text-align:right;font-size:12px;">'.$key.'</td>
			<td  style=" text-align:center;font-size:12px;">'.indian_number($value,2).'</td>
			</tr>';
		}
	}
	...
	<td  style=" text-align:center;font-size:12px;">'.indian_number($final_total,2).'</td>
	</tr>
	<tr>
	<td colspan="8" style=" text-align:right;font-size:14px;">Basic Amount<br>Round Off  </td>
	<td  style=" text-align:center;font-size:14px;">'.indian_number($final_total,2).'<br>'.indian_number($round_off,2).'</td>
	</tr>
	<tr>
	<td colspan="8" style=" text-align:right;font-size:14px;background-color:	#b3b3b3">Total Order Value (In Figure) </td>
	<td  style=" text-align:center;font-size:14px;font-weight:bold;background-color:	#b3b3b3">'.indian_number(($final_total+$round_off),2).' </td>
	</tr>';
	...
	Total Order Value (In Words): <span style="font-weight:bold;font-size:13px;">'.convert_number_to_words_new($final_total+$round_off).'</span></td>
	</tr>
	<tr style="">
	<td colspan="9" style=" text-align:left;font-size:14px;">
	Total Tax (In Words): <span style="font-weight:bold;font-size:13px;">'.convert_number_to_words_new($total_tax).'</span></td>
	</tr>
	<tr style="">
