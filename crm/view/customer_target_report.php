...
<body>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
										...
										<div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8"> 
                                                        <select class="select2" id="state_id" name="state_id" onChange="reload_data();">
									...
									<div class="adv-table" id="adv-table" style="margin-top:120px;overflow-x: scroll;width:100%;min-height: 70px;padding-top: 40px;">
									</div>
								</div>
							</div>	
						</section>
	...
	<script src="<?=ROOT.CRM_ROOT ?>js/app/customer_target_report.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
