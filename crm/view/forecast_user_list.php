...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	FORECAST_USER_SLUG_READ,
	FORECAST_USER_SLUG_ADD
]);

if(!in_array(FORECAST_USER_SLUG_READ,$bulkAccessArray)){
			...
			<section class="wrapper">
						...
						<section class="panel">
							...
							<div class="">
								<ul class="breadcrumb">
									...
									<li><a href="<?=ROOT.CRM_ROOT.'forecast_user_list'?>"><?=$form?> list</a></li>
								</ul>
							</div>
						</section>
						<!--breadcrumbs end -->
				...
				<div class="row">			
					<div class="col-sm-12">
						...
						<div class="col-md-12">
							<div class="col-md-3">
								<?php echo getBranchBox($dbcon, $branch_id, $rel['branch_id'], false, true,'load_forecast_datatable()','3','9'); ?>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="f_target_period" class="col-md-4 control-label">User*</label>
									<div class="col-md-8">
										<select class="select2" name="f_user_id" id="f_user_id" onchange="load_forecast_datatable()">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="col-md-8">
										<select class="select2" id="forecast_type" name="forecast_type" onchange="load_forecast_datatable()">
							...
							<div class="col-md-2">	
								<span class="tools pull-right">
									<?php if(in_array(FORECAST_USER_SLUG_ADD,$bulkAccessArray)){ ?>
										<a href="<?=ROOT.CRM_ROOT.'forecast_user_add'?>"><button class="btn btn-success btn-flat">Add <?=$form?></button></a>
									<?php } ?>
								</span>
							</div>
						</div>
...
<?php include_once($include1.'preview_forecast_approve_hist.php'); ?>
<!--footer end-->
</section>
