...
$form="Customer wise Sales Order Summary Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        CUSTOMER_SALES_ORDER_SUMMARY_REPORT_VIEW
]);
if(!in_array(CUSTOMER_SALES_ORDER_SUMMARY_REPORT_VIEW,$bulkAccessArray)){
...
<html lang="en">
<head>
	<title>CUSTOMER WISE SALES ORDER SUMMARY</title>
...
<body>
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/customerwisesalesordersummary.js?<?=time()?>"></script>
