...
<html lang="en">
<head>
	<title>LEAD BY CLOSING DATES</title>
...
<body>
	<section id="container" class="sidebar-closed">
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="col-md-12">
										...
										<div class="col-md-4" >
											<button type="button" id="addcust" onclick="load_data_chart();" class="btn btn-primary">Show Report</button>
										</div>
									...
									<div class="row">
										<div class="col-md-12 margin_row">
											...
											<div class="col-md-8">
												<div id="report_leads_by_closing_dates" style="width: 900px; height: 400px;"></div>
											</div>
											<div class="col-md-2">
											</div>
										</div>
		...
		<script src="<?=ROOT.CRM_ROOT?>js/app/report_leads_by_closing_dates.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
