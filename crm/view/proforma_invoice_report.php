...
<body>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<div class="input-group date form_datetime-component">
														...
														<input type="text" id="rep_date" onChange="cust_so_detail_report();" class="form-control datepikerdemo" value="">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-4">Proforma Type </label>
												<div class="col-md-8">
													<select class="select2" name="proforma_type" id="proforma_type" onchange="cust_so_detail_report();" >
														<option value="1" selected>Quotation</option>
								...
								<div class="proforma_order_detail" id="proforma_order_detail" style="overflow-x: scroll; width: 100%;">
	...
	<!-- <script src=""></script> -->
	<!-- <script src=""></script> -->
	<script src="<?=ROOT.CRM_ROOT?>js/app/proforma_invoice_report.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
