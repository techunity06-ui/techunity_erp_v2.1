...
<body>
	<section id="container" class="sidebar-closed">
		...
		<?php include_once('../../'.ADMINISTRATION_ROOT.'include/add_city.php');?>
		<?php include_once('../../'.ADMINISTRATION_ROOT.'include/add_state.php');?>
		
		<?php include_once($incPath.'footer.php');?>
	</section>
	<?php include_once($incPath.'include_js_file.php');?>   
	<script src="<?=ROOT.CRM_ROOT?>js/app/sales_order.js"></script>
	<script>
