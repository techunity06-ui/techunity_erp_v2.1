...
<body>
						...
						<section class="panel">
							...
							<header class="panel-heading respadlr0">
								<div class="col-md-12">
									...
									<div class="col-lg-5">
										<div class="form-group">
											<label class="control-label col-lg-4 col-md-4 col-xs-4 respad-10"> Choose Inquiry</label>
											<div class="col-lg-8 col-md-8 col-xs-8 respad-r0">
											<select class="select2" id="inquiry_id" name="inquiry_id" onChange="load_inquiry_reg_datatable();">
												<option value="">Choose Inquiry</option>
												<?=get_inquiry_no($dbcon,"");?>
											</select>
											</div>
										</div>
									</div>
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/inq_reg.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
