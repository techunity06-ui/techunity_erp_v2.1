...
$form="Appointment Activity Report";
?>
...
<body>
						...
						<section class="panel">
							<header class="panel-heading">
								<span class="tools pull-right">
									<a href="javascript:;" onClick="tableToExcel('adv-table', 'Appointment Activity List')" ><button class="btn btn-success btn-flat" >Export Excel</button></a>	
								</span>
								<span class="tools pull-right">
							...
							<div class="panel-body">
								<div class="col-md-12">	
									<div class="col-md-4" >
										...
										<div class="col-md-8">
											<select class="select2" name="user_id" id="user_id" onChange="load_appointment_activity_list_datatable()">
								...
								<div class="row">
									<div class="col-md-12 margin_row">
										<div class="col-md-2">
											<button class="btn btn-dark btn-flat" onClick="clear_appointment_activity_list_report();" style="margin-right:20px;"><i class="fa fa-remove"></i> Clear Chart</button>
										</div>
										<div class="col-md-8">
											<div id="report_appointment_activity_list" style="width: 900px; height: 400px;"></div>
										</div>
										<div class="col-md-2">
										</div>
									</div>
								...
								<div class="adv-table" id="adv-table">
									<table  class="display table table-bordered table-striped" id="ledger_appointment_activity">
										<thead>
											<tr>
												<th>Sr. NO.</th>
												<th>Appointment Startdate</th>
												<th>Appointment Enddate</th>
												<th>Subject</th>
												<th>Purpose</th>
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/report_appointment_activity_list.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
