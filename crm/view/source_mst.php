...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
	CUSTOMER_SOURCE_SLUG_READ,
	CUSTOMER_SOURCE_SLUG_CREATE
]);

if(!in_array(CUSTOMER_SOURCE_SLUG_READ,$bulkAccessArray)){
	...
	<section id="container" >
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<!--unit overview start-->
				<div class="row">
					<?php if(in_array(CUSTOMER_SOURCE_SLUG_CREATE,$bulkAccessArray)){ ?>
						<div class="col-sm-3">
							<section class="panel">
								<header class="panel-heading">
									New <?=$form?>
		...
		<script src="<?=ROOT.CRM_ROOT?>js/app/source_mst.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
