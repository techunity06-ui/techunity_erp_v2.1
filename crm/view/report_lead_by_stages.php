...
<body>
	<section id="container" class="sidebar-closed">
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="col-md-12">
										...
										<div class="col-md-4" >
											<div class="col-md-4"><strong>Lead Owner</strong></div>
											<div class="col-md-8">
											 	<select class="select2" id="user_id" name="user_id" onChange="load_data_chart();">
									...
									<div class="row">
										<div class="col-md-12 margin_row">
											...
											<div class="col-md-8">
												<div id="report_lead_by_stages" style="width: 900px; height: 400px;"></div>
											</div>
											<div class="col-md-2">
											</div>
										</div>
		...
		<script src="<?=ROOT.CRM_ROOT?>js/app/report_lead_by_stages.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
