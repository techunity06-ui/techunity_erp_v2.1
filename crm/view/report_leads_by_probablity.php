...
$form="Leads by Probablity Report";
?>

<!DOCTYPE html>
<html lang="en">
<head>
	<title>LEAD BY PROBABLITY</title>
...
<body>
	<section id="container" class="sidebar-closed">
							...
							<div class="panel-body">
								<div class="col-md-12">
										...
										<div class="col-md-4" >
											...
											<div class="col-md-8">
												<select  class="select2" name="source_id" id="source_id" onChange="load_data_chart()" >
													<!--<option value="">--Select Customer--</option>-->
													<!-- <=get_refer_by($dbcon);?>	 -->
													<?=get_inquiry_probability($dbcon,$rel['opp_id']);?>
												</select>
											</div>
										</div>
										<!--<div class="col-md-4" >
									...
									<div class="row">
										<div class="col-md-12 margin_row">
											...
											<div class="col-md-8">
												<div id="report_leads_by_probablity" style="width: 900px; height: 400px;"></div>
											</div>
											<div class="col-md-2">
											</div>
										</div>
		...
		<script src="<?=ROOT.CRM_ROOT?>js/app/report_leads_by_probablity.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
