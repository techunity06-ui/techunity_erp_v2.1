...
<html lang="en">
<head>
	<title>ISO INQUIRY REPORT</title>
...
<body>
					...
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading"> 
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-8">
											<select class="select2" id="cust_id" name="cust_id" onChange="generate_report();">
												<?= getcustomer($dbcon,'') ?>
											</select>
										</div>
									</div>
							...
							<div class="panel-body">
								<div class="adv-table" id="adv-table" style="overflow-x: scroll; overflow-y: scroll; height: 650px;">
	...
	<script src="<?=ROOT.CRM_ROOT?>js/app/iso_inquiry_report.js?<?=time()?>"></script>  
	<script>
		$(".select2").select2({
			width: '100%'
		});
