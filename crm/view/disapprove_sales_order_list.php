...
// if(!in_array(ORDER_ACCEPTANCE_SLUG_LIST,$bulkAccessArray)){
...
<html lang="en">
<head>
	<title>DISAPPROVE SALES ORDER LIST</title>
...
<body>
					...
					<section class="panel">
						<header class="panel-heading respadlr0">
							...
							<div class="col-md-4" style="display: none;">
								...
								<div class="col-md-8">
									<select class="form-control" name="ac_status" id="ac_status" onchange="reload_data();" style="display: none;">
										<option value="3" selected>Disapprove</option>
									</select>
								</div>
							</div>
								...
								<table  class="display table table-bordered table-striped" id="dynamic-table">
									...
									<tfoot>
										<tr>
											...
											<th></th>
											<th></th>
											<?php if(in_array(ORDER_ACCEPTANCE_SLUG_EDIT,$bulkAccessArray) || in_array(ORDER_ACCEPTANCE_SLUG_PRINT,$bulkAccessArray)){ ?>
	...
	<script src="<?= ROOT.CRM_ROOT?>js/app/order_acceptance.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
