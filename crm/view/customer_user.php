											...
											<div class="col-md-12">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="col-md-8 col-xs-11">
															<input type="text" class="form-control" name="cust_mobile" id="cust_mobile" value="<?=$rel['cust_mobile']?>" <?=($getpagePermissions['crm_partymst_cust_mobile'] == '0') ? '' : 'required';?>/>
														</div>
													</div>							 
												</div>
											</div>
											...
											<table class="table table-bordered">
												<thead>
													...
													<tr>
														...
														<td>
															<input type="number" class="form-control" name="consignee_mobile" id="consignee_mobile" onkeypress="return isNumberKey(event)" maxlength="10"/>
														</td>
														<td>
									...
									<table class="table table-bordered">
										<thead>
											...
											<tr>
												...
												<td>
													<input type="text" class="form-control" name="transporter_contact" id="transporter_contact">
												</td>
