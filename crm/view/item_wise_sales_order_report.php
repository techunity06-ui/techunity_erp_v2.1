...
$form="Item Wise Sales Order Details";
$countryid = '101';
...
<html lang="en">
<head>
	<title>ITEM WISE SALES ORDER</title>
...
<body>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
									    <div class='col-md-4'>
            								<div class="form-group">
            									<label class="control-label col-lg-4 col-md-4 col-xs-4 respad-l0 text-right">Choose Date</label>
            									<div class=" col-lg-8 col-md-8 col-xs-8 respad-r0">
            										<div class="input-group date form_datetime-component">
            											<input type="hidden" id="from_date"  value="<?=$start?>">
            											<input type="hidden" id="to_date"  value="<?=$end?>">
            											<input type="text" id="rep_date"  onChange="item_so_detail_report();" class="form-control datepikerdemo" value="">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-8">
													<input id="product_id" name="product_id" style="width:100%;" placeholder="Select Product" onchange="item_so_detail_report();"/>
												</div>
											</div>
										</div>
										</div> 
										...
										<div class="col-md-4" style="margin-top: 10px;">	
											<div class="form-group">
												...
												<div class="col-md-8">
													<select class="select2" name="c_add_country" id="c_add_country" onChange="load_state(this.value,'c_add_state','');item_so_detail_report()">
										...
										<div class="col-md-4" style="margin-top: 10px;">
											<div class="form-group">
												...
												<div class="col-md-8">
													<select class="select2" name="c_add_state" id="c_add_state" onChange="load_city(this.value,'c_add_city','');item_so_detail_report()">
										...
										<div class="col-md-4" style="margin-top: 10px;">
											<div class="form-group">
												<label class="control-label col-md-4 text-right">City</label>
												<div class="col-md-8">
													<select class="select2" name="c_add_city" id="c_add_city" onchange="item_so_detail_report()">
									...
									<div class="item-so-detail-table mtop20" id="item-so-detail-table">
	...
	<!-- <script src=""></script> -->
	<!-- <script src=""></script> -->
	<script src="<?=ROOT.CRM_ROOT?>js/app/item_so_detail.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
