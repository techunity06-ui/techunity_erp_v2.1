...
$form="Customer Wise Sales Order Details";
$start=date('1-m-Y');
$end=date("d-m-Y");
...
<html lang="en">
<head>
	<title>CUSTOMER WISE SALES ORDER</title>
...
<body>
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="select2" name="cust_id" id="cust_id" onchange="cust_so_detail_report();" >
										...
										<span class="tools pull-right"> 
											<a href="javascript:;" onClick="tableToExcel('cust-so-detail-table', '<?=$form?>')" ><button class="btn btn-primary btn-flat" >Export Excel</button></a>	
										</span>
									</div>
									
									<div class="col-md-12" style="margin-top: 10px;"></div>
									<div class="cust-so-detail-table" id="cust-so-detail-table">
									</div>
								</div>
							</div>	
						</section>
	...
	<!-- <script src=""></script> -->
	<!-- <script src=""></script> -->
	<script src="<?=ROOT.CRM_ROOT?>js/app/cust_so_detail.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
