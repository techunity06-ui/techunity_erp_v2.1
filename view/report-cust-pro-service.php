<?php 
	...
	$form="Customer Product Service Report";
?>

<!DOCTYPE html>
<html lang="en">
<head>
<title>CUSTOMER PRODUCT SERVICE</title>
	 ...
	 <button class="btn btn-warning btn-flat" onClick="PrintMe('adv-table');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>											
				...
				<div class="panel-body">
					<div class="row">
							...
							<div class="col-md-4" >
							 <select  class="select2" name="cust_id" id="cust_id" onChange="load_cust_sold_pro(this.value);generate_report_product_service()">
