					...
					<div class="panel-body">
						<form role="form" id="module_add" action="javascript:;" method="post" name="module_add">
						  ...
						  <?php //Amish Soni 06-01-2021
							if(in_array(EMAIL_MODULE_SLUG_CREATE, $bulkAccessArray)) { ?>
			...
			<section class="panel">
				  <header class="panel-heading">
					...
					<span class="tools pull-right">		
						<a href="javascript:;" onClick="tableToExcel('module-table', 'Instalment Collection')" ><button class="btn btn-info btn-flat" >Export Excel</button></a>	
					</span>
					<?}?>
				  </header>
				  <div class="panel-body">
				  <div class="adv-table">
				  <table  class="display table table-bordered table-striped" id="module-table">
				  <thead>
				  <tr>
					  <th>Sr. NO.</th>
					  <th>Module Name</th>
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
	...
	<script src="<?=ROOT?>js/app/email_module_mst.js"></script>
<script>
