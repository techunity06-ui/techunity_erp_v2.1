						...
						<div class="col-md-12" style="height:20px;" ></div>
							<div class="col-md-12">
	                            ...
	                            <div class="col-md-2">
	                            	 <div class="form-group">
	                                    <label>Product:</label>
	                                    <select class="select2" id="product_id" name="product_id" onchange="load_machine_configuration_datatable()" placeholder="Choose Products"> 
	                            ...
	                            <div class="col-md-2">
	                            	<div class="form-group">
	                                    <label>Short Count:</label>
	                                    <input id="short_count" name="short_count" type="text" class="form-control" title="Date" value="" placeholder="Short Count" onchange="load_machine_configuration_datatable();">
	                                </div>
	                            </div>
	                            <div class="col-md-2">
	                            </div>
	                            <div class="col-md-2">
	                            	<span class="tools pull-right">
										<a href="<?=ROOT.'machine_configuration_add'?>"><button class="btn btn-success btn-flat">Add <?=$form?></button></a>
									</span>
	                            </div>
                        	</div>
					</header>	
