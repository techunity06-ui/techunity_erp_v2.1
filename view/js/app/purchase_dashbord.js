...
function load_dashbord_count()
{
	...
	editReq = $.ajax({
		type: "POST",
		url: root_domain+'app/purchase_dashboard/',
...
function load_top_20_vender()
{
	...
	var mainurl = root_domain + 'app/purchase_dashboard/index.php?mode=top_20_vender&start_date='+d_start_date+'&end_date='+d_end_date+'&user_id='+d_user_id+'&vendor_filter='+vendor_filter;
	$.getJSON(mainurl, function(json) {
		var arr1=new Array();
...
function load_top_20_product()
{
	...
	var mainurl = root_domain + 'app/purchase_dashboard/index.php?mode=top_20_product&start_date='+d_start_date+'&end_date='+d_end_date+'&user_id='+d_user_id+'&product_filter='+product_filter;
	$.getJSON(mainurl, function(json) {
		var arr1=new Array();
		for(var i=0;i<json.length;i++)
		{	
...
function load_top_20_cat()
{
	...
	var mainurl = root_domain + 'app/purchase_dashboard/index.php?mode=top_20_cat&start_date='+d_start_date+'&end_date='+d_end_date+'&user_id='+d_user_id+'&pur_cat_filter='+pur_cat_filter;
	$.getJSON(mainurl, function(json) {
		var arr1=new Array();
		for(var i=0;i<json.length;i++)
		{	
...
function load_top_20_delay_product()
{
	...
	var mainurl = root_domain + 'app/purchase_dashboard/index.php?mode=top_20_dealy_product&start_date='+d_start_date+'&end_date='+d_end_date+'&user_id='+d_user_id
	$.getJSON(mainurl, function(json) {
		var arr1=new Array();
		for(var i=0;i<json.length;i++)
		{	
...
function detalils_view(type){
	window.location=root_domain+'po_pending_details/'+type;
}

function load_target_chart()
{

	var mainurl = root_domain +'app/purchase_dashboard/index.php?mode=load_target_chart';
...
var mainurl = root_domain +'app/purchase_dashboard/index.php?mode=load_purchase_po_com&pur_amount_filter='+pur_amount_filter;
