...
function load_dispatch_datatable(){
	...
	$("#dispatch-list-datatable").dataTable({
		...
		"iDisplayLength": 10,
		"sAjaxSource": root_domain+'app/pending_dispatch_list_crm/',
		"fnServerParams": function ( aoData ) {
			aoData.push( {"name": "mode", "value": "fetch" }, {"name": "date", "value": date }, {"name": "inv_status", "value": inv_status } );
		},
...
function load_pend_disp(){
	...
	$.ajax({
		type: "POST",
		url: root_domain+'app/pending_dispatch_list_crm/',
