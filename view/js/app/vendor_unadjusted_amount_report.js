...
function generate_report() {
	...
	$.ajax({
		type: "POST",
		url: root_domain + 'app/report_vendor_unadjusted_amount/',
...
function generate_chart(cust_id = 0)
{
	...
	var mainurl = root_domain + 'app/report_vendor_unadjusted_amount/index.php?mode=generate_chart&cust_id='+cust_id;
