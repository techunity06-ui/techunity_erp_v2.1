...
function next_page(){
	...
	//return false;
		...
		$.ajax({
			...
			data: { mode : "save_work_order_product",product_id:product_id,qty:qty,bom_version_id:bom_version_id,branch_id:branch_id},
			success: function(response)
			{
				...
				if(arr.res==="1"){
						...
						var jobcard_rp_id = arr.jobcard_rp_id;
						location.href= root_domain+'direct_jobcard/'+product_id+'/'+branch_id+'/'+bom_version_id+'/'+qty+'/'+jobcard_rp_id;
						return false;
					}else{
