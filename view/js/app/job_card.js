...
function load_po_datatable()
{
	...
	datatable = $("#dynamic-table").dataTable({
			...
			"iDisplayLength": 10,
			"sAjaxSource": root_domain+'app/job_card/',
...
function get_item_information(id=null, product_id=null, vender_id=null, type=null) {
	Loading();
 	$.ajax({
		type: "POST",
		url: root_domain+'app/job_card/',
		data: { mode : 'get_item_selected_information', product_id : product_id, vender_id : vender_id, type : type, id : id},
		success: function(data){
			$('#table_id').val(id);
			Unloading();
		}		
