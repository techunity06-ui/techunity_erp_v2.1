<?php 
	...
	$form="Paid Spare Report";
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>PAID SPARE</title>
...
function generate_service_user_report() 
{
	...
	$("#adv-table").dataTable({
		...
		"fnServerParams": function ( aoData ) {
			aoData.push( {"name": "mode", "value": "spare_report"},{"name": "report_type", "value": "paid"}, {"name": "date", "value": date}, {"name": "state_id", "value": state_id}, {"name": "city_id", "value": city_id} );
		},
...
<section class="panel">
	...
	<div class="">
		<ul class="breadcrumb">
			...
			<li><a href="<?=ROOT.'paid_spare_report'?>"> <?=$form?></a></li>
		</ul>
	</div>
</section>
<!--breadcrumbs end -->
...
<section class="panel">
	<header class="panel-heading">
		<span class="tools pull-right">
			<a href="javascript:;" onClick="tableToExcel('adv-table', 'Paid Spare Report')" ><button class="btn btn-success btn-flat">Export Excel</button></a>
		</span>
		<span class="tools pull-right">
