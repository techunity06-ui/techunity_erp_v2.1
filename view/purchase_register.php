...
<section id="container" >
						...
						<header class="panel-heading">
						 ...
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'purchase_register'?>"><?=$form?></a></li>
						  </ul>
						 </div>
					</section>
				  <!--breadcrumbs end -->
						...
						<div class="col-md-12">
							...
							<div class="form-group" style="margin-top:20px;">
								 <div id="cat">
                                  ...
                                  <div class="col-md-8">
									<select  class="select2" name="vender_id" id="vender_id" onChange="reload_data();">
										<?= get_ledger($dbcon,'',' and l_group IN (1003,1004,1005,1006,1007,'.SUNDRY_CREDITORS.')')?>
									</select>
							      </div>
                            	</div>
							</div>
   ...
   <script src="<?=ROOT?>js/app/purchase_register.js"></script>
