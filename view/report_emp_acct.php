							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										...
										<?php if($usertype!='3') { ?>
											<div class="col-md-4" >
												<select  class="select2" name="emp_id" id="emp_id" onChange="generate_report_emp_ledger();" readonly>
													<option value="">--Select Emplpoyee--</option>
													<?=getAllEmployee($dbcon,$emp_id)?>	
												</select> 
											</div>
										<?php } else { ?>
