<?php 
	...
	$form="Invoice wise Payment Report";
?>
...
<body>
  <section id="container" >
				  ...
				  <section class="panel">
					  <header class="panel-heading">
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'all_report'?>">Invoice  Report</a></li>
						  </ul>
						 </div>
					</section>
				  <!--breadcrumbs end -->
							...
							<div class="col-md-12">
								...
								<!--<div class="form-group col-md-12" style="margin-top:20px;">
									<label class="control-label col-md-2" >Report Type</label>
									 <div class="col-md-1">
										All	<input id="report" name="report" checked="checked" type="radio" onClick="reload_data();" class="" title="All" value="all">
									</div>
									<div class="col-md-2">
										Employee
										<input id="report" name="report" onClick="reload_data();" type="radio" class="" title="paid" value="emp">
									</div>
										Category 
										<input id="report" name="report"  onClick="reload_data();" type="radio" class="" title="due" value="cat">
								</div>-->
									  ...
									  ?>
                                        <input type="hidden" id="from_date"  value="<?=$start?>">
         					 		   ...
         					 		   <input type="text" id="rep_date"  onChange="reload_data();" class="form-control datepikerdemo" value="">
											...
											<button type="button" class="btn btn-danger date"><i class="fa fa-calendar"></i></button>
											</span>
											</div>
                                  </div>
								</div> 
   ...
   <script src="<?=ROOT?>js/app/paymentreport_all.js"></script>
