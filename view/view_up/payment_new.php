				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="purchasepayment_add" action="javascript:;" method="post" name="purchasepayment_add">
						...
						<div class="col-md-12">	
						 <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select class="select2" name="paymentmodeid" id="paymentmodeid" onChange="paymentmode(this.value);/*get_cash_opening_bal(this.value,'max_paid_amount','tran_amounterr');*/" required title="Select Debit Account">
						...
						<div class="col-md-12 text-center">
							...
							<a href="<?=ROOT.'payment_list'?>" type="button" class="btn btn-danger">Cancel</a>
						</div>
