					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li><a href="<?=ROOT.'report_ledger'?>"> Group List</a></li>
							  <li><a href="<?=ROOT.'ledger_detail/'.$row1['l_group'];?>"> <?=$row1['g_name']?></a></li>
							  <li ><a href="<?=ROOT.'vendor_ledger'?>"><?=$form." For <strong style='color:red'>".$row1['l_name']."</strong>"; ?></a></li>
