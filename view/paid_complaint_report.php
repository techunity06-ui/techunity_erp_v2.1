<?php 
	...
	$form="Paid Complaint Report";
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>PAID COMPLAINT</title>
...
function generate_service_user_report() 
{
	...
	$("#adv-table").dataTable({
		...
		"fnServerParams": function ( aoData ) {
			aoData.push( {"name": "mode", "value": "complaint_install_report"},{"name": "comp_type", "value": "2"},{"name": "report_type", "value": "2"}, {"name": "date", "value": date}, {"name": "cat_id", "value": cat_id}, {"name": "status_id", "value": status_id} );
		},
...
<section class="panel">
	...
	<div class="">
		<ul class="breadcrumb">
			...
			<li><a href="<?=ROOT.'paid_complaint_report'?>"> <?=$form?></a></li>
		</ul>
	</div>
</section>
<!--breadcrumbs end -->
...
<section class="panel">
	<header class="panel-heading">
		<span class="tools pull-right">
			<a href="javascript:;" onClick="tableToExcel('adv-table', 'Paid Complaint Report')" ><button class="btn btn-success btn-flat">Export Excel</button></a>
		</span>
		<span class="tools pull-right">
