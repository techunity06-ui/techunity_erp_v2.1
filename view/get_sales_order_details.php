...
<html lang="en">
	...
	<body>
		<section id="container" >
			...
			<?php include_once('../include/so_stock_allocate.php');?>
			<?php include_once('../include/so_product_version.php');?>
		</section>
		<?php include_once('../include/include_js_file.php');?>   
		<script src="<?php echo ROOT; ?>js/app/get_sales_order_details.js"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
