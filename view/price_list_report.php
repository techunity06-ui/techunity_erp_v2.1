...
$form="Price List Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        PRICE_LIST_REPORT_VIEW
]);
if(!in_array(PRICE_LIST_REPORT_VIEW,$bulkAccessArray)){
											...
											<div class="col-md-12">
												<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="Vendor Wise" value="vendorwisepricelistreport" checked="">
													</label>
												</div>
											</div>
											<!-- <div class="col-md-12">
												<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="itemwiseratesummaryreport">
													</label>
												</div>
											</div> -->
											...
											<!-- <div class="col-md-12">
												<div class="col-md-5">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="allwiseratesummaryreport">
													</label>
												</div>
											</div> -->
										</div>
									...
									<div class="col-md-12" style="margin-left: 15px;">
										<div class="col-md-6">
											...
											<div class="col-md-7" style="">
												<select  class="select2" name="vendor_id" id="vendor_id" onChange="getAllitemsbyvendoridjobcard(this.value);" >
										...
										<div class="col-md-6">
											...
											<div class="col-md-7" style="">
												<select  class="select2" name="item_id" id="item_id" >
													...
													<?php load_all_product($dbcon,'')?>
												</select>
											</div>
										</div>
									</div>

									<?php if(in_array(PRICE_LIST_REPORT_VIEW,$bulkAccessArray)){ ?> 
									<div class="col-md-12" style="text-align: center;">
										<button id="preview" class="btn btn-success" onclick="generate_report_price_list()">Preview</button>
									</div>
									<?php } ?>
