<?php 
	...
	$form="Complaint Wise Expense Report";
					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'report_expense_complaint'?>"><?=$form?></a></li>
	 ...
	 <button class="btn btn-warning btn-flat" onClick="PrintMe('adv-table');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>											
				...
				<div class="panel-body">
					<div class="row">
										 ...
										 <?php 
										  ...
										  ?>
											 ...
											 <input type="hidden" id="to_date"  value="<?=date('t-m-Y')?>">
												<input type="text" id="rep_date"  onChange="generate_report_expense();" class="form-control datepikerdemo" value="">
							...
							<div class="col-md-3" >
								<input class="form-control" name="comp_id" id="comp_id" placeholder="Enter Complaint Number..." />
								<div id="suggesstion-box"></div>
							</div>
							
							<?php if($usertype!='3') { ?>
							<div class="col-md-3" >
							 <select  class="select2" name="emp_id" id="emp_id" onChange="generate_report_expense()">
								<option value="">--Select Employee--</option>
									<?=getAllEmployee($dbcon,$id)?>		
							 </select>
							</div>
							<?php } else { ?>
							...
							<div class="col-md-3" >
								 <select  class="select2" name="exp_id" id="exp_id" onChange="generate_report_expense()">
