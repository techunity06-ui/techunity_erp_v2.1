<?php 
	...
	$form="Employee Performance Report";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
{	
	$("#adv-table").dataTable({
		...
		"fnServerParams": function ( aoData ) {
			aoData.push( {"name": "mode", "value": "emp_performance_report"} );
		},
...
<section class="panel">
	...
	<div class="">
		<ul class="breadcrumb">
			...
			<li><a href="<?=ROOT.'emp_performance_report'?>"> <?=$form?></a></li>
		</ul>
	</div>
</section>
<!--breadcrumbs end -->
...
<section class="panel">
	<header class="panel-heading">
		<span class="tools pull-right">
			<a href="javascript:;" onClick="tableToExcel('adv-table', 'Employee Performance Report')" ><button class="btn btn-success btn-flat">Export Excel</button></a>
		</span>
		<span class="tools pull-right">
						...
						<table class="display table table-bordered table-striped" id="adv-table">
							<thead>
								<tr>
									<th>Employee Name</th>
									<th>Installation</th>
									<th>Paid Complaint</th>
									<th>Free Complaint</th>
								</tr>
							</thead>
							<tbody>
							</tbody>				 
