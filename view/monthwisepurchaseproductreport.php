<?php 
	...
	$form="Monthly Purchase Product Report";
?>
...
<body>
  <section id="container" >
					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'monthwisepurchaseproductreport'?>"><?=$form?></a></li>
   ...
   <script src="<?=ROOT?>js/app/monthwisepurchaseproductreport.js"></script>
