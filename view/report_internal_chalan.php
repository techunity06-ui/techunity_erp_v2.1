...
<table width="100%" class="maintable" style="font-size: 12px;" id="invoice_type" >
	<thead>
		...
		<tr height="30px">					
			...
			<th width="12%" style="text-align:center;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Required Quantity</strong></th>
			...
			<th width="12%" style="text-align:center;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Received Quantity</strong></th>
			<th width="12%" style="text-align:center;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Returned Quantity</strong></th>
		</tr>
	</thead>
	<tbody style="border: 1px solid;">
		...
		<tr style="height:40px">
				...
				<td style="text-align:center;padding-right:10px;vertical-align:top;border-bottom-color:#FFFFFF; border-right:1px solid;" >
					<?= ($row['status'] == 'receive') ? $row['received_qty'] : '-'?>
				</td>
				<td style="text-align:center;padding-right:10px;vertical-align:top;border-bottom-color:#FFFFFF; border-right:1px solid;" >
				<?= ($row['status'] == 'receive') ? $row['return_qty'] : '-'?>
				</td>
		</tr>
		<?php	
			$i++; 
