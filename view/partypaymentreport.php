<?php 
	...
	$form="Customer Outstanding Statement";
?>
                                ...
                                <section class="panel">
                                    ...
                                    <div class="">
                                        <ul class="breadcrumb">
                                                ...
                                                <li ><a href="<?=ROOT.'partypaymentreport'?>"><?=$form?></a></li>
                                        </ul>
                                     </div>
                                </section>
                                <!--bread crumbs end -->
...
<script src="<?=ROOT?>js/app/partypaymentreport.js?<?=time()?>"></script>
