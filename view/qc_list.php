<?php 
    ...
    if(!in_array(QC_DONE_LIST,$bulkAccessArray)) {
...
<body>
  <section id="container" >
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				...
				<span class="tools pull-right">
					...
					<a href="<?=ROOT.'qc_add'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
				</span> -->
   ...
   <script src="<?=ROOT.PRODUCTION_ROOT?>js/app/qc_detail.js?<?=time()?>"></script>
