	 ...
	 <button class="btn btn-warning btn-flat" onClick="PrintMe('adv-table');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>											
				...
				<div class="panel-body">
					<div class="row">
							...
							<div class="col-md-6" >
								 <select  class="select2" name="product_id" id="product_id" onChange="generate_report();" style="width:350px">
									<?=get_product($dbcon,$id,'0,1,2,3,4,5')?>	
								 </select>
							</div>
						</div>
