<?php 
	...
	$form = "Customer Unadjusted Amount Report";
...
<html lang="en">
        ...
        .link_dash
	{
                            ...
                            <section class="panel">
                                ...
                                <div class="">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="<?=ROOT.'report_cust_unadjusted_amount'?>"><?=$form?></a></li>
                                    </ul>
                                </div>
                            </section>
                        </div>	
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4" id="cust_div" style="display: none;">
                                                        <select  class="select2" name="cust_id" id="cust_id" onChange="generate_report();generate_chart();">
                                                            <?=get_ledger($dbcon,$ledger_id,' and l_group IN ('.SUNDRY_DEBTORS.') ')?>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script src="<?=ROOT?>js/app/cust_unadjusted_amount_report.js?<?=time()?>"></script>
