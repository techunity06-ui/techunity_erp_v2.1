...
$form="Purchase Bill Register Report";
?>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-6">
											<div class="col-md-4">
												<label>
													<div class='external-event label label-primary ui-draggable' style='position: relative;width:90px;'>All</div>				<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="allpurchasepaymenteport" checked="">
												</label>
											</div>
											...
											<div class="col-md-8">
												<label>
													<div class='external-event label label-success ui-draggable' style='position: relative;width:150px;'>Purchase Type Wise</div>					
									...
									<button id="preview" class="btn btn-success" onclick="generate_report_purchase_bill_summary_data()" style="float: right;margin-right: 3%;margin-top:8px;">Preview</button>
