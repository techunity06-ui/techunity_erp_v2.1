                                        ...
                                        <div class="col-md-12" style="margin: 10px 0;">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        <label>
                                                            <input id="cust_type_all" name="cust_type" type="radio" checked="checked" style="width:20px;height:20px;vertical-align:middle" onClick="$('#cust_div').hide();generate_report();" class="" title="All" value="0">
                                                            <div class='external-event label label-primary ui-draggable' style='position: relative;width:100px;'>All</div>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label>
                                                            <input id="cust_type_sc" name="cust_type" type="radio" style="width:20px;height:20px;vertical-align:middle" onClick="$('#cust_div').show();" class="" title="Choose Party" value="1">
                                                            <div class='external-event label label-warning ui-draggable' style='position: relative;width:100px;'>Choose Customer</div>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-3" id="cust_div" style="display: none;">
                                                        <select  class="select2" name="cust_id" id="cust_id" onChange="generate_report();">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="col-md-4" style="text-align:right;">Day wise</div>
                                                    <div class="col-md-6">
                                                        <select  class="select2" name="pay_terms" id="pay_terms" onChange="reload_data();">
