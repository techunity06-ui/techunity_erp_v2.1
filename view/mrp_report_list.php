					...
					<div class="row">			
						<div class="col-sm-12">
									...
									<?
										...
										$querymenu1re1="SELECT menumaster.*, CASE WHEN parent_id = 0 THEN id ELSE parent_id END AS sort FROM menu_master_access as menumaster WHERE menumaster.status=0 and menu_path='#mrp_report_list' ORDER BY sort, id";
