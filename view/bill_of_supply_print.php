<?php 
	...
	$form="Bill of Supply";
	$mode="Print";
	$bill_of_supply_id=$dbcon->real_escape_string($_REQUEST['id']);
	$query="select invoice.*,country.country_name,state.state_name,city.city_name,cust.l_name,cust.m_address,cust_pincode,cust.cust_mobile,cust.gst_no from tbl_bill_of_supply as invoice 
		...
		where bill_of_supply_id=$bill_of_supply_id";
				  ...
				  <section class="panel">
					  <header class="panel-heading">
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'bill_of_supply_list'?>">Bill of Supply List</a></li>
		...
		<center>
			<div class="col-md-1"> </div>With Logo
				...
				<div class="col-md-4">
					...
					<a href="<?=ROOT.'bill_of_supply_list'?>" type="button" class="btn btn-danger"><i class="fa fa-ban"></i> Cancel</a>
...
<table width="100%" class="maintable" style="font-size: 12px;" id="invoice_type" >
	<thead>
		<tr>
			<th colspan="4" style="text-align:center;">
				...
				<strong class="data_title" style="font-size:12px;float:right;">ORIGINAL</strong>
			</th>
		</tr>
		</tr>
				...
				<table border="0" style="font-size:12px;border-collapse:separate;" cellpadding="0"  cellspacing="0" width="100%" id="">
					<!--<thead>-->
						<tr>
							...
							<td style="vertical-align:top;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">: <strong><?=$rel['bill_of_supply_no']?></strong>
							</td>							
						</tr>
						<tr>
							...
							<td style="vertical-align:top;border-bottom:1px solid;border-right:1px solid;">
								: <?=date('d/m/Y',strtotime($rel['bill_of_supply_date']))?>							
							</td>							
						</tr>
	...
	<tbody style="border: 1px solid;">
		<?php
			$qry="select * FROM `tbl_bill_of_supplytrn` as trn 
			left join product_mst as product on product.product_id=trn.product_id 
			left join unit_mst as per on per.unitid=trn.unit_id 
			where bill_of_supply_trn_status=0 and bill_of_supply_id=".$rel['bill_of_supply_id'];
