...
$form="Pending Purchase Order Item WiseList";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        PENDING_PURCHASE_ORDER_ITEM_WISE_REPORT_VIEW
]);
if(!in_array(PENDING_PURCHASE_ORDER_ITEM_WISE_REPORT_VIEW,$bulkAccessArray)){
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
										...
										<div class="col-md-12">
											...
											<div class="col-md-2">
												<label>
													...
													<input id="task_status_all po_date_wise" name="po_date_wise" type="radio" style="width:20px;height:20px;vertical-align:middle" onClick="" class="" title="All" value="po" checked="">
												</label>
											</div>	
											<div class="col-md-2">
									...
									<?php if(in_array(PENDING_PURCHASE_ORDER_ITEM_WISE_REPORT_VIEW,$bulkAccessArray)){ ?> 
									<button id="preview" class="btn btn-success" onclick="generate_item_wise_report()">Preview</button>
									<?php } ?>
								</div>
