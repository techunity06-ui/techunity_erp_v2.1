<?php 
	...
	$cnt=1;
	$sel=$dbcon->query("select * from tbl_quotation_trn");
	while($row=brp_mysqli_fetch_array($sel))
	{
		...
		if($r_tax['tax_cat']=="INTRA")
		{
			...
			$info1['tx_transaction_id'] = $row['quot_trn_id'];
			$info1['tx_transaction_type'] = 'tbl_quotation_trn';
			...
			$info2['tx_transaction_id'] = $row['quot_trn_id'];
			$info2['tx_transaction_type'] = 'tbl_quotation_trn';
			...
			$dbcon->query("update tbl_quotation_trn set  cgst_tax_per='$tax_per',cgst_tax_rate='$tax_amount',sgst_tax_per='$tax_per',sgst_tax_rate='$tax_amount' where quot_trn_id='$row[quot_trn_id]'");
		...
		else
		{
			...
			$dbcon->query("update tbl_quotation_trn set  igst_tax_per='$tax_per',igst_tax_rate='$tax_amount' where quot_trn_id='$row[quot_trn_id]'");
		}
		...
		$q_update = "update tbl_quotation_trn set product_tax_cat='$tax_cat_id' where quot_trn_id='$row[quot_trn_id]'"."<br>"; 
		
		$dbcon->query("update tbl_quotation_trn set product_tax_cat='$tax_cat_id' where quot_trn_id='$row[quot_trn_id]'");
