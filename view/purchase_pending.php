...
<section id="container" >
						...
						<header class="panel-heading">
						 ...
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'purchase_pending'?>"><?=$form?></a></li>
						  </ul>
						 </div>
					</section>
				  <!--breadcrumbs end -->
						...
						<div class="col-md-12">
							...
							<div class="form-group" style="margin-top:20px;">
								...
								<div class="form-group" style="">
									<div id="cat">
										<label class="control-label col-md-4">Purchase No</label>
										<div class="col-md-8">
											<select class="select2" name="invoice_id" id="invoice_id" onChange="reload_data();" >
												<?=get_po_no($dbcon);?>	
											</select>
										</div>
									</div>
							...
							<div class="col-md-12" style="padding-top:12px;padding-bottom:12px;">
								<div class="col-md-6">
                                                                    <div class="col-md-4" style="text-align:right;white-space:nowrap;">Select Customer </div>
								<div class="col-md-7" >
										<select  class="select2" name="cust_id" id="cust_id" onChange="reload_data();">
											<?= get_ledger($dbcon,'',' and l_group IN ('.SUNDRY_CREDITORS.')')?>
										</select>
								</div>
								</div>
							</div>
   ...
   <script src="<?=ROOT?>js/app/purchase_pending.js"></script>
