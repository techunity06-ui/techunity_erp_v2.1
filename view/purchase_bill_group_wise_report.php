							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
													...
													<div class="form-group">
														...
														<div class="col-md-8 col-xs-11">
															 <select class="select2" name="product_category[]" id="product_category" multiple="">
																<?=get_all_category_modify($dbcon,$rel['product_category']);?>
															 </select>
														</div>
													</div>
												</div>
											...
											<button id="preview" class="btn btn-success" onclick="generate_item_wise_pur_bil_report()" style="float: right;
    margin-right: 33px;
    margin-top: 10px;">Preview</button>
    <?php } ?>
