...
<body>
  <section id="container" >
			  ...
			  <div class="col-lg-12">
				  ...
				  <section class="panel">
					  <header class="panel-heading">
						 <h3 style=""><span class="english"> <?=$form?></span>
							</h3>
				...
				<span class="english"> Home</span>
							  ...
							  <li ><a href="#"><span class="english"> <?=$form?></span>
							</a></li>
				...
				<section class="panel">
				  <header class="panel-heading">
						 <span class="tools pull-right">
							<a href="javascript:;" onClick="tableToExcel('adv-table', 'Instalment Collection')" ><button class="btn btn-success btn-flat" ><span class="english">Export Excel</span></button></a>
							<button class="btn btn-warning btn-flat" onClick="PrintMe('adv-table');" style="margin-right:20px;"><i class="fa fa-print"></i> <span class="english">Print Report</span></button>						
						</span>
				  </header>				
   ...
   <script src="<?=ROOT?>js/app/profit_loss_statement.js"></script>
