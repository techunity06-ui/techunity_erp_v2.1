...
<html lang="en">
	...
	<body>
									...
									<form class="form-horizontal" role="form" id="multiple_indent_approove" action="javascript:;" method="post" name="multiple_indent_approove">
										<div class="row">
											<div class="col-md-12">
												...
												<div class="col-md-4">
													<?php echo getBranchBox($dbcon, $branch_id, '', false, false, 'get_pending_work_order_no(this.value);get_pending_indent_no(this.value);get_pending_product(this.value);load_pending_indent()'); ?>	
												</div>
											</div>
		...
		<script src="<?=ROOT?>js/app/multiple_approove_indent.js?<?=time()?>"></script>
<script>
$(".select2").select2({
	width: '100%'
});
