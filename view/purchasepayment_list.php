...
<section id="container" >
			...
			<div class="col-sm-12">
				...
				<header class="panel-heading">
					...
					<span class="tools pull-right">
						<a href="<?=ROOT.'purchasepayment'?>" ><button class="btn btn-success btn-flat" >Add <?=$form?></button></a>					
					</span>
				 <br/>
				</header>	
	...
	include_once('../include/modal_use_credit_amount.php');
	?>   
   <script src="js/app/purchasepayment.js"></script>
