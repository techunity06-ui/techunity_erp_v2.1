<?php
	...
	$qry1="select * from tbl_sales_ordertrn where cron_status_total=0 and sales_ordertrn_status =0";
    ...
    if(brp_mysqli_num_rows($result1) > 0){
        while($rel=brp_mysqli_fetch_assoc($result1)){
        	...
        	$updateid=update_record("tbl_sales_ordertrn", $info, "sales_ordertrn_id=".$rel['sales_ordertrn_id'], $dbcon);
