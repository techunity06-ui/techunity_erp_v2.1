...
<body>
  <section id="container" >
					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'monthwisepaymentreport'?>"><?=$form?></a></li>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="col-md-6" style="margin-top:20px;">
								<div class="col-md-4" style="text-align:right;">Select Customer </div>
								<div class="col-md-8" >
   ...
   <script src="<?=ROOT?>js/app/monthlypurchasepayment.js?<?=time()?>"></script>
