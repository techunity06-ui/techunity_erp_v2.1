...
<body>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-3">
											...
											<div class="col-md-12">
												...
												<label>
													<div class='external-event label label-warning  ui-draggable' style='position: relative;width:110px;'>Done</div>					
													<input id="task_status_all" name="mode_type" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" onchange="generate_report()" title="Done" value="done">
												</label>
										...
										<div class="col-md-3">
											...
											<div class="col-md-12">
												<label>
													<div class='external-event label label-warning  ui-draggable' style='position: relative;width:110px;'>Pending</div>					
													<input id="task_status_all" name="mode_type" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" onchange="generate_report()" value="pending" >
												</label>
											</div>	
										...
										<div class="col-md-3">
											<div class="col-md-12">
												<label>
													<div class='external-event label label-warning  ui-draggable' style='position: relative;width:110px;'>All</div>					
													<input id="task_status_all" name="mode_type" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" onchange="generate_report()" value="all" checked="">
												</label>
											</div>	
										</div>
									...
									<!-- <div class="col-md-12" style="text-align: center;" style="display: none;">
										<button id="preview" class="btn btn-success" onclick="generate_report_workorder_stage()">Preview</button>
									</div> -->
	...
	<script src="<?=ROOT?>js/app/wostagereport.js?<?=time()?>"></script>
