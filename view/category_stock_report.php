...
if(strpos($_SERVER['REQUEST_URI'], "sub_category_report")==true) {
	$parent_id =$dbcon->real_escape_string($_REQUEST['id']);
	$mode  = 'sub_cat'; 
}else{
	$mode  = 'main_cat';
}
$form="Category Wise Stock Report";
...
<body>
					...
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12"> 
										<!-- <div class="col-md-4" id="product_drop">
										...
										<div class="col-md-4" id="category_drop">
											<label class="control-label col-lg-4 col-md-4 col-xs-3">Product Category</label>
	                                	...
	                                	<label class="control-label col-lg-4 col-md-4 col-xs-3">Choose Date</label>
				                           <div class=" col-lg-8 col-md-8 col-xs-9">
				                              ...
				                              <input type="text" id="rep_date" class="form-control datepikerdemo" value="" onchange="get_category_report()">
										...
										<!--  <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-xs-11">
                                                            <select class="select2" id="product_type" name="product_type" onchange="get_category_report()">
                                                                <php echo get_product_type_company($dbcon, $product_type, ''); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div> -->
										 <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 col-xs-11">
                                                            <select class="select2" name="product_category" id="product_category" onchange="get_category_report();">
                                                                <?= get_all_category($dbcon, $parent_id); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
									</div>
									<div class="col-md-12" id="adv-table">
	...
	<script src="<?=ROOT?>js/app/categorystockreport.js?<?=time()?>"></script>
	<script>
		$(".select2").select2({
			width: '100%'
		});
	...
	<?php if($mode=='main_cat'){
			echo "<script type='text/javascript'>get_category_report()</script>";
	}else{
			 echo "<script type='text/javascript'>get_category_report()</script>";
	}?>
</body>
