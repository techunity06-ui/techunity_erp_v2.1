...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li ><a href="<?=ROOT.'leads_by_source_reports'?>"><?=$form?></a></li>
									</ul>
								</div>
							</section>
						</div>	
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-4" >
												<select  class="select2" name="source_id" id="source_id" onChange="generate_report_product_service()" multiple >
		...
		<script src="<?=ROOT?>js/app/leads_by_source_reports.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
