...
<body>
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<label>
														...
														<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="allanalysisreport" checked="">
													</label>
												</div>
												<div class="col-md-6">
													<label>
	...
	<script src="<?=ROOT?>js/app/vendoranalysis.js?<?=time()?>"></script>
