...
<html lang="en">
   <head>
      <?php include_once('../include_css_file.php');?>
   </head>
   <body>
      <section id="container" >
         <?php include_once('../include_top_menu.php');?>
         <!--sidebar start-->
                        ...
                        <header class="panel-heading">
                           ...
                           <div class="col-md-4">
                              <label class="control-label col-lg-4 col-md-4 col-xs-3">Branch</label>
                                 <div class=" col-lg-8 col-md-8 col-xs-9">
                                    <select class="branch_validate" name="branch_id" id="branch_id" required onchange="reload_data()">
      ...
      <?php include_once('preview_direct_material_aprv_hist.php'); ?>
      <?php include_once('../include_js_file.php');?>    
      <script src="<?=ROOT?>js/app/grn_approve_pending_list.js"></script>
