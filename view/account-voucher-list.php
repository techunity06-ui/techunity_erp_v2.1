...
<body>
  <section id="container" >
					  ...
					  <header class="panel-heading">
						...
						<div class="">
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="#">Account Voucher list</a></li>
						</ul>
						 </div>
					</section>
				  <!--breadcrumbs end -->
			...
			<div class="col-sm-12">
				<section class="panel">
				  <header class="panel-heading">
					...
					<a href="<?=ROOT.'account-voucher-entry'?>" ><button class="btn btn-success btn-flat" >Add <?=$form?></button></a>					
				 </span>
   ...
   <script src="js/app/account_voucher_entry.js"></script>
