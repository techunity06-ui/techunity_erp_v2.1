...
$form="Pending Purchase Oreder Report";
?>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-12">
											...
											<div class="col-md-2">
												<label>
													<div class='external-event label label-primary ui-draggable' style='position: relative;width:90px;'> Date</div>					
													<input id="task_status_all po_date_wise" name="po_date_wise" type="radio" style="width:20px;height:20px;vertical-align:middle" onClick="load_task_datatable();" class="" title="All" value="po">
												</label>
											</div>	
											<div class="col-md-2">
										...
										<div class="col-md-12" style="margin-top: 15px;">
											...
											<div class="col-md-4" >
											<select  class="select2" name="vendor_id" id="vendor_id" onChange="getpo(this.value);" >
										...
										<div class="col-md-12" style="margin-top: 15px;">
											...
											<div class="col-md-4" >
											<select  class="select2" name="items_id" id="items_id" onChange="">
										...
										<div class="col-md-12" style="margin-top: 15px;">
											<div class="col-md-2" style="text-align:right;">
												<label>With Conv Qty. :</label>
											</div>
											<div class="col-md-4" >
												<label>
																		
													<input id="task_status_all withconv" name="withconv" type="checkbox" style="width:20px;height:20px;vertical-align:middle" onClick="load_task_datatable();" class="" title="All" value="1">
												</label>
											</div>
											</div>
										...
										<button id="preview" class="btn btn-success" onclick="generate_follow_up_report()">Priview</button>
