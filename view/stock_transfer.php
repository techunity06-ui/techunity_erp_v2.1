								...
								<div class="panel-body">
									<form class="form-horizontal" role="form" id="stock_transfer_add" action="javascript:;" method="post" name="stock_transfer_add" enctype="multipart/form-data">
										<div class="row"> 
											...
											<div class="col-md-12" style="margin-top:10px;">
												<div class="col-md-4">
													<label class="col-md-4 control-label">Transfer No</label>
													...
													<div class="col-md-12 col-xs-11">
														<table cellspacing="10" style=" border-spacing:10px;" class="display table table-bordered table-striped">
															<tr id="field">
																...
																<th width="20%" class="text-center">Work Order</th>
																<th width="10%" class="text-center">Reserve Qty</th>
																<th width="20%" class="text-center">Transfer Work Order</th>
															...
															<tr id="field">
																...
																<td width="20%" >
																<select class="select2" name="work_order_id" id="work_order_id" title="Select Work Order"onchange="reserve_stock_check(this.value)">
