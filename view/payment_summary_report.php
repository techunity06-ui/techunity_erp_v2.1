								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-3">
											<div class="col-md-12">
												<label>
													<div class='external-event label label-primary ui-draggable' style='position: relative;width:90px;'>Vendor Wise</div>				<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="vendorwisepaymentsummary" checked="">
												</label>
											</div>
											<div class="col-md-12">
												<label>
													<div class='external-event label label-warning  ui-draggable' style='position: relative;width:120px;'>Vender Wise Ledger</div>	<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="All" value="vendwiseledgerpaymentreport">
												</label>
											</div>
											<div class="col-md-12">
												<label>
													<div class='external-event label label-success ui-draggable' style='position: relative;width:90px;'>Bill No Wise</div>					
													<input id="task_status_all" name="report_wise" type="radio" style="width:20px;height:20px;vertical-align:middle"  class="" title="Bill No Wise" value="billnowisepaymenteport">
												</label>
											</div>
									...
									<button id="preview" class="btn btn-success" onclick="generate_report_payment_summary_data()" style="margin-left:40%">Preview</button>
