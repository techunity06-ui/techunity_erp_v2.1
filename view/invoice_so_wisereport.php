						...
						<h3><?=$form?></h3>
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'invoicewisereport'?>">Invoice  Report</a></li>
						  </ul>
						 </div>
					</section>
				  <!--breadcrumbs end -->
	 ...
	 <button class="btn btn-warning btn-flat" onClick="PrintMe('adv-table');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>											
				...
				<div class="panel-body">
					<div class="row">
							...
							<div class="col-md-2" style="text-align:right;">Select Type </div>
							<div class="col-md-4" >
							 <select style="width:170px;" class="form-control" name="type_id" id="type_id" onChange="reload_data();">
...
<div class="col-md-6" style="margin-top:20px;">
					...
					<div class="adv-table" id="adv-table" style="margin-top:100px;">
   ...
   <script src="<?=ROOT?>js/app/invoice_so_wisereport.js?<?=time()?>"></script>
