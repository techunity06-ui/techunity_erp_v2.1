<?php 
	...
	$form="Customer Satisfaction Status Report";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
function generate_service_user_report() 
{
	...
	$("#adv-table").dataTable({
		...
		"fnServerParams": function ( aoData ) {
			aoData.push( {"name": "mode", "value": "customer_status_report"},{"name": "date", "value": date}, {"name": "state_id", "value": state_id}, {"name": "city_id", "value": city_id}, {"name": "status_id", "value": status_id} );
		},
...
<section class="panel">
	...
	<div class="">
		<ul class="breadcrumb">
			...
			<li><a href="<?=ROOT.'customer_status_report'?>"> <?=$form?></a></li>
		</ul>
	</div>
</section>
<!--breadcrumbs end -->
...
<section class="panel">
	<header class="panel-heading">
		<span class="tools pull-right">
			<a href="javascript:;" onClick="tableToExcel('adv-table', 'Customer Satisfaction Status Report')" ><button class="btn btn-success btn-flat">Export Excel</button></a>
		</span>
		<span class="tools pull-right">
