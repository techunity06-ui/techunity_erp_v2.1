...
$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        ...
        TODAY_PURCHASE_SLUG_VIEW,
        TILL_DATE_PURCHASE_SLUG_VIEW,
        TODAY_SALE_SLUG_VIEW,
        TILL_DATE_SALE_SLUG_VIEW,
        TODAY_INQUIRY_ADD_SLUG_VIEW,
        TODAY_QUOTATION_CREATE_SLUG_VIEW,
        TODAY_PENDING_INQUIRY_FOLLOWUP_SLUG_VIEW,
        TODAY_PENDING_QUOTATION_FOLLOWUP_SLUG_VIEW,
        TODAY_SO_PLANNING_PENDING_SLUG_VIEW,
        TODAY_INDENT_APPROVED_PENDING_SLUG_VIEW,
        TODAY_PO_CREATED_SLUG_VIEW,
        TODAY_PO_PENDING_SLUG_VIEW,
        TODAY_PENDING_GRN_SLUG_VIEW,
        TODAY_INQUIRY_WON_SLUG_VIEW,
        TODAY_TOTAL_AMOUNT_WON_INQUIRY_SLUG_VIEW,
    ],$company_id,$user_id);
                     ...
                     <tbody>
                        <tr>
                           <td style="margin-top:20px" align="center" bgcolor="#165FAC" colspan="4" height="50" valign="middle">
                              <p style="margin: 0;font-size: 18px;color:#fff;">Today\'s Summary</p>
                           </td>
                        </tr>
                        <tr>
                           <td align="left" colspan="4" height="70" valign="top" style="/*! padding-left: 20px; */width:60%;border-radius: 4px;border: 1px solid #165FAC;display: inline-table;/*! margin: 20px; */margin: 20px;padding: 20px;">
                              <p style="margin: 0;font-size: 15px;line-height: 18px;font-weight: bold;color: #fff;margin-bottom: 10px;background: #165FAC;padding: 10px;border-radius: 4px;"> Today\'s Summary</p>';

                             if(in_array(TODAY_PURCHASE_SLUG_VIEW,$bulkAccessArray)) { 
                               $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  <span style="width:55%;display:inline-block">Today\'s Purchase :</span>
                                  <span style="width:20%;display:inline-block">'.today_purchase_total_amount($dbcon).' Rs.</span> </div>';  
                                  } 
                            ...
                            if(in_array(TILL_DATE_PURCHASE_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  <span style="width:55%;display:inline-block"> Till Date Purchase:</span>
                                  <span style="width:20%;display:inline-block">'.today_purchase_total_till_date($dbcon).' Rs.</span> </div>';       
                                }
                                  /* End :: Cody by Sanat ::  10-08-2021 */
                            if(in_array(TODAY_SALE_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  <span style="width:55%;display:inline-block">Today\'s Sales :</span>
                                  <span style="width:20%;display:inline-block">'.today_sales_total_amount($dbcon).' Rs.</span> </div>'; 
                                }

                                   /* Start :: Code by Sanat ::  10-08-2021 
                                     comment :: Total sales till date of finantial year  
                                  */
                                     if(in_array(TILL_DATE_SALE_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  <span style="width:55%;display:inline-block">Till Date Sales :</span>
                                  <span style="width:20%;display:inline-block">'.today_sales_total_till_date($dbcon).' Rs.</span> </div>';       
                                }

                                  /* End :: Cody by Sanat ::  10-08-2021 */
                                  if(in_array(TODAY_INQUIRY_ADD_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  ...
                                  <span style="width:20%;display:inline-block">'.today_inquiry_add_count($dbcon).'</span> </div>';
                                   ...
                                   if(in_array(TODAY_QUOTATION_CREATE_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                              ...
                              /*$template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  ...
                                  if(in_array(TODAY_PENDING_INQUIRY_FOLLOWUP_SLUG_VIEW,$bulkAccessArray)) { 
                                  $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  <span style="width:55%;display:inline-block">Today No. of Pending Inquiry Followup :</span>
                                  <span style="width:20%;display:inline-block">'.today_pending_inquiry_folloup_count($dbcon).'</span> </div>';
                                }
                                   if(in_array(TODAY_PENDING_QUOTATION_FOLLOWUP_SLUG_VIEW,$bulkAccessArray)) { 
                                  $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  <span style="width:55%;display:inline-block">Today No. of Pending Quotation Followup :</span>
                                  <span style="width:20%;display:inline-block">'.today_pending_quotation_folloup_count($dbcon).'</span> </div>';
                                  
                    }
                     if(in_array(TODAY_SO_PLANNING_PENDING_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
...
if(in_array(TODAY_INDENT_APPROVED_PENDING_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
...
if(in_array(TODAY_PO_CREATED_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
...
if(in_array(TODAY_PO_PENDING_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                              ...
                              if(in_array(TODAY_PENDING_GRN_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  ...
                                  */
                                   ...
                                   if(in_array(TODAY_INQUIRY_WON_SLUG_VIEW,$bulkAccessArray)) { 
                                   $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
  ...
  if(in_array(TODAY_TOTAL_AMOUNT_WON_INQUIRY_SLUG_VIEW,$bulkAccessArray)) { 
                              $template .= '<div style="margin: 0;font-size: 12px;line-height: 18px;font-weight: normal;color: #4c4c4c;margin:10px;">
                                  <span style="width:55%;display:inline-block">Today No. of Total Amount of Won Inquiry :</span>
                                  <span style="width:20%;display:inline-block">'.today_total_amount_of_won_inquiry($dbcon).' Rs.</span> </div>';    
                                  }
                                 /* End :: Cody by Sanat ::  10-08-2021 */
