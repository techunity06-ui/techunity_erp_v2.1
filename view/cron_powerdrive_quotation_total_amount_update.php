<?php
	...
	$qry1="select * from tbl_quotation_trn where cron_status_total=0 and quot_trn_status =0";
    ...
    if(brp_mysqli_num_rows($result1) > 0){
        while($rel=brp_mysqli_fetch_assoc($result1)){
        	...
        	$updateid=update_record("tbl_quotation_trn", $info, "quot_trn_id=".$rel['quot_trn_id'], $dbcon);
