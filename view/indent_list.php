...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<div class="col-md-12" style="margin-top:20px">
										<div class="col-md-5">
											<?php echo getBranchBox($dbcon, $branch_id, '', false, true, 'reload_data(this.value)'); ?>	
										</div>
										<div class="col-md-7">	
											<span class="tools pull-right">
												<a href="<?=ROOT.'multiple_approove_indent'?>" ><button class="btn btn-success btn-flat" >Multiple <?=$form?></button></a>
											</span>
										</div>
									</div>
		...
		<script src="js/app/indent_list.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
