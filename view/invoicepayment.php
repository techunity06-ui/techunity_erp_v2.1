  ...
  <section id="container" >
      ...
      <!--main content start-->
				  ...
				  <section class="panel">
					  <header class="panel-heading">
						  ...
						  <ul class="breadcrumb">
								...
								<li>
									<a href="<?=ROOT.'invoicepayment_list'?>"> Payment List</a>
								</li>
						  </ul>
						 </div>
					</section>
		  ...
		  <div class="row">			
			...
			<form class="form-horizontal" role="form" id="invoicepayment_add" action="javascript:;" method="post" name="invoicepayment_add">
					<div class="row">
							<div class="col-md-12">	
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-lg-3 padding-right">
										<select class="form-control"  name="accountid" id="accountid" required title="Select Bank" onchange="">
											<?=get_all_group($dbcon,$rel['accountid'],' and g_pid!=0','0');?>
										</select>
						...
						<div class="col-md-12">
							<table  class="display table table-striped" id="purchase_data">
							  ...
							  <tbody>
								<tr>
									<td colspan="7" style="padding: 30px;" class="text-center">
										<h4> There are no bills for this customer. </h4>
									</td>
								</tr>
								<tr> 
...
<?php include_once('../include/footer.php');?>
   ...
   <script src="<?=ROOT?>js/app/invoicepayment.js?<?=time()?>"></script>
