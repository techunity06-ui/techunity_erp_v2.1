<?php 
	...
	$query="select * from tbl_planning where pl_order_id=$invoiceid";
...
<table width="100%" class="maintable" style="font-size: 12px;" id="invoice_type" >
		...
		<tr>
			<th colspan="5" style="padding:0px !important;">
				<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
					<!--<thead>-->
						<tr>
							<td width="10%" style="vertical-align:top;border:1px solid;border-right:none;"><strong>Order No </strong>
							</td>
							 
							<td style="vertical-align:top;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;" colspan="2">: <strong><?=$rel['pl_order_no']?></strong>
							</td>
						
							<td style="vertical-align:top;border:1px solid;border-right:none;white-space:nowrap;">
								<strong>Order Date</strong>
							</td>
							<td style="vertical-align:top;border-bottom:1px solid;border-right:1px solid;"  colspan="2" >
								: <?=date('d/m/Y',strtotime($rel['pl_order_date']))?>							
							</td>							
						</tr>
	...
	<tbody style="border: 1px solid;">
		<?php
			$qry="select * FROM `tbl_sales_ordertrn` as trn left join tbl_product as product on product.product_id=trn.product_id left join unit_mst as per on per.unitid=trn.unit_id where sales_ordertrn_status=0 and sales_order_id=".$rel['sales_order_id'];
