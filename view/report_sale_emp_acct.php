<?php 
	...
	$form="Sales Enginner Account Report";
...
<html lang="en">
<head>
<title>SALES ENGINEER ACCOUNT</title>
...
<body>
  <section id="container" >
				  ...
				  <section class="panel">
						...
						<div class="">
							<ul class="breadcrumb">
								...
								<li><a href="<?=ROOT.'report_sale_emp_acct'?>"><?=$form?></a></li>
							</ul>
						</div>
					</section>
				  <!--breadcrumbs end -->
							...
							<?php if($_SESSION['user_type']=='2') { ?>
								...
								<div class="col-md-4" >
									<select  class="select2" name="user_id" id="user_id" onChange="generate_report_emp_ledger();">
										<?=get_users_typewise($dbcon,$user_id," and user_type in(8,9)")?>	
									</select> 
								</div>
							<?php }
							else { ?>
   ...
   <script src="<?=ROOT?>js/app/report_sale_emp_acct.js?<?=time()?>"></script>
