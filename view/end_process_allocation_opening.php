<?php 
	...
	//echo $id;
	$query="select ap.*,p.product_name,p.product_type,p.product_setting_check,pr.process_name,sum(j_qty) as inqty,j.jobwork_id from tbl_allocate_process as ap left join product_mst as p on p.product_id=ap.p_product_id left join process_mst as pr on pr.process_id=ap.process_id left join tbl_jobwork as j on j.j_ref_id=ap.p_ref_id where p_id='$id'";
    ...
    <?php include_once('../include/include_top_menu.php');?>
      ...
      <!--main content start-->
		...
		<form class="form-horizontal" role="form" id="end_allocate_add" action="javascript:;" method="post" name="start_allocate_add">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="col-md-6 col-xs-11">
							<input type="text" name="machine_no1" id="machine_no1" class="form-control" value=""  required />
			...
			<input type='hidden' name='product_qc' id='product_qc' value='<?=$product_qc;?>' />
...
<script src="<?=ROOT?>js/app/allocate_process_end_opening.js"></script>
