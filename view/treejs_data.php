		...
		while($childNode = mysqli_fetch_assoc($resChildNodes))
		{
			...
			if(mysqli_num_rows($resChildNodes1) > 0)
			{
				...
				<li>
					...
					<label><input type="checkbox" id="'. $childNode['product_id'].'" parent-id="'. $parent_id.'" class="jtree_parent_checkbox" name="sp_part[]" value="'.$childNode['product_id'].'"> '.$new_number.$pro_name.'</label>
				</li>';
			...
			else
			{
				...
				echo '<li><label><input type="checkbox" id="'. $childNode['product_id'].'" parent-id="'. $parent_id.'" class="jtree_child_checkbox" name="sp_part[]" value="'.$childNode['product_id'].'"> '.$new_number.$pro_name.'</label></li>';
