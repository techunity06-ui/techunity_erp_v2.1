...
<html lang="en">
	...
	<body >
						...
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading">
									<h3 style="float:left;"><?=$form?></h3></br></br>
								</header>	
								<div class="">
									<ul class="breadcrumb">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12">
												...
												<div class="form-group" style="margin-top:20px;">
													...
													<div class="col-md-8">
														<div class="input-group date form_datetime-component">
															<input id="report_date" name="report_date" type="text" class="form-control default-date-picker required valid" title="Date" value="<?=$date;?>" placeholder="Report Date">
														</div>
													</div>
												</div>	
											</div>
											<div class="col-md-1">
												<div class="form-group" style="margin-top:20px;">
													<button class="btn btn-warning btn-flat" onClick="report_ledger();" >Preview Report</button>	
												</div>
											</div>
										</div>
		...
		<script src="<?=ROOT?>js/app/report_store_accept.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
