<?php 
	...
	$form="Frequent Complaint Report";
...
<html lang="en">
<head>
<title>FREQUENT COMPLAINT</title>
									  ...
									  <div class="col-md-3">
										<div class="input-group date form_datetime-component">
											 ...
											 <input type="hidden" id="to_date"  value="<?=date('t-m-Y')?>">
												<input type="text" id="rep_date"  onChange="generate_report_frequent();" class="form-control datepikerdemo" value="">
