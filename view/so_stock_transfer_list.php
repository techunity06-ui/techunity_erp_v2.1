...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li ><a href="<?=ROOT.'stock_transfer_list'?>">Stock Transfer List</a></li>
									</ul>
								</div>
							</section>
						</div>
								...
								<header class="panel-heading">
									...
									<?php if(in_array(INVENTORY_STOCK_TRANSFER_LIST_SLUG_CREATE,$bulkAccessArray)){ ?>		
										<span class="tools pull-right">
											<a href="<?=ROOT.'stock_transfer'?>" ><button class="btn btn-success btn-flat" >Stock Transfer</button></a>					
										</span>
									<?php } ?>
		...
		<script src="js/app/so_stock_transfer.js"></script>
		<script>
