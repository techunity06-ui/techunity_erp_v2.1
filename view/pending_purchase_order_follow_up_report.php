...
$form="Pending Purchase Order Follow Up Report";

$bulkAccessArray = canCheckPermissionAccess($dbcon, [
        PENDING_PURCHASE_ORDER_FOLLOWUP_REPORT_VIEW
]);
if(!in_array(PENDING_PURCHASE_ORDER_FOLLOWUP_REPORT_VIEW,$bulkAccessArray)){
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
										...
										<center>
											<?php if(in_array(PENDING_PURCHASE_ORDER_FOLLOWUP_REPORT_VIEW,$bulkAccessArray)){ ?>
											<button id="preview" class="btn btn-success" onclick="generate_follow_up_report()" style="margin-top: 20px">Preview</button>
											<?php } ?>
										</center>
