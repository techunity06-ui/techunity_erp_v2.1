<?php 
	...
	$stock_type=$dbcon->real_escape_string($_REQUEST['stock_type']);
...
<body>
  <section id="container" >
				  ...
				  <section class="panel">
					...
					<div class="">
						<ul class="breadcrumb">
							...
							<li ><a href="<?=ROOT.'product_ledger'?>"><?=$form?></a></li>
						</ul>
					</div>
				  </section>
				  <!--breadcrumbs end -->
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				...
				<div class="panel-body">
					<div class="row">
							<div class="col-md-12">
								<input type="hidden" name="prosel" id="prosel" value="<?=$product_id?>" />
							...
							<div class="col-md-4" >
								 ...
								 <!-- <select  class="select2" name="prod_id" id="prod_id" onChange="reload_data();">
									<?=get_product($dbcon,$product_id,$inventory_pro_type)?>
								</select>  -->
   ...
   <script src="<?=ROOT?>js/app/product_ledger.js?<?=time()?>"></script>
