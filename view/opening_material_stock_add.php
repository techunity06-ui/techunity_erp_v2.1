									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-6 col-xs-11">
													<input id="stock_date" name="stock_date" type="text" class="form-control default-date-picker required valid" title="Date" value="<?php if($mode=='Add'){echo $date;}else if($mode=='Edit'){echo date('d-m-Y',strtotime($rel['stock_date']));}?>" placeholder="Invoice Date">
												</div>
											</div>	
										</div>
										 <div class="col-md-4">
