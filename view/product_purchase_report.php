<?php 
	...
	$form="Partywise Purchase Report";
?>
...
<body>
  <section id="container" >
						...
						<h3 style="float:left;"><?=$form?></h3>
						 <?php include_once('../include/reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><a href="<?=ROOT.'product_sale_report'?>"><?=$form?></a></li>
						  </ul>
						 </div>
					</section>
				  <!--breadcrumbs end -->
							...
							<div class="form-group" style="margin-top:20px;">
								 <div id="cat">
                                  ...
                                  <div class="col-md-8">
									...
									{	
									echo '<option value="'.$rel['product_id'].'">'.$rel['product_name'].'</option>';
									}
									?>	
									</select>
							      </div>
   ...
   <script src="<?=ROOT?>js/app/product_purchase_report.js?<?=time()?>"></script>
