...
<html lang="en">
                                 ...
                                 <div class="col-md-12 margin_row" style="margin-top:25px !important;">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="text" class="form-control" name="product_base_qty" id="product_base_qty" value="<?php if($mode=='Clone'){ echo $rel['product_base_qty'];  } else { ?> 1 <?php } ?>" required  <?=$readonly?> />
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group">
                                          <label for="Product Type" class="col-md-4 control-label">Qty</label>
                                          <div class="col-md-8 col-xs-11">
                                             <input type="text" class="form-control" name="product_conv_qty" id="product_conv_qty" value="<?php if($mode=='Clone'){ echo $rel['product_conv_qty'];  } else { ?> 1 <?php } ?>" required  <?=$readonly?> />
                                          </div>
                                       </div>
                                    </div>
                     ...
                     <div class="col-md-12 margin_row">
                        <table class="table table-bordered">
                           ...
                           <td>
                              ...
                              <td>
                                 <input type="text" class="form-control" name="tolerance_plus" id="tolerance_plus" onkeyup="check_param_tolerance(this.value)" />
                              </td>
                              <td>
                                 <input type="text" class="form-control" name="tolerance_minus" id="tolerance_minus" onkeyup="check_param_tolerance(this.value)" />
                              </td>
                              <td>
 ...
 <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="text" name="weight" min="0" id="weight" class="form-control" placeholder="Weight" value="<?=$mode=='Clone'?$rel['weight']:''?>"  />
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-12 margin_row">
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="number" name="product_opening" min="0" id="product_opening" class="form-control" placeholder="Opening Stock" value="<?=$mode=='Clone'?$rel['product_opening']:0?>" required readonly />
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="number" name="product_min_stock" min="0" id="product_min_stock" class="form-control" placeholder="Minimum Stock" value="<?=$mode=='Clone'?$rel['product_min_stock']:''?>" required />
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="number" name="product_max_stock" min="0" id="product_max_stock" class="form-control" placeholder="Minimum Stock" value="<?=$mode=='Clone'?$rel['product_max_stock']:''?>" required />
                                          </div>
                                       </div>
                                    </div>
                                 </div>
 					 ...
 					 <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="number" name="product_min_order" min="0" id="product_min_order" class="form-control" placeholder="Minimum Order" value="<?=$mode=='Clone'?$rel['product_min_order']:''?>" required />
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="number" name="product_max_order" min="0" id="product_max_order" class="form-control" placeholder="Maximum Order" value="<?=$mode=='Clone'?$rel['product_max_order']:''?>" required />
                                          </div>
                                       </div>
                                    </div>
 					 			  <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="text" name="reorder_qty" min="0" id="reorder_qty" class="form-control" placeholder="Reorder Quantity" value="<?=$mode=='Clone'?$rel['reorder_qty']:''?>"  />
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="number" name="self_life_days" min="0" id="self_life_days" class="form-control" placeholder="Self Life Days" value="<?=$mode=='Clone'?$rel['self_life_days']:''?>"  />
                                          </div>
                                       </div>
                                    </div>
									<div class="col-md-4">
									   <div class="form-group">
									      ...
									      <div class="col-md-8 col-xs-11">
									         <input type="number" name="warrenty_period" min="0" id="warrenty_period" class="form-control" placeholder="Warrenty Period" value="<?=$mode=='Clone'?$rel['warrenty_period']:''?>"  />
									      </div>
									   </div>
									</div>
						...
						<div class="col-md-12 margin_row">                                  
                                    ...
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="text" name="model_no" min="0" id="model_no" class="form-control" placeholder="Model No" value="<?=$mode=='Clone'?$rel['model_no']:''?>"  />
                                          </div>
                                       </div>
                                    </div>
                                     <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          <label for="is_grn" class="col-md-4 control-label">Item Code Generation...</label>
                                          <div class="col-md-8 col-xs-11">
                                             <select class="select2" id="item_code_generate" name="item_code_generate" >
                                             <?php echo get_common_boolean_value($dbcon,$rel['item_code_generate']); ?>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
							  ...
							  <div class="col-md-12 margin_row">
							       <div class="col-md-4">
                                       <div class="form-group">
                                          <label for="is_grn" class="col-md-4 control-label">Common Item Master for Different Comapnies ?</label>
                                          <div class="col-md-8 col-xs-11">
                                             <select class="select2" id="common_item_diff_company" name="common_item_diff_company" >
                                             <?php echo get_common_boolean_value($dbcon,$rel['common_item_diff_company']); ?>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          <label for="is_grn" class="col-md-4 control-label">Party Code Generations...</label>
                                          <div class="col-md-8 col-xs-11">
                                             <select class="select2" id="party_code_generate" name="party_code_generate" >
                                             <?php echo get_common_boolean_value($dbcon,$rel['party_code_generate']); ?>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          <label for="is_grn" class="col-md-4 control-label">Enable Multiple Make in Item Master?</label>
                                          <div class="col-md-8 col-xs-11">
                                             <select class="select2" id="multiple_make_item_master" name="multiple_make_item_master" >
                                             <?php echo get_common_boolean_value($dbcon,$rel['multiple_make_item_master']); ?>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
 ...
 <div class="col-md-12 margin_row">
                                  <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 show_hide_fields">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                          <input id="item_status_date" name="item_status_date" type="text" class="form-control default-date-picker required valid" title="Item Date" placeholder="Item Date" value="<?=$mode=='Clone'?$rel['item_status_date']:''?>" placeholder="Item Status Date" >
                                          </div>
                                       </div>
                                    </div>                                    
                                    <div class="col-md-4 show_hide_fields" >
					         ...
					         <table class="table table-bordered">
                              ...
                              <td class="processRate_label_manage">
                                 <input type="number" class="form-control" name="process_rate" id="process_rate" />
					               ...
					               <td>
					                  <input type="number" class="form-control" name="process_loss" id="process_loss" onkeyup="check_process_loss(this.value)" />
					               </td>
                              <td>
                                 <input type="number" class="form-control" name="process_scrap_tolerance_plus" id="process_scrap_tolerance_plus" onkeyup="check_scrap_tolerance(this.value)" />
                              </td>
                              <td>
                                 <input type="number" class="form-control" name="process_scrap_tolerance_minus" id="process_scrap_tolerance_minus" onkeyup="check_scrap_tolerance(this.value)" />
                              </td>
                        ...
                        <table class="table table-bordered" style="margin-right: auto;margin-left: auto;width: 80%">
                           ...
                           <tr>
                              ...
                              <td>
                                 ...
                                 <br><br>
                                 <input type="text" class="form-control" name="make_value" id="make_value" onkeypress=""  />
                              </td>
                              <td>
            ...
            <a href="<?=ROOT.'product_list'?>" type="button" class="btn btn-danger">Cancel</a><div class="col-md-3"></div>
            </div>
            </div>
            </form>
            </section>
