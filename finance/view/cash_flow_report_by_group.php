<?php 
	...
	$form="CASH FLOW Report";
	$userid=$_SESSION['user_id'];
	$id=isset($_GET['id'])?$_GET['id']:'0';
	
	$sel1=$dbcon->query("select g_name from tbl_group where g_id='$id'");
...
<body onload="">
  <section id="container" >
					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once($include.'reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <?php if(!empty($id)){ ?>
							  <li><a href="<?=ROOT.FINANCE_ROOT ?>cash_flow_report">CashFlow Report By Month</a></li>
							  <?php } ?>
							  <li ><?=$form ?></li>					  
						  </ul>
						 </div>
			...
			<div class="col-sm-12">
				...
				<div class="panel-body">
					<div class="row">
							...
							<input type="hidden" name="monthyear" id="monthyear" value="<?php echo $id ?>" />
						
						</div>
					
					<div class="adv-table" id="adv-table" style="margin-top:5px; padding-left: 20px;">
				  <div class="col-md-6">		
						<table class="table table-responsive table-bordered table-stripped" id="cashinflow_group" style="width: 600px; ">
						
						</table>
					</div>
					<div class="col-md-6">		
						<table class="table table-responsive table-bordered table-stripped" id="cashoutflow_group" style="width: 600px; ">
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/cash_flow.js?<?=time()?>"></script>
