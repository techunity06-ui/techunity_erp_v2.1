<?php 
    ...
    $bulkAccessArray = canCheckPermissionAccess($dbcon, [
		...
		$stateid='1';
		$cityid='1';
		if(strpos($_SERVER['REQUEST_URI'], "credit_note_without_itm_edit")==true)
		{
      ...
      if(!$rel){
          header("Location: ".ROOT."credit_note_without_itm_list");
      }
...
<html lang="en">
	<head>
		<title>CREDIT NOTE WITH OUT ITEM</title>
	...
	<body>
						...
						<div class="col-sm-12">
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal" role="form" id="credit_note_add" action="javascript:;" method="post" name="credit_note_add">
										<div class="row">
											<div class="col-md-12 respclear"  style="margin-top:10px;">
												<div class="col-md-6">
													<div class="form-group">
													  <label class="col-md-4 control-label">Credit Entry No </label>
												...
												<div class="col-md-6">  	
													 <div class="form-group">  	
													  <label class="col-md-4 control-label" >Credit Entry date </label>
                                                    ...
                                                    <div class="col-md-5">							
														<div class="form-group">
															...
															<div class="col-md-7 col-xs-11">
																<select class="select2" name="gst_nature" id="gst_nature" onchange="showHideLink(this.value);get_debit_credit_note_popup(this.value);get_data_description(this.value);">
																	<?php echo get_common_category($dbcon, 33,'GST Nature',$rel['gst_nature']); ?>
																</select>							
																<a href="#" style="display: none;" onclick="return get_debit_credit_note_popup(100)" id="checkCreditLink" >Check Credit Note</a>
																<a href="#" style="display: none;" onclick="return get_debit_credit_note_popup(86)" id="checkDebitLink" >Check Debit Note</a>
															</div>
															<div class="col-md-1">
													...
													<div class="col-md-5">
														<div class="form-group">
														  <label class="col-md-5 control-label">Currency Converter *</label>
															<div class="col-md-4 col-xs-11">													
																<input id="currency_enable" name="currency_enable" type="checkbox" class="" title="" value="1" style="width:20%;height:25px;" onChange="currency_change();">
															</div>
														 </div>
													</div>				
													...
													<div class="col-md-5 currency_div" style="display:none">
														<div class="form-group">
														  <label class="col-md-5 control-label">Currency Rate *</label>
															<div class="col-md-7 col-xs-11">
																<input id="currency_rate" name="currency_rate" type="text" class="form-control valid numbersOnly" title="" value="" placeholder="">
															</div>
														</div>	
													</div>
												</div>
											...
											<div class="col-md-12">
												<center>
													...
													<a href="<?=ROOT.FINANCE_ROOT.'credit_note_without_itm_list'?>" type="button" class="btn btn-danger">Cancel</a>
												</center>
											</div>
										</div>
										...
										<input type="hidden" name="entry_type_id" id="entry_type_id" value="1" placeholder="0-JV,1-CR,2-DR"/>
										...
										<input type="hidden" name="cr_dr_entry_type" id="cr_dr_entry_type" value="1" placeholder="0-JV,1-CR,2-DR">
									</form>
								</div>
							</section>
						</div>
		...
		<script src="<?=ROOT.FINANCE_ROOT?>js/app/credit_note_without_itm.js"></script>
	...
	/* Added By Jayesh 30-07-2021 For tab and enter key */   
		...
		if($mode=="Edit")
		{
			...
			if($rel['gst_nature'] == 100 || $rel['gst_nature'] == 86){
	    	echo "<script>
