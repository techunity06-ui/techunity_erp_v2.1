...
<body onload="report_ledger_detail();load_ledger();">
					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once($include.'reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <li ><?=$form." For <strong style='color:red'>".$row1['g_name']."</strong>"; ?></li>
					...
					<div class="row">
                     ...
                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
										 <input type="hidden" id="to_date"  value="<?=$end_date?>">
         					 		        <input type="text" id="rep_date"  onChange="report_ledger_detail();" class="form-control datepikerdemo" value="">
							...
							<div class="col-md-6" >
								<div class="form-group" style="margin-top:20px;">
									...
									<div class="col-md-8 col-xs-11">
										<select class="select2" name="showledger_id" id="showledger_id" onChange="report_ledger_detail();" >
												<?= get_ledger($dbcon,'',''); ?>
										</select>
									</div>
								</div>
