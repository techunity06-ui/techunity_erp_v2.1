...
<body onload="">
  <section id="container" >
		  ...
		  <div class="row">			
			<div class="col-sm-12">
				...
				<div class="panel-body">
					...
					<div class="adv-table" id="adv-table" style="margin-top:80px; padding-left: 20px;">
				  		
						<table class="table table-responsive table-bordered table-stripped" id="all_tcs" style="width: 1300px; ">
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/tcs_report.js?<?=time()?>"></script>
