...
<body onload="">
  <section id="container" >
                    ...
                    <div class="row">
                     ...
                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
                                         <input type="hidden" id="to_date"  value="<?=$end_date?>">
                                            <input type="text" id="rep_date"  onChange="report_bill_sale();" class="form-control datepikerdemo" value="">
                           ...
                           <div class="col-md-6">
                                <div class="form-group" style="margin-top:20px;">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group date form_datetime-component">
                                            <select class="select2" name="cust_id" id="cust_id" tabindex="2" onChange="report_bill_sale();">
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/report_bill_sale.js?<?=time()?>"></script>
