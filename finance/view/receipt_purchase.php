<?php 
	...
	$invoiceid=$dbcon->real_escape_string($_REQUEST['id']);
        $query="select receipt_id,receipt_no,total_paid_amount, rec.company_id,receipt_date, cust.l_name as company_name,cust.m_address as cust_address, pay.common_mst_name as payment_mode, rec.cheque_dtl from tbl_receipt as rec 
					  ...
					  <header class="panel-heading">
						  ...
						  <ul class="breadcrumb">
							  ...
							  if($_REQUEST['report']=='report')
								{?>
							  <li><a href="<?=ROOT.FINANCE_ROOT.'payment_list'?>">Party Wise Payment Report</a></li>
							<?php }
				  ...
				  <header class="panel-heading">
					  New <?=$form?>
						...
						<div class="panel-body">
							...
							{?>
							<a href="<?=ROOT.FINANCE_ROOT.'payment_list'?>" type="button" class="btn btn-success">Cancel</a>
							<?php }
							else if($_REQUEST['report']=='0')
							{
							?>
