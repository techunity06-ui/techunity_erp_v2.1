...
<html lang="en">
<head>
<title>Bill TO Bill Purchase</title>
...
<body onload="">
  <section id="container" >
                      ...
                      <header class="panel-heading">
                         ...
                         <?php include_once($include.'reporthead_menu.php');?>
                          ...
                          <ul class="breadcrumb">
                              ...
                              <li><a href="<?=ROOT.FINANCE_ROOT.'bill_to_bill_sale'?>">Bill To Bill Sale</a></li>
                    ...
                    <div class="row">
                     ...
                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
                                         <input type="hidden" id="to_date"  value="<?=$end_date?>">
                                            <input type="text" id="rep_date"  onChange="report_bill_purchase();" class="form-control datepikerdemo" value="">
                           ...
                           <div class="col-md-6">
                                <div class="form-group" style="margin-top:20px;">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group date form_datetime-component">
                                            <select class="select2" name="vender_id" id="vender_id" title="Select Vender"  onChange="report_bill_purchase();" >
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/report_bill_purchase.js?<?=time()?>"></script>
