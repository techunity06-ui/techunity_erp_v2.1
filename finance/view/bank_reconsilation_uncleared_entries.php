<?php 
	...
	$form="Bank Reconsilation UnCleared Entries";
				...
				<div class="panel-body">
									 ...
									 <?
									  ...
									  ?>
										 ...
										 <input type="hidden" id="to_date"  value="<?=date('t-m-Y')?>">
         					 		        <input type="text" id="rep_date"  onChange="bank_reco_uncleared_entries_report();" class="form-control datepikerdemo" value="">
					...
					<div class="adv-table" id="adv-table" style="margin-top:120px;">
						...
						<table class="table table-bordered table-stripped">
							...
							<tbody id="data_table_for_uncleared">	
							</tbody>
						</table>
				  	</div>
				  	</div>
