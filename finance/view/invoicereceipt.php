														...
														<th colspan="11" style="padding:0px !important;">
															<table style="font-size:10px;border-collapse: collapse;border-top:none !important;" cellpadding="0" cellspacing="0" width="100%" >
																...
																<tr>
																	...
																	<td width="38%" style="vertical-align:top;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">: <?=$rel['trans_name']?>						
																	</td>							
																</tr>
																<tr>
												...
												<tbody style="border: none;">
															...
															<td class="borderleftadd" colspan="11" style="padding: 0px !important;border:1px solid">
																...
																<table class="footer-table" width="100%">
																	...
																	<tr  height="20px">
																		...
																		<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; "></td>
													...
													if($rel['stateid']==$set_head['stateid']){
															...
															<tr height="20px">
																		...
																		<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; "><?=number_format(($total_cs_gst/2),2,".","")?></td>
																</tr>
																<tr height="20px">
																		<td  style="border-right:1px solid;border-top:1px solid; font-size:10px;" colspan="5">
																		</td>
														...
														<tr height="20px">
																	...
																	<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; "><?=number_format($total_i_gst,2,".","")?></td>
															</tr>
											...
											<?php		}
													...
													{ ?>
																	...
																	<tr height="20px">
																			...
																			<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; "><?=number_format($row11['add_sum'],2,".","")?></td>
																	</tr>
...
where b.sundry_voucher_id=".$rel['invoice_id']." and b.sundry_voucher_table='tbl_invoice' and b.isdelete='0' and le.default_sundry='0'";
													...
													{ ?>
																	...
																	<tr height="20px">
																			...
																			<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; "><?=number_format($row12['sundry_amount'],2,".","")?></td>
																	</tr>
													...
													<?php } ?>
																...
																<?php 
																 ...
																 $r=round($total)-$total; ?>
																<?php if($rel['formulaid']){                                                                                                                                             $tax_on_total = get_tax_on_total ($dbcon, $total, $rel['formulaid']);                                                                                                  ?>                                                                                   <!--<tr height="20px">                                                                             <td class="borderleftadd" style="border-right:1px solid;border-top:1px solid;font-size:10px;" colspan="<?=$colspan?>">                                                                                                          </td>                                                                                                                                                <td colspan="3" style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left  !important">Sub Total</td>                                                                                                                                            <td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; "><?=number_format($total,2,".","")?></td>                                                                                                                                        </tr>-->                                                                                                           <tr height="20px">                                                            <td class="borderleftadd" style="border-right:1px solid;border-top:1px solid;font-size:10px;" colspan="<?=$colspan?>">                                       </td>                                                                                                                                              <td colspan="3" style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left  !important">Add : <?= $tax_on_total['tax_name'] ?></td>                                                                                                                                                <td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; "><?=number_format($tax_on_total['tax_value'],2,".","")?></td>                                        </tr>                                    <?php                                    $total = $total + $tax_on_total['tax_value'];                                                                                                                                     } ?>
																	<tr height="20px">
																	...
																	<tr height="20px">
																		<td style="border-right:1px solid;border-top:1px solid;font-size:10px;" colspan="<?=$colspan?>">
																			...
																			<?=ucwords(convert_number_to_words($rel['total']))?>
																		</td>
																		<td colspan="3" style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left  !important">
																			<strong>Grand Total</strong> :
																		</td>
																		<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; ">
