...
//				include_once('../include/quick_link.php');
	 ...
	 <button class="btn btn-warning btn-flat" onClick="PrintMe('adv-table');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>											
				...
				<div class="panel-body">
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
								  <div class="input-group date form_datetime-component">
									 ...
									 <input type="hidden" id="from_date"  value="<?=$financial_year['financial_start_date'];?>">
									 <input type="hidden" id="to_date"  value="<?=$financial_year['financial_end_date'];?>">
						...
						<div class="adv-table" id="pdc-regularized-table">
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/pdc_report.js?<?=time()?>"></script>
