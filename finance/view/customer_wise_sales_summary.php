...
$form="Customer wise Sales Summary Report";
...
<body>
	...
	<!--customer_wise_sales_summary js placed at the end of the document so the pages load faster -->
	<?php include_once($include.'/include_js_file.php');?>   

	<script src="<?=ROOT?>js/app/complaint.js?<?=time()?>"></script>
	<script src="<?=ROOT.FINANCE_ROOT?>js/app/customerwisesalessummary.js?<?=time()?>"></script>
