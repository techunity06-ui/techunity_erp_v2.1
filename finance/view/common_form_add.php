...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
			...
			<div class="col-md-12">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select class="form-control" name="bill_method_id" id="bill_method_id" tabindex="1">
							<option value="">--Select Method--</option>
							<option value="1">New Ref.</option>
							<option value="2">Append</option>
						</select>
						<strong id="billmethod_error_id" class="common_form_error"></strong>
					</div>	
				</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						<label for="edit_zone_name">Amount.</label>
						<input type="number" min="0" class="form-control" name="bill_amt" id="bill_amt" />
		...
		<div class="row margin_row">
			<div class="col-md-3">
				<div class="form-group">
					...
					<input type="text" class="form-control default-date-picker" name="bill_due_date" id="bill_due_date" value="<?=date("d-m-Y");?>" />
				</div>	
			</div>
		...
		<div class="row margin_row">
			<div class="col-md-12 ">
				<div class="col-md-3">
					<input type="button" id="add_bill_adjustment_btn" value="Add"  class="btn btn-primary" onclick="add_bill_adjustment()"  tabindex="" />
				</div>
			</div>
