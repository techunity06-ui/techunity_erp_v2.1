...
<body onload="report_ledger()">
						...
						<section class="panel">
							...
							<div class="">
								<ul class="breadcrumb">
									...
									<li ><a href="<?=ROOT.FINANCE_ROOT.'report_sales_card'?>"><?=$form?></a></li>
										...
										<div class="col-md-6" >
											<div class="form-group" style="margin-top:20px;">
												...
												<div class="col-md-8 col-xs-11">
													<select class="select2" name="elcon_sales_id" id="elcon_sales_id" onChange="report_elcon_sales_card();" >
														<?=get_elcon_sales_card($dbcon,'');?>	
	...
	<script src="<?=ROOT.FINANCE_ROOT?>js/app/report_sales_card.js?<?=time()?>"></script>
