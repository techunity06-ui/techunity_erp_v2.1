<?php 
	...
	//echo $usertype;
	$cost_center_details=get_table_details_option($dbcon,'tbl_cost_center','cost_center_id','cost_center_name',' and isdelete=0');
...
<body onload="bank_reco_all_entries_report()">
  <section id="container" >
				...
				<div class="panel-body">
					<div class="row">
	                  ...
	                  <div class="col-md-5">
	                     ...
	                     <input type="hidden" id="from_date"  value="<?=$start?>">
	         					 	 ...
	         					 	 <input type="text" id="rep_date"  onChange="" class="form-control datepikerdemo" value="">
							...
							<div class="col-md-6" >
								<div class="form-group" style="margin-top:20px;">
									...
									<div class="col-md-8 col-xs-11">
										<select class="select2" name="g_id" id="g_id" onChange="cost_center_report(this.value);" >
					...
					<div class="adv-table" id="adv-table" style="margin-top:120px;">
						...
						<table class="table table-bordered table-stripped">
							...
							<tbody id="costcenter_data_table">
   ...
   <script src="<?=ROOT.FINANCE_ROOT ?>js/app/cost_center_report.js?<?=time()?>"></script>
