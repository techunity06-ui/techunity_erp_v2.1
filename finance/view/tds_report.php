...
<body onload="">
  <section id="container" >
			...
			<div class="col-sm-12">
				...
				<div class="panel-body">
					...
					<div class="row">
									...
									<div class="col-md-6">
				                     ...
				                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
														 <input type="hidden" id="to_date"  value="<?=$end_date?>">
				         					 		        <input type="text" id="rep_date"  onChange="load_all_ledger();" class="form-control datepikerdemo" value="">
	                    ...
	                    <div class="col-md-8">
	                      <select class="form-control" id="tds_cat" onChange="load_all_ledger();" >
	                      	<?=get_all_tds_cat_ledger($dbcon);?>
	                      </select>	
	                    </div>
					...
					<div class="adv-table table-responsive" id="adv-table" style="margin-top:80px; padding-left: 20px;">
				  		
						<table class="table table-bordered table-stripped" id="all_ledger" style="width: 1300px; ">
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/tds_report.js?<?=time()?>"></script>
