<?php 
	...
	$form="Bank Reconsilation Cleared Entries";
				...
				<div class="panel-body">
									 ...
									 <?php 
									  ...
									  ?>
										 ...
										 <input type="hidden" id="to_date"  value="<?=date('t-m-Y')?>">
         					 		        <input type="text" id="rep_date"  onChange="bank_reco_cleared_entries_report();" class="form-control datepikerdemo" value="">
					...
					<div class="adv-table" id="adv-table" style="margin-top:120px;">
						...
						<table class="table table-bordered table-stripped">
							...
							<tbody id="data_table_for_cleared">
