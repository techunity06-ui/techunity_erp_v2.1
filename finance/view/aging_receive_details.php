...
<body onload="">
  <section id="container" >
                      ...
                      <header class="panel-heading">
                         ...
                         <?php include_once($include.'reporthead_menu.php');?>
                          ...
                          <ul class="breadcrumb">
                              ...
                              <li><a href="<?=ROOT.FINANCE_ROOT.'aging_receivable'?>">Aging Receivable</a></li>
                    ...
                    <div class="row">
                     ...
                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
                                         <input type="hidden" id="to_date"  value="<?=$end_date?>">
                                            <input type="text" id="rep_date"  onChange="report_aging_receivable();" class="form-control datepikerdemo" value="">
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/aging_report_receieve.js?<?=time()?>"></script>
