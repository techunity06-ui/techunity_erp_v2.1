...
<body>
						...
						<section class="panel">
							...
							<div class="">
								<ul class="breadcrumb">
									...
									<li><a href="<?= ROOT . FINANCE_ROOT . 'gstr_invoice_report.php' ?>"><?= $form ?></a></li>
								</ul>
							</div>
						</section>
						<!--breadcrumbs end -->
						...
						<section class="panel">
							...
							<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-7">
											<div class="input-group date form_datetime-component">
												...
												<input type="text" id="rep_date" onChange="load_gstr_invoice_datatable();" class="form-control datepikerdemo" value="">
								...
								<span class="tools pull-right">
									<a href="javascript:;" onClick="exportCsv()"><button class="btn btn-success btn-flat">Export Excel</button></a>
								</span>
								<!-- <span class="tools pull-right">
							...
							<div class="panel-body">
								...
								<div class="adv-table">
									<table class="display table table-bordered table-striped" id="gstr-invoice-report-table">
										<thead>
											<tr>
												<th>#</th>
												...
												<th>Invoice Date</th>
												<th>Invoice Value</th>
												<th>Invoice HSN/SAC</th>
												<th>Goods/Service</th>
												<th>Taxanble Value</th>
												<th>QTY</th>
												<th>UNIT</th>
												<th>IGST Rate</th>
												<th>IGST Amt</th>
	...
	<script src="<?= ROOT . FINANCE_ROOT ?>js/app/gstr_invoice_report.js?<?= time() ?>"></script>
