<?php 
	...
	$form="Trial Balance Sheet Report By Group";
...
<html lang="en">
<head>
<title>Trial Balance Sheet By Group</title>
...
<body onload="">
					...
					<div class="row">
                     ...
                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
										 <input type="hidden" id="to_date"  value="<?=$end_date?>">
         					 		        <input type="text" id="rep_date"  onChange="load_all_ledger_group();" class="form-control datepikerdemo" value="">
							...
							<input type="hidden" name="r_mode" id="r_mode" value="group_report" />
						</div>
					
					<div class="adv-table" id="adv-table" style="margin-top:80px;">
				  	
				  	<strong>Note : Press Shift + v to see detail view</strong>
						<table class="table table-responsive table-bordered table-stripped" id="all_ledger">
  ...
  <script src="<?=ROOT?>js/mousetrap/mousetrap-bind-dictionary.min.js"></script>
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/trial_balance_sheet.js?<?=time()?>"></script>
