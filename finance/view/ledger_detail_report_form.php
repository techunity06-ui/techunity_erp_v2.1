...
<body onload="report_ledger_form()">
					  ...
					  <header class="panel-heading">
						 ...
						 <?php include_once($include.'reporthead_menu.php');?>
						  ...
						  <ul class="breadcrumb">
							  ...
							  <?php if($_POST['report_type'] == 'trial_blc_sht_ledger'){ ?>
							  	<li><a href="<?=ROOT.FINANCE_ROOT.'trial_balance_sheet'?>"> Trial Balance Sheet</a></li>
							  <?php }else if($_POST['report_type'] == 'all_ledger'){ ?>
							  <li><a href="<?=ROOT.FINANCE_ROOT.'all_ledger_report'?>"> Ledger List</a></li>
							  <?php } if($_POST['report_type'] != 'all_ledger' && $_POST['report_type'] != 'trial_blc_sht_ledger'){ ?>
							  <li><a href="<?=ROOT.FINANCE_ROOT.'report_ledger'?>"> Group List</a></li>
							  <li><a href="<?=ROOT.FINANCE_ROOT.'ledger_detail/'.$row1['l_group'];?>"> <?=$row1['g_name']?></a></li>
							<?php } ?>
							  <li ><?=$form." For <strong style='color:red'>".$row1['l_name']."</strong>"; ?></li>
					...
					<div class="row">
                     ...
                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
										 <input type="hidden" id="to_date"  value="<?=$end_date?>">
         					 		        <input type="text" id="rep_date"  onChange="report_ledger_form();" class="form-control datepikerdemo" value="">
