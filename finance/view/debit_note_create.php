										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="col-md-8 col-xs-11">
														<input type="text" class="form-control default-date-picker" name="debitnote_date" id="debitnote_date" value="<?php if($mode=='Add'){ echo date("d-m-Y");}else if($mode=='Edit'){ if($rel['debitnote_date']=='0000-00-00'){ echo ""; } else { echo date('d-m-Y',strtotime($rel['debitnote_date']));} } ?>" tabindex="6" />
													</div>
												</div>
											</div>
											 ...
											 <div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="col-md-5 col-xs-11">
														<input id="total" name="total" type="text" readonly="readonly" class="form-control" title="Grand Total" max="0"  value="<?php if($mode=="Add"){echo '0';}else if($mode=='Edit'){ echo $rel['basic_total'];}?>" placeholder="total">
													</div>
												</div>	
