                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <select class="select2" id="product_type" name="product_type" onchange="pro_status(this.value);get_product_code(this.value);">
                                                ...
                                                <option value="9" <?php if($mode=='Edit'){ if($rel['product_type']=='9'){ echo "selected"; } } ?>>SCRAP</option>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-md-12 margin_row" style="margin-top:25px !important;">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-8 col-xs-11">
                                             <input type="text" class="form-control" name="product_base_qty" id="product_base_qty" value="<?php if($mode=='Edit'){ echo $rel['product_base_qty'];  } else { ?> 1 <?php } ?>" required  <?=$readonly?> />
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                       <div class="form-group">
                                          <label for="Product Type" class="col-md-4 control-label">Qty</label>
                                          <div class="col-md-8 col-xs-11">
                                             <input type="text" class="form-control" name="product_conv_qty" id="product_conv_qty" value="<?php if($mode=='Edit'){ echo $rel['product_conv_qty'];  } else { ?> 1 <?php } ?>" required  <?=$readonly?> />
                                          </div>
                                       </div>
                                    </div>
					...
					<div class="tab-pane" id="tsetting" >
					   ...
					   <div class="row" style="margin-left:20px;">
					      <div class="col-md-4 margin_row">
					         ...
					         <input type="checkbox"  name="product_setting_check[]" id="product_setting_check"  value="process_product" class="product_process process_on_procduct" <?php if($mode=='Edit'){ if(in_array("process_product",$check_array_setting)) { echo "checked"; } } ?> onclick="return false;">
					         <span class="checkmark"></span>
					         </label>
					      </div>
					      <div class="col-md-4 margin_row">
                        <label class="container"><span class="margin_span">QC For Product</span>
                        <input type="checkbox"  name="product_setting_check[]" id="product_setting_check"  value="product_qc" class="product_process qc_on_procduct" <?php if($mode=='Edit'){ if(in_array("product_qc",$check_array_setting)) { echo "checked"; } } ?> onclick="return false;" >
                        <span class="checkmark"></span>
                        </label>
                     </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <input type="checkbox"  name="enable_stockbalance" id="enable_stockbalance"  <?php if($rel['enable_stockbalance']=="1"){ echo "checked"; }  ?>>
                        <span class="checkmark"></span>
                        </label>
                     </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <input type="checkbox"  name="enable_negative_stock" id="enable_negative_stock" <?php if($rel['enable_negative_stock']=="1"){ echo "checked"; }  ?>>
                        <span class="checkmark"></span>
                        </label>
                     </div>                    
					   </div>
