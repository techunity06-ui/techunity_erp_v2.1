...
<body>
  <section id="container" >
				    ...
				    <!--breadcrumbs start -->
                        <section class="panel">
                            <header class="panel-heading">
                                <h3>Pending Invoice Approval</h3>
                            </header>
                            <div class="">
                                <ul class="breadcrumb">
                                    <li><a href="<?=ROOT.'dashboard'?>"><i class="fa fa-home"></i> Home</a></li>
                                    <li class="active">Pending Invoice Approval</li>
                                </ul>
                            </div>
                        </section>
                    <!--breadcrumbs end -->
      ...
      <!--footer start-->
        ...
        <?php include_once($include1.'preview_invoice_approval_hist.php');?>
        <?php include_once($include1.'preview_invoice_aprv_image_modal.php');?>
      <!--footer end-->
  </section>
    <!-- js placed at the end of the document so the pages load faster -->
	<?php include_once($include.'include_js_file.php');?>   
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/unapproved_invoice.js"></script>
