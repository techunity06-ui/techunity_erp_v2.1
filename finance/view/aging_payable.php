...
<body onload="">
  <section id="container" >
                    ...
                    <div class="row">
                     ...
                     <input type="hidden" id="from_date"  value="<?=$start_date?>">
                                         <input type="hidden" id="to_date"  value="<?=$end_date?>">
                                            <input type="text" id="rep_date"  onChange="report_aging_payable();" class="form-control datepikerdemo" value="">
   ...
   <script src="<?=ROOT.FINANCE_ROOT?>js/app/aging_report_payable.js?<?=time()?>"></script>
