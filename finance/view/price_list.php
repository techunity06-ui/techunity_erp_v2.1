<?php 
 error_reporting(E_ALL);
	...
	if(!in_array(PRICE_LIST_VIEW,$bulkAccessArray)){
			...
			<div class="row">			
				<div class="col-sm-12">
					<section class="panel">
							...
							<?php if(in_array(PRICE_LIST_CREATE,$bulkAccessArray)){	?>
								<span class="tools pull-right">
									<a href="<?=ROOT.FINANCE_ROOT.'price_list_create'?>" ><button class="btn btn-success btn-flat" >Create Price List</button></a>					
								</span>
							<?php } ?>
