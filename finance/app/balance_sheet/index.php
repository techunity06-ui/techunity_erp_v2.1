...
include_once(COMMON_FUNCTION_INNER_PATH."balance_sheet_functions.php");
...
//    $start_date = date($year.'-04-01',strtotime($end_date));
   ...
   // echo '<pre>';    print_r($fixed_assets); exit;
...
//        $suspence_account_entries = get_suspence_account_entries($dbcon, $where_date);
    ...
    $str='';
    $str .= '<strong class="noprint">Note : Press Shift + v to see detail view</strong><br/>';
...
$str.='<tr height="20px">
            ...
            <td class="grand_total_l" style="text-align: right;border-top: 1px #101010 solid;border-bottom: 1px #101010 solid;border-right: 1px #101010 solid;color: #101010;"><span id="tass">'.$total_liability.'</span></td>
            <td style="border-top: 1px #101010 solid;border-bottom: 1px #101010 solid;border-left: 1px #101010 solid;color: #101010;"><strong>Total</strong></td>
           <!--<td class="grand_total_a" style="text-align: right;border-top: 1px #101010 solid;border-bottom: 1px #101010 solid;border-right: 1px #101010 solid;color: #101010;">'.$total_assets.'</td>-->
            <td class="grand_total_a" style="text-align: right;border-top: 1px #101010 solid;border-bottom: 1px #101010 solid;border-right: 1px #101010 solid;color: #101010;"><span id="tass">'.$total_assets.'</span></td>
        </tr>';
