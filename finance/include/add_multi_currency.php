					...
					<div class="form-group">
						<table cellspacing="10" style="border-spacing:10px;" id="product_list" class="display table table-bordered table-striped">
							...
							<tr id="field1">
								...
								<td style="vertical-align:top;">
									<input type="text"  title="Currency Opening Balance" placeholder="Currency Opening Balance" id="currency_opening_balance" name="currency_opening_balance" class="form-control" onkeypress="return isNumberKey(event)" onchange="validateFloatKeyPress(this);" />
								</td>
								<td style="vertical-align:top;">
								...
								<td style="vertical-align:top;">
									<input type="text"  title="Opening Balance" placeholder="Opening Balace In Rs." id="curreency_opening_balance_rs" name="curreency_opening_balance_rs" class="form-control" onkeypress="return isNumberKey(event)" onchange="validateFloatKeyPress(this);" />
								</td>
