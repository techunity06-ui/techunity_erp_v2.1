					...
					<div class="form-group">
						<table cellspacing="10" style="border-spacing:10px;" id="product_list" class="display table table-bordered table-striped">
							<tr id="field">
								...
								<th width="30%" class="text-center">Opening Balace(in Rs.)</th>
							...
							<tr id="field1">
								...
								<td style="vertical-align:top;">
									...
									<select class="select2" name="multi_branch_id" id="multi_branch_id">
										<?php echo getBranchBox_new($dbcon, $branch_id); ?>
									</select>
								...
								<td style="vertical-align:top;">
									<input type="number"  title="Opening Balance" placeholder="Opening Balace In Rs." maxlength="20" id="branch_opening_balance" name="branch_opening_balance" class="form-control" onkeypress="return isNumberKey(event)" onchange="validateFloatKeyPress(this);" />
								</td>
					...
					<div class="form-group">
						<div class="adv-table">
							<table  class="display table table-bordered table-striped" id="multi_branch_table">							
								...
								<tfoot>
									<tr><th colspan="3" style="text-align: right;">Total</th><th><span id="multibranch_total"></span><span id="multibranch_total_type"></span></th></tr>
								</tfoot>
							</table>
						</div>
					</div>
