...
function quotation_print($dbcon, $quotation_id, $save_file)
{
    ...
    if (strtolower($type) == 'pdf') {
        ...
        $header = '<table>
        <tr>
        <td style="width:70%;vertical-align:top;"><b>' . $comp_rel["company_name"] . '<br>' . $comp_rel["address"] . '<br>Mobile no : ' . $comp_rel["contact_no"] . '<br>E-mail : ' . $comp_rel["website"] . '</b></td>
        <td style="width:30%;padding:15px;"><div style="text-align:center;"><img src="' . DOMAIN_F . LOGO . $comp_rel["logo"] . '" style="width: 200px;" /></div></td>
        </tr>
        </table>';
		...
		.page{
			...
			<div>
			<div style="text-align:center;font-size:17px;padding:0;margin:0;"><strong>OFFER</strong></div>
			<table >
			<tr style="text-align:left;vertical-align:top;">
			<td rowspan="5"  style="vertical-align:top;width:69%;"><p><strong>To, <br>' . $rel['cust_name'] . '</strong><br/>
			...
			<td style="text-align:right;vertical-align:top;text-align:left;">RFQ NO.: </td>
			<td style="text-align:right;vertical-align:top;text-align:left;">' .$rel['inquiry_no'] . '</td>
		
			</tr>
			
			<tr style="text-align:left;vertical-align:top;">
			
			<td style="text-align:right;vertical-align:top;text-align:left;">RFQ DATE:</td>
			<td style="text-align:right;vertical-align:top;text-align:left;">' . date("d-M-Y", strtotime($rel['inquiry_date'])) . '</td>
		
			</tr>
			
			<tr style="text-align:left;vertical-align:top;">
			
			<td style="text-align:right;vertical-align:top;text-align:left;">OFFER NO.: </td>
			<td style="text-align:right;vertical-align:top;text-align:left;">' . $rel['quotation_no'] . '</td>
		
			</tr>
			<tr style="text-align:left;vertical-align:top;">
			
			<td style="text-align:right;vertical-align:top;text-align:left;">OFFER DATE:</td>
			<td style="text-align:right;vertical-align:top;text-align:left;">' . date("d-M-Y", strtotime($rel['quotation_date'])) . '</td>
			...
			<th style="width:50%;text-align:center;border:1px solid;">Valve Details</th>
			<th style="width:10%;text-align:center;border:1px solid;">Size</th>
			<th style="width:10%;text-align:center;border:1px solid;">Class</th>
        ...
        if ($companyConfiguration['quot_revise_time_rate_with_discount'] == 0) {
            if ($disc_qrys['discount'] > 0) {
                $html .= '<th style="width:10.5%;text-align:center;border:1px solid;">Discount <br>' . $currency_name . '</th>';
            }
        }
        $html .= '<th style="width:14.5%;text-align:center;border:1px solid;">Total Amount <br>' . $currency_name . '</th>
			</tr>
			</thead>
			<tbody>';
        if ($inquiry_type != "2") {
        ...
        $html .= '<table style="font-size:14px;border-collapse: collapse;width:100%;" cellpadding="3" cellspacing="3">
			<tr >
			<td colspan="" style="text-align:right;border-top: 1px solid; width:83%"><b>BASIC TOTAL</b></td>
        ...
        $html .= '
			...
			<td colspan="" style="text-align:right;"><b>TOTAL OFFER VALUE
			</td>
			<td style="text-align:right;"><b>
        ...
        if (mysqli_num_rows($terms_qry_rs)) {
            ...
            $html .= '<div>
				...
				<thead>
				<tr>
				<th colspan="2" style="text-align:center; border:1px solid;">Terms and Condition</th>
				</tr>
				</thead><tbody>';
            while ($term_rel = mysqli_fetch_assoc($terms_qry_rs)) {
                ...
                $html .= '<tr>
					...
					<td width="30%" style="width:25%;text-align:left;border:1px solid;padding:5px; font-weight: bold; vertical-align: top;">' . $term_rel['tc_name'] . '</td>
					<td width="70%" style="width:70%;text-align:left;border:1px solid #000;padding:5px;">' . $string . '</td>
					</tr>';
                $t++;
            }
            $html .= '<tr>
            <th colspan="2" style="text-align:center; border:1px solid;">GST NO. : '.$comp_rel['vatno'].'</th>
            </tr></tbody></table>';
        }
...
// echo $html;exit;
        ...
        $mpdf = new mPDF('', 'A4', '0', 'proximanova', '10', '10', '27', '10', '1', '1');
