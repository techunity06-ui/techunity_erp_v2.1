...
/*if($companySettings) {
	echo $companySettings['quotation_print_content'];
...
$quotation_print_content_new = '
<p><b>Subject : Budgetary Offer for Maruti '.$rel['quot_subject'].' <b><p>
<p><b> </b></p>
<p><b>Respected Sir,</b></p>

<p><b> </b></p>

<p><b>This is with reference to your email for your requirement Maruti '.$rel['quot_subject'].'.</b></p>
...
//$quotation_print_content = '<h3>Subject:-  <u>Budgetary offer for Maruti '.$rel['quot_subject'].'</u></h3><br>';

/*$quotation_print_content .= '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is with reference to your email for your requirement Maruti '.$rel['quot_subject'].'</p>
<br />
...
.page{
	...
	<br />
	'.stripslashes($quotation_print_content_new).''.stripslashes($quotation_print_content).'
	<br /><br />
	<p>Regards</p>
	...
	while($trn_rel=mysqli_fetch_assoc($trn_qry_rs)){
		...
		'.$product_desc.'<br>';
				...
				$html.='<a href="'.ROOT.'view/upload/product_images/'.$trn_rel["image_name"].'" target="_blank"><img src="'.ROOT.'view/upload/product_images/'.$trn_rel['image_name'].'" style="width: 100px;height: 100px;"></a>';
			}else{
				$html.='';
			}
				$html.='</td>
	...
	'.(($rel['quot_remark']) ? $rel['quot_remark'] : '').'</td></tr></tbody></table>';
