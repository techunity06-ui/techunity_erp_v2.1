...
<table cellpadding="5" cellspacing="5" border="0" style="font-size: 16px; font-family: calibri; border: 0;">
	<tr>
	<td rowspan="5"	 style="text-align:left;width:50%;">
<div style="text-align:center;"><img src="' . DOMAIN_F . LOGO . $comp_rel["logo"] . '" style="width:350px;border: 1px white solid" /></div>
	<h3>' . $comp_rel['company_name'] . '</h3>
	' . $comp_rel['address'] . '	
	' . $userPhone . '<br>' . $userEmail . '<br>
	PAN No. : ' . $comp_rel['pan_no'] . ' CIN No. : ' . $comp_rel['cin'] . '<br>
    GSTIN : ' . $comp_rel['vatno'] . '

	</td>
	<td colspan="2" style="width:50%;background-color: #b3b3b3;text-align: center;">
			<h3>PRO FORMA INVOICE</h3>
		</td>
	</tr> 
	<tr>
	<td  style="text-align:left;vertical-align: top;">Invoice No.</td>
	<td  style="text-align:right;vertical-align: top;">' . $rel['invoice_no'] . ' </td>
	</tr> 

	<tr>
	<td  style="text-align:left;vertical-align: top;">Date</td>
	<td  style="text-align:right;vertical-align: top;">' . date('d-m-Y', strtotime($rel['invoice_date'])) . ' </td>
	</tr> 

	<tr>
	<td  style="text-align:left;vertical-align: top;">Terms of Payment</td>
	<td  style="text-align:right;vertical-align: top;">' . $rel['payment_terms'] . ' </td>
	</tr> 

	<tr>
	<td  style="text-align:left;vertical-align: top;border-right:none;">Client ID </td>
	<td  style="text-align:right;vertical-align: top;border-left:none;">' . $rel['client_id'] . '<br><br><br><br><br><br>
	</td>
	</tr> 
    ...
    <tr>
        <td style="border: 1px solid black; vertical-align:top; border-right:0px;">To:<br>' . $rel['company_name'] . '
       <br>';
    ...
    $html .= '<br>
        Contact:  ' . $rel['cust_mobile'] . '<br>
        Email: ' . $rel['c_con_email'] . '<br>
        Dear ' . $rel['c_con_fname'] . ', 
        </td>
...
';
    ...
    <div>
    <table  style="font-size: 16px; font-family: calibri;border-collapse: collapse;width:100% !important;table-layout:fix;" >
                     <tr style="background-color:#b3b3b3">
                <td style="border: 1px solid black; width: 40px; text-align: center;width:8%;"><b>SN </b></td>
                
                <td style="border: 1px solid black; text-align:center;width:10%; "><b>Code</td>
                ...
                <td style="border: 1px solid black;text-align: center;width:8%;"><b>Qty<br>(Ea)</b></td><td style="border: 1px solid black;text-align: center;width:10%;"><b>Tax</b></td><td style="border: 1px solid black;text-align: center;width:10%;"><b>UNIT PRICE <br>'.$currency_name.'</b></td>';
                if($disc_row['discount'] > 0){
               
                    $html .='   <td style="border: 1px solid black;text-align: center;width:8%;"><b>Disc %</b> </td>'; 
                 }
$html .='<td style="border: 1px solid black;text-align: center;width:10%;"><b>TOTAL PRICE <br>'.$currency_name.' </b></td>
</tr>';

    $qry = "select trn.*,product.*, hsn.hsn_code,product.product_hsn,product.product_name,unit_name FROM `tbl_proforma_trn` as trn 
    left join product_mst as product on product.product_id=trn.product_id 
    left join mst_hsn_code as hsn on hsn.hsn_id=product.product_hsn 
    left join unit_mst as per on per.unitid=trn.unit_id where trancation_status=0 and invoice_id=" . $rel['invoice_id'] . " group by trancation_id order by trancation_id desc";
    // echo $qry;die;
    $result_qry = $dbcon->query($qry);
    $i = 1;
    $pcount = 1;

    $cnt = mysqli_num_rows($result_qry);
    $total = 0;
    $discount = 0;
    $totalqty = 0;
    $charges_qty = 0;
    ...
    while ($rel_qry = mysqli_fetch_assoc($result_qry)) {
        ...
        $html .= '<tr>
<td widtd="5%" style="text-align:right;border: 1px solid;vertical-align:top;">' . $i . '</td>
<td  style="text-align:left;border: 1px solid;vertical-align:top;">' . $rel_qry['product_icode'].'</td>
<td widtd="12%" style="text-align:left;border: 1px solid;vertical-align:top;">' . $rel_qry['product_name'];
if (!empty($rel_qry['product_desc'])) {

    $html .=  nl2br($rel_qry['product_desc']);
}
$html .= '</td>

<td widtd="15%" style="text-align:left;border: 1px solid;vertical-align:top;">' . $rel_qry['hsn_code'] . '
   
</td>
<td widtd="15%" style="text-align:right;border: 1px solid;vertical-align:top;">' . $rel_qry['product_qty'] . '
    (Ea)
</td>
<td widtd="13%" style="text-align:right;border: 1px solid;vertical-align:top;"> '.$rel_qry['igst_tax_per'].'% </td>
<td widtd="13%" style="text-align:right;border: 1px solid;vertical-align:top;"> ' . number_format($rel_qry['product_rate'], 2, ".", "") . ' </td>';
        if ($disc_row['discount'] > 0) {
            $html .= '<td width="13%"  style="text-align:right;vertical-align:top;">' . number_format($rel_qry['product_discount_conv'], 2, ".", "") . '<br>(' . $pro_disc . ')</td>';
        }
        $html .= '
<td width="15%" style="text-align:right;border: 1px solid;vertical-align:top;"> ' . number_format($rel_qry['product_amount'], 2, ".", "") . '</td>
</tr>
...
';
    ...
    $html .= '
        <tr >
        <td colspan="' . $colspan . '" style="font-weight:bold;text-align:right;border:0;">Sub Total   </td>
    ...
    while ($row12 = mysqli_fetch_assoc($resultrtyw)) {
        $html .= '<tr>
            <td colspan="' . $colspan . '" style="font-weight:bold;text-align:right;border:0;">' . $row12['l_name'] . '</td>
    ...
    if ($rel['stateid'] == $set_head['stateid']) {
        $html .= '<tr>
            <td colspan="' . $colspan . '" style="font-weight:bold;text-align:right;border:0;">SGST (' . ($gst_per / 2) . ' %)</td>
            <td style="text-align:right;font-weight: bold;">' . number_format(($total_cs_gst / 2), 2, ".", "") . '</td>
            </tr>
            <tr>
            <td colspan="' . $colspan . '" style="font-weight:bold;text-align:right;border:0;">CGST (' . ($gst_per / 2) . ' %)</td>
            <td style="text-align:right;font-weight: bold;">' . number_format(($total_cs_gst / 2), 2, ".", "") . '</td>
            </tr>';
        ...
        $html .= '<tr>
            <td colspan="' . $colspan . '" style="font-weight:bold;text-align:right;border:0;">IGST (' . ($gst_per) . ' %)</td>
    ...
    $html .= '<tr>
      <td colspan="' . $colspan . '" style="text-align:right;border:1px solid black;font-weight:bold;">Add: Total GST ' . $total_per . '
      </td>
      <td style="border:0;font-weight:bold;text-align:right">' . $total_gst . '
      </td>
      </tr>
      <tr>
      <td colspan="' . $colspan . '" style="text-align:right;border:1px solid black;font-weight:bold;">TOTAL AMOUNT IN ' . $currency_name . '
      </td>
      <td style="border:0;font-weight:bold;text-align:right">' . number_format($rel['g_total'], 2, ".", "") . '
      </td>
      </tr>
      <!-- <tr>
      <td colspan="' . $colspan . '" style="text-align:right;border:0;font-weight:bold;">Advance Amount
      </td>
      <td style=border:0;font-weight:bold;text-align:right;">' . number_format($rel['advance_payment'], 2, ".", "") . '
      </td>
      </tr> -->
      <tr>
      <td colspan="' . ($colspan + 1) . ' " style="text-align:left;border:0;font-weight:bold;"><span style="font-weight:bold;">  TOTAL AMOUNT IN WORDS IN ' . $currency_name . ' : 
      ...
      <!--  <tr>
      <td colspan="' . ($colspan + 1) . ' " style="text-align:left;border:0;font-weight:bold;"><span style="font-weight:bold;">  100% ADVANCE PAYABLE AMOUNT IN WORDS IN  : ' . $currency_name . ' 
      ' . ucwords(convert_number_to_words_new($rel['g_total'], $rel['currency_id'], $rel['currency_in_word_end'], $rel['currency_in_word'])) . '
      </span>
      </td>
      ...
      <div style="clear:both;"></div>
			 <div style= "text-align:center;">This is a Software Generated proforma invoice. Continued ...</div>';
    ...
    <td colspan="4" style="border:0;font-size: 18px; "><b>Bank Details</b></td>
   </tr>
    <tr style="border-top:none;border-bottom:none;">
    <td width="20%" style="border:0;padding-left:10px;">Bank Name</td>
    <td width="5%" style="border:0;">:</td>
    <td width="75%" colspan="2" style="border:0;text-align:left;">' . $set_head['bank_name'] . '</td>
  
    
   </tr>
    <tr style="border-top:none;border-bottom:none;">
    <td style="border:0;padding-left:10px;">Account Name</td>
    <td style="border:0;">:</td>
    <td colspan="2" style="border:0;text-align:left;">' . $set_head['company_name'] . '</td>
  
    
   </tr>
    <tr style="border-top:none;border-bottom:none;">

    <td style="border:0;padding-left:10px;">Account No</td>
    <td style="border:0;">:</td>
    <td colspan="2" style="border:0;text-align:left;">' . $set_head['ac_no'] . '</td>
  
    
   </tr>
    <tr style="border-top:none;border-bottom:none;">
    <td style="border:0;padding-left:10px;">IFSC Code</td>
    <td style="border:0;">:</td>
    <td colspan="2" style="border:0;text-align:left;">' . $set_head['ifcs'] . '</td>
  
    
   </tr>
   <tr style="border-top:none;border-bottom:none;">
   <td colspan="4" style="border:0;font-size: 18px; "><b>Amount in Words</b></td>
  </tr>
   <tr style="border-top:none;">
   <td colspan="4" style="border:0;padding-left:10px;"><b>Rupees: Sixteen Thousand Two Hundred and Twenty Five Only</b></td>
  </tr>
  <tr><td colspan="4">
';
    ...
    where qtrm.quotation_terms_trn_status=0 and qtrm.quotation_id=" . $rel['quotation_id'] . " order by qtrm.tc_priority";
        ...
        $html .= '<p>
        Terms and Conditions: ' . $rel['terms_condition'] . ' ' . $comp_rel['terms_condition'] . '
                 </p>';
    }
