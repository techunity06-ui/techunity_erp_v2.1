...
if($companySettings) {
	$quotation_print_content = ($quotation_print_content) ? $quotation_print_content : $companySettings['quotation_print_content'];
...
.page{
	...
	$html.='<tr>
	<td colspan="4" style="text-align:right;border:1px solid;"><b>Basic Amount:- Ex Factory </b></td>
	...
	'.ucfirst(convert_number_to_words_new($rel['g_total'],$currency_word_start,$currency_word_end)).'</b></td></tr>';
