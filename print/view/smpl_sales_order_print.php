								...
								<div class="col-lg-12" id="receipt_print">	<div class="col-md-12 breakout" style=" margin-top:10px;" id="print1">
									...
									<table  class="maintable headermain " id="table_head" width="100%">
										<tr style="border: 1px solid;">
											...
											<td width="60%">
												<?if($companyConfiguration['so_header_content']!=''){?>
										...
										<thead>
											<tr>
													...
													<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
														<!--<thead>-->
															<tr>
																...
																<td width="25%" style="vertical-align:top;border-top:1px solid; ">: <strong><?=$rel['sales_order_no']?></strong>
																</td>
															</tr>
															<tr>
															...
															<tr>
																<td style="vertical-align:top;white-space:nowrap; border-bottom: 1px solid;">
																	<strong>Cust. Order date.</strong>
																</td>
												...
												<tr height="30px">					
													...
													<th width="15%" style="text-align:center;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Batch No</strong></th>
													<th width="15%" style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Quantity</strong></th>
												</tr>
											</thead>
											<tbody style="border: 1px solid;">
												...
												while($row=mysqli_fetch_assoc($result)) { 
													$get_batch_no = get_salesorder_batchno($dbcon, $row['sales_ordertrn_id']);
												?>
													<tr style="height:30px">
														<td style="text-align:center !important;vertical-align:top;border:1px solid;">
															<?=$i?>
														</td>
														<td style="text-align:center !important;padding-right:10px;vertical-align:top;border:1px solid;" >
															<?=$row['product_icode']?>
														</td>
														<td style="padding-left:5px;border:1px solid;vertical-align:top;" >
															...
															<td style="text-align:center !important;vertical-align:top;border:1px solid;white-space: nowrap;" >
													...
													<tr>
														<td colspan="5" style="text-align: right; border-right: 1px solid; border-top: 1px solid;"><strong>For, <?=$set_head['company_name'];?></strong><br><img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature'];?>" style="height: 100px; width: : 100px;"></td>
													</tr>
													<tr>
														<td colspan="3" style="border-bottom: 1px solid; vertical-align: bottom;"><strong>Prepared By _______________________  Approved By _______________________</strong></td>
														<td colspan="2" style="text-align: right; border-right: 1px solid; border-bottom: 1px solid;"><strong>Authorized Signature</strong></td>
													</tr>
													<!-- <tr>
														<td colspan="5" style="text-align: right; border-right: 1px solid; border-top: 1px solid;"><img src="<?=ROOT.LOGO.$set_head['f_logo']?>"  style="width:100%"/></td>
													</tr> -->
												</tbody>
											</table>
										</div>
