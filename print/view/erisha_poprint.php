...
$form="Purchase Order";
		...
		$query="select po.*,state.state_name,modesup.mode_dispatch,payterms.payment_terms as payment_term,l.l_name as vender_name,country.country_name,l.m_address as vender_address,l.gst_no as tin_no,l.cust_mobile as vender_mobile, us.user_name,us.user_mail,us.user_phone,l.stateid,l.ledger_code, state.gst_state_code, city.city_name, bmast.branch_address, city1.city_name as bcity, state1.state_name as bstate, country1.country_name as bcountry,l.cust_email,l.cust_mobile from tbl_purchaseorder as po 
	...
	<table width="100%" class="maintable" border="1" id="table_head">
		...
		<tr style="border:none;">
			<td width="100%" style="border:none;"> 
				<img src="<?=ROOT.LOGO.'Erisha Agritech.png'?>" style="width:100%;"/>
		...
		<tr>
			<th colspan="11" style="padding:0px !important;">
				<table style="font-size:12px;border-collapse: collapse;border-top:none;" cellpadding="0" cellspacing="0" width="100%" >
						...
						<tr>
							<td colspan="4" style="text-align:center;width:100%;"> 
								<strong style="font-size:14px;">
									<?=$form?> / Service Order / Work Order
								</strong>
							</td>
						</tr>
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;">
								<strong>Vendor Name </strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;">
						...
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
								<strong>Vendor Site </strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$rel['city_name']?></strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;">
						...
						<tr>
							<td width="25%" rowspan="2" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
								<strong>Address </strong>
							</td>
							<td width="25%" rowspan="2" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$rel['vender_address']?></strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;">
						...
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;height:20px">
								<strong></strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong></strong>
						...
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;height:20px;border-top:none;border-bottom:none;">
								<strong></strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-top:none;border-bottom:none;">
								<strong></strong>
							</td>
								<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-top:none;">
								<strong></strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-top:none;">
								<strong></strong>
							</td>
						</tr>
						<tr>
							...
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$rel['tin_no']?></strong>
							</td>
								<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;">
								<strong>Our CIN</strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;">
								<strong>: U29243DL2019PTC358606</strong>
							</td>
						</tr>
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
							...
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								...
								<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
								<strong>Our GSTIN</strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$set_head['vatno']?></strong>
							</td>
						</tr>
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
							...
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$rel['ledger_code']?></strong>
							</td>
								<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
								<strong>Our IEC Code</strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$set_head['iec_no']?></strong>
							</td>
						</tr>
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
							...
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$rel['cust_cont_name']?></strong>
							</td>
								<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
								<strong>Contact Person</strong>
							</td>
						...
						<tr>
							...
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$rel['cust_mobile']?></strong>
							</td>
								<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
								<strong>Mobile</strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-bottom:none;border-top:none;">
								<strong>: <?=$rel['user_phone']?></strong>
							</td>
						</tr>
						<tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-bottom:none;border-top:none;">
						...
						<tr>
							...
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-top:none;">
								<strong>: <?=$rel['cust_email']?></strong>
							</td>
								<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-top:none;">
								<strong>Email</strong>
							</td>
							<td width="25%" style="vertical-align:top;border:1px solid;border-left:none;border-top:none;">
								<strong>: <?=$rel['user_mail']?></strong>
							</td>
						</tr>
						<!-- <tr>
							<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;">
						...
						<!-- <tr>
							...
							<td width="50%" colspan="2" style="vertical-align:top;border:1px solid;">
							<?phpif(!empty($baddress)){ ?>
							<b>Ship To, </b><br/>
								<strong><?php //=$cons_company_name?></strong>
								<span style="font-weight:normal;">   <br/> 
								<?=$baddress?>
								<br/>
			...
			<tr>
				...
				<table class="footer-table" width="100%">
					<tr width="61.6%" height="20px">
						...
						<td colspan="2" style="text-align:right;" width="10%"><?=number_format($total_product_amount,2,".","")?></td>	
					</tr>
					...
					//echo	$n="select mst.*,t.tax_name from tbl_tax_trn as mst left join tbl_tax as t on t.tax_id=mst.tx_tax_id where tx_tran_type_id='$purchaseorder_id' group by tx_tax_id";
					...
					<tr height="20px">
						...
						<td colspan="3" style="border-top:1px solid;border-right:1px solid;text-align:left" >
							...
							Add. <?php echo $rel1['tax_name']; ?>
						</td>
						<td colspan="2" style="text-align:right; border-top:1px solid;border-right:1px solid; "><?=number_format($rel122['tamo'],2,".","")?></td>
