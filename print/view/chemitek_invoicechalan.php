								...
								<div class="col-lg-12 table-responsive" id="receipt_print">	<div class="col-md-12" style=" margin-top:10px;" id="print1">
									<table width="100%" class="maintable" border="0" style="" id="table_head">
										<tr style="border:none;">
											<td colspan="3" style="border: 0px; "><img src="<?=ROOT.LOGO.$set_head['logo']?>" style="width:2in;height: 70px;padding-top:0px;" /></td>
											<td colspan="6" style="text-align:center;border: 0px;">
												<span style="font-size:16px;"><b>DELIVERY CHALLAN</b></span><br/>
												<span style="font-size:16px;"><b><?=$set_head["company_name"]?></b></span><br/>

												<span style="font-size:12px;"><?=$set_head["address"]?></span>
				...
				$item_code = " -- (".$row['product_icode'].")";
											...
											<tr style="height:40px">
												...
												<td style="padding-left:5px;border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;" >
													<strong><?=stripcslashes($row['product_name'])?></strong><?=$item_code;?>
