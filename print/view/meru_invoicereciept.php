...
if(strtolower($type) == 'pdf') {
	...
	where po.invoice_id=$salesorderid";
...
*/
	$sales = "select * from tbl_invoicetrn as trn 
...
//$header = get_header($dbcon,'text-align: left','200px','50px');
		...
		<td style="text-align:left;vertical-align:top;width:50%; bold;border:none !important;border-top:1px solid !important">
			<strong>'.$rel['invoice_no'].' - DTD : '.$invoice_date.'</strong>
		</td>
...
$html.='<html>
<head>					
<title>Invoice No - '.$rel['invoice_no'].'</title>
...
.page{
	...
	$html .='<table width="100%" style="font-size:13px;border-collapse: collapse;width:100%;border:none !important;" cellpadding="3" cellspacing="3">
		...
		<tr>
			<td rowspan="5" style="width:33.33%;vertical-align:top !important;border:1px solid !important;">
				<strong>Bill To : </strong>'.$bill_to_party.'
			</td>
			<td rowspan="5" style="width:33.33%;vertical-align:top;border:1px solid !important;">
				<strong>Ship To : </strong>'.$consigni_to_party.'
			</td>
			<td style="width:16.66%;vertical-align:top;border:1px solid !important;border-right:none !important">
				<strong>Invoice No 	 </strong></td>
			<td style="width:16.66%;vertical-align:top;border:1px solid !important;border-left:none !important">
				: '.$rel['invoice_no'].'
			</td>
		</tr>
		<tr>
			<td style="vertical-align:top;border:1px solid !important;border-right:none !important"><strong>Invoice Date </strong></td>
			<td style="vertical-align:top;border:1px solid !important;border-left:none !important"> : '.$invoice_date.'</td>
		</tr>
		<tr>
			<td style="vertical-align:top;border:1px solid !important;border-right:none !important"><strong>Your P.O. No </strong></td>
			<td style="vertical-align:top;border:1px solid !important;border-left:none !important"> : '.$rel['order_no'].'</td>
		</tr>
		<tr>
			<td style="vertical-align:top;border:1px solid !important;border-right:none !important"><strong>Your P.O. Date </strong></td>
			<td style="vertical-align:top;border:1px solid !important;border-left:none !important"> : '.$order_date.'</td>
		</tr>
		<tr>
			<td style="vertical-align:top;border:1px solid !important;border-right:none !important"><strong>O.A. No. </strong></td>
			<td style="vertical-align:top;border:1px solid !important;border-left:none !important"> : '.$order_no.'</td>
		</tr>
	</table>';
	...
	<td style=" text-align:right;font-size:13px;border:1px solid !important;">'.$rel['currency_symbol'].' '.($rel['g_total_conv']+$rel['round_off_conv']).' </td>
	</tr>';
	...
	if($t_cnt = mysqli_num_rows($terms_qry_rs)){
		$t=1;
		$html.='<div>
		<table style="font-size:14px;border-collapse: collapse;width:100%;border:1px solid !important" cellpadding="5" cellspacing="5">
		<thead>
		...
		while($term_rel=mysqli_fetch_assoc($terms_qry_rs)){
			...
			<td style="width:100%;text-align:left;border:none !important;border-right:1px solid !important;">'.$string.'</td>
			</tr>';
			$t++;
		}
		$html.='</tbody></table></div>'; 
	}
	$html .='<table style="font-size:14px;border-collapse: collapse;width:100%;border:1px solid !important" cellpadding="5" cellspacing="5">
		<tr>
			<td style="width:50%;border:none !important"></td>
			<td style="width:50%;border:none !important;text-align:right"><strong>For, '.$rel['company_name'].'</strong><br><br><br><br>
			<strong>Authorised Signature</strong></td>
		</tr>
		<tr>
			<td colspan="2" style="text-align:center;border:none !important"><strong>Subject To AHMEDABAD Juridiction.</strong></td>
		</tr>
	</table>';
...
$mpdf->WriteHTML('<table style="font-size:13px;border-collapse: collapse;width:100%;border:none !important" >	    
<tr>
	<td colspan="3" style="text-align:right; font-size:18px; padding-bottom:0px;border:none;width:50%"> <strong>Tax Invoice</strong>
	</td>
	<td colspan="3" style="text-align:right; font-size:14px; padding-bottom:0px;border:none;width:50%">(Original)</td>
</tr>
<tr>
...
$mpdf->WriteHTML($html);
$mpdf->WriteHTML('<center class="nextpage"></center>');
$mpdf->WriteHTML('<table style="font-size:13px;border-collapse: collapse;width:100%;border:none !important" >	    
<tr>
	<td colspan="3" style="text-align:right; font-size:18px; padding-bottom:0px;border:none;width:50%"> <strong>Tax Invoice</strong>
	</td>
	<td colspan="3" style="text-align:right; font-size:14px; padding-bottom:0px;border:none;width:50%">(Duplicate)</td>
</tr>
<tr>
	<td colspan="6" style="text-align:center; font-size:18px; padding-bottom:0px;border:none;height:5px "> 
	</td>
...
<tr>
	...
	<td colspan="3" style="text-align:right; font-size:14px; padding-bottom:0px;border:none;width:50%">(Triplicate)</td>
</tr>
<tr>
	<td colspan="6" style="text-align:center; font-size:18px; padding-bottom:0px;border:none;height:5px "> 
	</td>
