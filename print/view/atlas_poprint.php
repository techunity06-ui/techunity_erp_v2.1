	...
	<section id="container" >
									...
									<table width="100%" class="maintable" style="font-size: 12px;margin-top: 5px;border-top: 1px solid;" id="invoice_type" >
										<thead>
											<tr>
												<th colspan="11" style="padding:0px !important;">
													...
													<?php if($set_head['website']){?><br/>E-Mail: <?=$set_head['website']?><?php }?></td>
															...
															<td width="15%" style="vertical-align:top;border:1px solid;border-left:none;">
														...
														<tr>
															...
															<td style="vertical-align:top;border:1px solid;border-left:none;">
																: <?=date('d-m-Y',strtotime($rel['purchaseorder_date']))?>
															</td>
														</tr>
														<tr>
															<td style="vertical-align:top;border:1px solid;border-right:none;">
											...
											<tr>
												...
												<th width="7%" style="text-align:center;border:1px solid;border-top: none;"><strong>Discount</strong></th>
										...
										<tbody style="border: 1px solid;">
											...
											left join unit_mst as per2 on per2.unitid=product.product_conv_unit where purchaseordertrn_status=0 and purchaseorder_id=".$rel['purchaseorder_id']." group by purchaseordertrn_id order by purchaseordertrn_id";
		...
		//tax summary calculation start
												...
												<tr style="height:40px">
													...
													<td style="border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;" colspan="2">
														...
														<td style="text-align:center;vertical-align:top;border-bottom-color:#FFFFFF; border-right:1px solid;white-space:nowrap;" >
															...
															<td style="text-align:center;vertical-align:top;border-bottom-color:#FFFFFF; border-right:1px solid;white-space:nowrap;"><?=$row['product_discount']?></td>
															<td style="text-align:right;vertical-align:top;border-bottom-color:#FFFFFF;border-right:1px solid;">
													...
													<tr style="height:20px">
														<td style="border-top:1px solid;border-right:1px solid;border-left:1px solid; text-align:right;" colspan="3"><strong>Total</strong></td>
			...
			while($bill_sundry1 = brp_mysqli_fetch_array($bill1_sun)){
				$total_cs_gst  += $bill_sundry1['sundry_gst_amount'];
				$total_i_gst  += $bill_sundry1['sundry_gst_amount'];
			}
			?>		
													<tr>
														<td colspan="11" style="padding: 0px !important;border:1px solid">
															<table class="footer-table" width="100%">
																<tr width="60%" height="20px">
																	<td style="border-right:1px solid;vertical-align: top;">
																		<strong>Rupees:</strong>
																		<?=ucwords(convert_number_to_words_new(round($rel['g_total'])))?>
																	</td>
																	<td width="25%" style="border-right:1px solid;text-align:left">
																		Basic Amount
																	</td>
																	<td colspan="2" style="text-align:right;" width="15%"><?=number_format($total_product_amount,2,".","")?></td>	
																</tr>
																<?php if($rel['stateid']==$set_head['stateid']){ ?>
																	<tr height="20px">
																			<td style="border-right:1px solid;border-top:1px solid;vertical-align: top;" rowspan="3"><strong>Remarks: </strong>
																			</td>
																		<td style="border-top:1px solid;border-right:1px solid;text-align:left" >CGST
																		</td>
																		<td colspan="2" style="text-align:right; border-top:1px solid;"><?=number_format(($total_cs_gst/2),2,".","")?></td>
																	</tr>
																	<tr>
																		<td style="border-top:1px solid;border-right:1px solid;text-align:left" >SGST
																		</td>
																		<td colspan="2" style="text-align:right; border-top:1px solid;"><?=number_format(($total_cs_gst/2),2,".","")?></td>
																	</tr>
																	<?php }else { ?>
																		<tr>
																			<td style="border-right:1px solid;border-top:1px solid;vertical-align: top;" rowspan="2"><strong>Remarks: </strong>
																			<br>	<?=$rel['remark']?>
																			</td>
																		<td style="border-top:1px solid;border-right:1px solid;text-align:left" >
																			IGST
																		</td>
																		<td colspan="2" style="text-align:right; border-top:1px solid;"><?=number_format(($total_i_gst),2,".","")?></td>
																		</tr>
																	<?php } $r=round($rel['g_total'])-$rel['g_total']; ?>
																	<tr height="20px">
			...
			where b.sundry_voucher_id=".$rel['purchaseorder_id']." and b.sundry_voucher_table='tbl_purchaseorder' and b.isdelete='0' and le.default_sundry='0' ");
																	while($bill_sundry = brp_mysqli_fetch_array($bill_sun)){
																	?>
																	<tr height="20px">
																		<td style="border-right:1px solid;border-top:1px solid;vertical-align: top;">
																		</td>
																	...
																	?>
																	<tr height="20px">
																		<td style="border-right:1px solid;border-top:1px solid;vertical-align: top;"><strong>Company GST No : <?= ($set_head['vatno']!=0) ? $set_head['vatno'] : "" ?></strong>
																		</td>
																		<td style="border-top:1px solid;border-right:1px solid;text-align:left"><strong>Grand Total</strong> </td>
																		<td style="text-align:right; border-top:1px solid;font-size:13px;border-bottom:1px solid; "><strong><?=number_format($rel['g_total'],0,".","").'.00'?></strong></td>
																	</tr>
																	<tr>
																		<td style="vertical-align:top;text-align:left;border-top:1px solid;" class="con" colspan="4">
																			<strong>Mode of Dispatch :</strong> <?=$rel['mode_dispatch'];?><br><strong>Payment Terms :</strong> <?=$rel['payment_term'];?><br><strong>Delivery Date :</strong> <?=date('d-m-Y',strtotime($rel['purchaseorder_due_date']));?>
																		</td>
																	</tr>
																	<tr>
																		<td style="vertical-align:top;text-align:left;border-top:1px solid;" class="con" colspan="4">
																	...
																	<tr>
																		<td style="vertical-align:top;border-top:1px solid;height: 50px;" colspan="4">
																	...
																	<tr>
																		<td colspan="4" style="vertical-align:bottom;text-align: left;">Authorised Signatory</td>
																	</tr>
																</table>
															</td>
														</tr>		
