...
$query="select invoice.*,tdet.transportation_name,country.country_name,state.state_name,city.city_name,cust.l_name as company_name,cust.m_address as cust_address,cust_pincode,cust_mobile,gst_no,us.user_name from tbl_sales_order as invoice 
...
left join tbl_transport_transaction as trns on trns.transport_transaction_table_id = invoice.sales_order_id and transport_transaction_table= 'tbl_sales_order'
left join  transportation_details as tdet on tdet.id = trns.transport_id 
	...
	<section id="container" >
		...
		<section id="main-content">
			<section class="wrapper">
											...
											<tr>
												<th colspan="6" style="padding:0px !important;">
													<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
														<!--<thead>-->
															<tr>
																...
																<td rowspan="4" width="55%" style="vertical-align:top;border:1px solid;padding-bottom:0px !important;border-right:none">
																	M/s,<br>
														...
														<tr height="30px">					
															...
															<th width="30%"  style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;" ><strong>Item Description</strong></th>
															<th width="20%"  style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;" ><strong>Product Category</strong></th>
															<th width="20%"  style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;" ><strong>Rack No.</strong></th>
															<th width="20%"  style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;" ><strong>Closing Stock</strong></th>
													...
													<tbody style="border: 1px solid;">
														<?php
														$qry="select * FROM `tbl_sales_ordertrn` as trn 
														left join product_mst as product on product.product_id=trn.product_id 
														left join tbl_category as cat on cat.cat_id=product.product_category
														left join unit_mst as per on per.unitid=trn.unit_id where sales_ordertrn_status=0 and sales_order_id=".$rel['sales_order_id'];
														...
														while($row=mysqli_fetch_assoc($result))
														{
															...
															$stock = stock_cur($dbcon, $row['product_id'], $row['unit_id']);
															?>
															<tr style="height:40px">
																...
																<td style="padding-left:5px;border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;" >
																	...
																	<?php }else{ ?>
																		...
																		<td style="padding-left:5px;border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;text-align: center;" >
																			<strong><?=$cat_name?></strong>
																		</td>
																		<td style="padding-left:5px;border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;text-align: center;" >
																			<strong><?=$row['rack_no']?></strong>
																		</td>
																		<td style="padding-left:5px;border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;text-align: center;" >
																			<strong><?=$stock?></strong>
																		</td>
																...
																<?php } ?>
																<tr height="24px">
																	<td colspan="5" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;border-left:1px solid;font-size:14px;text-align:right !important;">TOTAL</td>
																...
																<tr height="24px">
																	<td colspan="6" style="text-align: left; border-right: 1px solid;font-size:14px;border-top:1px solid;border-bottom:1px solid;"><strong>Remark : </strong> <?=$rel['remark']?></td>
																</tr>
																<tr>
																<td colspan="2" style="text-align: Center; border-right: 1px solid;"></td>
																<td colspan="2" style="text-align: Center; border-right: 1px solid;"><?php echo date("d-m-Y"); ?></td>
																	<td colspan="2" style="text-align: center; border-right: 1px solid;"><img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature'];?>" style="height: 100px; width: : 100px;"></td>
																</tr>
																<tr>
																	<td colspan="2" style="text-align: Center; border-right: 1px solid; border-bottom: 1px solid;"><strong>Authorized Name</strong></td>
																	<td colspan="2" style="text-align: Center; border-right: 1px solid; border-bottom: 1px solid;"><strong>Date & Time</strong></td>
																	<td colspan="2" style="text-align: Center; border-right: 1px solid; border-bottom: 1px solid;"><strong>Authorized Signature</strong></td>
																</tr>
															</tbody>
														</table>
													</div>
				...
				<?php 
					function stock_cur($dbcon,$product_id,$unit){
						...
						if (in_array($get_pro_type_rel['product_type'], $product_type_arr)){
							...
							$rstock=reserve_stock($dbcon,$product_id,$unit_id,$reserve_id,$request_id,$complaint_id,$sales_order_trn_id,$branch_id,$is_store_approval,$p_id,'',$stock_id);

							$current_stock-$unclear_qty-$rstock;
						}
