...
//echo "<pre>";print_r($set_head);die();
    ...
    $header='';
    $header .= '<table style="font-size:13px;border-collapse: collapse; width:100%; border:none !important;border-bottom:1px solid !important" >
		<tr style="border:none !important">
			<td colspan="4" style="vertical-align:top;border:none !important; text-align:left;height:10px"></td>
		</tr>
		<tr style="border:none !important">
			<td colspan="3" style="vertical-align:top;border:none !important; text-align:left"><h2>'.$set_head['company_name'].'</h2></td>

			<td rowspan="5" style="vertical-align:top;border:none !important;text-align:right"><img src="'.DOMAIN_F.LOGO.$set_head['logo'].'" style="height: 60px; width: 100px;"></td>
		</tr>
		<tr style="border:none !important">
			<td colspan="3">'.$set_head['address'].' '.$set_head['city_name'].'-'.$set_head['pincode'].','.$set_head['state_name'].',INDIA</td>
		</tr>
		<tr style="border:none !important">
			<td colspan="3">Phone : '.$set_head['contact_no'].'</td>
		</tr>
		<tr style="border:none !important">
			<td colspan="3">Web : '.$set_head['company_website'].'</td>
		</tr>
		<tr style="border:none !important">
			<td style="border:none !important">Gst No : '.$set_head['vatno'].'</td>
			<td style="border:none !important">Lut No : '.$set_head['lut_no'].'</td>
			<td style="border:none !important">IEC No : '.$set_head['iec_no'].'</td>
		</tr>
	</table>';
    $header .='<table style="text-align:center;border:none">
    ...
    <tr>
    <td colspan="2" style="border:1px solid;font-weight:normal;font-size: 14px;height:140px;vertical-align:top">
    <span style="font-weight:bold;font-size: 14px">Delivery At</span>
    <br><strong style="font-weight:normal;font-size: 14px;font-weight: bold">'.$rel['company_name'].'</strong><br>';
    if(empty($rel['consignee_id'])){ 
        if($rel['quot_address']!='' && $rel['quot_address']!='0'){ 
            $header.= $rel['quot_address'];
            $header.='<br/>';
...
$footer ='<table width="100%" style="border-top:2px solid">
		...
		<tr style="border:none !important">
		<td style="text-align:left;vertical-align:top;width:50%; bold;border-top:1px solid !important;border-right:none !important;border-left:none !important;border-bottom:none !important">
			<strong>'.$rel['invoice_no'].' - DTD : '.date('d-m-Y',strtotime($rel['invoice_date'])).'</strong>
		</td>
		<td style="text-align:right;vertical-align:top;width:50%; bold;border-top:1px solid !important;border-right:none !important;border-left:none !important;border-bottom:none !important"> <strong>Page {PAGENO} of {nbpg}</strong></td>
		</tr>
		</table>';
...
$mpdf=new mPDF('','A4','0','calibri','10','10','115','2','1','1');
