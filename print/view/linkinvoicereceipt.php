...
$query="select invoice.*,country.country_name,state.state_name,cust.stateid,state.gst_state_code, city.city_name, cust.l_name, cust.m_address, type.invoice_type, cust_pincode, cust_mobile, gst_no, dispatch.mode_dispatch, cust.m_pan from tbl_invoice as invoice 
							...
							<!--<div class="col-sm-12">-->
								<section class="panel">
									...
									<div class="col-lg-12 " id="receipt_print">	
										<div class="col-md-12 breakout table-responsive" style=" margin-top:10px;" id="print1">
															...
															<th colspan="11" style="padding:0px !important;">
																<table style="font-size:10px;border-collapse: collapse;border-top:none !important;" cellpadding="0" cellspacing="0" width="100%" >
																	...
																	<tr>
																		...
																		<td style="vertical-align:top;border-bottom:1px solid;border-right:1px solid" colspan="">: <?=$po_number;?> </td>
																		<td style="vertical-align:top;border-bottom:1px solid "><strong>Date </strong></td>
																		<td style="vertical-align:top;border-bottom:1px solid;border-right:1px solid" colspan="">: <?=$po_number_date?></td>
