...
<html lang="en">
<head>
	<title>MANUAL INDENT - <?=$rel['pre_no']?></title>
							...
							<div class="panel-body">
								<center>
									...
									<div class="col-sm-4 col-xs-6 resspace"  style="text-align:right">
										...
										<a href="<?=ROOT.PURCHASE_ROOT.'pre_list'?>" type="button" class="btn btn-danger"><i class="fa fa-ban"></i> Cancel</a>
									</div>
											...
											<tr>
												<th colspan="6" style="padding:0px !important;">
													<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
														<!--<thead>-->
															<tr>
																<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-left:none"><strong>Manual Indent No </strong>
																</td>
																
																<td width="25%" style="vertical-align:top;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">: <strong><?=$rel['pre_no']?></strong>
																</td>
																
																<td width="25%" style="vertical-align:top;border:1px solid;border-right:none;border-left:none;white-space:nowrap;">
																	<strong>Indent Date</strong>
																</td>
																
																<td width="25%" style="vertical-align:top;border-bottom:1px solid;border-right:1px solid;border-top:1px solid;">
																	: <?=date('d/m/Y',strtotime($rel['pre_date']))?>		
																</td>							
															</tr>
														...
														<tr height="30px">					
															...
															<th width="25%"  style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;" ><strong>Item Description</strong></th>
															...
															<th width="8%" style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Rate</strong></th>
															<th width="20%" style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Vender</strong></th>
														...
														while($row=mysqli_fetch_assoc($result))
														{
															...
															<tr style="height:40px">
																...
																<tr height="24px">
																	...
																	<td style="border-right:1px solid;border-bottom:1px solid; border-top:1px solid;font-size:14px;"><?=number_format($total,2,".","")?></td>
																	<td style="border-right:1px solid;border-bottom:1px solid; border-top:1px solid;font-size:14px;"></td>
																</tr>	
																<tr>
																	<td colspan="6" style="text-align: right;"><img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature'];?>" style="height: 100px; width: : 100px;"></td>
																</tr>
																<tr>
																	<td colspan="6" style="text-align: right;border-bottom: 1px solid black;"><strong>Authorized Signature</strong></td>
																</tr>
															</tbody>
														</table>
													</div>
