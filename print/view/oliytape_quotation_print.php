...
if($company_config['po_header_content']!=''){
	...
	<tr style="border: 0px;">
	<td style="text-align: center; width: 25%; border: 0px;"><img src="'.DOMAIN_F.LOGO.$comp_rel['logo'].'" style="width:150px;"/></td>
	'.$po_header_content .'
	</tr>
	</table>';
...
//Amish Soni End 16-03-2021
		...
		//tax summary calculation start
			...
			if($rel['c_add_state']==$comp_rel['stateid']){
				$html.='<tr>
				<td colspan="'.$colspan.'" style="text-align:right;border:1px solid;"><b>CGST ('.($gst_per/2).' %)</b></td>
				<td style="text-align:center;border:1px solid;"><b>
				'.number_format(($total_cs_gst/2),2,".","").'
				</b></td>
				</tr>
				<tr>
				<td colspan="'.$colspan.'" style="text-align:right;border:1px solid;"><b>SGST ('.($gst_per/2).' %)</b></td>
				<td style="text-align:center;border:1px solid;"><b>
				'.number_format(($total_cs_gst/2),2,".","").'
				</b></td>
				</tr>';
				...
				$html.='<tr>
				<td colspan="'.$colspan.'" style="text-align:right;border:1px solid;"><b>IGST ('.($gst_per).' %)</b></td>
				<td style="text-align:center;border:1px solid;"><b>
...
//echo $html;exit;
			...
			$mpdf=new mPDF('','A4','0','proximanova','10','10','40','25','1','1');
