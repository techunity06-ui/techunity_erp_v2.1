...
//echo "<pre>";print_r($set_head);die();
    ...
    $header = get_header($dbcon,'text-align: center','','100px').'<table style="text-align:center;border:none">
    ...
    <tr>
    <td colspan="2" style="border:1px solid;font-weight:normal;font-size: 14px;height:175px">
...
if($rel['performa_invoice_type'] == '2'){
    $terms_qry="select qtrm.*,mst.tc_name from tbl_salesorder_terms_trn as qtrm 
        ...
        if(mysqli_num_rows($terms_qry_rs)){
            $html.='<tr id="rawnone">
<td colspan="6" width="50%" style="border:1px solid"><div>
            <table width="100%">
            <thead>
...
$mpdf = new Mpdf(['format' => 'A4','margin_left' => 10,'margin_right' => 10,'margin_top' => 105,'margin_bottom' => 2,'margin_header' => 1,'margin_footer' => 1,'default_font' => 'calibri']);
// $mpdf=new Mpdf('','A4','0','calibri','10','10','105','2','1','1');
