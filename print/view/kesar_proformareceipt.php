...
$html='';
$header =get_header($dbcon,'text-align: left','30%','10%').'<table style="text-align:center;border:none">
<tr style="border:none">
<td style="border:none; text-align: right;"><input type="checkbox">&nbsp;Original&nbsp;&nbsp;<input type="checkbox">&nbsp;Duplicate&nbsp;&nbsp;<input type="checkbox">&nbsp;Triplicate</td>
</tr>
<tr>
<td> 
...
$footer = '<img src="'.DOMAIN_F.LOGO.$set_head["f_logo"].'" style="padding-top:10px;" />';
...
for($j=0; $j<$pr; $j++){
  ...
  '.ucwords(convert_number_to_words_new($pay_amo)).'
  </span>
  <br>
  <br>
...
<tr>
<td style="border:1px solid;font-weight:normal;font-size: 14px;">Sub Amount
</td>
<td style="border:1px solid;font-weight:normal;font-size: 14px;text-align:right">'.number_format($rel['g_total'],2,".","").'
</td>
</tr>
<tr>
<td style="border:1px solid;font-weight:normal;font-size: 14px;">Advance Payment
</td>
...
<td style="border:1px solid;font-weight:normal;font-size: 14px;text-align:right">'.number_format($pay_amo,2,".","").'
</td>
</tr>
<tr id="rawnone">
...
$mpdf=new mPDF('','A4','0','calibri','10','10','95','2','1','1');
