...
$cons_company_name	= $set_head['company_name'];
$cons_address	= $set_head['address'];
$cons_gst_no		= $set_head['vatno'];
$cons_pan_no	= $set_head['pan_no'];
$cons_contact_no= $set_head['contact_no'];
$cons_email		= $set_head['website'];

$chkUser="SELECT * FROM users WHERE user_id=".$_SESSION['user_id'];
$getUser=mysqli_fetch_assoc($dbcon->query($chkUser));
			...
			<section class="wrapper">
				...
				<div class="row">			
							...
							<div class="panel-body">
								<!--<center>-->
									...
									<div class="col-lg-12 table-responsive" id="receipt_print">	<div class="col-md-12" style=" margin-top:10px;" id="print1">
										...
										<table width="100%" class="maintable" id="table_head" style="border:none;">
										...
										<table width="100%" class="maintable" style="font-size: 12px;margin-top: 5px;" id="invoice_type" >
											<thead>
												<tr>
													<th colspan="8" style="padding:0px !important;">
														<table style="font-size:12px;border-collapse: collapse;border-top:none;" cellpadding="0" cellspacing="0" width="100%" >
															...
															<tr>
																<td width="20%" style="vertical-align:top;border:1px solid;border-right:none;">
																	<strong>Purchase Order No </strong>
																</td>
																<td width="30%" style="vertical-align:top;border:1px solid;border-left:none;">
															...
															<tr>
																<td style="vertical-align:top;border:1px solid;border-right:none;white-space: nowrap;">
																	<strong>HP Engineering Job No</strong>
																</td>
																<td style="vertical-align:top;border:1px solid;border-left:none;">
																	<strong>: <?=$rel['vendor_reference']?></strong>
																</td>
																<td style="vertical-align:top;border:1px solid;border-right:none;">
																	<strong>Delivery Date </strong>
																</td>
																<td style="vertical-align:top;border:1px solid;border-left:none;">
																	<strong>: <?=date('d-m-Y',strtotime($rel['purchaseorder_due_date']))?></strong>
																</td>
															</tr>
															...
															<tr>
																<td style="vertical-align:top;border:1px solid;" colspan="2">
																	<strong>Bill To,</strong><br>
																	<?= $rel['vender_name']; ?><br>
																	<?= $rel['vender_address']; ?><br>
																	Phone : <?= $rel['vender_mobile']; ?><br>
																	GST No. : <?= $rel['tin_no']; ?>
																</td>
																<td style="vertical-align:top;border:1px solid;" colspan="2">
																	<strong>Ship To,</strong><br>
																	<?= $cons_company_name; ?><br>
																	<?= $cons_address; ?><br>
																	GST NO. : <?= $cons_gst_no; ?>&nbsp;&nbsp;&nbsp;PAN No. : <?= $cons_pan_no; ?><br>
																	Phone No. : <?= $cons_contact_no; ?>&nbsp;&nbsp;&nbsp;Email : <?= $cons_email; ?><br>
																	Contact : <?= $getUser['user_name']; ?>&nbsp;&nbsp;&nbsp;MO. : <?= $getUser['user_phone']; ?><br>
												...
												<tr>
													<th width="5%" style="text-align:center;border:1px solid;border-top: none;"><strong>SR.<br/> NO.</strong></th>
													<th width="45%" style="text-align:center;border:1px solid;border-top: none;" colspan="2">
											...
											<tbody style="border: 1px solid;">
												...
												$i=1;$total=0;$discount=0;$totalqty=0;$charges_qty=0;$total_cs_gst=0;$total_i_gst=0;$gst_per=0;$gst_rate=0;
					...
					//base_unit_name,per2.unit_name as conv_unit_name
												...
												<?php $countnum= ($rel['stateid']==$set_head['stateid']) ? 5 : 4; ?>		
												<tr style="border-top:1px solid black;">
													<td style="border-top:1px solid;border-right:1px solid;vertical-align: top;white-space: nowrap;" colspan="<?=$colspan?>" rowspan="<?= $countnum; ?>"><strong>Documents Required Along With Delivery</strong><br>
														1) Delivery Challan<br>
														2) Invoice Copy<br>
														3) Material Test Certificate<br>
														4) Our Purchase Order Copy
													</td>
													<td style="border-top:1px solid;border-right:1px solid;text-align:left;vertical-align: top;white-space: nowrap;" colspan="2" rowspan="<?= $countnum; ?>" ><strong>Other Details :</strong><br>
														Freight : Extra<br>
														Dispatch Mode : <?=$rel['mode_dispatch']?><br>
														Delivery Place : <br><?= $cons_company_name; ?>
													</td>
													<td colspan="2" style="border-top:1px solid;border-right:1px solid;text-align:left">
														Taxable Amount
													</td>
													<td colspan="2" style="border-top:1px solid;border-right:1px solid;text-align:right;"><?=number_format($total_product_amount,2,".","")?></td>
												</tr>
												<?php if($rel['stateid']==$set_head['stateid']){ ?>
													<tr>
														...
														<td colspan="2" style="text-align:right; border-top:1px solid;border-right:1px solid;"><?=number_format(($total_cs_gst/2),2,".","")?></td>
													</tr>
													<tr>
														<td colspan="2" style="border-top:1px solid;border-right:1px solid;text-align:left" >
															SGST
												...
												<?php } else{ ?>
													<tr>
														...
														<td colspan="2" style="text-align:right; border-top:1px solid;border-right:1px solid;"><?=number_format(($total_i_gst),2,".","")?></td>
													</tr>
												<?php }
												...
												?>
												<tr>
													<td colspan="2" style="border-top:1px solid;border-right:1px solid;text-align:left">Round off</td>
													<td colspan="2" style="text-align:right; border-top:1px solid;border-right:1px solid;"><?=number_format($r+$rel['round_off'],2,".","")?></td>
												</tr>

												<tr>
													<td colspan="2" style="border-top:1px solid;border-right:1px solid;text-align:left"><strong>Grand Total</strong> </td>
												...
												<tr>
													<td style="border-top:1px solid; border-right: 1px solid;" colspan="8">
												...
												<tr>
													<td style="border-top:1px solid; border-right: 1px solid;" colspan="8">
														<strong>Note:</strong>
														As per GST Rules E way Compulsory on Invoice Value more than Rs.50,000/- Please send E way bill with dispatch Documents, otherwise  your Invoice will be not be Process for Payment.
													</td>
												</tr>
												<tr>
													<td style="border-top:1px solid; border-right: 1px solid;" colspan="8">
														<strong>Rejection:</strong>
														Supplier is responsible to take back Rejected Material within 10 days after intimation.
													</td>
												</tr>
												<tr>
												...
												<tr style="height: 100px;">
													<td colspan="3" style="vertical-align:top;border-top:1px solid; text-align: center;"><br><img src="<?=DOMAIN_F.'view/upload/signature/'.$getUser['authorized_signature']?>" style="height: 80px; width: 80px;"></td>
													<td colspan="2" style="vertical-align:top;border-top:1px solid; text-align: center;"></td>
													<td colspan="3" style="vertical-align:top;border-top:1px solid;text-align: center; border-right: 1px solid;"><br><img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature']?>" style="height: 80px; width: 80px;"></td>
												</tr>
												<tr style="border-bottom: 1px solid black;border-top: none;">
													<td colspan="3" style="vertical-align:top;border-top:none;text-align: center;"><strong>Prepared By</strong></td>
													<td colspan="2" style="vertical-align:top;border-top:none;text-align: center;"><strong>Checked By</strong></td>
													<td colspan="3" style="vertical-align:top;border-top:none;text-align: center; border-right: 1px solid;"><strong>Approved By</strong></td>
												</tr>		
											</tbody>
