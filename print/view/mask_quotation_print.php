...
$ps = 1;
	...
	while($sp_ro = mysqli_fetch_array($pr_se)){
		$html .= '<h3 style="text-decoration: underline; text-align: left; margin-top: 0px; "><strong>'.$ps.') '.$sp_ro['product_name'].'</strong></h3><br>'.(($sp_ro['product_spec']) ? $sp_ro['product_spec'] : '').'<br>';
		$html .= '';
		$ps++;
				...
				<tr>
				 ...
				 <table  style="font-size:14px;border-collapse: collapse;width:100% !important;table-layout:fix;" >
				 	<tr style="border-bottom:none">
				 		<td style="width:50%;border-bottom:none;padding-top:0px;padding-bottom:0px"><p><strong>GSTIN: 24AAPFM9186L1ZF</strong></p></td>
...
<strong>PAN: AAPFM9186L<br />
IEC: 0813026105<br />
ISO 9001:2015 CERTIFICATE NO: 200620019102<br />
MSME REGISTRATION NO: GJ01B0155049</strong><br><br>
<strong>BANK DETAILS: <br>A/c. Name: Mask Hydraulic Machineries<br />
IFSC CODE: - UTIB0003606<br />
</td>
				 	...
				 	<tr style="border-top:none;">
				 		...
				 		<strong>Bank Name: - AXIS BANK, 
Branch: - VATVA <br>
A/C. NO: - 921020035746755</strong></td>
	...
	if(mysqli_num_rows($terms_qry_rs)){
		...
		while($term_rel=mysqli_fetch_assoc($terms_qry_rs)){
			...
			<td style="border: 0;"><strong>'.$term_rel['tc_name'].' : </strong><br>'.$string.'</td>
			</tr>';
			$tc++;
		}
		$html.='
...
$mpdf=new mPDF('','A4','0','proximanova','10','10','45','20','1','1');
