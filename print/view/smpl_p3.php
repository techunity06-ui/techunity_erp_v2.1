...
.page{
	...
	<tr  style="border-top:1px solid; border-left:1px solid; border-right:1px solid;    ">
	<td colspan="4" style="text-align:Left;font-size:18px;font-weight:bold;padding-bottom:0px; height:35px;"></td>
	</tr></table>';
	//////////////////////////////////////////Page - 1 start//////////////////////////////////////////////
	
	$html.='<table>
	<tr>
	<td colspan="4" style=" text-align:left;"><b>LINE CLEARANCE FOR MANUFACTURING ( Pre-processing checks)</b> </td>
	
	</tr>
	
	<tr>
	<td  colspan="" style=" text-align:left; width:40%  "><b>Parameter To Be Check</b> </td>
	<td colspan="" style=" text-align:Center; width:20%"><b>Please (Tick)</b> </td>
	<td colspan="2" style=" text-align:Center; width:40% "><b>Remark</b> </td>
	
	</tr>
	<tr>
	<td colspan="" style=" text-align:left;"><b>1) Machine Name & No.</b> </td>
	<td colspan="" style=" text-align:center;"><input type="checkbox" name="1" value="1"></td>
	<td colspan="2" style=" text-align:left;"><b></b> </td>
	</tr>
	<tr>
	<td colspan="" style=" text-align:left;"><b>2) M/c Cleanin done by operator</b> </td>
	<td colspan="" style=" text-align:center;"><input type="checkbox" name="2" value="2"></td>
	<td colspan="2" style=" text-align:left;"><b></b> </td>
	</tr>
	<tr>
	<td colspan="" style=" text-align:left;"><b>3) Tools & Equipments</b> </td>
	<td colspan="" style=" text-align:center;"><input type="checkbox" name="3" value="3"></td>
	<td colspan="2" style=" text-align:left;"><b></b> </td>
	</tr>
	<tr>
	<td colspan="" style=" text-align:left;"><b>4) Measuring Istruments</b> </td>
	<td colspan="" style=" text-align:center;"><input type="checkbox" name="4" value="4"></td>
	<td colspan="2" style=" text-align:left;"><b></b> </td>
	</tr>
	<tr>
	<td colspan="" style=" text-align:left;"><b>5) Drawing Availability</b> </td>
	<td colspan="" style=" text-align:center;"><input type="checkbox" name="5" value="5"></td>
	<td colspan="2" style=" text-align:left;"><b></b> </td>
	</tr>
	<tr>
	<td colspan="" style=" text-align:left;"><b>6) Shop floor area</b> </td>
	<td colspan="" style=" text-align:center;"><input type="checkbox" name="6" value="6"></td>
	<td colspan="2" style=" text-align:left;"><b></b> </td>
	</tr>
	<tr>
	<td colspan="" style=" text-align:left;"><b></b> </td>
	<td colspan="" style=" text-align:center;"><input type="checkbox" name="6" value="6"></td>
	<td colspan="2" style=" text-align:left;"><b></b> </td>
	</tr>
	</table>
	...
	<table>
	<tr style="border-top:1px solid; border-left:1px solid; border-right:1px solid;    ">
	<td colspan="" style=" text-align:left; width:50%; height:100px;border-right:none;">Cleaned On : </td>
	<td colspan="" style=" text-align:left; width:50%; height:100px; border-left:none;">By : </td>
	</tr>
	</table>
	
	<table>
	<tr style="border-top:1px solid; border-left:1px solid; border-right:1px solid;    ">
	<td colspan="" style=" text-align:left; width:50%; ">Released By QC : </td>
	<td colspan="" style=" text-align:left; width:50%; ">Date : </td>
	</tr>
	</table>
	<table>
	<tr  style="border-top:1px solid; border-left:1px solid; border-right:1px solid;    ">
	<td colspan="4" style="text-align:Left;font-size:16px;padding-bottom:0px; height:35px;">
	<br><br>
	Check the equipment cleanliness & accessories cleanliness with respective SOP.
	<br><br>
	Abbreviation : - <br>
	1.0 BMR- Batch Manufacturing Report<br>
	2.0 Mfg.- Manufacturing<br>
	3.0 RM- Row Material<br>
	4.0 QA- Quality Assurance<br>
	5.0 FIR- Final Inspection Register<br>
	6.0 Dept.- Department<br>
	7.0 SMPL- Smit Medimed Pvt.Ltd.<br>
	8.0 ORN- Order Registration Number<br><br>
	</td>
	</tr>
	</table>
	<table>
