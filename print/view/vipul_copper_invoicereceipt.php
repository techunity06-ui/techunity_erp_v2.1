													...
													<tbody style="border: none;">
														...
														//tax summary calculation start
															...
															<tr style="height:25px">
																...
																<?php
																$i++; 
																$mtotalnoofpack+=$row['no_of_pack'];
                                          $mtotalqty+=$row['product_qty'];
                                          $mtotalsqr=$totalsqr+$row['sqr_ft']-$charges_qty1;
                                          $mtotal_product_amount+=($row['product_qty']*$row['product_rate']);
                                          $mtotaltaxable+=$row['taxable_value'];
                                          $mtotaltax1+=$row['tax_amount1'];
                                          $mtotaltax2+=$row['tax_amount2'];
                                          $mtotal+=$row['total'];
		                                          ...
		                                          <td class="borderleftadd" style="border:1px solid; text-align:right  !important;" colspan="3">
		                                             <strong>Groupwise Sub Total</strong>
		                                          </td>
		                                          <td style="text-align:center  !important; border:1px solid;" >
		                                             <strong><?=$mtotalnoofpack?></strong>
		                                          </td>
		                                          <td style="text-align:center  !important; border:1px solid;">
		                                             <strong><?=number_format($mtotalqty,2,".","")?></strong>
		                                          </td>
		                                          <?phpif($rel_disc['discount'] > 0){ ?>
		                                          <td style="border:1px solid;"></td>
		                                          <?}?>
		                                          <td style="border:1px solid;"></td>
		                                          <td style="border:1px solid; text-align:right  !important;">
		                                             <strong><?=number_format($mtotaltaxable,2,".","")?></strong>
		                                          </td>
		                                          <td style="border:1px solid; text-align:right  !important;">
		                                          </td>
		                                          <td style="border:1px solid; text-align:right  !important;">
		                                             <strong><?=number_format($mtotaltax1+$totaltax2,2,".","")?></strong>
		                                          </td>
		                                          <td style="border:1px solid; text-align:right  !important;">
		                                             <strong><?=number_format($mtotal,2,".","")?></strong>
		                                          </td>
		                                       </tr>
		                                       <?php 
                                          		$mtotalnoofpack=0;
