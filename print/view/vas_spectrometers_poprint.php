					...
					<tr style="height:40px">
						...
						<tr style="height:20px">
							...
							<?phpif($set_head['show_disc']=='1'){?>
								...
								<td style="border-top:1px solid;border-right:1px solid;text-align:right;"><strong><?=($rel['stateid']==$set_head['stateid']) ? number_format(($total_cs_gst/2),2,".","") : number_format(($total_i_gst),2,".","")?></strong></td>
							...
							<tr>
								...
								<tr height="20px">
									<td  style="border-right:1px solid;border-top:1px solid; font-size:12px;" colspan="<?=$colspan?>">COMPANY GST No. : <?=$set_head['vatno']?>
									</td>
									<td colspan="3" style="border-top:1px solid;border-right:1px solid;font-size:12px;text-align:left  !important" >
										CGST
									</td>
									<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:12px;border-left:1px solid; "><?=number_format(($total_cs_gst/2),2,".","")?></td>
								</tr>
								<tr height="20px">
							...
							<?php }else{ ?>
								<tr height="20px">
									...
									<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:12px;border-left:1px solid; "><?=number_format($total_i_gst,2,".","")?></td>
								</tr>
							...
							while($row11=mysqli_fetch_assoc($result11)) { ?>
								...
								<tr height="20px">
									...
									<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:12px;border-left:1px solid; "><?=number_format($row11['add_sum'],2,".","")?></td>
								</tr>
							...
							while($row12=mysqli_fetch_assoc($result12)) { ?>
								...
								<tr height="20px">
									...
									<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:12px;border-left:1px solid; "><?=number_format($row12['sundry_amount'],2,".","")?></td>
								</tr>
							...
							$colspan = 6; ?>
								<tr height="20px">
									...
									?></td>
									<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:12px;border-left:1px solid; "><?=number_format($totaltax2,2,".","")?></td>
								</tr>
							...
							<tr height="20px">
								...
								<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:12px;border-left:1px solid; ">
