...
//Amish Soni End 16-03-2021
		...
		.page{
			...
			<div>
				...
				<table style="font-size:14px; border-collapse: collapse;width:100%;" cellpadding="5" cellspacing="5">
					<tr>
						...
						<td width="10%" style="border:1px solid;border-right:0px solid;border-bottom:0px solid;vertical-align: top;"><strong>P.I No.</strong></td>
						<td width="1%" style="border:1px solid;border-left:0px solid;border-right:0px solid;border-bottom:0px solid;vertical-align: top;"><strong>:</strong></td>
					...
					<tr>
						...
						<td width="1%" style="border:1px solid;border-left:0px solid;border-right:0px solid;border-top:0px solid;vertical-align: top;"><strong>:</strong></td>
						<td width="15%" style="border:1px solid;border-left:0px solid;border-top:0px solid;vertical-align: top;">'.$consinee_user_name.' </td>
					</tr>
				</table>
			...
			<th style="width:13%;text-align:center;border:1px solid;">PRICE</th>
			';
			
			if($disc_qrys['discount'] > 0){
				$html.='<th style="width:12%;text-align:center;border:1px solid;">DISC </th>';
			}
		...
		//tax summary calculation start
				...
				if($disc_qrys['discount'] > 0){
					...
					'.$currency_symbol.' '.indian_number($trn_rel['product_discount_conv'],0).'<br>('.$trn_rel['discount_per'].' %)
					</td>';
				}
