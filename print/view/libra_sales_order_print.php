...
$delivery_date='';$sfg_date='';$po_date='';
						...
						<section class="panel">
							...
							<div class="panel-body">
								...
								<div class="col-lg-12" id="receipt_print">	<div class="col-md-12 breakout" style=" margin-top:10px;" id="print1">
									...
									border-color: black;
									margin-top: 0px;
									border: none; padding:17px 0 0;" id="table_head" width="100%">
											...
											<tr>
												<th colspan="5" style="padding:0px !important;">
													<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
														<!--<thead>-->
															<tr>
																...
																<td rowspan="7" width="55%" style="vertical-align:top;border:1px solid;padding-bottom:0px !important;border-right:none">
																	M/s,<br>
													...
													<tbody style="border: 1px solid;">
														...
														$qry="select trn.*, per.unit_name, product.product_icode,product.product_alias_name,product.product_name FROM `tbl_sales_ordertrn` as trn left join product_mst as product on product.product_id=trn.product_id left join unit_mst as per on per.unitid=trn.unit_id where sales_ordertrn_status=0 and sales_order_id=".$rel['sales_order_id'];
