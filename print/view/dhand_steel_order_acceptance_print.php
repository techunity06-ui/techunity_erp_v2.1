...
//Quotation Data
	$query="select invoice.*,country.country_name,state.state_name,city.city_name,cust.l_name as company_name,cust.m_address as cust_address,cust.cust_pincode,cust.cust_mobile,cust.gst_no,cust.m_pan,per.c_con_fname,per.c_con_lname,state.gst_state_code,td.transportation_name,cust.cust_cont_name
...
<table>
<tr>
<td colspan="3" style="border: 0px; "><img src="'.DOMAIN_F.LOGO.$comp_rel['logo'].'" style="width:210px;height:100px;" /></td>
...
.page{
	...
	<tr style="">
	<td colspan="9" style=" text-align:left;font-size:14px;">
	Total Tax (In Words): <span style="font-weight:bold;font-size:13px;">'.convert_number_to_words_new($gst_rate).'</span></td>
	</tr>
	<tr style="">
