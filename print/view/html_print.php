							...
							<div class="panel-body">
								<center>
									...
									<div class="col-md-4">
										...
										<a href="javascript:;" onClick="tableToExcel('invoice_type', '<?=$form?>')" ><button class="btn btn-success btn-flat" >Export Excel</button></a>

										<a href="javascript:;" onClick="exportFile()" ><button class="btn btn-warning btn-flat" >With Out Format Export Excel</button></a>
									</div>
								</center>	
												...
												<table class="footer-table" width="100%">
													...
													<tr height="50px" style="border-bottom:none;">
														...
														<td colspan="2" style="vertical-align:top;text-align:right;">
																<img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature']?>" style="height: 100px; width: 180px;">
														</td>
													</tr>
													<tr height="20px">
