  ...
  display: table;
	...
	<tr>';
		...
		$html .= '<tr>
			...
			<tr>
			<td colspan="7" style="border-top:1px solid;text-align:left;"><b>Amount in words : ' . ucfirst(convert_number_to_words_new($rel['g_total'], $rel['currency_id'], $currency_word_start, $currency_word_end)) . '
			</b></td>
