...
if(strtolower($type) == 'pdf') {
	$query="SELECT invoice.*, country.country_name, state.state_name, cust.stateid, state.gst_state_code, city.city_name, cust.l_name, cust.m_address, type.invoice_type, cust_pincode, cust_mobile, gst_no, dispatch.mode_dispatch, cust.m_pan, cust.enable_sez, pay.payment_terms as terms from tbl_invoice as invoice 
	...
	if($company_config['finance_print_letterhead_per']==0){
		...
		<tr>
		<td style="border-bottom:1px solid;border-left:1px solid;white-space:nowrap;border-right:none;vertical-align:top">Delivery Note</td>
		<!--<td style="border-bottom:1px solid;border-right:1px solid;border-left:none;">: '.(($rel['challan_no']) ? $rel['challan_no'] : '').' </td>-->
		<td style="border-bottom:1px solid;border-right:none;vertical-align:top">Mode/Terms of Payment  <br><strong> '.$rel['terms'].'</strong></td>
		...
		<td style="border-bottom:1px solid;border-left:1px solid;border-right:none;vertical-align:top">Reference No. & Date </td>
		<!--<td style="border-bottom:1px solid;border-right:1px solid;border-left:none;">: '.$po_number.' </td>-->
		<td style="border-bottom:1px solid;border-right:none;vertical-align:top">Other Reference </td>
		...
		<tr style="height:40px">
		<td style="border-bottom:1px solid;border-left:1px solid; border-right:none;vertical-align:top">Buyers Order No<br><strong>'.$po_number.'</strong></td>
		<!--<td style="border-bottom:1px solid;border-right:1px solid;border-left:none;">: '.$set_head['state_name'].'</td>-->
		<td class="boderremoveres" style="border-bottom:1px solid;border-right:none;vertical-align:top">Date <br><strong> '.$po_number_date.'</strong></td>
		...
		<tr>
		<td rowspan="4" style="vertical-align:top;border-right:1px solid;border-left:1px solid;"><b>Buyer (Bill To) : </b><br/><strong>'.$rel['l_name'].'</strong><br><span style="font-weight:normal;">'.$rel['m_address'].'<br/>'.$rel['city_name'].', '.$rel['state_name'].', '.$rel['country_name'];
		...
		<td style="vertical-align:top;border-right:1px solid;border-left:1px solid;height:40px">Dispatch Through <br> <strong>'.$r_t['transportation_name'].'</strong></td>
		<td style="vertical-align:top;border-right:1px solid;border-left:1px solid;">Destination <br> <strong>'.$place_of_supply.'</strong></td>';
		
		$header.='</tr>
		<tr style="height:40px">
			<td style="vertical-align:top;border-right:1px solid;border-left:1px solid;">Motor Vehicle No <br> <strong>'.$r_t['transport_vehicle_no'].'</strong></td>
			<td style="vertical-align:top;border-right:1px solid;border-left:1px solid;">LR-RR No <br> <strong>'.$r_t['transport_gr_no'].'</strong></td>
		</tr>
		<tr style="height:40px">
		<td style="border-bottom:1px solid;border-left:1px solid;white-space:nowrap;border-right:none;vertical-align:top">Dispatch Doc No. <br> <strong>'.$rel['challan_no'].'</strong></td>
		<!--<td style="border-bottom:1px solid;border-right:1px solid;border-left:none;">: '.$rel['eway_bill_no'].'</td>-->
		<td class="boderremoveres" style="border-bottom:1px solid;border-right:none;vertical-align:top">Delivery Note Date <br> <strong>'.$challan_date.'</strong></td>
		...
		if($rel['enable_consignee']==1) {
			$header.='<td  style="vertical-align:top;border-right:1px solid"><b>Consignee (Ship to) : </b><br><strong>'.$rel['l_name'].'</strong><br><span style="font-weight:normal;">'.$rel['m_address'].'<br/>'.$rel['city_name'].', '.$rel['state_name'].', '.$rel['country_name'];
			if(!empty($rel['cust_pincode'])){
				$header.='-  '.$rel['cust_pincode'];
			}
			$header.='</span><br>';
			...
			$header.='<td  style="vertical-align:top;border-right:1px solid"><b>Consignee (Ship to) : </b><br><strong>'.$cons_data['company_name'].'</strong><span style="font-weight:normal;">'.$cons_data['m_address'].'<br/>'.$cons_data['city_name'].', '.$cons_data['state_name'].', '.$cons_data['country_name'];
		...
		$header .='<td colspan="2" style="border-top:none;vertical-align:top">'.nl2br($rel['remark']).'</td></tr></table>';
		$footer = '';
	}else{
		$header ='';
		$footer = '';
	...
	.page{
		...
		$html.='<th width="9%" style="border:1px solid;border-top: none;"><strong>Amount</strong></th>';
		...
		while($row=brp_mysqli_fetch_assoc($result))
		{
			...
			$html.='</td>
			<td style=" border-right:1px solid;vertical-align:top;border-bottom:none;border-top:none" >'.$row['product_hsn_code'].'</td>
			...
			$html.='</strong></td>
			<td style="vertical-align:top; border-right:1px solid; text-align: center;border-bottom:none;border-top:none" >'.number_format($row['product_rate_conv'],2).'</td>
			...
			$html.='<td style=" vertical-align:top;border-right:1px solid; text-align: center;border-bottom:none;border-top:none"><strong>'.number_format(($row['product_amount_conv']),2).'</strong>	</td>';
			/*if($company_config['tax_editable'] == 0 && $rel['sales_type'] == 1 ){
		...
		if($rel['stateid']==$set_head['stateid'] && ($custLedgerDetails['enable_sez'] == 0)){
			...
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="text-align: center; border-top:1px solid;border-left:1px solid;;border-bottom:none;border-top:none "><strong>'.number_format($c_gst,2).'</strong></td>
			</tr>
			...
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="text-align:center; border-top:1px solid;border-left:1px solid;;border-bottom:none;border-top:none "><strong>'.number_format($s_gst,2).'</strong></td>
			</tr>';
		}else{
			$html.='<tr style="height:25px;border-bottom:none;border-top:none">
			...
			<td style="border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="text-align:center; border-left:1px solid;border-bottom:none;border-top:none "><strong>'.number_format($i_gst,2).'</strong></td>
			</tr>';
		}
		...
		foreach ($get_bill_sundry as $billsundry) {
			...
			if(($billsundry['l_name'] == 'TCS') && ($company_config['enable_tcs_reporting'] == 1) && ($custLedgerDetails['enable_tcs']==1) && ($arr >= $company_config['gross_balance_limit'])){
				...
				<td style="border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
				<td style="border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
				<td style="text-align:center; border-left:1px solid;border-bottom:none;border-top:none "><strong>'.(($rel['currency_id']==$company_state['currency_id']) ? round((($total_tcs_calculate*$billsundry['tax_value'])/100),2) : round((($total_tcs_calculate_conv*$billsundry['tax_value'])/100),2)).'</strong></td>
				</tr>';
			}
		}
		...
		while($row11=brp_mysqli_fetch_assoc($result11)){
			...
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="text-align:center; border-top:1px solid;border-left:1px solid; border-bottom:none;border-top:none"><strong>'.number_format($row11['add_sum'],2).'</strong></td>
			</tr>';
		} 
		...
		while($row12=brp_mysqli_fetch_assoc($result12)){
			...
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="text-align:center; border-top:1px solid;border-left:1px solid;border-bottom:none;border-top:none "><strong>'.number_format($row12['sundry_amount_conv'],2).'</strong></td>
			</tr>';
		}
		if($tax_name[1]) { 
			$html.='<tr style="height:25px;border-bottom:none;border-top:none">
		...
		$html .='<tr style="height:25px;border-bottom:none;border-top:none">
			...
			<td style="border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="border-right:1px solid;font-size:10px;text-align:left;border-bottom:none;border-top:none" ></td>
			<td style="text-align:center; border-left:1px solid;border-bottom:none;border-top:none "><strong>'.number_format($rel['round_off'],2).'</strong></td>
		</tr>';
		$lines = 4;
		for($i=1; $i<=$lines; $i++){
			$html .='<tr style="height:20px;border-bottom:none;border-top:none">
		...
		$html.='<td style="border-top:1px solid;border-right:1px solid;"></td>
		<td style="border-top:1px solid;border-right:1px solid;text-align:center;"><strong>'.number_format($rel['g_total_conv'],0).'.00'.'</strong></td>';
		/*if($company_config['tax_editable'] == 0 && $rel['sales_type'] == 1 ){
		...
		if($company_config['tax_editable'] == 0){
			if($rel['sales_type']==1){
				if($rel['stateid']==$set_head['stateid']){
					$html.='<table border="0" style="font-size:10px;padding:0px" width="100%">
					<tr> 
					...
					$html.='<table border="0" style="font-size:10px;text-align:right;padding:0px" width="100%">
					<tr> 
					<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>HSN Code</strong></td>
					<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>Taxable Amt.</strong></td>
				...
				{	
					...
					<td style="vertical-align:top;text-align:center;border-right:1px solid;border-bottom:1px solid;" >
					'.number_format($rel_tax['product_amount'],2).'
					</td>';
					if($rel['stateid']==$set_head['stateid']){
						...
						<td style="vertical-align:top;text-align:center;border-right:1px solid;border-bottom:1px solid;" >
						'.number_format($rel_tax['cgst_tax_rate'],2).'
						</td>
						<td style="vertical-align:top;text-align:center;border-right:1px solid;border-bottom:1px solid;" >
						'.str_replace("SGST","",$rel_tax['sgst_tax_per']).'
						</td>
						<td style="vertical-align:top;text-align:center;border-right:1px solid;border-bottom:1px solid;" >
						'.number_format($rel_tax['sgst_tax_rate'],2).'
						</td>';
					}else if($rel['stateid']!=$set_head['stateid']) {
						$html.='<td style="vertical-align:top;text-align:center;border-right:1px solid;border-bottom:1px solid;" >
						...
						<td style="vertical-align:top;text-align:center;border-right:1px solid;border-bottom:1px solid;" >
						'.number_format($rel_tax['igst_tax_rate'],2).'
						</td>';
					}
		...
		$html .='<table width="100%" style="border: none;">
			...
			<tr style="height:20px;border-bottom:none;border-top:none;line-height: 0.5;padding:0px">
				<td style=" width:25%;border-top:none;border-bottom:none;border-right:none;vertical-align:top;text-align:left;padding:0px;">Company GST IN</td>
		...
		$mpdf=new mPDF('','A4','0','calibri','10','10','110','10','1','1');
