...
//Amish Soni End 16-03-2021
		...
		.page{
			...
			<table style="width: 100%;">	
				<tbody>	
					<tr>	
						<td style="width: 35%; text-align: right; font-size:18px;"><center><strong>'.$form.'</strong></center></td>	
					</tr>	
				</tbody>	
			</table>
			...
			Company Name : <strong>'.$rel['cust_name'].'</strong><br/>
			Address : <strong>'.($quot_address).'</strong><br />
			GST NO. : <strong>'.$rel['cust_gst'].'</strong><br />
			Tel No. : <strong>'.$rel['cust_mobile'].'</strong><br />
			Contact Person :<strong>'.$rel['c_con_fname'].' '.$rel['c_con_lname'].' <br />	
			Email Id: '.strtolower($rel['c_con_email']).' </strong>
