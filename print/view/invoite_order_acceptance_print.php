...
';
	...
	.page{
		...
		//	$product_desc = ($trn_rel['description']!='0') ? nl2br($trn_rel['description']) : '';
			$product_desc = $trn_rel['description'];
		...
		<tr style="">
		<td colspan="9" style=" text-align:left;font-size:14px;">
		Total Tax (In Words): <span style="font-weight:bold;font-size:13px;">'.(($rel['currency_id']=='1') ? convert_number_to_words_new($gst_rate,$rel['currency_id'],$currency_word_end,$currency_word_start) : convert_number_to_words_new($gst_rate,$rel['currency_id'],$currency_word_end,$currency_word_start)).'</span></td>
		</tr>
		<tr style="">
		...
		<tr style="border-bottom: 0px; ">
		<td style=" text-align:right;font-size:14px;font-weight:bold;height:45px;vertical-align: top;">
