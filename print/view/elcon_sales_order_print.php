									...
									<div class="panel-body">
										<center>
											<div class="col-sm-5"  style="padding-left:0;">
												<label class="col-md-2 control-label" style="padding:10px 0;">Print</label>
											...
											<div class="col-sm-3 col-xs-6">
												<label class=" control-label col-xs-7" style="padding-top: 10px; padding:10px 0 0;">With Logo</label>
												<div class="  col-xs-5">
										...
										<div class="col-lg-12" id="receipt_print">	
											<div class="col-md-12 breakout" style=" margin-top:10px;" id="print1">
												...
												<!--<table  class="maintable headermain " border="2" style="border-radius: 10px;border-collapse: separate;border-width: 2px;border-color: black;margin-top: 23px;border: 1px solid; padding:17px 0 0;" id="table_head" width="100%">-->
													
													<table  class="maintable headermain " border="0" style=" padding:17px 0 0;" id="table_head" width="100%">
														<tr style="border:none;">
															<td width="100%" style="border:none;padding:0px 0px !important;"> 
																<img src="<?=DOMAIN.LOGO.$set_head['logo']?>"  style="width:100%"/>
											...
											<table width="100%" class="maintable" style="font-size: 11px;   border-right: 1px solid !important; border-left: 1px solid !important;" id="invoice_type" >
												<thead>
													<tr>
														<th colspan="5" style="padding:0px !important;">
															<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
																<tr>
																	<td width="25%" style="vertical-align:top;border-top:1px solid;border-left:none;white-space:nowrap;">
																		<strong>Order No   </strong>
																	</td>
																	<td width="25%" style="vertical-align:top;border-right:1px solid;border-top:1px solid;border-left:none">
																		<strong>: <?=$rel['sales_order_no']?> </strong>
																	</td>
																	<td width="50%" colspan="2" rowspan="4" style="vertical-align:top;border:1px solid;border-right:none;border-left:none;">
																		<?=$party_address?>
																	</td>
																</tr>
																<tr>
																	<td style="vertical-align:top;border-top:1px solid;border-left:none;white-space:nowrap;">
																		<strong>Order Date </strong>
																	</td>
																	<td style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>: <?=date('d/m/y',strtotime($rel['sales_order_date']))?> </strong>
																	</td>
																</tr>
																<tr>
																	...
																	<td style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none">
																		<strong>: <?=date('h:i:s a',strtotime($rel['cdate']))?> </strong>
																	</td>
																</tr>
																<tr>
																	<td style="vertical-align:top;border-top:1px solid;border-left:none;white-space:nowrap;">
																...
																<tr>
																	...
																	<td style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>: <?=$rel['order_by']?> </strong>
																	</td>
																	<td colspan="2" rowspan="3" style="vertical-align:top;border:1px solid;border-right:none;border-left:none;">
																		<?=$party_address_con?>
																	</td>
																</tr>
																<tr>
																	...
																	<td style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>: <?=$rel['po_no']?> </strong>
																	</td>
																</tr>
																<tr>
																	<td style="vertical-align:top;border-top:1px solid;border-bottom:1px solid;border-left:none;white-space:nowrap;">
													...
													<tr height="30px">					
														...
														<th width="65%"  style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;" ><strong>Product Name</strong></th>
