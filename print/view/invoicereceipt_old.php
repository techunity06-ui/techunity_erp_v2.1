											...
											<table  class="maintable headermain " id="table_head" width="100%">
												<tr style="border:none;">
													<td width="100%" style="border:none;">
														<img src="<?=ROOT.LOGO.$set_head['logo']?>"  style="width:2.27in;"/>
												...
												<table width="100%" class="maintable" style=" font-size:11px" id="invoice_type" >
													<thead id="fiac">
														<tr>
															<th colspan="11" style="padding:0px !important;">
																...
																<?php } ?>
																<tr>
																		<td class="" style="vertical-align:top;border:1px solid; border-right:none !important;text-align: left;" colspan="3">
																		...
																		<td width="20%" colspan="3" style="vertical-align:top;border-bottom:1px solid; border-right:1px solid;border-top:1px solid;text-align: right;">
																			<img style="height: 50%;width: 50%;"  src="data:image/png;base64,<?php echo $rel['einv_SignedQRCode'] ?>" />
																		</td>
													...
													<tr>
														...
														<?php if($rel_disc['discount'] > 0){ ?>
															...
															<?php if($company_config['tax_editable'] == 0 && $rel['sales_type'] == 1 ){ ?>
													...
													<tbody style="border: none;">
														...
														//tax summary calculation start
															...
															<tr style="height:20px">
																...
																<td style="border-top:1px solid;border-right:1px solid;text-align:right  !important;">
																	<strong><?=number_format($total_gst_rate,2,".","")?></strong>
																</td>
																<td style="border-top:1px solid;border-right:1px solid;text-align:right  !important;">
																...
																<td class="borderleftadd" colspan="11" style="padding: 0px !important;border:1px solid">
																	...
																	<?php if($rel['formulaid']){
																		...
																		<tr height="20px">
																			...
																			<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-left:1px solid; "><?= $rel['round_off']; ?></td>
																		</tr>
																		<tr height="20px">
																			<td style="border-right:1px solid;border-top:1px solid;font-size:10px;" colspan="<?=$colspan?>">
