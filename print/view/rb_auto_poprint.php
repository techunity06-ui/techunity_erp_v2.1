...
//$footer='<img src="'.DOMAIN_F.LOGO.$comp_rel['f_logo'].'" style="padding-left:0px !important;width:8.27in"/>';
	...
	.page{
		...
		$html.='<tr>
		<td colspan="5" rowspan="'.$rows.'" style="text-align:left; vertical-align: top; color: red; font-weight: bold;">REMARKS: '.$remark.'</td>
		...
		<tr>
		<td colspan="8" style="text-align: right; font-weight: bold;">Total In Words: '.ucwords(convert_number_to_words_new($rel['g_total_conv'],$rel['currency_id'],$currency_code['currency_in_word_end'],$currency_code['currency_in_word'])).'</td>
		</tr>
		<tr>
		<td colspan="8" style="vertical-align:bottom; text-align: right; height: 80px;"><img src="'.DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature'].'" style="height: 75px;width: 75px;"/><br>Authorised Signatory</td>
		</tr>
		</tbody></table>
