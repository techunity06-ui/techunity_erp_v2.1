...
//$header ='<div style="text-align:right;"><img src="'.DOMAIN_F.LOGO.'Hermettic_Equipments.png" style="width:8.27in;padding-top:20px;" /></div>';  
	...
	$header = get_header($dbcon,'text-align: left','250px','130px');
...
//$sundrytax_rels = mysqli_fetch_assoc($sundrytax);
	...
	.page{
		...
		while($row=mysqli_fetch_assoc($result))
		{
			...
			if($row['rate_unit'] != $row['unit_id']){
				$pqty = number_format($row['sh_conv_qty'],2,".","").' '.$row['conv_unit_name'].'<br>'.number_format($row['sh_qty'],2,".","").' '.$row['base_unit_name'];
			}else{
			...
			$html .='</td>
			<td style="text-align:center;vertical-align:top;border-bottom:1px solid;border-right:1px solid">'.$row['product_hsn_code'].'</td>
			<td style="text-align:center;vertical-align:top;border-bottom:1px solid;border-right:1px solid">
			'.$pqty.'
			</td>
			<td style="text-align:center;vertical-align:top;border-bottom:1px solid;border-right:1px solid">'.number_format($product_rate,2,".","").'</td>';
			/*if($get_disc['discount'] > 0.00){
			...
			$html.='<td style="text-align:center;vertical-align:top;border-bottom:1px solid;border-right:1px solid">'.$gst_per.' %</td>
			<td style="text-align:right;vertical-align:top;border-bottom:1px solid;border-right:1px solid">'.number_format($gst_rate,2,".","").'</td>
		...
		for($j=0; $j<$pr; $j++){
			$html .= '<tr style="height:30px">
				<td style="text-align:center;border:none;vertical-align:top;"></td>
				<td style="text-align:center;border:none;vertical-align:top;"></td>
				<td style="text-align:center;border:none;vertical-align:top;"></td>
				<td style="text-align:center;border:none;vertical-align:top;"></td>
				<td style="text-align:center;border:none;vertical-align:top;"></td>
	...
	///////////////////////////////////////////////////////////////////Tax Calculation End////////////////////////////////////////////////////////			
				...
				<td colspan="" rowspan="0" style="height:80px; width:50%;  text-align:left; vertical-align:top; border-left:1px solid; border-bottom:1px solid !important;border-top:1px solid; font-weight: bold;"><strong>Remarks:</strong><br> '.$rel['remark'].'</td>
				<td colspan="" style="text-align:center;vertical-align:top;font-weight: bold;height:80px; width:50%;border-top:1px solid;border-bottom:1px solid;border-right:1px solid">For, '.$set_head['company_name'].'
