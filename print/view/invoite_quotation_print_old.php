...
//Amish Soni End 16-03-2021
		...
		.page{
			...
			<table style="font-size:12px; width:100%;" cellpadding="0" cellspacing="0">
				<tr>
					<td width="10%" style="border-left:1px solid;"><strong>Cust. Name</strong></td>
					<td width="1%" style="border:0px solid;"><strong>:</strong></td>
				...
				<tr>
					<td style="border-left:1px solid;"><strong>Kind. Attn</strong></td>
					<td style="border:0px solid;"><strong>:</strong></td>
					<td style="border-right:0px solid;">'.$rel['c_con_fname'].' '.$rel['c_con_lname'].'</td>
					
					<td style="border-left:0px solid;"><strong>Mob.No</strong></td>
					<td style="border:0px solid;"><strong>:</strong></td>
					<td style="border-right:1px solid;">'.$rel['c_con_mobile'].'</td>
				...
				<tr>
					<td style="border-left:1px solid;"><strong>Address</strong></td>
					<td style="border:0px solid;"><strong>:</strong></td>
					<td colspan="4" style="border-right:0px solid;">'.($quot_address).'</td>
				</tr>
				<tr>
					<td style="border-left:1px solid;border-bottom:1px solid;"><strong>Email Id</strong></td>
					<td style="border:0px solid;border-bottom:1px solid;"><strong>:</strong></td>
					<td colspan="4" style="border-right:0px solid;border-bottom:1px solid;">'.$rel['c_con_email'].'</td>
				</tr>
			</table>
			<table style="font-size:12px; width:100%;" cellpadding="1" cellspacing="1">
				<tr>
			...
			<table style="font-size:14px;border-collapse: collapse;width:100%;" cellpadding="3" cellspacing="3">
				<thead>
					...
					$html.='<th style="width:10%;text-align:center;border:1px solid;">GST <br>'.$currency_name.'</th>
							<th style="width:15%;text-align:center;border:1px solid;">AMOUNT <br>'.$currency_name.'</th>
					</tr>
				</thead>
				<tbody>';
			if($inquiry_type!="2"){
