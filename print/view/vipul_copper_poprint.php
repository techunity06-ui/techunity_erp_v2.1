...
<body>
	<section id="container" >
										...
										<table width="100%" class="maintable" border="1" id="table_head" style="border-radius:6px;border-collapse: separate; border-width: 2px;    border-color: black;" >
											<tr style="border:none;">
												<td width="100%" style="border:none;"> 
													<img src="<?php echo DOMAIN_F.LOGO.$set_head['logo']?>" style="width:100%;" />
												</td>
											</tr>
										</table>
		...
		<tbody style="border: 1px solid;">
			...
			$i=1;$total=0;$discount=0;$totalqty=0;$charges_qty=0;$total_cs_gst=0;$total_i_gst=0;
						...
						<table class="footer-table" width="100%">
							...
							<?php if($rel['stateid']==$set_head['stateid']){ ?>
								<tr height="20px">
									...
									<td colspan="3" style="border-top:1px solid;border-right:1px solid;text-align:left" >CGST (<?=number_format(($gst_per/2),2,".","")?> %)</td>
									<td colspan="2" style="text-align:right; border-top:1px solid;border-left:1px solid; "><?=number_format(($total_cs_gst/2),2,".","")?></td>
								</tr>
								<tr height="20px">
									<td style="border-right:1px solid;border-top:1px solid;" colspan="<?=$colspan?>"></td>
									<td colspan="3" style="border-top:1px solid;border-right:1px solid;text-align:left" >SGST (<?=number_format(($gst_per/2),2,".","")?> %)</td>
									<td colspan="2" style="text-align:right; border-top:1px solid;border-left:1px solid; "><?=number_format(($total_cs_gst/2),2,".","")?></td>
								</tr>
							<?php } else{ ?>
								<tr height="20px">
									<td style="border-right:1px solid;border-top:1px solid;" colspan="<?=$colspan?>"></td>
									<td colspan="3" style="border-top:1px solid;border-right:1px solid;text-align:left" >IGST (<?=number_format(($gst_per),2,".","")?> %)</td>
