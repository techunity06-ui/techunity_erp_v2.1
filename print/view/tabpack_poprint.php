									...
									<div class="col-lg-12 table-responsive" id="receipt_print">	<div class="col-md-12" style=" margin-top:10px;" id="print1">
										...
										<table width="100%" class="maintable" style="font-size: 12px;margin-top: 5px;" id="invoice_type" >
													...
													<th colspan="10" style="padding:0px !important;">
														<table style="font-size:12px;border-collapse: collapse;border-top:none;" cellpadding="0" cellspacing="0" width="100%" >
															...
															<tr>
																...
																<td width="20%" style="vertical-align:top;border:1px solid;border-right:none;white-space: nowrap;">
																	<strong>Vendor Ref./ Quote No.</strong>
																</td>
																<td width="30%" style="vertical-align:top;border:1px solid;border-left:none;">
																	<strong>: NA</strong>
																</td>
															...
															<tr>
																...
																<td style="vertical-align:top;border:1px solid;border-right:none;white-space: nowrap;">
																	<strong>Vendor Ref./ Quote Date  </strong>
																</td>
																<td style="vertical-align:top;border:1px solid;border-left:none;">
																	<strong>: NA</strong>
																</td>
															...
															<tr style="border-bottom:none;">
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none;">Vendor Name</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;"><strong>: <?=$rel['vender_name']?></strong></td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none;">Dispatch To</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;">: <strong><?=$cons_name?></strong></td>
															</tr>
															<tr style="border-bottom:none;border-top:none;">
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none; vertical-align: top;">Address</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;">: <?=$rel['vender_address']?><br><?=$rel['city_name']?>, <?=$rel['state_name']?>, <?=$rel['country_name']?></td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none;vertical-align: top;">Address</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;vertical-align: top;">: <?=$consignee_address?></td>
															</tr>
															<tr style="border-bottom:none;border-top:none;">
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none;">GSTIN</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;">: <?=$rel['tin_no']?></td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none;">GSTIN</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;">: <?=$set_head['vatno']?></td>
															</tr>
															<tr style="border-bottom:none;border-top:none;">
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none;">Email</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;">: <?=$rel['vennder_email']?></td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-right:none;">Email</td>
																<td style="border:1px solid;border-top:none;border-bottom:none;border-left:none;">: <?=$set_head['website']?></td>
															</tr>
															<tr style="border-top:none;">
																<td style="border:1px solid;border-top:none;border-right:none;">Phone No</td>
																<td style="border:1px solid;border-top:none;border-left:none;">: <?=$rel['vender_mobile']?></td>
																<td style="border:1px solid;border-top:none;border-right:none;">Phone No</td>
																<td style="border:1px solid;border-top:none;border-left:none;">: <?=$set_head['contact_no']?></td>
															</tr>
														</table>
													</th>
												</tr>
											...
											<tbody style="border: 1px solid;">
												...
												<?php if($rel['stateid']==$set_head['stateid']){ ?>
													<tr height="20px">
														<td  style="border-right:1px solid;border-top:1px solid; font-size:12px;" colspan="5">COMPANY GST No. : <?=$set_head['vatno']?>
													</td>
												...
												<tr height="20px">
													<td  style="border-right:1px solid;border-top:1px solid; font-size:12px;" colspan="5">
													</td>
													<td colspan="3" style="border-top:1px solid;border-right:1px solid;font-size:12px;text-align:left  !important" >
														SGST <?=($gst_per/2);?> %
													</td>
										...
										<tr>
											<td colspan="<?=5+$colspan?>" style="border:1px solid;border-left:none;">
												<strong>Remark:</strong> <?=($rel['remark']) ? $rel['remark'] : ''?>
											</td>
										</tr>	
										<tr>
											...
											<td colspan="5" style="vertical-align:top;border-top:1px solid;">
												<center>
													...
													<br><br>
													<center><img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature'];?>"  style="weight:100%;height:60px;margin-top: -20px;"/></center>
