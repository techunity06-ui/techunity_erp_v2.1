												...
												<!--<thead>-->
													<tr>
														<td rowspan="4" width="55%" style="vertical-align:top;border:1px solid;padding-bottom:0px !important;">
															M/s,<br><strong><?=$company_name1?></strong><span style="font-weight:normal;"> <br><?=$cust_address?>,<br/><?=$city_name?>,<?=$state_name?>,<?=$country_name?><?phpif(!empty($cust_pincode)){ ?> - <?=$cust_pincode?><?php} ?></span><br> <strong> GSTIN : <?=$gst_no?></strong>
														</td>
