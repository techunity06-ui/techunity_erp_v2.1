...
function quotation_print($dbcon, $quotation_id, $save_file)
{
    ...
    <table style="font-size:16px;width: 100%;border: none;">
        <tr style="border:none;">
            ...
            <th style="text-align: right;border: none;">Date: ' . $rel['inquiry_ref_date'] . ' </th>
        </tr>
        <br>
        ...
        <tr style="border:none;">
            <td colspan="2" style="text-align: left; border: none;"><span style="text-decoration:underline;"><b>Kind Attention </b></span>:	' . $rel['c_con_fname'] . ' <br>
        ...
        <tr style="border:none;">
            <td colspan="2" style="text-align: left; border: none; ">' . $rel["quot_header"] . '<br>
                </td>
    ...
    ';
		...
		while ($trn_rel = mysqli_fetch_assoc($trn_qry_rs)) {
			...
			<td style="border:1px solid;">'. $trn_rel['product_name'] . ' </td>
			<td style="border:1px solid;">'. $trn_rel['product_qty'] . ' </td>
			<td style="border:1px solid;">'. $currency_symbol . ' ' . $trn_rel['product_rate'] . '</td>
			</tr>
		...
		$html .= '<br>
		<h3 style="text-align:left"> Bank Details: '.$comp_rel["bank_name"].', '.$comp_rel["branch_name"].', A/C No: '.$comp_rel["ac_no"].',<br>
		RTGS/NEFT IFSC CODE: '.$comp_rel["ifcs"].'</h3>
		<tr  style="border:none;">
			<td colspan="4" style="border: 1px solid black;  text-align: center; "><b>Bank Name : HDFC Bank Ltd, Branch & IFSC  : Chandkheda & HDFC0004894, Account No. : 59255540000001,</b></td> 
		</tr>
			 ';
		$html .= '</table>
