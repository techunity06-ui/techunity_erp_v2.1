											...
											<tr>
												<th colspan="5" style="padding:0px !important;">
													...
													<tbody style="border: 1px solid;">
														<?php
														$qry="select * FROM `tbl_sales_ordertrn` as trn left join product_mst as product on product.product_id=trn.product_id left join unit_mst as per on per.unitid=trn.unit_id where sales_ordertrn_status=0 and trn.pid=0 and sales_order_id=".$rel['sales_order_id'];
														...
														while($row=brp_mysqli_fetch_assoc($result))
														{
															...
															<tr style="height:40px">
																<td style="text-align:left !important;vertical-align:top;border-right:1px solid;border-left:1px solid;">
																	<?=$i?>
																</td>
																<td style="padding-left:5px;border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;" >
																	...
																	$qry1="select * FROM `tbl_sales_ordertrn` as trn left join product_mst as product on product.product_id=trn.product_id left join unit_mst as per on per.unitid=trn.unit_id where sales_ordertrn_status=0 and sales_order_id=".$rel['sales_order_id']." and trn.pid=".$row['sales_ordertrn_id'];
															...
															<tr style="height:40px">
																...
																<tr>
																	<td colspan="3" style="text-align: right; border-right: 1px solid;"><img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature'];?>" style="height: 100px; width: : 100px;"></td>
																</tr>
																<tr>
