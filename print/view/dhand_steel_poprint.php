				...
				for($j=0; $j<$pr; $j++)
				{
					...
					<tr style="height:40px">
						...
						<tr style="height:20px">
							...
							<?php if($set_head['stateid']==$rel['stateid']){ ?>
								<tr height="20px">
							...
							while($row11=mysqli_fetch_assoc($result11)){ ?>
								<tr height="20px">
									...
									<td colspan="2" style="text-align:right; border-top:1px solid;border-right:1px solid; "><?=number_format($row11['add_sum'],2,".","")?></td>
								</tr>
							<?php }
							...
							while($row12=mysqli_fetch_assoc($result12)){ ?>
								<tr height="20px">
									...
									<td colspan="2" style="text-align:right; border-top:1px solid;border-right:1px solid; "><?=number_format($row12['sundry_amount'],2,".","")?></td>
								</tr>
							<?php }
