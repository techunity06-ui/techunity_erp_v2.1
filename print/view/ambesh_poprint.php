...
if(strtolower($type) == 'pdf') {
	...
	/*if($rel['consignee_id']==0){
		$party_address_con="<strong>".$comp_rel["company_name"]."</strong>
		<span style='font-weight:normal;'> <br/>
		".$comp_rel["address"].",<br/>";*/
...
.page{
	...
	<td colspan="3" style="border: 0px; font-size:14px;white-space: nowrap;">PO Date :<span style="font-size:13px;">'.$purchaseorder_date.'</span></td>
	</tr>
	...
	<td colspan="5" style="border-bottom:none;  text-align:left;vertical-align:top">'.$party_address_con.'</td>
	</tr>
	<tr style="border:none; border-left:1px solid; border-right:1px solid;">
	...
	while($trn_rel=brp_mysqli_fetch_assoc($trn_qry_rs)){
		...
		$html.='<td border="0" style="border-radious: 0px; border: none!important;font-size:11px;font-weight:bold'.$align.'">'.$trn_rel['product_name'].' '.$drawing_number.' '.$item_code.' '.$alias.' '.$wno.'</td> 
		</tr>
...
$mpdf=new mPDF('','A4','0','calibri','10','10','20','10','1','1');
