...
$header ='<div style="text-align:right;"><img src="'.DOMAIN_F.LOGO.$comp_rel["logo"].'"/></div>
...
$footer='<div style="text-align:center;"><img src="'.DOMAIN_F.LOGO.$comp_rel['f_logo'].'" style="padding-left:0px !important;"/></div>';
...
.page{
	...
	<p>Email-Id : '.strtolower($rel['cust_email']).'</p>
	</td>
	</tr>
	<tr style="border: 0;">
	...
	<tr style="border: 0;">
	<td style="border: 0; font-weight: bold;">GSTIN No</td>
	<td style="border: 0; font-weight: bold;">: '.$comp_rel['vatno'].'</td>
	</td>
	</tr>
	<tr style="border: 0;">
	<td style="border: 0; font-weight: bold;">Delivery From</td>
	<td style="border: 0; font-weight: bold;">: '.$rel['delivery_from'].'</td>
	</td>
	</tr>
	<tr style="border: 0;">
	<td style="border: 0; font-weight: bold;">P.O Address To</td>
	<td style="border: 0; font-weight: bold;">: '.$rel['po_address_to'].'</td>
	</td>
	</tr>
	<tr style="border: 0;">
	...
	if($inquiry_type==1){
		$trn_qrys="select trn.*, pro.product_name from tbl_quotation_trn as trn left join product_mst as pro on pro.product_id=trn.product_id where trn.quot_trn_status=0 and trn.quotation_id=".$rel['quotation_id'];
	} else {
		$trn_qrys="select trn.*, pro.product_name from tbl_quotation_project_trn as trn left join product_mst as pro on pro.product_id=trn.product_id where trn.quotation_projecttrn_status=0 and trn.quotation_id=".$rel['quotation_id'];
	}
	// echo $trn_qrys;
	...
	if(mysqli_num_rows($trn_qry_rss)>0){
		...
		<div>
		<strong><h4 style="text-align: center;">Annexure I - Technical Datasheet</h4></strong>';
		$i = 1;
		while($qry_res = mysqli_fetch_assoc($trn_qry_rss)){
			$html.='<strong>'.$i.') '.$qry_res['product_name'].' :</strong><br>';
	...
	if(trim($rel['quot_annex_content'])){
		$html.='<center class="nextpage"></center>
		<strong><h4 style="text-align: center;">Annexure II - Exclusions</h4></strong><div class="quot_annex_content_div">'.$rel['quot_annex_content'].'</div>';
	}
	...
	<thead>
	<tr style="border: 0;">
	<th style="text-align:center; font-weight: bold; border: 0;">Annexure III - Commercial Terms & Conditions</th>
	</tr>
	</thead><tbody>';
	...
	$html.='<center class="nextpage"></center>
	<div>
	<strong><h4 style="text-align: center;">Annexure IV - Price Bid for Storage Tanks</h4></strong>
...
// echo $html;exit;
	...
	$mpdf=new mPDF('','A4','0','proximanova','10','10','33','40','1','1');
