...
//Amish Soni End 16-03-2021
		...
		.page{
			...
			<tr style="border-left:none;border-right:none">
				<th colspan="10" style="font-size:18px; text-align:left; border-left:none; border-right:none"><strong>1. PROFORMA INVOICE</strong></th>
			</tr>
			<tr>
			...
			while($row_im=brp_mysqli_fetch_array($pro_im_rs)){
				...
				$html.='<tr>
					<td rowspan="3">'.$i.'</td>
					<td rowspan="3"><img src="'.DOMAIN_F.'view/upload/product_images/'.$row_im['image_name'].'" style="width:250px;height:250px"></td>
