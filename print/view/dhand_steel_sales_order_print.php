												...
												<tr>
													<th colspan="5" style="padding:0px !important;">
														<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
															<!--<thead>-->
																<tr>
																	<td colspan="2" style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>Order No : <?=$rel['sales_order_no']?> </strong>
																	</td>
																	<td style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>Order Date : <?=date('d/m/y',strtotime($rel['sales_order_date']))?> </strong>
																	</td>
																	<td style="vertical-align:top;border:1px solid;border-right:none;border-left:none">
																		<strong>Order Time : <?=date('h:i:s a',strtotime($rel['cdate']))?> </strong>
																	</td>
																</tr>
																<?php
																$user_name = $dbcon->query("SELECT user_name FROM `users` WHERE user_id=".$rel['user_id'])
																->fetch_object()->user_name;     
																?>
																<tr>
																	<td colspan="3" style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>Salesman Name : <?=$user_name?> </strong>
																	</td>
																	<td style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>Order by : <?= $rel['order_by']?> </strong>
																	</td>
																</tr>
																<tr>
																	<td colspan="3" style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
																		<strong>Customer Name : <?= $company_name ?> </strong>
																	</td>
																	<td style="vertical-align:top;border:1px solid;border-right:1px solid;border-left:none;white-space:nowrap;">
...
<!--						<tr>
			...
			<tr height="30px">					
				...
				<th width="65%"  style="text-align:center !important;border-right:1px solid; border-bottom:1px solid;border-top: none;" ><strong>Model</strong></th>
				<th width="15%" style="text-align:center;border-right:1px solid; border-bottom:1px solid;border-top: none;"><strong>Finish</strong></th>
		...
		<tbody style="border: 1px solid;">
			<?php 
			$qry="select *,cat.cat_name FROM `tbl_sales_ordertrn` as trn 
				...
				<tr style="height:40px">
					...
					<td style="padding-left:5px;border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;" >
						...
						<td style="text-align:center !important;padding-right:10px;vertical-align:top;border-bottom-color:#FFFFFF; border-right:1px solid;" >
							<?=($row['cat_name']) ? $row['cat_name'] : 'Primary'?>
						</td>
						<td style="text-align:center !important;padding-right:10px;vertical-align:top;border-bottom-color:#FFFFFF; border-right:1px solid;" >
...
<?php} ?>
<tr height="24px">
	<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;border-left:1px solid;font-size:14px;text-align:right !important;"></td>
	<td style="text-align:center;border-bottom:1px solid; border-top:1px solid;font-size:14px;border-right:1px solid; ">TOTAL</td>
	<td style="border-right:1px solid;border-bottom:1px solid;border-top:1px solid;font-size:14px;text-align:center !important; "><?=number_format($totalqty,2,".","")?></td>
</tr>	
<tr>
</table>
</td>
...
<td colspan="4" style="padding: 0px !important;border:1px solid">
				...
				<?php $checkbox = '<input type="checkbox"  style="height: 20px;width: 20px;">'
				?>                                                        
				<div class="col-md-12" id="print2">
					<strong>Note: </strong><br/>
					1.&nbsp;<?= $checkbox ?>&nbsp;Before Delivery Goods Checked? (Mortise Accessories, Mortise Left of Right, Color, Quality).<br>
					2.&nbsp;<?= $checkbox ?>&nbsp;Bill Qty & Physical Qty & WhatsApp Order Qty Matched ? (All Of Three Matched Compulsory)<br/>
					3.&nbsp;<?= $checkbox ?>&nbsp;Goods Packed OK?<br/>
					4.&nbsp;<?= $checkbox ?>&nbsp;<strong>Remark:</strong>&nbsp;<?= $rel['remark']?><br/>
				</div>
				<div style="height:30px;"></div>
				<div id="print3">
					<table>
						<tr style="height:30px;">
							<td width="11%" style="border:none !important"><span style="margin-left:5px;">Bill Date:  </span>  </td>
							<td width="14%" style="border-bottom:1px solid black;border-left: none;"><span style=""></span> </td>

							<td width="10%" style="border:none !important"><span style="margin-left:5px;">Bill No:  </span>  </td>
							<td width="15%" style="border-bottom:1px solid black;border-left: none;"><span style=""></span> </td>

							<td width="10%" style="border:none !important"><span style="margin-left:5px;">Bill Qty:  </span>  </td>
							<td width="15%" style="border-bottom:1px solid black;border-left: none;"><span style=""></span> </td>

							<td width="10%" style="border:none !important"><span style="margin-left:5px;">Bill Amt:  </span>  </td>
							<td width="15%" style="border-bottom:1px solid black;border-left: none;"><span style=""></span> </td>
						</tr>
					</table>
				</div>
				<div id="print4">
					<table>
						<tr style="height:30px;">
							<td width="15%" style="border:none !important"><span style="margin-left:5px;">Packed By:  </span>  </td>
							<td width="10%"><span style=""></span> </td>

							<td width="15%" style="border:none !important"><span style="margin-left:5px;">Packed Date:  </span>  </td>
							<td width="10%" style="border-bottom:1px solid black;border-left: none;"><span style=""></span> </td>

							<td width="15%" style="border:none !important"><span style="margin-left:5px;">Packed Time:  </span>  </td>
							<td width="15%" style="border-bottom:1px solid black;border-left: none;"><span style=""></span> </td>

							<td width="15%" style="border:none !important"><span style="margin-left:5px;">Bill by:  </span></td>
							<td width="10%"><span style=""></span> </td>
						</tr>
					</table>
				</div>
...
if ($('input[name=logo]:Checked').val() == "1") {
	...
	$('#table_head').show();
	$('#table_foot').show();
	docprint.document.write(' @media print{ @page { size:A5; margin: 0.2in <?=$set_head['letter_head_right_margin']?>in 0.2in <?=$set_head['letter_head_left_margin']?>in; } }   ');

}
else{
	docprint.document.write(' @media print{ @page { size:A5; margin: <?=$set_head['letter_head_top_margin']?>in <?=$set_head['letter_head_right_margin']?>in <?=$set_head['letter_head_bottom_margin']?>in <?=$set_head['letter_head_left_margin']?>in; } }  #table_head, #table_foot { display:none }');
