...
$key = "encryptionkey";
$text=$_REQUEST['id'];
$decrypted=openssl_decrypt(hex2bin($text),'AES-128-CBC',$key);
$invoiceid=$dbcon->real_escape_string($decrypted);
															...
															<tr>
																<td class="borderleftadd" colspan="11" style="padding: 0px !important;border:1px solid">
																	<table class="footer-table" width="100%">
																		...
																		where b.sundry_voucher_id=".$rel['po_id']." and b.sundry_voucher_table='tbl_pono' and b.isdelete='0' and b.sundry_ledger_id=".TDS." ";
