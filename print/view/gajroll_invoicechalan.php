...
<table width="100%" class="maintable" border="1" style="" id="table_head">
					...
					<tr>
						<td rowspan="4" width="55%" style="vertical-align:top;border:1px solid;padding-bottom:0px !important;">
							...
							<span style="font-weight:normal;"> <br>
								...
								<td style="vertical-align:top;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">: <strong><?=$rel['challan_no']?></strong>
								</td>							
							</tr>
							<tr>
