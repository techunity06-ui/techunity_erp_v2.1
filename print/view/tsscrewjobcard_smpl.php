...
.page{
	...
	$blnk = 6;
	$height_td=12;
	$stage1 = array("Turning","Hex/Star Punch","Deburring","Thread Milling","Head Threading","Q.C Check");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=6)
		{
	...
	$blnk = 4;
	$stage2 = array("Point Grinding","Self Taping","Buffing / CDM","Ultra - Cleaning");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=4)
		{
	...
	$blnk = 5;
	$stage3 = array("Length","Head OD","Cannulation/Thread Pitch","Outer Dia","Hex/Star Punch");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=5)
		{
	...
	$blnk = 4;
	$stage5 = array("Length","Outer Dia","Finishing","Hex/Torx");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=4)
		{
