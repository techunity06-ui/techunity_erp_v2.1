...
<table style="font-size:14px;border-collapse: collapse;width:100%;" cellpadding="3" cellspacing="3">
<tr >
<td rowspan="5" width="30%" style="border-top: none;text-align:left;vertical-align: top;"><strong> EXPORTER:- <br>
'.$comp_rel['company_name'].',</strong><br>'.$comp_rel['address'].'<br><strong>Phone :</strong>'.$comp_rel['contact_no'].'</td>
<td width="45%" style="border-top: none;text-align:left;"><strong> PROFORMA INVOICE NO : '.$rel['invoice_no'].'<br><b> DATE: </b>'.$rel['invoice_date'].'</td>
<td width="25%" style="border-top: none;text-align:center;"><strong>  <span> ORIGINAL  </span></strong></td>

</tr>
<tr >
<td width="45%" style="border-top: none;text-align:left;"><strong>Buyer’s Orders No :  </strong>'.$po_number.' <br> <b>Date :</b>'.$po_number_date.'</td>
<td width="25%" style="border-top: none;text-align:center;"><strong>Exporter’s Ref:  '.$exporters_ref.'</strong></td>

</tr>
<tr >
<td colspan="2" style="border-top: none;text-align:left;"><strong> PROFORMA INVOICE NO :  </strong> '.$rel['invoice_no'].' <br><b> DATE:</b>'.$rel['invoice_date'].'</td>

</tr>
<tr >
<td colspan="2" style="border-top: none;text-align:left;"><strong> Seller’s Registration info  <br> GSTIN - </strong>'.$comp_rel['vatno'].'<b> PAN NO :</b> '.$comp_rel['pan_no'].'</td>
...
<table style="font-size:14px;border-collapse: collapse;width:100%;" cellpadding="3" cellspacing="3">
<tr>
    <td width="30%" rowspan="2" style="border: 1px solid; vertical-align: top;"><strong> INVOICE TO:- <br>
    '.$rel['company_name'].',</strong><br>'.$rel['c_add_address'].'<br><strong>Phone :</strong>'.$rel['c_con_mobile'].'
    
        </td>

    <td  width="70%" style="vertical-align:top">
    <strong> Goods cleared under LUT (ARN): '.$comp_rel['lut_no'].'  </strong>
        </td>
</tr>
<tr>';

if (empty($cons_data['cust_address'])) {
    $html .=' <td style="border: 1px solid; text-align: left; vertical-align: top;">
            <strong> Delivery Address: </strong>'.$rel['c_add_address'].'
          </td>';
}else{
    $html .=' <td style="border: 1px solid; text-align: left; vertical-align: top;">
    <strong> Delivery Address: </strong>' . $cons_data['cust_address'] . '
  </td>';
}

$html .='</tr>
<tr>
    <td rowspan="2" style="border: 1px solid; text-align:left;vertical-align: top;">
    <strong>CONSIGNEE:- <br>
...
';
        ...
        $html.='
        <tr>
        <td colspan="5" style="font-weight:bold;text-align:right;border: 1px solid;">TOTAL</td>
        ...
        while($row12=mysqli_fetch_assoc($result12))
        {
            ...
            $html.='<!-- Added By sahaj -->
            <tr>
            <td colspan="5" style="font-weight:bold;text-align:right;border: 1px solid;">'.$row12['l_name'].'</td>
            <td  style="font-weight:bold;text-align:center;border: 1px solid;">'.number_format($row12['sundry_amount'],2,".","").'</td>
            </tr>
			';
        }
        if ($tax_amnt+$total_sundrytax < 0 ){   
 
        $html .=' <tr>
        <td colspan="5" style="font-weight:bold;text-align:right;border: 1px solid;">';
      ...
      <td  style="font-weight:bold;text-align:center;border: 1px solid;"><span style="text-align:right">'.number_format(($tax_amnt+$total_sundrytax),2,".","").'</span></td>
      </tr>
      ...
      $html .='<tr>
      <td colspan="5" style="text-align:right;border:1px solid;font-weight:bold;font-size: 14px;">TOTAL AMOUNT IN '.$currency_name.'
      </td>
      <td style="border:1px solid;font-weight:bold;font-size: 14px;text-align:center">'.number_format($rel['g_total_conv'],2,".","").'
      </td>
      </tr>
      <tr>
      <td colspan="5" style="text-align:right;border:1px solid;font-weight:bold;font-size: 14px;">Advance Amount
      </td>
      <td style="border:1px solid;font-weight:bold;font-size: 14px;text-align:center;">'.number_format($rel['advance_payment'],2,".","").'
      </td>
      </tr>
      <tr>
      <td colspan="6" style="text-align:left;border:1px solid;font-weight:bold;font-size: 14px;"><span style="font-weight:bold;font-size: 14px;">  TOTAL AMOUNT IN WORDS IN '.$currency_name.' : 
      ...
      <tr>
      <td colspan="6" style="text-align:left;border:1px solid;font-weight:bold;font-size: 14px;"><span style="font-weight:bold;font-size: 14px;">  100% ADVANCE PAYABLE AMOUNT IN WORDS IN  : '.$currency_name.' 
      '.ucwords(convert_number_to_words_new($rel['g_total'],$rel['currency_id'],$rel['currency_in_word_end'],$rel['currency_in_word'])).'
      </span>
      </td>
...
';
	...
	<td colspan="2"  style="width:25%;text-align:left; vertical-align: top; border:none;"><br><br>Sky Air Cooler</td>
