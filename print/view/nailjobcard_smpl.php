...
.page{
	...
	$blnk = 6;
	$height_td=20;
	$stage1 = array("Finish Turning","Proximal Threading","Crimping","Distal Hole Drilling/Slotting","Nailing Bending","Q.C Check");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=6)
		{
	...
	$blnk = 4;
	$stage2 = array("Burrs Removing","Buffing","Blasting","Ultra - Cleaning");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=4)
		{
	...
	$blnk = 4;
	$stage3 = array("Length","Proximal Diameter","Proximal Tapping","Jig Matching");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=4)
		{
	...
	$blnk = 2;
	$stage5 = array("Jig Matching","Finishing");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=2)
		{
