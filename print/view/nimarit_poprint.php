...
//Quotation Data
	$query="select po.*,state.state_name,modesup.mode_dispatch,payterms.payment_terms as payment_term,l.l_name as vender_name,country.country_name,l.m_address as vender_address,l.ledger_code,l.cust_cont_name,l.gst_no as tin_no,l.cust_mobile as vender_mobile,l.stateid,state.gst_state_code,city.city_name,bran.branch_address,brnc.country_name as branch_country,brns.state_name as branch_state,brnci.city_name as branch_city,branz.zone_name,bran.branch_pincode,comp.company_name,le.l_name as con_ven,bm.branch_name as cons_bran,cur.currency_code from tbl_purchaseorder as po 
...
if($company_config['po_header_content']!=''){
	...
	<tr style="border: 0px;">
	<td style="text-align: center; width: 25%; border: 0px;"><img src="'.DOMAIN_F.LOGO.$comp_rel['logo'].'" style="width:100px;height:100px;"/></td>
	'.$po_header_content .'
	</tr>
	</table>';
...
//$sundrytax_rels = mysqli_fetch_assoc($sundrytax);
	...
	.page{
		...
		$html.='<tr>
			<td colspan="'.$cols.'" style="text-align:left;border:1px solid;color:Black; font-weight: bold;width:50%">Basic PO Amount: '.ucfirst(convert_number_to_words($total_product_amount)).'</td>
		...
		$html.='<tr>
				...
				<div style="margin-top:50px !important"><br><br><br><br><br> Authorised Signatory</div>
				</td>
				</tr>
				...
				<th style="width:25%;text-align:center;border:1px solid;"></th>
				<th style="width:5%;text-align:center;border:1px solid;"></th>
				<th style="width:8%;text-align:center;border:1px solid;"></th>
				<th style="width:10%;text-align:center;border:1px solid;"></th>';
				/*if($get_disc['discount'] > 0){ 
					$html.='<th style="width:7%;text-align:center;border:1px solid;"></th>';
				}
				$html.='<th style="width:10%;text-align:center;border:1px solid;"></th>';*/
		$html.='<th style="width:5%;text-align:center;border:1px solid;"></th>
				<th style="width:10%;text-align:center;border:1px solid;"></th>
				<th style="width:15%;text-align:right;border:1px solid;"></th>
				</tr>
				</tr>
				</table>
				</div>
