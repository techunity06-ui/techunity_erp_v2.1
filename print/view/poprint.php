...
.page{
	...
	if ($getspecialConfiguration['adk_permission'] == 0) {
		$html .= '<td colspan="5" style="border-bottom:none;  text-align:left;">
			Payment Terms : '.$rel['payment_term_name'].'
			<br>Terms of delivery :'.$delivery_week.'
			<br>Mode of Delivery :'.$rel['mode_dispatch'].' 
			</td>';
	} else {
		$html .= '<td colspan="5" style="border-bottom:none;  text-align:left;"></td>';
	}
	...
	if ($getspecialConfiguration['adk_permission'] == 1) {
		...
		<td colspan="8" style=" text-align:left;font-size:14px;height:60px;vertical-align:top">
	...
	<tr style="border-bottom:none">
	<td colspan="2" style="height:50px;border-bottom:none;vertical-align:top;text-align:center;width:20%;font-weight:bold;">Purchase
	</td>
	<td colspan="2" style="height:50px;border-bottom:none;vertical-align:top;text-align:center;width:20%;font-weight:bold;">'.$user_rel['user_name'].'</td>
