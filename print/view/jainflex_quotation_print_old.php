		...
		/*		$pr=10-$cnt;
			...
			<td   style="border: 1px solid black;  text-align: right;width:30%; border-left:none; "><b>Account No. : '.$comp_rel["ac_no"].'</b></td> 
			 ...
			 if(mysqli_num_rows($terms_qry_rs)){
				...
				<td colspan="2"  style=" border: 0px; text-align: left;padding-left: 10px; ">
				 ...
				 $html .='</table><td width="30%" style="text-align: left; border-right: 1px solid black;border-bottom: 1px solid black; padding-left: 10px;" >
						<b>With Best Regards, 
						<br>			
						<br>			
						<br>	
