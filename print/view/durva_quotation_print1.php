...
//p($rel);
		...
		<table style="font-size:22px; border-collapse: collapse;width:100%;" cellpadding="5" cellspacing="5">
	<tr>
	<td style="text-align:left;width:25%; border:1px solid;">Ref No</td>
	<td style="text-align:left;width:35%; vertical-align:top; border:1px solid;">'.$rel['quotation_no'].'</td>
	<td style="text-align:left;width:15%; vertical-align:top; border:1px solid;"> Date</td>
	<td style="text-align:left;width:15%; vertical-align:top; border:1px solid;"> '.date("d-M-Y",strtotime($rel['quotation_date'])).'</td>
	<td rowspan="4" style="text-align:left;width:10%; vertical-align:center; border:1px solid;"> <img src="'.DOMAIN_F.LOGO.$comp_rel["logo"].'" style="width:4in;" /></td>
	</tr>
		<tr>
	<td style="text-align:left;width:%;">Customer Name</td>
	<td style="text-align:left;width:%; vertical-align:top;">'.$rel['cust_name'].'</td>
	<td rowspan="2" colspan="2" style="text-align:left;width:%; vertical-align:top;"> Address: '.($quot_address).' </td>
	
	
	</tr>	<tr>
	<td style="text-align:left;width:0%;">Contact Person</td>
	<td style="text-align:left;width:0%; vertical-align:top;">'.$rel['c_con_fname'].' '.$rel['c_con_lname'].'</td>
	
	
	
	</tr>	<tr>
	<td style="text-align:left;width:0%;">Contact Number</td>
	<td style="text-align:left;width:0%; vertical-align:top;">'.$rel['c_con_mobile'].'</td>
	<td style="text-align:left;width:0%; vertical-align:top;"> Email</td>
	<td style="text-align:left;width:0%; vertical-align:top;"> '.$rel['c_con_email'].'</td>
...
//Amish Soni End 16-03-2021
		...
		.page{
			...
			<br />
			'.(($rel['quot_header']) ? $rel['quot_header'] : '').'
...
//echo $html;exit;
			...
			$mpdf=new mPDF('','A4','0','proximanova','10','10','35','25','1','1');
