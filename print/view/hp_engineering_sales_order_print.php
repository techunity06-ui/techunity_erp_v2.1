...
$users = mysqli_fetch_assoc($dbcon->query("SELECT * FROM users WHERE user_id=".$rel['user_id']));
$soquery = mysqli_fetch_assoc($dbcon->query("SELECT * FROM tbl_quot_po_aprv_log WHERE sales_order_id=".$invoiceid." AND approve_status=1 ORDER BY quot_aprv_log_id DESC LIMIT 1"));
$souser = mysqli_fetch_assoc($dbcon->query("SELECT * FROM users WHERE user_id=".$soquery['user_id']));
						...
						<section class="panel">
							...
							<div class="panel-body">
								...
								<div class="col-lg-12" id="receipt_print">	<div class="col-md-12 breakout" style=" margin-top:10px;" id="print1">
									<table  class="maintable headermain " border="0" id="table_head" width="100%">
												...
												<th colspan="5" style="padding:0px !important;">
															...
															<tr>
																...
																<td rowspan="3" width="55%" style="vertical-align:top;border:1px solid;padding-bottom:0px !important;border-right:none">
																	...
																	<span style="font-weight:normal;"> <br>
																		<?=str_replace("\R\N"," ",$cust_address)?>,<br/>
																		<?=$city_name?>,
																		<?=$state_name?>,
																		<?=$country_name?>
													...
													<tbody style="border: 1px solid;">
														...
														while($row=mysqli_fetch_assoc($result))
														{
															...
															<tr height="24px">
																<td colspan="3" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;border-left:1px solid;font-size:14px;text-align:left !important;">Remark : <?=(($rel['remark']) ? $rel['remark'] : '')?></td>
															</tr>
															<tr height="25px">
																<td colspan="3" style="border-bottom: 1px solid">
																	<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%">
																		<tbody>
																			<tr>
																				<td width="50%" style="text-align: center;">Approved By : <strong><?php if($rel['approve_status']==3){ echo $souser['user_name']; } ?></strong></td>
																				<td width="50%" style="text-align: center;">Prepared By : <strong><?=$users['user_name'];?></strong></td>
																			</tr>
																		</tbody>
																	</table>
																</td>
