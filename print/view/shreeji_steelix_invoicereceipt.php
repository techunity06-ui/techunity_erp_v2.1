...
if(strtolower($type) == 'pdf') {
	...
	left join users as us on us.user_id=invoice.user_id
	...
	if($rel['invoice_date']!="1970-01-01 00:00:00" && $rel['invoice_date']!="0000-00-00 00:00:00")
	{
		$invoice_date=date('d-m-Y h:i a',strtotime($rel['invoice_date']));
	}
...
/*
	...
	.page{
		...
		<td style="border: none;text-align: left;"> Debit Memo</td>
		<td style="border: none;text-align: center;" colspan="4"> <strong style="font-size:14px;">'.(($rel["invoice_type"]) ? $rel["invoice_type"] : 'TAX INVOICE').'</strong></td>
		<td style="border: none;text-align: right;" > Original</td>
		</tr>
		</table>
		...
		$html.='<tr>
				...
				<b>Bill to Party : </b><br/><strong>'.$rel['l_name'].'</strong><br><span style="font-weight:normal;">'.$rel['m_address'].'<br/>'.$rel['city_name'].', '.$rel['state_name'].', '.$rel['country_name'];
				...
				<td style="width:25%;border-left:none">
						: <strong>'.$rel['invoice_no'].'</strong>
				</td>
		</tr>
		
		<tr>
				<td style="border-right:none"><strong>Date </strong></td>
				<td style="border-left:none"> : <strong>'.$invoice_date.'</strong> </td>
		</tr>
		<tr>
				<td style="border-right:none"><strong>PO No. </strong></td>
				<td style="border-left:none"> : <strong>'.$po_number.'</strong></td>
		</tr>
		<tr>
				<td style="border-right:none"><strong>Date </strong></td>
				<td style="border-left:none"> : <strong>'.$po_number_date.'</strong></td>
		</tr>
		<tr>
				<td style="border-right:none"><strong>Transport Detail</strong></td>
				<td style="border-left:none"> : <strong>'.$r_t['transportation_name'].'</strong></td>
		</tr>

		<tr>
				<td style="border-right:1px solid;border-left:1px solid;"><strong>GSTIN: '.$rel['gst_no'].' <br>PAN No. : '.$rel['m_pan'].'</strong></td>
				<td style="border-right:none"><strong>LR./ Docket No.</strong
				></td>
				<td style="border-left:none"> : <strong>'.$r_t['transport_gr_no'].'</strong></td>
		</tr>

		<tr>';
	
		if($rel['enable_consignee']==1) {
			$html.='<td rowspan="5" style="vertical-align:top;border-right:1px solid"><b>Shipped to Party : </b><br><strong>'.$rel['l_name'].'</strong><br><span style="font-weight:normal;">'.$rel['m_address'].'<br/>'.$rel['city_name'].', '.$rel['state_name'].', '.$rel['country_name'];
			if(!empty($rel['cust_pincode'])){
				$html.='-  '.$rel['cust_pincode'];
			}
			$html.='</span><br>';
			...
			$html.='<td rowspan="5" style="vertical-align:top;border-right:1px solid"><b>Consignee : </b><br><strong>'.$cons_data['company_name'].'</strong><span style="font-weight:normal;">'.$cons_data['m_address'].'<br/>'.$cons_data['city_name'].', '.$cons_data['state_name'].', '.$cons_data['country_name'];
		...
		$html.='
			<td style="border-right:none"> <strong>LR. Date</strong></td>
			<td style="border-left:none"> : <strong>'.date('d-m-Y',strtotime($r_t['transport_gr_date'])).'</strong></td>
		</tr>
		<tr>
			<td style="border-right:none"> <strong>Carton</strong></td>
			<td style="border-left:none"> : <strong>'.$rel['num_of_parcel'].'</strong></td>
		</tr>
		<tr>
			<td style="border-right:none"><strong>Payment Terms</strong></td>
			<td style="border-left:none"> : <strong>'.$rel['terms'].'</strong></td>
		</tr>
		<tr>
			<td style="border-right:none"><strong>Salesman Name</strong></td>
			<td style="border-left:none"> : <strong>'.$rel['user_name'].'</strong></td>
		</tr>
		<tr>
			<td style="border-right:none"><strong>Place Of Supply</strong></td>
			<td style="border-left:none"> : <strong>'.$cons_state_name.' - '.$cons_gst_state_code.'</strong></td>
		</tr>';

		$html .='<tr>
				<td><strong>GSTIN:  '.$rel['gst_no'].'</strong></td>
				<td style="border-right:none">E-Way Bill No.</td>
				<td style="border-left:none"> : '.$rel['eway_bill_no'].'</td>
		</tr>';
		...
		<th width="25%" style="border:1px solid;border-top: none;" ><strong>Particulars </strong></th>
		<th width="20%" style="border:1px solid;border-top: none;" ><strong>Category Name </strong></th>
		<th width="8%" style="border:1px solid;border-top: none;"><strong>HSN Code</strong></th>
		<th width="7%" style="border:1px solid;border-top: none;"><strong>QTY.</strong></th>
		<th width="10%" style="border:1px solid;border-top: none;"><strong>Rate</strong></th>';
		if($rel_disc['discount'] > 0){
		...
		$qry="select trn.*,product.product_name,unit_name,cat.cat_name FROM `tbl_invoicetrn` as trn 
		...
		while($row=brp_mysqli_fetch_assoc($result))
		{
			...
			$html.='</td>
			<td style="border-right:1px solid;vertical-align:top;"><strong>'.$row['cat_name'].'</strong></td>
			...
			$html.='<td style=" vertical-align:top;border-right:1px solid; text-align: center;">'.number_format(($row['product_amount']),2,".","").'</td>';
			$html.='</tr>';
			$i++; 
		...
		$cnt = 6-$cnt;
		for($i=0; $i<$cnt; $i++){
			$html .='<tr style="border-top:none;border-bottom:none">
				<td style="height:35px;border-bottom:none;"></td>
				<td style="height:35px;border-bottom:none;border-top:none"></td>
				<td style="height:35px;border-bottom:none;border-top:none"></td>
				<td style="height:35px;border-bottom:none;border-top:none"></td>
				<td style="height:35px;border-bottom:none;border-top:none"></td>
				<td style="height:35px;border-bottom:none;border-top:none"></td>
		...
		<td style="border-top:1px solid;border-right:1px solid;border-left:1px solid; text-align:left;" colspan="3"><strong>Company GST No. : '.$set_head['vatno'].'</strong></td>
		<td style="border-top:1px solid;border-right:1px solid;border-left:1px solid; text-align:center;" rowspan="2"><strong>Total</strong></td>
		<td style="text-align:center;border-top:1px solid;border-right:1px solid;" rowspan="2"><strong>'.number_format($totalqty,2,".","").'</strong></td>';
		if($rel_disc['discount'] > 0){
			$html.='<td rowspan="2" style="border-top:1px solid;border-right:1px solid;"></td>';
		}
		$html.='<td style="border-top:1px solid;border-right:1px solid;" rowspan="2"></td>';
		if($company_config['tax_editable'] == 0 && $rel['sales_type'] == 1 ){
			$html.='<td rowspan="2" style="border-top:1px solid;border-right:1px solid;text-align:center;"></td>
		...
		$html.='<td rowspan="2" style="border-top:1px solid;border-right:1px solid;text-align:center;"><strong>'.number_format($totaltaxable,2,".","").'</strong></td>
		</tr>
		<tr>
			<td style="border-top:1px solid;border-right:1px solid;border-left:1px solid; text-align:left;" colspan="3"><strong>Company Pan No.: '.$set_head['pan_no'].'</strong></td>
		</tr>
		</table>';
		...
		<tr height="20px">
		<td style="border-right:1px solid;border-top:1px solid;"><strong> </strong><br></td>
		<td style="border-top:1px solid;border-right:1px solid;text-align:left">Round Off</td>
		<td style="text-align:right; border-top:1px solid;border-left:1px solid; ">'. $rel['round_off'].'</td>
		</tr>
		<tr height="20px">
		...
		border-right:none;border-left:none;border-bottom:none;text-align:left  !important">';
