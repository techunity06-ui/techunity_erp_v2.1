...
if($company_config['po_header_content']!=''){
	...
	<tr style="border: 0px;">
	<td style="text-align: center; width: 100%; border: 0px;"><img src="'.DOMAIN_F.LOGO.$comp_rel['logo'].'" style="width:100%;"/></td>
	</tr>
	</table>';

	$footer='<table style="width: 100%; font-size: 12px;">
	<tr style="border: 0px;"><td style="text-align: center; width: 100%; border: 0px;"><img src="'.DOMAIN_F.LOGO.$comp_rel['f_logo'].'" style="padding-left:0px !important;width:100%"/></td></tr>
	</table>';
