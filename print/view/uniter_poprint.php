...
.page{
	...
	<td colspan="4" style="border: 0px; font-size:14px;"><span style="font-size:13px;">:U29309GJ2020PTC112810</span> </td>
	...
	<td colspan="2"  style=" text-align:center;"><b>Required Date</b> </td>
	<td style=" text-align:center;"><b>GST Rate</b> </td>
	...
	while($trn_rel=brp_mysqli_fetch_array($trn_qry_rs)){
		...
		<td colspan="2" style=" text-align:center;font-size:12px;">'.$gst_per.'%</td>
	...
	<td colspan="4" rowspan="2" style="font-size:13px;width:100px;text-align:center">
	Taxable Value
	</td>';
	if($rel['stateid']==$comp_rel['stateid']){
