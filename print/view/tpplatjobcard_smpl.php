...
.page{
	...
	<td colspan="6" style=" text-align:left;"><b>PRODUCT NAME:</b> '.$rel['product_name'].'</td>
	...
	<td colspan="11" style=" text-align:Center;"><b>STAGE-1 (Manufacturing)</b></td>
	</tr>';
	$blnk = 7;
	...
	$blnk = 5;
	$height_td=12;
	$stage1 = array("Facing","Plating Bending","1st Side Machining","2nd Side Machining","Q.C Check");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=5)
		{
		...
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;">'.$stage1[$i].'</td>
	...
	$blnk = 5;
	$stage2 = array("Burrs Removing","Buffing","CFM/ Vibratory","Blasting","Ultra - Cleaning");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=5)
		{
		$html.='<tr>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;">'.$stage2[$i].'</td>
		<td colspan="2" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
...
$html.='</table>';
	...
	$blnk = 5;
	$stage3 = array("Length","Width","Thickness","Proximal Thread. Check","Distal Thread Check");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=5)
		{
		$html.='<tr>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;">'.$stage3[$i].'</td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
	...
	$blnk = 4;
	$stage5 = array("Length","Width","Thickness","Finishing");
	for($i=0; $i<=$blnk; $i++)
	{
		if($i !=4)
		{
		$html.='<tr>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;">'.$stage5[$i].'</td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
		<td colspan="" style=" height: '.$height_td.'px; text-align:Center;"></td>
...
$html.='</table>';
	...
	$html.='</table>';
	$html.='<table><tr>
	<td colspan="13" style=" height: '.$height_td.'px; text-align:Center;"></td>
	
	</tr>
	<tr>
	<td colspan="6" style=" height: 80px;width:60%; text-align:left;vertical-align: top;"><b>Remarks:</b></td>
	</td>
	<td colspan="7" style=" height: 80px;width:40%; text-align:left;vertical-align: top;"><b>Reviewed & Approved By Manager</b></td>
	</td>
	</tr>
