								...
								<section class="panel">
									...
									<div class="col-lg-12 " id="receipt_print">	
										<div class="col-md-12 breakout" style=" margin-top:10px;" id="print1">
											...
											<table  class="maintable headermain " style="margin-top: 23px; padding: 17px 0 0;border: 1px solid;" id="table_head" width="100%">
												<tr style="border:none;">
													<td width="100%" style="border:none;"> 
														<img src="<?=ROOT.LOGO.'Gajroll.png'?>" style="width:100%;padding: 2px;"/>
					...
					<tbody style="border: none;">
						...
						while($row=mysqli_fetch_assoc($result))
						{
							...
							<tr style="height:25px">
								...
								$total_product_amount+=(($row['product_qty']*$row['product_rate'])-$row['product_discount']);
												...
												<td class="borderleftadd" colspan="11" style="padding: 0px !important;border:1px solid">
													...
													<table class="footer-table" width="100%">
														<tr height="20px">
															...
															<td colspan="2" style="text-align:right  !important;font-size:10px;" width="10%"><?=number_format($total_product_amount,2,".","")?></td>	
														</tr>
														<tr  height="20px">
																		...
																		{ ?>
																			...
																			if($rel['packing']!="0.00")
																				...
																				<?php if($rel['formulaid']){ 
																					...
																					<?php 
																					$total = $total + $tax_on_total['tax_value'];
																				} ?>
																				<tr height="20px">
																				...
																				<tr height="20px">
																					...
																					<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-right:1px solid; ">
																						<strong><?=number_format($total,0,".","").'.00'?></strong>
																					</td>
																				</tr>
																				<tr height="35px">
																				...
																				<tr>
																					<td style="border-right:1px solid;border-top:1px solid;font-size:10px;padding:0px !important;" 	colspan="<?=5+$colspan?>">
																						...
																						$query="select sum(product_amount) as product_amount,sum(tax_amount1) as tax_amt1,trn.product_hsn_code,sum(tax_amount2) as tax_amt2,tax_name1,tax_name2,product_qty,product_rate,product_discount  
																						...
																						{
																							$taxable_amt = ($rel_tax['product_rate'] * $rel_tax['product_qty'])-$rel_tax['product_discount'];
																							...
																							echo '</tr>';
																							$totalamt+=($rel_tax['product_rate']*$rel_tax['product_qty'])-$rel_tax['product_discount'];
