...
.page{
	...
	<th style="width:55%;text-align:left;border-top:1px solid;border-bottom:1px solid">Item Details</th>
	...
	while($trn_rel=mysqli_fetch_assoc($trn_qry_rs)){
		...
		<td style="width:50%;text-align:left; "><strong>'.$trn_rel['product_name'].'</strong>'.$alias_name.'<br>'.nl2br($trn_rel['product_desc']).'<br><strong>HSN/SAC : '.$trn_rel['product_hsn'].'</strong></td>
		<td style="width:10%;text-align:center;vertical-align:top;">'.$trn_rel['product_qty'].'</td>
	...
	$mpdf=new mPDF('','A4','0','calibri','10','10','43.5','10','1','1');
