...
//echo "<pre>";print_r($set_head);die();
    ...
    $html='';
    $header = get_header($dbcon,'text-align: center','100%','20%').'<table style="text-align:center;border:none">
    <tr>
    <td> 
    <strong style="font-size:16px;text-align:center;border:none">
    <span> PRO FORMA INVOICE '.$dft.'</span>
    </strong>
    </td>
    </tr>
    </table> ';
...
<table>
  ...
  if($rel['quot_address']!='' && $rel['quot_address']!='0'){ 
        $cadd.= $rel['quot_address'];
        $cadd.='<br/>';
    }else{ 
        $cadd.= $rel['cust_address'];
        $cadd.=' <br/>';
        $cadd.=$rel['city_name'].','. $rel['state_name'].','. $rel['country_name'];
        if(!empty($rel['cust_pincode'])){
            $cadd.='-'. $rel['cust_pincode'];
        } 
    }
...
<table style="font-size:14px;border-collapse: collapse;width:100%;" cellpadding="3" cellspacing="3">
    <tr>
        <td class="boldHeading" style="border:1px solid;border-bottom: none;font-size:14px;text-align:left;width:15%;font-weight: 600;"><strong>M/S</strong></td>
        <td style="border:1px solid;font-size:14px;text-align:left;width:35%;">'.$rel['company_name'].'</td>
        <td style="border:1px solid;font-size:14px;border-right: none;text-align:left;width:25%;"><strong>QUOTATION NO:</strong></td>
        <td style="border:1px solid;font-size:14px;text-align:left;width:25%;border-left: none;"></td>
    </tr>
    <tr>
        <td style="border:1px solid;border-bottom: none;border-top: none;font-size:14px;text-align:left;"><strong>Add :</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;">'.$cadd.'</td>
        <td style="border:1px solid;border-top: none;border-right: none;font-size:14px;text-align:left;"><strong>INVOICE NO:</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;border-left: none;">
            '.$rel['invoice_no'].'
        </td>
    </tr>
    <tr>
        <td style="border:1px solid;border-bottom: none;border-top: none;font-size:14px;text-align:left;"><strong>E-mail:</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;"></td>
        <td style="border:1px solid;border-top: none;border-right: none;font-size:14px;text-align:left;"><strong>DATE:</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;border-left: none;">
            '.date('d/m/Y',strtotime($rel['invoice_date'])).'
        </td>
    </tr>
    <tr>
        <td style="border:1px solid;border-bottom: none;border-top: none;font-size:14px;text-align:left;"><strong>Mob :</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;"></td>
        <td style="border:1px solid;border-top: none;border-right: none;font-size:14px;text-align:left;"><strong>PURCHASE ORNDER. NO:</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;border-left: none;">
            '.$order_no.'
        </td>
    </tr>
    <tr>
        <td style="border:1px solid;border-bottom: none;border-top: none;font-size:14px;text-align:left;"><strong>Kind Attn:</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;"></td>
        <td style="border:1px solid;border-top: none;border-right: none;font-size:14px;text-align:left;"><strong>DATE:</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;border-left: none;">
            '.$order_date.'
    ...
    <tr>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;"><strong>GSTIN:</strong></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;">'.$cons_gst_no.'</td>
        <td style="border:1px solid;border-top: none;border-right: none;font-size:14px;text-align:left;"></td>
        <td style="border:1px solid;border-top: none;font-size:14px;text-align:left;border-left: none;"></td>
    </tr>
</table>
<table style="font-size:14px;border-collapse: collapse;width:100%;" cellpadding="3" cellspacing="3">
<thead>
...
<td style="text-align:center !important; vertical-align:top;border:1px solid;">';
...
$html.='<td style="width:400px;border:1px solid;font-size:14px;border-right:1px solid;vertical-align:top;'.$clas.'" >
...
$html.= '</td>
<td style="vertical-align:top; border:1px solid;border-right:1px solid;white-space:nowrap;font-size:14px;text-align:right" >';
if($row['product_type']!='8'){ 
...
$html.='</td>
<td style="vertical-align:top;font-size:14px;text-align:right;border:1px solid;" >';
if($row['product_type']!='8'){ 
 $html.=$row['unit_name'];
}
$html.='</td>
...
for($j=0; $j<$pr; $j++){
  ...
  <br>
  <span style="font-weight:bold;font-size: 14px"> BANK A/C: </span> <span style="font-size:14px;">'.$set_head['bank_name'].'</span>
  <br>
  <span style="font-weight:bold;font-size: 14px"> BRANCH: </span> <span style="font-size:14px;">'.$set_head['branch_name'].'</span>
  <br>
  ...
  if($rel['stateid']==$set_head['stateid']){
    $html.='CGST ('.($gst_per/2).' %) <span></span><br>SGST ('.($gst_per/2).' %) <span></span>';
}else{
    $html.='IGST ('.($gst_per).' %) <span></span>';
}
$billamt = 0; 
...
<span style="text-align:right">'.number_format(($gst_rate+$billamt),2,".","").'</span>';
$html.='
</td>
</tr>
<tr>
<td style="border:1px solid;font-weight:normal;font-size: 14px;"><strong>GRAND TOTAL</strong>
</td>
<td style="border:1px solid;font-weight:normal;font-size: 14px;text-align:right"><strong>'.number_format($rel['g_total'],2,".","").'</strong>
</td>
</tr>
<tr id="rawnone">
...
<td colspan="3" style="border-bottom:1px solid !important;border-right:none;font-weight:normal;font-size: 14px;" >
...
$mpdf=new mPDF('','A4','0','calibri','10','10','47','2','1','1');
