...
.clearfix::after {
  ...
  display: table;
	...
	<th style="width:50%;text-align:left;border-top:1px solid;border-bottom:1px solid">Description</th>
	<th style="width:15%;text-align:center;border-top:1px solid;border-bottom:1px solid">HSN/SAC</th>
	<th style="width:15%;text-align:center;border-top:1px solid;border-bottom:1px solid">Quantity</th>
	<th style="width:15%;text-align:center;border-top:1px solid;border-bottom:1px solid">UOM</th>
	...
	/*$trn_qry="select trn.*,pro.product_name,unit.unit_name,trn.product_spec as spe, hsn.hsn_code as product_hsn,hsn.sale_gst, pro.product_alias_name from tbl_quotation_trn as trn 
	...
	while($trn_rel=mysqli_fetch_assoc($trn_qry_rs)){
		...
		<td style="width:50%;text-align:left;vertical-align:top; ">'.$trn_rel['product_name'].'<br>'.nl2br($trn_rel['product_desc']).'</strong>';
		...
		$html.='</td>
		<td style="width:15%;text-align:center;vertical-align:top;">'.$trn_rel['product_hsn'].'</td>
		<td style="width:15%;text-align:center;vertical-align:top;">'.$trn_rel['product_qty'].'</td>
		
		
		<td style="width:15%;text-align:center;vertical-align:top;">'.$trn_rel['unit_name'].'</td>';
	...
	if(mysqli_num_rows($terms_qry_rs)){
		$html.='<h4 style="text-align:left; border-top:1px solid;">Terms & Conditions</h4>
	...
	$mpdf=new mPDF('','A4','0','calibri','10','10','37','35','1','1');
