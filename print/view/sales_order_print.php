						...
						<section class="panel">
							...
							<div class="panel-body">
								...
								<div class="col-lg-12" id="receipt_print">	<div class="col-md-12 breakout" style=" margin-top:10px;" id="print1">
									...
									border: 0px solid; padding:17px 0 0;" id="table_head" width="100%">
									<tr style="border:none;">
										<td width="50%" style="border:none;padding:0px 0px !important;"> 
											<img src="<?=DOMAIN.LOGO.$set_head['logo']?>"  style="width:50%"/>
											</td>
											<td width="50%" style="border:none;padding:0px 0px !important;"> 
												<strong><?=$set_head['company_name']?></strong></br>
												<?=$set_head['address']?></br>
												<?php if($set_head['website']){?>Email: <?=$set_head['website']?><?php }?></br>
												<?php if($set_head['contact_no']){?>(M) <?=$set_head['contact_no']?><?php }?></br>
												<?php if($set_head['company_website']){?>Website: <?=$set_head['company_website']?><?php }?>
													...
													<tbody style="border: 1px solid;">
														...
														while($row=mysqli_fetch_assoc($result))
														{
															...
															<tr style="height:40px">
																...
																<tr>
																	<td colspan="3" style="text-align: right; border-right: 1px solid;"><img src="<?=DOMAIN.'view/upload/signature/'.$set_head['authorized_signature'];?>" style="height: 100px; width: : 100px;"></td>
																</tr>
																<tr>
