...
include_once(COMMON_FUNCTION_PATH."common_functions.php");
	...
	$query="select po.*,jo.jobwork_no,ppo.purchaseorder_no,ppo.purchaseorder_date,state.state_name,l.l_name as vender_name,country.country_name,l.m_address as vender_address,l.gst_no as tin_no,l.cust_mobile as vender_mobile,l.stateid,state.gst_state_code,city.city_name,disp.mode_dispatch as modedis from tbl_grn as po 
		...
		left join mode_of_dispatch as disp on disp.mode_dis_id = po.mode_dispatch
...
<section id="container" >
	...
	<div class="row">			
		...
		<div class="panel-body">
			<!-- <center>
				<a href="<?=ROOT.INVENTORY_ROOT.'grn_list'?>" type="button" class="btn btn-info"><i class="fa fa-arrow-left"></i> Back to List</a>
			<center> -->
	<center>
			<div class="col-md-4" ></div>
						<br/>
				<label class="col-md-4 control-label"> With Logo </label>
	...
	<thead>
			...
			<th colspan="11" style="padding:0px !important;">
				<table style="font-size:12px;border-collapse: collapse;border-top:none;" cellpadding="0" cellspacing="0" width="100%" >
					<!--<thead>-->	
						...
						<tr>
							<td width="50%" rowspan="6" style="vertical-align:top;border:1px solid;">
							<b></b>
								<strong><?=$set_head['company_name']?></strong>
								<span style="font-weight:normal;">   <br/>
								<?=$set_head['address']?>
								
								<br/><strong>GST IN/UIN : </strong> <?=$set_head['tin_no']?>
								<br><strong>State Name :</strong> <?=$set_head['state_name']?>, <?=$set_head['gst_state_code']?></span>
									<!--<br>
									Mobile no : <?=$rel['cust_mobile']?>-->
							</td>
						</tr>
						<tr>
							<td width="25%"  style="vertical-align:top;border:1px solid;"><strong>Grn No </strong>
							</td>
							<td width="25%" colspan="" style="vertical-align:top;border:1px solid;"> <strong>Grn Date </strong></strong>
							</td>
						</tr>
						<tr>
							<td style="vertical-align:top;border:1px solid;white-space:nowrap;">
								<span style="font-weight:normal;"><?=$rel['grn_no']?></span>
							</td>
							<td style="vertical-align:top;border:1px solid;">  
								<span style="font-weight:normal;"><?=date('d-m-Y',strtotime($rel['grn_date']))?></span>
							</td>
						</tr>
						<tr>
							<td  style="vertical-align:top;border:1px solid;"><strong>Supplier Invoice No. </strong>
							</td>
							<td colspan="" style="vertical-align:top;border:1px solid;"> <strong>Date</strong>
							</td>
						</tr>
						<tr>
							<td style="vertical-align:top;border:1px solid;white-space:nowrap;height:20px"><span style="font-weight:normal;"><?=$rel['invoice_no']?></span>
							</td>
							<td style="vertical-align:top;border:1px solid;"> 
								<span style="font-weight:normal;"><?=date('d-m-Y',strtotime($rel['grn_date']))?></span>
							</td>
						...
						<tr>
							<td style="vertical-align:top;border:1px solid;white-space:nowrap;"><strong>P.Order No. </strong>
							</td>
							<td style="vertical-align:top;border:1px solid;"> 		
								<strong>Date</strong>
							</td>
						...
						<tr>
							<td width="53.7%" rowspan="4" style="vertical-align:top;border:1px solid;">
								...
								<?=$rel['vender_address']?>
							 	<br>
								State Name <?=$rel['state_name']?>, <?=$rel['gst_state_code']?></span>
								<!--<br>
									Mobile no : <?=$rel['cust_mobile']?>-->
								<br/>GST IN/UIN : <span style="font-weight:normal;"><?=$rel['tin_no']?></span>
							</td>
						</tr>
						<tr>
							<td style="vertical-align:top;border:1px solid;white-space:nowrap;height:25px"><span style="font-weight:normal;"><?=$ref_no?> </span>
							</td>
							<td style="vertical-align:top;border:1px solid;"> 		
								<span style="font-weight:normal;"><?=$purchaseorder_date?></span>
							</td>
						</tr>
						
						<tr>
							<td style="vertical-align:top;border:1px solid;border-right:none;white-space:nowrap;"><strong>Dispatch Through </strong>
							</td>
							<td style="vertical-align:top;border:1px solid;border-left:none;"> : <strong> <?=$rel['modedis']?></strong>
							</td>
						</tr>
						<tr>
							<td style="vertical-align:top;border:1px solid;border-right:none;white-space:nowrap;"><strong>Vehicle No.</strong>
							</td>
							<td style="vertical-align:top;border:1px solid;border-left:none;"> : <?=$rel['vehicle_no']?><strong></strong>
							</td>
						</tr>
						<tr>
							<td style="vertical-align:top;border:1px solid;">Eway Bill : </td>
							<td style="vertical-align:top;border:1px solid;border-right:none;"></td>
							<td style="vertical-align:top;border:1px solid;border-left:none;"></td>
						</tr>
						<!--</thead>-->
				</table>
		...
		<tr>
			...
			<th width="<?=$dynamicwidth?>%" style="text-align:center;border:1px solid;border-top: none;" colspan="2">
				<strong>Description Of Goods / Parts No. </strong>
			</th>
			...
			<th width="8%" style="text-align:center;border:1px solid;border-top: none;">
				<strong>Cat/Part No.</strong>
			</th>
			<th width="8%" style="text-align:center;border:1px solid;border-top: none; padding: 0px 0px !important;">
				<strong>Quantity</strong>
				<table style="border-top:1px solid;border-collapse: collapse">
					<tr>
						<td style="border-right:1px solid;width:32.33%">Invoice Qty.</td>
						<td style="border-right:1px solid;width:38.33%">Recieved Qty.</td>
						<td style="width:33.33%">Reject Qty.</td>
					</tr>
				</table>
			</th>
	...
	<tbody style="border: 1px solid;">
		<?php
			$qry="select trn.*,product.*,ptrn.product_hsn_code,ptrn.product_rate,(select sum(product_qty) from tbl_grn_trn where grn_trn_status=0 and purchaseordertrn_id = ptrn.purchaseordertrn_id) as received_qty,per.unit_name,ptrn.product_rate as prate FROM `tbl_grn_trn` as trn 
			left join product_mst as product on product.product_id=trn.product_id
			left join tbl_purchaseordertrn as ptrn on ptrn.purchaseordertrn_id=trn.purchaseordertrn_id
		...
		?>
		<tr style="">
			<td style="text-align:center;vertical-align:top;border-right:1px solid;border-left:1px solid;border-bottom:1px solid;border-bottom-color:#c9c7c7">
					<?=$i?>
			</td>
			<td style="border-bottom:1px solid; border-right:1px solid;border-bottom-color:#c9c7c7" colspan="2">
			...
			<td style="border-bottom:1px solid; border-right:1px solid;vertical-align:top;text-align:center;border-bottom-color:#c9c7c7" >
			<?=$row['product_hsn_code']?>
			</td>
			...
			<td style="text-align:center;vertical-align:top;border-bottom:1px solid; border-right:1px solid;white-space:nowrap;padding: 0px 0px !important;border-bottom-color:#c9c7c7" >
				<table style="border:none;border-collapse: collapse;width:100%">
					<tr>
						<td style="width:32.33%;border-right:1px solid"><?=$row['product_qty'].' '.$row['unit_name']?> </td>
						<td style="width:38.33%;border-right:1px solid"><?=$row['product_qty'].' '.$row['unit_name']?></td>
						<td style="width:33.33%;">0 <?=$row['unit_name']?></td>
					</tr>
				</table>
			</td>
			<td style="text-align:right;vertical-align:top;border-bottom:1px solid;border-right:1px solid;border-bottom-color:#c9c7c7">
				<?=$row['prate']?>
			</td>
			...
			<td style="text-align:right;vertical-align:top;border-bottom:1px solid;border-right:1px solid;border-bottom-color:#c9c7c7">
				<?php 
					$amount = '';
					$amount = $row['prate'] * $row['product_qty'];
					$disc 	= ($amount*$row['product_disc'])/100;
					$amount = $amount-$disc;
				?>
				<?=$amount?>
			</td>
		...
		?>	
			<tr style="height: 30px">
					<td style="border-right:1px solid;border-left:1px solid;border-bottom: 1px solid;border-bottom-color:<?=$color?>"></td>
					<td style="border-right:1px solid;border-bottom: 1px solid;border-bottom-color:<?=$color?>" colspan="2"></td>
					<td style="border-right:1px solid;border-bottom: 1px solid;border-bottom-color:<?=$color?>"></td>
					<?php /* if($set_head['show_disc']=='1'){*/?>
					<td style="border-right:1px solid;border-bottom: 1px solid;border-bottom-color:<?=$color?>"></td>
					<?php /*}*/?>
					<!--<td style="border-right:1px solid;"></td>-->
					<td style="border-right:1px solid;border-bottom: 1px solid;border-bottom-color:<?=$color?>"></td>
					<td style="border-right:1px solid;padding: 0px 0px !important;border-bottom: 1px solid;border-bottom-color:<?=$color?>">
						<table style="border:none;border-collapse: collapse;width:100%;height:30px;border-bottom-color:<?=$color?>">
							<tr>
								<td style="width:32.33%;border-right:1px solid"></td>
								<td style="width:38.33%;border-right:1px solid"></td>
		...
		<?php } ?>
		<tr>
			<td colspan="6" style="border:1px solid;text-align:right"><b>Total</b></td>
			<td style="border:1px solid;text-align:right;padding:0px 0px !important">
				<table style="border:none;border-collapse: collapse;width:100%;height: 20px">
					<tr>
						<td style="width:32.33%;border-right:1px solid"><strong><?=$totalqty?></strong></td>
						<td style="width:38.33%;border-right:1px solid"><strong><?=$totalqty?></strong></td>
						<td style="width:33.33%;"><strong>0</strong></td>
					</tr>
				</table>
			</td>
			...
			<td style="border:1px solid;text-align:right"></td>
			<td style="border:1px solid;text-align:right"></td>
			<td style="border:1px solid;text-align:right"><strong><?=number_format($totaltaxable,2,".","")?></strong></td>
		</tr>
		<tr>
			<td colspan="7" style="border:1px solid;text-align:right"></td>
			<td colspan="3" style="border:1px solid;text-align:center"><i>Freight</i></td>
			<td style="border:1px solid;text-align:right"></td>
		</tr>	
		<tr>
			<td colspan="7" style="border:1px solid;text-align:right"></td>
			<td colspan="3" style="border:1px solid;text-align:center"><i>Packing & Forwarding</i></td>
			<td style="border:1px solid;text-align:right"></td>
		</tr>
		<tr>
			<td colspan="7" style="border:1px solid;text-align:right"></td>
			<td colspan="3" style="border:1px solid;text-align:center"><i>Purchase IGST 18%</i></td>
			<td style="border:1px solid;text-align:right"></td>
		</tr>
		<tr>
			<td colspan="7" style="border:1px solid;text-align:right"></td>
			<td colspan="3" style="border:1px solid;text-align:center"><i>Grand Total</i></td>
			<td style="border:1px solid;text-align:right"><strong><?=number_format($totaltaxable,2,".","")?></strong></td>
		</tr>	
		<tr>
			<td colspan="7" style="border:1px solid;text-align:left"><strong>Amount Chargeable (in words)</strong></td>
			<td colspan="4" style="border:1px solid;text-align:right">E. & O.E</td>
		</tr>
		<tr>
			<td colspan="7" style="border:1px solid;text-align:left;height:20px"><?=ucfirst(convert_number_to_words($totaltaxable))?></td>
			<td rowspan="4" colspan="4" style="border:1px solid;text-align:left;vertical-align:top"><strong>For, <?=$set_head['company_name']?></strong></td>
		</tr>

		<tr>
			<td colspan="7" style="border:1px solid;text-align:left;height:20px"></td>
		</tr>

		<tr>
			<td colspan="7" style="border:1px solid;text-align:left"><strong>Remarks:</strong></td>
		</tr>
		<tr>
			<td colspan="7" style="border:1px solid;text-align:left;height:20px"><?=$rel['remark']?></td>
		</tr>
		<tr>
			<td colspan="7" style="border:1px solid;text-align:left;height:20px"></td>
			<td colspan="4" style="border:1px solid;text-align:left">Authority Signature</td>
		</tr>
		<tr>
			<td colspan="7" style="border:1px solid;text-align:left;height:20px"></td>
			<td colspan="4" style="border:1px solid;text-align:right"></td>
		</tr>
	</tbody>
