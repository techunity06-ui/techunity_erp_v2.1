...
if(strtolower($type) == 'pdf') {
	...
	// }else{
		...
		$header ='<div style="text-align:center;"><img src="'.DOMAIN_F.LOGO.$set_head["logo"].'" style="width:8.27in;border: 1px white solid" /></div>';
		$footer ='<div style="text-align:center;"><img src="'.DOMAIN_F.LOGO.$set_head["f_logo"].'" style="width:8.27in;border: 1px white solid" /></div>';
	// }
	...
	.page{
		...
		<td colspan="2" style="border-bottom:1px solid;border-right:1px solid;border-left:none;">: '.$r_t['transport_doc_no'].'</td>
		</tr>
		<tr>
		...
		<br>';
		if(!empty($set_head['authorized_signature'])){
		...
		$mpdf = new Mpdf(['format' => 'A4','margin_left' => 10,'margin_right' => 10,'margin_top' => 22,'margin_bottom' => 22,'margin_header' => 1,'margin_footer' => 1,'default_font' => 'calibri']);
		// include("../../view/export/mpdf/mpdf.php");
		// $mpdf=new mPDF('','A4','0','calibri','10','10','22','22','1','1');
