...
.page{
	...
	<body>';
		...
		// ';
		$html .= '<table cellpadding="5" cellspacing="5" border="0" style="font-size: 16px; font-family: calibri; border: 0;">
	<tr>
 ...
 <div style="text-align:center;"><img src="' . DOMAIN_F . LOGO . $comp_rel["logo"] . '" style="width:350px;border: 1px white solid" /></div>
	...
	<tr>
	<td  style="text-align:left;vertical-align: top;">Quotation No.</td>
	<td  style="text-align:right;vertical-align: top;">' . $rel['quotation_no'] . ' </td>
	</tr> 

	<tr>
	<td  style="text-align:left;vertical-align: top;">Date</td>
	<td  style="text-align:right;vertical-align: top;">' . date("d-m-Y", strtotime($rel['quotation_date'])) . ' </td>
	</tr> 
    ...
    <table cellpadding="5" cellspacing="5" border="0" style="font-size: 16px; font-family: calibri; border: 0;">
				...
				<tr>
				    <td style="border: 1px solid black; vertical-align:top; border-right:0px;">To:<br>
                    ' . $quot_address . '<br>
                    Contact:  ' . $rel['c_con_mobile'] . '
	...
	';
	   ...
	   ';
				...
				$html .= '
		                    <td style="border: 1px solid black;text-align: center;width:10%;"><b>Tax</b></td>
			...
			$html .= '<tr>
                   ...
                   <td style="border: 1px solid black;border-top: none; ; border-bottom: none;vertical-align:top;" ><b> ' . $trn_rel['product_icode'] . '</b></td>
                   
                   <td style="border: 1px solid black; text-align:left; padding-left: 5px; border-top: none; border-bottom: none;vertical-align:top;" ><b>' . $trn_rel['product_name'] . '<br>';
			if (!empty($product_desc)) {
				$html .= 'Desc:</b>' . $product_desc . '';
			}
			$html .= ' </td>
			...
			if ($disc_qrys['discount'] > 0) {
				...
				$html .= '   <td style="border: 1px solid black;border-top: none; padding-left: 5px; border-bottom: none;vertical-align:top;text-align:right"><b>' . $trn_rel['discount_per'] . '%</b></td>
';
			}
			if (!empty($total_cs_gst) || !empty($total_i_gst)) {
				if ($rel['c_add_state'] == $comp_rel['stateid']) {
					$html .= '
		<td style="border: 1px solid black;border-top: none; padding-left: 5px; border-bottom: none;vertical-align:top;text-align:right"><b>
		' . $trn_rel['cgst_tax_per'] . '%<br>
		' . $trn_rel['sgst_tax_per'] . '%
		</b></td>';
		...
		' . $trn_rel['igst_tax_per'] . '%
			...
			if ($cnt == $p) {
				$html .= '<tr style="">
					<td style="border: 1px solid black; width: 40px; text-align: right;" colspan="' . ($colspan - 6) . '"><b>TOTAL QUANTITY</b></td> 
                   ...
                   <td style="border: 1px solid black;text-align:right"><b></b></td>
                   <td style="border: 1px solid black;text-align:right"><b>Sub Total</b></td>
           ...
           where b.sundry_voucher_id=" . $rel['quotation_id'] . " and b.sundry_voucher_table='tbl_quotation' and b.isdelete='0' and le.default_sundry='0'";
				...
				while ($row12 = mysqli_fetch_assoc($result12)) {
					$html .= '<tr>
               <td style="border: 1px solid black; width: 40px; text-align: right;" colspan="' . ($colspan - 2) . '"><b>' . strtoupper($row12['l_name']) . '</b></td>
               <td  style="border: 1px solid black;text-align:right"><b> ' . $currency_symbol . ' ' . number_format($row12['sundry_amount_conv'], 2, ".", "") . '</b></td>';
				...
				$html .= '<tr>
               <td style="border: 1px solid black; width: 40px; text-align: right;" colspan="' . ($colspan - 2) . '"><b>Total Amount </b></td>
           ...
           <tr>
			 ...
			 <div style=
			 "text-align:center;">This is a Software Generated Quotation. Continued ...</div>';
			}
	...
	';
		...
		$html .= '
			<table class="pxborder" style="font-size: 12px; font-family: Arial, Helvetica, sans-serif;border:1px solid black;">
			<tr>
		<td style=" white-space: pre-line;">	<h3 text-align:left;padding-left:30px;>Bank Details</h3><br>
		<b>Bank Name</b> : ' . $comp_rel['bank_name'] . ' <br>
<b>Account Name</b> :  ' . $comp_rel['company_name'] . ' <br>
<b>Account No</b> :  ' . $comp_rel['ac_no'] . ' <br>

<b>IFSC Code</b> :  ' . $comp_rel['ifcs'] . ' 
</td>
		</tr>
      		';
		...
		$html .= '</table>
		   <div style=
		   "text-align:center;">This is a Software Generated Quotation.</div>';
		...
		$mpdf = new mPDF('', 'A4', '0', 'proximanova', '10', '10', '5', '5', '1', '1');
