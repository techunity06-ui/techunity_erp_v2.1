...
$query="select invoice.*,country.country_name,state.state_name,cust.stateid,state.gst_state_code, city.city_name, cust.l_name, cust.m_address, cust_pincode, cust_mobile, gst_no, cust.m_pan from tbl_pono as invoice 
...
$purchase_pro_print=explode(",", $company_config['purchase_pro_print']);

$sundrytax=$dbcon->query("select b.* from tbl_bill_sundry_transaction as b where b.sundry_voucher_id=".$rel['po_id']." and b.sundry_voucher_table='tbl_pono' and b.isdelete='0' ");
...
$qry_disc="SELECT SUM(trn.product_discount) as discount FROM `tbl_potrancation` as trn where potrancation_status =0 and po_id=".$rel['po_id'];
// $rel_disc = brp_mysqli_fetch_assoc($qry_disc);
$result = $dbcon->query($qry_disc);
$rel_disc = brp_mysqli_fetch_assoc($result);
											...
											<table  class="maintable headermain " id="table_head" width="100%">
												...
												<table width="100%" class="maintable" style=" font-size:11px" id="invoice_type" >
														...
														<tr>
															<th colspan="11" style="padding:0px !important;">
																<table style="font-size:10px;border-collapse: collapse;border-top:none !important;" cellpadding="0" cellspacing="0" width="100%" >
																	...
																	<tr>
																		<td class="" style="vertical-align:top;border:1px solid; border-right:none !important;"><strong>PO No </strong>
																		</td>
																		<td width="20%" colspan="" style="vertical-align:top;border-bottom:1px solid; border-right:1px solid;border-top:1px solid">: <strong><?=$rel['po_no']?></strong>
																		</td>
																		<td width="10%" style="vertical-align:top;border-bottom:1px solid;border-top:1px solid"><strong>Date </strong>
																		</td>
																		<td width="20%" style="vertical-align:top;border-bottom:1px solid;border-right:1px solid;border-top:1px solid" colspan="">: <strong><?=$po_date?></strong>
																		</td>
																		...
																		<td width="38%" style="vertical-align:top;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">: <?=$r_t['transportation_name']?></td>							
																	</tr>
																	<tr>
																		...
																		<td style="vertical-align:top;border-bottom:1px solid;border-right:1px solid;">: <?=$r_t['transport_doc_no']?></td>
																	</tr>
																	<tr>
																		<td class="boderremoveres" style="vertical-align:top;border-bottom:1px solid;border-left:1px solid;"><strong>Po No </strong></td>
																		<td style="vertical-align:top;border-bottom:1px solid;border-right:1px solid" colspan="">: <?=$rel['po_no'];?> </td>
																		<td style="vertical-align:top;border-bottom:1px solid "><strong>Date </strong></td>
																	...
																	<tr>
																		...
																		<td style="vertical-align:top;border-bottom:1px solid;border-right:1px solid">: <?=$r_t['transport_vehicle_no']?></td>
																	...
																	<tr id="rawnone">
																		...
																		<tr id="rawnone"> 
																			<td colspan="2" width="25%" style="border-left:1px solid;border-bottom:1px solid;font-weight:normal;">State : <?=$rel['state_name']?></td>
																			<td colspan="2" width="23.5%" style="border-right:1px solid;text-align:left;border-bottom:1px solid;border-right:1px solid;font-weight:normal;">Code : <?=$cons_data['gst_state_code']?></td>
													...
													<tbody style="border: none;">
														<?php $qry="select trn.*,product.*,unit_name FROM `tbl_potrancation` as trn left join product_mst as product on product.product_id=trn.product_id left join unit_mst as per on per.unitid=trn.unit_id where potrancation_status =0 and po_id=".$rel['po_id']." group by potrancation_id order by product.product_type,potrancation_id";
														...
														while($row=mysqli_fetch_assoc($result))
														{
															...
															if(in_array('alias',$purchase_pro_print)){
																$alias_name = " -- (".$row['product_alias_name'].")";
															}
														...
														//tax summary calculation start
															...
															<tr style="height:25px">
																<td class="borderleftadd" style="text-align:center !important; vertical-align:top;border-right:1px solid;border-left:1px solid;">
																	<?php if($row['product_type']!='9'){ echo $i;}?>
																</td>
																<td style="border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;<?php if($row['product_type']=='9'){ echo 'text-align:right !important;padding-top:5px;vertical-align:top;';}?>" >
																	<strong><?=stripcslashes($row['product_name'])?><?=$alias_name?></strong>
															...
															<tr style="height:20px">
																...
																<?php if($company_config['tax_editable'] == 0){ ?>
																	...
																	<td style="border-top:1px solid;border-right:1px solid;text-align:right  !important;">
																		<strong><?=number_format($gst_rate,2,".","")?></strong>
																	</td>
																	<td style="border-top:1px solid;border-right:1px solid;text-align:right  !important;">
															...
															<tr>
																	...
																	<table class="footer-table" width="100%">
																		...
																		<?php if($rel['stateid']==$set_head['stateid'] && ($custLedgerDetails['enable_sez'] == 0)){ ?>
																			...
																			<tr height="20px">
																				...
																				<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-left:1px solid; "><?=number_format($c_gst,2,".","")?></td>
																			</tr>
																			<tr height="20px">
																				<td  style="border-right:1px solid;border-top:1px solid; font-size:10px;" colspan="<?=$colspan?>">
																				</td>
																				...
																				<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-left:1px solid; "><?=number_format($s_gst,2,".","")?></td>
																			</tr>
																		<?php }else{ ?>
																			<tr height="20px">
																				<td  style="border-right:1px solid;border-top:1px solid; font-size:10px;" colspan="<?=$colspan?>">
																				...
																				?>
																				<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-left:1px solid; "><?=number_format($i_gst,2,".","")?></td>
																			</tr>
																		<?php } ?>
																		<?php 
																		...
																		where b.sundry_voucher_id=".$rel['po_id']." and b.sundry_voucher_table='tbl_pono' and b.isdelete='0' ";
																		...
																		if(brp_mysqli_num_rows($result121)>0)
																		{
																			...
																			<tr height="20px">
																				...
																				<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-left:1px solid; "><?=number_format($tcs_gst,2,".","")?></td>
																			</tr>
																		<?php }
																		$qry11="select sum((tc.tax_per*trn.product_amount)/100) as add_sum ,l.l_name,l.l_id,t.tax_cat_id from tbl_potrancation as trn 
																		...
																		where tc.tax_additional='1' and trn.po_id=".$rel['po_id']." and trn.potrancation_status!=2 and tc.isdelete='0' group by tc.tax_id";
																		...
																		from tbl_bill_sundry_transaction as b left join tbl_ledger_bill_sundry as l on l.bill_sundry_id=b.sundry_ledger_id 
																		left join tbl_ledger as le on le.l_id=b.sundry_ledger_id 
																		where b.sundry_voucher_id=".$rel['po_id']." and b.sundry_voucher_table='tbl_pono' and b.isdelete='0' and le.default_sundry='0' ";
																	...
																	<?php if($rel['formulaid']){
																		...
																		<tr height="20px">
																			<td style="border-right:1px solid;border-top:1px solid;font-size:12px;" colspan="<?=$colspan?>">
																				<strong>COMPANY GSTIN : <?=$set_head['vatno']?> </strong><br>
																			</td>
																			<td colspan="3" style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left  !important">Round Off</td>
																			<td colspan="2" style="text-align:right  !important; border-top:1px solid;font-size:10px;border-left:1px solid; "><?=number_format($round,2);?></td>
																		</tr>
																		<tr height="20px">
																			<td style="border-right:1px solid;border-top:1px solid;font-size:10px;" colspan="<?=$colspan?>">
																				<strong>Rupees:</strong>
																				<?=ucwords(convert_number_to_words_new(round($rel['g_total'])))?>
																			</td>
																			<td colspan="3" style="border-top:1px solid;border-right:1px solid;font-size:10px;text-align:left  !important">
																			...
																			<tr>
																				...
																				//Sundry Tax Details
																					$sundrytax1=$dbcon->query("select b.*,tl.ledger_hsn from tbl_bill_sundry_transaction as b
																						...
																						where b.sundry_voucher_id=".$rel['po_id']." and b.sundry_voucher_table='tbl_pono' and b.isdelete='0' ");
																					while($sundry_tax=mysqli_fetch_assoc($sundrytax1))
																					{	
																					//echo $sundry_tax['sundry_gst_amount'];
																					...
																					echo '<td style="vertical-align:top;text-align:center;border-top:1px solid;">'.number_format($total1+$total_sun1,2).'</td></tr></table>';
																					?>
																				</td>
																			</tr>
																		<?php } ?>
																...
																<tr>
																	...
																	<td colspan="5" style=" border-left:none;vertical-align:top;border-top:1px solid black; text-align: center;">
																		For, <strong> <span style="font-size:10px;text-decoration:bold;">
																			<?=$set_head['company_name']?></span></strong>
																			<br><img src="<?=DOMAIN_F.'view/upload/signature/'.$set_head['authorized_signature'];?>" style="height: 100px; width: 100px;"><br>
