														...
														//tax summary calculation start
															...
															<tr style="height:25px">
																<td class="borderleftadd" style="text-align:center !important; vertical-align:top;border-right:1px solid;border-left:1px solid;">
																	<?phpif($row['product_type']!='9'){ echo $i;}?>
																</td>
																<td style="border-bottom-color:#FFFFFF; border-right:1px solid;vertical-align:top;<?phpif($row['product_type']=='9'){ echo 'text-align:right !important;padding-top:5px;vertical-align:top;';}?>" >
